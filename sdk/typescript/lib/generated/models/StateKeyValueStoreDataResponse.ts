 ...
 */
export function instanceOfStateKeyValueStoreDataResponse(value: object): boolean {
    let isInstance = true;
...
export function StateKeyValueStoreDataResponseFromJSON(json: any): StateKeyValueStoreDataResponse {
    return StateKeyValueStoreDataResponseFromJSONTyped(json, false);
}

export function StateKeyValueStoreDataResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): StateKeyValueStoreDataResponse {
...
export function StateKeyValueStoreDataResponseToJSON(value?: StateKeyValueStoreDataResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
