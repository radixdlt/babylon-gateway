 ...
 */
export function instanceOfResourceHoldersResponse(value: object): boolean {
    let isInstance = true;
...
export function ResourceHoldersResponseFromJSON(json: any): ResourceHoldersResponse {
    return ResourceHoldersResponseFromJSONTyped(json, false);
}

export function ResourceHoldersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResourceHoldersResponse {
...
export function ResourceHoldersResponseToJSON(value?: ResourceHoldersResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
