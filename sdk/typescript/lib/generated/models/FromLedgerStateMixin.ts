 ...
 */
export function instanceOfFromLedgerStateMixin(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function FromLedgerStateMixinFromJSON(json: any): FromLedgerStateMixin {
    return FromLedgerStateMixinFromJSONTyped(json, false);
}

export function FromLedgerStateMixinFromJSONTyped(json: any, ignoreDiscriminator: boolean): FromLedgerStateMixin {
...
export function FromLedgerStateMixinToJSON(value?: FromLedgerStateMixin | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
