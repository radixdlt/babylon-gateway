 ...
 * @export
 */
export const NativeResourceKind = {
    Xrd: 'Xrd',
...
export function NativeResourceKindFromJSON(json: any): NativeResourceKind {
    return NativeResourceKindFromJSONTyped(json, false);
}

export function NativeResourceKindFromJSONTyped(json: any, ignoreDiscriminator: boolean): NativeResourceKind {
    return json as NativeResourceKind;
}

export function NativeResourceKindToJSON(value?: NativeResourceKind | null): any {
    return value as any;
}
