 ...
 */
export function instanceOfStateEntityNonFungiblesPageRequestAllOf(value: object): boolean {
    let isInstance = true;
...
export function StateEntityNonFungiblesPageRequestAllOfFromJSON(json: any): StateEntityNonFungiblesPageRequestAllOf {
    return StateEntityNonFungiblesPageRequestAllOfFromJSONTyped(json, false);
}

export function StateEntityNonFungiblesPageRequestAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): StateEntityNonFungiblesPageRequestAllOf {
...
export function StateEntityNonFungiblesPageRequestAllOfToJSON(value?: StateEntityNonFungiblesPageRequestAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
