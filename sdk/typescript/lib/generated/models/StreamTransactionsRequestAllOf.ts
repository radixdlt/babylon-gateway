 ...
 * @export
 */
export const StreamTransactionsRequestAllOfTransactionStatusFilterEnum = {
    Success: 'Success',
    Failure: 'Failure',
    All: 'All'
} as const;
...
export function StreamTransactionsRequestAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTransactionsRequestAllOf {
    ...
    return {
        ...
        'event_global_emitters_filter': !exists(json, 'event_global_emitters_filter') ? undefined : json['event_global_emitters_filter'],
        'balance_change_resources_filter': !exists(json, 'balance_change_resources_filter') ? undefined : json['balance_change_resources_filter'],
        'transaction_status_filter': !exists(json, 'transaction_status_filter') ? undefined : json['transaction_status_filter'],
...
export function StreamTransactionsRequestAllOfToJSON(value?: StreamTransactionsRequestAllOf | null): any {
    ...
    return {
        ...
        'balance_change_resources_filter': value.balance_change_resources_filter,
        'transaction_status_filter': value.transaction_status_filter,
        'order': value.order,
