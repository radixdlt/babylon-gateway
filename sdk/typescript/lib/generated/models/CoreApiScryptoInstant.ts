 ...
 * 
 * @export
 * @interface CoreApiScryptoInstant
 */
export interface CoreApiScryptoInstant {
    /**
     ...
     * places of this API.
     * @type {string}
     * @memberof CoreApiScryptoInstant
     */
...
/**
 * Check if a given object implements the CoreApiScryptoInstant interface.
 */
export function instanceOfCoreApiScryptoInstant(value: object): boolean {
    let isInstance = true;
...
export function CoreApiScryptoInstantFromJSON(json: any): CoreApiScryptoInstant {
    return CoreApiScryptoInstantFromJSONTyped(json, false);
}

export function CoreApiScryptoInstantFromJSONTyped(json: any, ignoreDiscriminator: boolean): CoreApiScryptoInstant {
...
export function CoreApiScryptoInstantToJSON(value?: CoreApiScryptoInstant | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
