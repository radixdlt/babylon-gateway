...
import {
    ...
    instanceOfAccountAuthorizedDepositorsNonFungibleBadge,
    AccountAuthorizedDepositorsNonFungibleBadgeFromJSON,
    AccountAuthorizedDepositorsNonFungibleBadgeFromJSONTyped,
    AccountAuthorizedDepositorsNonFungibleBadgeToJSON,
} from './AccountAuthorizedDepositorsNonFungibleBadge';
import {
 ...
 * @export
 */
export type AccountAuthorizedDepositorsResponseItem = { badge_type: 'NonFungibleBadge' } & AccountAuthorizedDepositorsNonFungibleBadge | { badge_type: 'ResourceBadge' } & AccountAuthorizedDepositorsResourceBadge;
...
export function AccountAuthorizedDepositorsResponseItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountAuthorizedDepositorsResponseItem {
    ...
    switch (json['badge_type']) {
        case 'NonFungibleBadge':
            return {...AccountAuthorizedDepositorsNonFungibleBadgeFromJSONTyped(json, true), badge_type: 'NonFungibleBadge'};
        case 'ResourceBadge':
...
export function AccountAuthorizedDepositorsResponseItemToJSON(value?: AccountAuthorizedDepositorsResponseItem | null): any {
    ...
    switch (value['badge_type']) {
        case 'NonFungibleBadge':
            return AccountAuthorizedDepositorsNonFungibleBadgeToJSON(value);
        case 'ResourceBadge':
