 ...
 * 
 * @export
 * @interface CoreApiEpochChangeCondition
 */
export interface CoreApiEpochChangeCondition {
    /**
     * An integer between `0` and `10^10`, specifying the minimum number of rounds per epoch
     * @type {number}
     * @memberof CoreApiEpochChangeCondition
     */
...
/**
 * Check if a given object implements the CoreApiEpochChangeCondition interface.
 */
export function instanceOfCoreApiEpochChangeCondition(value: object): boolean {
    let isInstance = true;
...
export function CoreApiEpochChangeConditionFromJSON(json: any): CoreApiEpochChangeCondition {
    return CoreApiEpochChangeConditionFromJSONTyped(json, false);
}

export function CoreApiEpochChangeConditionFromJSONTyped(json: any, ignoreDiscriminator: boolean): CoreApiEpochChangeCondition {
...
export function CoreApiEpochChangeConditionToJSON(value?: CoreApiEpochChangeCondition | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
