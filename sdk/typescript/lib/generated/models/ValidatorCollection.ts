 ...
 */
export function instanceOfValidatorCollection(value: object): boolean {
    let isInstance = true;
...
export function ValidatorCollectionFromJSON(json: any): ValidatorCollection {
    return ValidatorCollectionFromJSONTyped(json, false);
}

export function ValidatorCollectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): ValidatorCollection {
...
export function ValidatorCollectionToJSON(value?: ValidatorCollection | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
