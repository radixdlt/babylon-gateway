 ...
 * @export
 */
export const ProgrammaticScryptoSborValueEnumKindEnum = {
    Enum: 'Enum'
} as const;
 ...
 */
export function instanceOfProgrammaticScryptoSborValueEnum(value: object): boolean {
    let isInstance = true;
...
export function ProgrammaticScryptoSborValueEnumFromJSON(json: any): ProgrammaticScryptoSborValueEnum {
    return ProgrammaticScryptoSborValueEnumFromJSONTyped(json, false);
}

export function ProgrammaticScryptoSborValueEnumFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProgrammaticScryptoSborValueEnum {
...
export function ProgrammaticScryptoSborValueEnumToJSON(value?: ProgrammaticScryptoSborValueEnum | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
