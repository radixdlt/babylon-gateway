 ...
 * 
 * @export
 * @interface CoreApiTransactionTrackerFieldStateValue
 */
export interface CoreApiTransactionTrackerFieldStateValue {
    /**
     * 
     * @type {number}
     * @memberof CoreApiTransactionTrackerFieldStateValue
     */
    start_epoch: number;
    /**
     * 
...
/**
 * Check if a given object implements the CoreApiTransactionTrackerFieldStateValue interface.
 */
export function instanceOfCoreApiTransactionTrackerFieldStateValue(value: object): boolean {
    let isInstance = true;
...
export function CoreApiTransactionTrackerFieldStateValueFromJSON(json: any): CoreApiTransactionTrackerFieldStateValue {
    return CoreApiTransactionTrackerFieldStateValueFromJSONTyped(json, false);
}

export function CoreApiTransactionTrackerFieldStateValueFromJSONTyped(json: any, ignoreDiscriminator: boolean): CoreApiTransactionTrackerFieldStateValue {
...
export function CoreApiTransactionTrackerFieldStateValueToJSON(value?: CoreApiTransactionTrackerFieldStateValue | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
