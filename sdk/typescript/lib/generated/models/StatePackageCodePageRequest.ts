 ...
 */
export function instanceOfStatePackageCodePageRequest(value: object): boolean {
    let isInstance = true;
...
export function StatePackageCodePageRequestFromJSON(json: any): StatePackageCodePageRequest {
    return StatePackageCodePageRequestFromJSONTyped(json, false);
}

export function StatePackageCodePageRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): StatePackageCodePageRequest {
...
export function StatePackageCodePageRequestToJSON(value?: StatePackageCodePageRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
