 ...
 */
export function instanceOfStateAccountResourcePreferencesPageResponse(value: object): boolean {
    let isInstance = true;
...
export function StateAccountResourcePreferencesPageResponseFromJSON(json: any): StateAccountResourcePreferencesPageResponse {
    return StateAccountResourcePreferencesPageResponseFromJSONTyped(json, false);
}

export function StateAccountResourcePreferencesPageResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): StateAccountResourcePreferencesPageResponse {
...
export function StateAccountResourcePreferencesPageResponseToJSON(value?: StateAccountResourcePreferencesPageResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
