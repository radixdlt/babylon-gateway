...
/**
 * Check if a given object implements the CoreApiFeeSummary interface.
 */
export function instanceOfCoreApiFeeSummary(value: object): boolean {
    let isInstance = true;
...
export function CoreApiFeeSummaryFromJSON(json: any): CoreApiFeeSummary {
    return CoreApiFeeSummaryFromJSONTyped(json, false);
}

export function CoreApiFeeSummaryFromJSONTyped(json: any, ignoreDiscriminator: boolean): CoreApiFeeSummary {
...
export function CoreApiFeeSummaryToJSON(value?: CoreApiFeeSummary | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
