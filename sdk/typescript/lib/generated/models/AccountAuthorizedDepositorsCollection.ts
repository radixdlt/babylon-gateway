 ...
 */
export function instanceOfAccountAuthorizedDepositorsCollection(value: object): boolean {
    let isInstance = true;
...
export function AccountAuthorizedDepositorsCollectionFromJSON(json: any): AccountAuthorizedDepositorsCollection {
    return AccountAuthorizedDepositorsCollectionFromJSONTyped(json, false);
}

export function AccountAuthorizedDepositorsCollectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountAuthorizedDepositorsCollection {
...
export function AccountAuthorizedDepositorsCollectionToJSON(value?: AccountAuthorizedDepositorsCollection | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
