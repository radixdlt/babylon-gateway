 ...
 * @export
 */
export const CoreApiSubstateType = {
...
export type CoreApiSubstateType = typeof CoreApiSubstateType[keyof typeof CoreApiSubstateType];


export function CoreApiSubstateTypeFromJSON(json: any): CoreApiSubstateType {
    return CoreApiSubstateTypeFromJSONTyped(json, false);
}

export function CoreApiSubstateTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CoreApiSubstateType {
    return json as CoreApiSubstateType;
}

export function CoreApiSubstateTypeToJSON(value?: CoreApiSubstateType | null): any {
    return value as any;
}
