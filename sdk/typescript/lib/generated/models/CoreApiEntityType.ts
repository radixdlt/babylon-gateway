 ...
 * @export
 */
export const CoreApiEntityType = {
...
export type CoreApiEntityType = typeof CoreApiEntityType[keyof typeof CoreApiEntityType];


export function CoreApiEntityTypeFromJSON(json: any): CoreApiEntityType {
    return CoreApiEntityTypeFromJSONTyped(json, false);
}

export function CoreApiEntityTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CoreApiEntityType {
    return json as CoreApiEntityType;
}

export function CoreApiEntityTypeToJSON(value?: CoreApiEntityType | null): any {
    return value as any;
}
