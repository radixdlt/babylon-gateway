 ...
 */
export function instanceOfStateEntitySchemaPageRequest(value: object): boolean {
    let isInstance = true;
...
export function StateEntitySchemaPageRequestFromJSON(json: any): StateEntitySchemaPageRequest {
    return StateEntitySchemaPageRequestFromJSONTyped(json, false);
}

export function StateEntitySchemaPageRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): StateEntitySchemaPageRequest {
...
export function StateEntitySchemaPageRequestToJSON(value?: StateEntitySchemaPageRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
