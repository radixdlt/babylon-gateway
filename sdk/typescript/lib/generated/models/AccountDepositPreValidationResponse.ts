 ...
 */
export function instanceOfAccountDepositPreValidationResponse(value: object): boolean {
    let isInstance = true;
...
export function AccountDepositPreValidationResponseFromJSON(json: any): AccountDepositPreValidationResponse {
    return AccountDepositPreValidationResponseFromJSONTyped(json, false);
}

export function AccountDepositPreValidationResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountDepositPreValidationResponse {
...
export function AccountDepositPreValidationResponseToJSON(value?: AccountDepositPreValidationResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
