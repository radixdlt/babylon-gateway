...
{
    // We believe the transaction is in at least one node mempool, or will hopefully (just) be entering one, or has entered one
    SubmittedOrKnownInNodeMempool,

    // A transaction which was previously SubmittedOrKnownInNodeMempool, but at last check, was past its
