...
namespace RadixDlt.NetworkGateway.FrontendSdk.Model
{
    ...
    /// TransferTokens
    /// </summary>
    [DataContract(Name = "TransferTokens")]
    ...
    public partial class TransferTokens : Action, IEquatable<TransferTokens>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferTokens" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransferTokens() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferTokens" /> class.
        /// </summary>
        ...
        /// <param name="type">type (required) (default to &quot;TransferTokens&quot;).</param>
        public TransferTokens(AccountIdentifier fromAccount = default(AccountIdentifier), AccountIdentifier toAccount = default(AccountIdentifier), TokenAmount amount = default(TokenAmount), string type = "TransferTokens") : base(type)
        {
            // to ensure "fromAccount" is required (not null)
            if (fromAccount == null)
            {
                throw new ArgumentNullException("fromAccount is a required property for TransferTokens and cannot be null");
            }
            this.FromAccount = fromAccount;
            // to ensure "toAccount" is required (not null)
            if (toAccount == null)
            {
                throw new ArgumentNullException("toAccount is a required property for TransferTokens and cannot be null");
            }
            this.ToAccount = toAccount;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for TransferTokens and cannot be null");
            }
            this.Amount = amount;
        }
        ...
        {
            return this.Equals(input as TransferTokens);
        }

        /// <summary>
        /// Returns true if TransferTokens instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferTokens to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferTokens input)
        {
            if (input == null)
            {
                return false;
