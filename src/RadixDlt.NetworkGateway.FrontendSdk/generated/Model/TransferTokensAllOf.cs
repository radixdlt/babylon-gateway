...
namespace RadixDlt.NetworkGateway.FrontendSdk.Model
{
    ...
    /// TransferTokensAllOf
    /// </summary>
    [DataContract(Name = "TransferTokens_allOf")]
    public partial class TransferTokensAllOf : IEquatable<TransferTokensAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferTokensAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransferTokensAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferTokensAllOf" /> class.
        /// </summary>
        ...
        public TransferTokensAllOf(AccountIdentifier fromAccount = default(AccountIdentifier), AccountIdentifier toAccount = default(AccountIdentifier), TokenAmount amount = default(TokenAmount))
        {
            // to ensure "fromAccount" is required (not null)
            if (fromAccount == null)
            {
                throw new ArgumentNullException("fromAccount is a required property for TransferTokensAllOf and cannot be null");
            }
            this.FromAccount = fromAccount;
            // to ensure "toAccount" is required (not null)
            if (toAccount == null)
            {
                throw new ArgumentNullException("toAccount is a required property for TransferTokensAllOf and cannot be null");
            }
            this.ToAccount = toAccount;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for TransferTokensAllOf and cannot be null");
            }
            this.Amount = amount;
        }
        ...
        {
            return this.Equals(input as TransferTokensAllOf);
        }

        /// <summary>
        /// Returns true if TransferTokensAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferTokensAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferTokensAllOf input)
        {
            if (input == null)
            {
                return false;
