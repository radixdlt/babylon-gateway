...
namespace RadixDlt.NetworkGateway.FrontendSdk.Api
{
    ...
    public partial class StatusApi : IDisposable, IStatusApi
    {
        ...
        /// <returns></returns>
        public StatusApi(RadixDlt.NetworkGateway.FrontendSdk.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public StatusApi(HttpClient client, RadixDlt.NetworkGateway.FrontendSdk.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public StatusApi(RadixDlt.NetworkGateway.FrontendSdk.Client.ISynchronousClient client, RadixDlt.NetworkGateway.FrontendSdk.Client.IAsynchronousClient asyncClient, RadixDlt.NetworkGateway.FrontendSdk.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            RadixDlt.NetworkGateway.FrontendSdk.Client.ApiResponse<GatewayResponse> localVarResponse = GatewayPostWithHttpInfo(body);
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of GatewayResponse</returns>
        public RadixDlt.NetworkGateway.FrontendSdk.Client.ApiResponse<GatewayResponse> GatewayPostWithHttpInfo(Object body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new RadixDlt.NetworkGateway.FrontendSdk.Client.ApiException(400, "Missing required parameter 'body' when calling StatusApi->GatewayPost");
        ...
        {
            RadixDlt.NetworkGateway.FrontendSdk.Client.ApiResponse<GatewayResponse> localVarResponse = await GatewayPostWithHttpInfoAsync(body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GatewayResponse)</returns>
        public async System.Threading.Tasks.Task<RadixDlt.NetworkGateway.FrontendSdk.Client.ApiResponse<GatewayResponse>> GatewayPostWithHttpInfoAsync(Object body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new RadixDlt.NetworkGateway.FrontendSdk.Client.ApiException(400, "Missing required parameter 'body' when calling StatusApi->GatewayPost");
