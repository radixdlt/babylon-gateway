...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230906132318_InitialCreate') THEN
    ...
    CREATE TYPE pending_transaction_status AS ENUM ('submitted_or_known_in_node_mempool', 'missing', 'rejected_temporarily', 'rejected_permanently', 'committed_success', 'committed_failure');
...
BEGIN
    ...
    CREATE TABLE ledger_transactions (
        ...
        tip_paid numeric(1000,0) NOT NULL,
...
BEGIN
    ...
    CREATE TABLE resource_entity_supply_history (
        ...
        total_burned numeric(1000,0) NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230906132318_InitialCreate') THEN
    CREATE INDEX "IX_entities_address" ON entities (address);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230906132318_InitialCreate') THEN
    CREATE INDEX "IX_pending_transactions_status" ON pending_transactions (status);
    END IF;
END $EF$;
...
BEGIN
    ...
    VALUES ('20230906132318_InitialCreate', '7.0.9');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230912125744_AddIndexOnEntitiesTable') THEN
    DROP INDEX "IX_entities_address";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230912125744_AddIndexOnEntitiesTable') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20230912125744_AddIndexOnEntitiesTable', '7.0.9');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230912130716_HandleRemoteGenericSchemaAssignment') THEN
    ALTER TABLE non_fungible_schema_history ADD schema_defining_entity_id bigint NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230912130716_HandleRemoteGenericSchemaAssignment') THEN
    ALTER TABLE key_value_store_schema_history ADD key_schema_defining_entity_id bigint NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230912130716_HandleRemoteGenericSchemaAssignment') THEN
    ALTER TABLE key_value_store_schema_history ADD value_schema_defining_entity_id bigint NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230912130716_HandleRemoteGenericSchemaAssignment') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20230912130716_HandleRemoteGenericSchemaAssignment', '7.0.9');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230912144644_MarkSchemaDefiningColumnsAsRequired') THEN
    UPDATE key_value_store_schema_history SET value_schema_defining_entity_id = key_value_store_entity_id
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230912144644_MarkSchemaDefiningColumnsAsRequired') THEN
    UPDATE key_value_store_schema_history SET key_schema_defining_entity_id = key_value_store_entity_id
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230912144644_MarkSchemaDefiningColumnsAsRequired') THEN
    UPDATE non_fungible_schema_history SET schema_defining_entity_id = resource_entity_id
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230912144644_MarkSchemaDefiningColumnsAsRequired') THEN
    UPDATE non_fungible_schema_history SET schema_defining_entity_id = 0 WHERE schema_defining_entity_id IS NULL;
    ALTER TABLE non_fungible_schema_history ALTER COLUMN schema_defining_entity_id SET NOT NULL;
    ALTER TABLE non_fungible_schema_history ALTER COLUMN schema_defining_entity_id SET DEFAULT 0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230912144644_MarkSchemaDefiningColumnsAsRequired') THEN
    UPDATE key_value_store_schema_history SET value_schema_defining_entity_id = 0 WHERE value_schema_defining_entity_id IS NULL;
    ALTER TABLE key_value_store_schema_history ALTER COLUMN value_schema_defining_entity_id SET NOT NULL;
    ALTER TABLE key_value_store_schema_history ALTER COLUMN value_schema_defining_entity_id SET DEFAULT 0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230912144644_MarkSchemaDefiningColumnsAsRequired') THEN
    UPDATE key_value_store_schema_history SET key_schema_defining_entity_id = 0 WHERE key_schema_defining_entity_id IS NULL;
    ALTER TABLE key_value_store_schema_history ALTER COLUMN key_schema_defining_entity_id SET NOT NULL;
    ALTER TABLE key_value_store_schema_history ALTER COLUMN key_schema_defining_entity_id SET DEFAULT 0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230912144644_MarkSchemaDefiningColumnsAsRequired') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20230912144644_MarkSchemaDefiningColumnsAsRequired', '7.0.9');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230914131533_CreateNonFungibleIdLocationHistory') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230914131533_CreateNonFungibleIdLocationHistory') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20230914131533_CreateNonFungibleIdLocationHistory', '7.0.9');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230915082111_AddRoyaltyVaultIndexToVaultHistory') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230915082111_AddRoyaltyVaultIndexToVaultHistory') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20230915082111_AddRoyaltyVaultIndexToVaultHistory', '7.0.9');
    END IF;
END $EF$;
COMMIT;
