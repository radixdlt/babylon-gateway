...
namespace RadixDlt.NetworkGateway.Workers;
...
public class LedgerSynchronizationWorker : BackgroundService
{
    ...
    public LedgerSynchronizationWorker(DistributedLockService distributedLockService, IOptionsMonitor<DataAggregatorOptions> optionsMonitor)
    {
