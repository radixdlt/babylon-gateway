...
//
// public record ResourceOwner(EntityAddress OwnerAddress);
//
// public record FungibleResourceOwner(EntityAddress OwnerAddress, string Amount) : ResourceOwner(OwnerAddress);
//
// public record NonFungibleResourceOwner(EntityAddress OwnerAddress, long NfidCount) : ResourceOwner(OwnerAddress);
//
// internal class ResourceOwnersProcessor
// {
//     private readonly ProcessorContext _context;
//     private readonly ReferencedEntityDictionary _referencedEntities;
//     private readonly Dictionary<EntityAddress, List<ResourceOwner>> _resourceOwners;
//
//     private List<StateHistory> _toAdd = new();
//
//     public ResourceOwnersProcessor(ProcessorContext context, ReferencedEntityDictionary referencedEntities)
//     {
//         _context = context;
