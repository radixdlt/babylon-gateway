...
SELECT
    ...
    nextval('entity_method_royalty_entry_history_id_seq') AS EntityMethodRoyaltyEntryHistorySequence,
    nextval('entity_method_royalty_totals_history_id_seq') AS EntityMethodRoyaltyTotalsHistorySequence,
    nextval('entity_method_royalty_entry_definition_id_seq') AS EntityMethodRoyaltyEntryDefinitionSequence,
