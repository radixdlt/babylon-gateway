...
internal class WriteHelper : IWriteHelper
{
    ...
    public async Task UpdateSequences(SequencesHolder sequences, CancellationToken token)
    {
        ...
        var parameters = new
        {
            ...
            entityMethodRoyaltyEntryHistorySequence = sequences.EntityMethodRoyaltyEntryHistorySequence,
            entityMethodRoyaltyTotalsHistorySequence = sequences.EntityMethodRoyaltyTotalsHistorySequence,
            entityMethodRoyaltyEntryDefinitionSequence = sequences.EntityMethodRoyaltyEntryDefinitionSequence,
...
SELECT
    ...
    setval('entity_method_royalty_entry_history_id_seq', @entityMethodRoyaltyEntryHistorySequence),
    setval('entity_method_royalty_totals_history_id_seq', @entityMethodRoyaltyTotalsHistorySequence),
    setval('entity_method_royalty_entry_definition_id_seq', @entityMethodRoyaltyEntryDefinitionSequence),
