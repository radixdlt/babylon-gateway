...
namespace RadixDlt.NetworkGateway.PostgresIntegration.IoC;
...
public static class GatewayApiBuilderExtensions
{
    ...
    public static GatewayApiBuilder AddPostgresPersistenceCore(this GatewayApiBuilder builder)
    {
        builder
            ...
            .AddScoped<IImplicitRequirementsQuerier, ImplicitRequirementsQuerier>()
            .AddScoped<ITransactionQuerier, TransactionQuerier>()
            .AddScoped<IOpenApiDocumentQuerier, OpenApiDocumentQuerier>()
            .AddScoped<IEntityStateQuerier, EntityStateQuerier>()
            .AddScoped<IAccountStateQuerier, AccountStateQuerier>()
            .AddScoped<IDepositPreValidationQuerier, DepositPreValidationQuerier>()
            .AddScoped<IKeyValueStoreQuerier, KeyValueStoreQuerier>()
            .AddScoped<IRoleAssignmentQuerier, RoleAssignmentQuerier>()
            .AddScoped<IBlueprintQuerier, BlueprintQuerier>()
            .AddScoped<IAccountLockerQuerier, AccountLockerQuerier>()
            .AddScoped<INonFungibleQuerier, NonFungibleQuerier>()
