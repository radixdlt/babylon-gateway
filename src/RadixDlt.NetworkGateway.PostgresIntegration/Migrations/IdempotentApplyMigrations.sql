...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250207125038_InitialCreate') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250207125038_InitialCreate') THEN
    CREATE UNIQUE INDEX "IX_implicit_requirements_hash" ON implicit_requirements (hash) WHERE discriminator = 'ed25519public_key';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250207125038_InitialCreate') THEN
    CREATE UNIQUE INDEX "IX_implicit_requirements_hash_entity_id" ON implicit_requirements (hash, entity_id) WHERE discriminator = 'global_caller_entity';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250207125038_InitialCreate') THEN
    CREATE UNIQUE INDEX "IX_implicit_requirements_hash_entity_id_blueprint_name" ON implicit_requirements (hash, entity_id, blueprint_name) WHERE discriminator = 'global_caller_blueprint';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250207125038_InitialCreate') THEN
    CREATE UNIQUE INDEX "IX_implicit_requirements_hash_entity_id1" ON implicit_requirements (hash, entity_id) WHERE discriminator = 'package_of_direct_caller';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250207125038_InitialCreate') THEN
    CREATE INDEX "IX_implicit_requirements_hash_first_seen_state_version" ON implicit_requirements (hash, first_seen_state_version);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250207125038_InitialCreate') THEN
    CREATE UNIQUE INDEX "IX_implicit_requirements_hash1" ON implicit_requirements (hash) WHERE discriminator = 'secp256k1public_key';
    END IF;
END $EF$;
...
BEGIN
    ...
    VALUES ('20250207125038_InitialCreate', '8.0.2');
    END IF;
END $EF$;
COMMIT;
