...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241009151119_InitialCreate') THEN
    ...
    CREATE TYPE ledger_transaction_marker_origin_type AS ENUM ('user', 'epoch_change', 'round_update', 'flash');
...
BEGIN
    ...
    VALUES ('20241009151119_InitialCreate', '8.0.2');
    END IF;
END $EF$;
COMMIT;
