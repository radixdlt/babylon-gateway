...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240320142212_InitialCreate') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240320142212_InitialCreate') THEN
    CREATE INDEX "IX_account_authorized_depositor_history_account_entity_id_res~1" ON account_authorized_depositor_history (account_entity_id, resource_entity_id, from_state_version) WHERE discriminator = 'resource';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240320142212_InitialCreate') THEN
    CREATE INDEX "IX_account_authorized_depositor_history_account_entity_id_reso~" ON account_authorized_depositor_history (account_entity_id, resource_entity_id, non_fungible_id_data_id, from_state_version) WHERE discriminator = 'non_fungible';
    END IF;
END $EF$;
...
BEGIN
    ...
    VALUES ('20240320142212_InitialCreate', '8.0.2');
    END IF;
END $EF$;
COMMIT;
