...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241011084333_InitialCreate') THEN
    ...
    CREATE TYPE ledger_transaction_marker_origin_type AS ENUM ('user', 'epoch_change', 'round_update', 'flash', 'genesis');
...
BEGIN
    ...
    VALUES ('20241011084333_InitialCreate', '8.0.2');
    END IF;
END $EF$;
COMMIT;
