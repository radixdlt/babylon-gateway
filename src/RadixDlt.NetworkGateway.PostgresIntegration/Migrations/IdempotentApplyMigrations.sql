...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250211120656_InitialCreate') THEN
    ...
    CREATE TYPE entity_role_requirement_type AS ENUM ('resource', 'non_fungible');
    ...
    CREATE TYPE implicit_requirement_type AS ENUM ('package_of_direct_caller', 'global_caller_entity', 'global_caller_blueprint', 'ed25519public_key', 'secp256k1public_key');
    ...
    CREATE TYPE ledger_transaction_marker_transaction_type AS ENUM ('user', 'genesis_flash', 'genesis_transaction', 'protocol_update_flash', 'protocol_update_transaction');
    CREATE TYPE ledger_transaction_marker_type AS ENUM ('transaction_type', 'event', 'manifest_address', 'affected_global_entity', 'manifest_class', 'event_global_emitter', 'epoch_change', 'resource_balance_change');
    CREATE TYPE ledger_transaction_status AS ENUM ('succeeded', 'failed');
    CREATE TYPE ledger_transaction_type AS ENUM ('genesis', 'user', 'user_v2', 'round_update', 'flash');
    ...
    CREATE TYPE queried_implicit_requirement_type AS ENUM ('package_of_direct_caller', 'global_caller', 'ed25519public_key', 'secp256k1public_key');
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250211120656_InitialCreate') THEN
    CREATE TABLE entities_by_role_requirement_entry_definition (
        id bigint GENERATED BY DEFAULT AS IDENTITY,
        entity_id bigint NOT NULL,
        first_seen_state_version bigint NOT NULL,
        discriminator entity_role_requirement_type NOT NULL,
        resource_entity_id bigint,
        non_fungible_local_id text,
        CONSTRAINT "PK_entities_by_role_requirement_entry_definition" PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250211120656_InitialCreate') THEN
    CREATE TABLE implicit_requirements (
        id bigint GENERATED BY DEFAULT AS IDENTITY,
        hash text NOT NULL,
        first_seen_state_version bigint NOT NULL,
        discriminator implicit_requirement_type NOT NULL,
        public_key_bytes bytea,
        entity_id bigint,
        blueprint_name text,
        CONSTRAINT "PK_implicit_requirements" PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE ledger_transaction_events (
        ...
        receipt_event_emitter_entity_ids bigint[] NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250211120656_InitialCreate') THEN
    CREATE INDEX "IX_entities_by_role_requirement_entry_definition_entity_id_re~1" ON entities_by_role_requirement_entry_definition (entity_id, resource_entity_id, non_fungible_local_id) WHERE discriminator = 'non_fungible';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250211120656_InitialCreate') THEN
    CREATE INDEX "IX_entities_by_role_requirement_entry_definition_entity_id_res~" ON entities_by_role_requirement_entry_definition (entity_id, resource_entity_id) WHERE discriminator = 'resource';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250211120656_InitialCreate') THEN
    CREATE INDEX "IX_entities_by_role_requirement_entry_definition_first_seen_s~1" ON entities_by_role_requirement_entry_definition (first_seen_state_version, id, entity_id, resource_entity_id, non_fungible_local_id) WHERE discriminator = 'non_fungible';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250211120656_InitialCreate') THEN
    CREATE INDEX "IX_entities_by_role_requirement_entry_definition_first_seen_st~" ON entities_by_role_requirement_entry_definition (first_seen_state_version, id, entity_id, resource_entity_id) WHERE discriminator = 'resource';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250211120656_InitialCreate') THEN
    CREATE UNIQUE INDEX "IX_implicit_requirements_ed25519public_key" ON implicit_requirements (hash) INCLUDE (public_key_bytes, first_seen_state_version) WHERE discriminator = 'ed25519public_key';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250211120656_InitialCreate') THEN
    CREATE UNIQUE INDEX "IX_implicit_requirements_global_caller_blueprint" ON implicit_requirements (hash, entity_id, blueprint_name) INCLUDE (first_seen_state_version) WHERE discriminator = 'global_caller_blueprint';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250211120656_InitialCreate') THEN
    CREATE UNIQUE INDEX "IX_implicit_requirements_global_caller_entity" ON implicit_requirements (hash, entity_id) INCLUDE (first_seen_state_version) WHERE discriminator = 'global_caller_entity';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250211120656_InitialCreate') THEN
    CREATE UNIQUE INDEX "IX_implicit_requirements_package_of_direct_caller" ON implicit_requirements (hash, entity_id) INCLUDE (first_seen_state_version) WHERE discriminator = 'package_of_direct_caller';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250211120656_InitialCreate') THEN
    CREATE UNIQUE INDEX "IX_implicit_requirements_secp256k1public_key" ON implicit_requirements (hash) INCLUDE (public_key_bytes, first_seen_state_version) WHERE discriminator = 'secp256k1public_key';
    END IF;
END $EF$;
...
BEGIN
    ...
    VALUES ('20250211120656_InitialCreate', '8.0.2');
    END IF;
END $EF$;
COMMIT;
