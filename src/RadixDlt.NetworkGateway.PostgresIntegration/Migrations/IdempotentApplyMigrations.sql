...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241014125146_InitialCreate') THEN
    ...
    CREATE TYPE ledger_transaction_marker_origin_type AS ENUM ('user', 'epoch_change', 'validator', 'protocol_update', 'genesis');
    CREATE TYPE ledger_transaction_marker_type AS ENUM ('origin', 'event', 'manifest_address', 'affected_global_entity', 'manifest_class', 'event_global_emitter');
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241014125146_InitialCreate') THEN
    CREATE TABLE account_locker_entry_resource_vault_totals_history (
        id bigint GENERATED BY DEFAULT AS IDENTITY,
        from_state_version bigint NOT NULL,
        account_locker_definition_id bigint NOT NULL,
        total_resources bigint NOT NULL,
        CONSTRAINT "PK_account_locker_entry_resource_vault_totals_history" PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241014125146_InitialCreate') THEN
    CREATE TABLE account_locker_totals_history (
        id bigint GENERATED BY DEFAULT AS IDENTITY,
        from_state_version bigint NOT NULL,
        account_locker_entity_id bigint NOT NULL,
        total_accounts bigint NOT NULL,
        CONSTRAINT "PK_account_locker_totals_history" PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241014125146_InitialCreate') THEN
    CREATE TABLE entity_method_royalty_entry_definition (
        id bigint GENERATED BY DEFAULT AS IDENTITY,
        from_state_version bigint NOT NULL,
        entity_id bigint NOT NULL,
        method_name text NOT NULL,
        CONSTRAINT "PK_entity_method_royalty_entry_definition" PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241014125146_InitialCreate') THEN
    CREATE TABLE entity_method_royalty_entry_history (
        id bigint GENERATED BY DEFAULT AS IDENTITY,
        from_state_version bigint NOT NULL,
        ...
        is_deleted boolean NOT NULL,
        is_locked boolean NOT NULL,
        CONSTRAINT "PK_entity_method_royalty_entry_history" PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241014125146_InitialCreate') THEN
    CREATE TABLE entity_method_royalty_totals_history (
        id bigint GENERATED BY DEFAULT AS IDENTITY,
        from_state_version bigint NOT NULL,
        entity_id bigint NOT NULL,
        total_entries_including_deleted bigint NOT NULL,
        total_entries_excluding_deleted bigint NOT NULL,
        CONSTRAINT "PK_entity_method_royalty_totals_history" PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241014125146_InitialCreate') THEN
    CREATE INDEX "IX_account_locker_entry_resource_vault_totals_history_account_~" ON account_locker_entry_resource_vault_totals_history (account_locker_definition_id, from_state_version);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241014125146_InitialCreate') THEN
    CREATE INDEX "IX_account_locker_totals_history_account_locker_entity_id_from~" ON account_locker_totals_history (account_locker_entity_id, from_state_version);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241014125146_InitialCreate') THEN
    CREATE INDEX "IX_entity_method_royalty_entry_definition_entity_id_from_state~" ON entity_method_royalty_entry_definition (entity_id, from_state_version);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241014125146_InitialCreate') THEN
    CREATE INDEX "IX_entity_method_royalty_entry_definition_entity_id_method_name" ON entity_method_royalty_entry_definition (entity_id, method_name);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241014125146_InitialCreate') THEN
    CREATE INDEX "IX_entity_method_royalty_entry_history_definition_id_from_stat~" ON entity_method_royalty_entry_history (definition_id, from_state_version);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241014125146_InitialCreate') THEN
    CREATE INDEX "IX_entity_method_royalty_totals_history_entity_id_from_state_v~" ON entity_method_royalty_totals_history (entity_id, from_state_version);
    END IF;
END $EF$;
...
BEGIN
    ...
    VALUES ('20241014125146_InitialCreate', '8.0.2');
    END IF;
END $EF$;
COMMIT;
