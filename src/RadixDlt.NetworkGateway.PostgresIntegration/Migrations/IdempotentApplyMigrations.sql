...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240116140418_MoveVmTypeToCodeHistoryTable') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240116140418_MoveVmTypeToCodeHistoryTable') THEN
    update package_code_history pch set vm_type = (select vm_type from entities e where e.id = pch.package_entity_id)
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240116140418_MoveVmTypeToCodeHistoryTable') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20240116140418_MoveVmTypeToCodeHistoryTable', '7.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240117093225_AddBlueprintHistoryAggregateTable') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240117093225_AddBlueprintHistoryAggregateTable') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20240117093225_AddBlueprintHistoryAggregateTable', '7.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240117153350_AddPackageCodeAggregateHistoryTable') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240117153350_AddPackageCodeAggregateHistoryTable') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20240117153350_AddPackageCodeAggregateHistoryTable', '7.0.11');
    END IF;
END $EF$;
COMMIT;
