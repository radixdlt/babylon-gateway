...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240508140647_InitialCreate') THEN
...
BEGIN
    ...
    CREATE TABLE entities (
        ...
        resource_entity_id bigint,
        account_locker_of_account_locker_entity_id bigint,
        account_locker_of_account_entity_id bigint,
...
BEGIN
    ...
    VALUES ('20240508140647_InitialCreate', '8.0.2');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240508152819_TunedVaultMigrations') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240508152819_TunedVaultMigrations') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20240508152819_TunedVaultMigrations', '8.0.2');
    END IF;
END $EF$;
COMMIT;
