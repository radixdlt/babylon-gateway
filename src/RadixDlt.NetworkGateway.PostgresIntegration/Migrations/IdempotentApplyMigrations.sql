...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240711154102_InitialCreate') THEN
    ...
    CREATE TYPE two_way_link_type AS ENUM ('dapp_account_type', 'dapp_definition', 'dapp_definitions', 'dapp_claimed_websites', 'dapp_claimed_entities');
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240711154102_InitialCreate') THEN
    CREATE TABLE unverified_two_way_link_aggregate_history (
        id bigint GENERATED BY DEFAULT AS IDENTITY,
        from_state_version bigint NOT NULL,
        entity_id bigint NOT NULL,
        entry_ids bigint[] NOT NULL,
        CONSTRAINT "PK_unverified_two_way_link_aggregate_history" PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240711154102_InitialCreate') THEN
    CREATE TABLE unverified_two_way_link_entry_history (
        id bigint GENERATED BY DEFAULT AS IDENTITY,
        from_state_version bigint NOT NULL,
        entity_id bigint NOT NULL,
        is_deleted boolean NOT NULL,
        is_locked boolean NOT NULL,
        discriminator two_way_link_type NOT NULL,
        value text,
        entity_ids bigint[],
        claimed_websites text[],
        CONSTRAINT "PK_unverified_two_way_link_entry_history" PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240711154102_InitialCreate') THEN
    CREATE INDEX "IX_unverified_two_way_link_aggregate_history_entity_id_from_st~" ON unverified_two_way_link_aggregate_history (entity_id, from_state_version);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240711154102_InitialCreate') THEN
    CREATE INDEX "IX_unverified_two_way_link_entry_history_entity_id_discriminat~" ON unverified_two_way_link_entry_history (entity_id, discriminator, from_state_version);
    END IF;
END $EF$;
...
BEGIN
    ...
    VALUES ('20240711154102_InitialCreate', '8.0.2');
    END IF;
END $EF$;
COMMIT;
