...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240711105811_InitialCreate') THEN
    ...
    CREATE TYPE two_way_link AS ENUM ('dapp_account_type', 'dapp_definition', 'dapp_definitions', 'dapp_claimed_websites', 'dapp_claimed_entities');
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE unverified_two_way_link_entry_history (
        ...
        is_deleted boolean NOT NULL,
        is_locked boolean NOT NULL,
        discriminator two_way_link NOT NULL,
        value text,
        entity_ids bigint[],
...
BEGIN
    ...
    VALUES ('20240711105811_InitialCreate', '8.0.2');
    END IF;
END $EF$;
COMMIT;
