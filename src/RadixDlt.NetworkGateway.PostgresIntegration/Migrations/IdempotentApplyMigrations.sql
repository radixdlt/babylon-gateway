...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250204103839_InitialCreate') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250204103839_InitialCreate') THEN
    CREATE INDEX "IX_entities_by_role_requirement_entry_definition_resource_ent~1" ON entities_by_role_requirement_entry_definition (resource_entity_id, non_fungible_local_id) WHERE discriminator = 'non_fungible';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250204103839_InitialCreate') THEN
    CREATE INDEX "IX_entities_by_role_requirement_entry_definition_resource_enti~" ON entities_by_role_requirement_entry_definition (resource_entity_id) WHERE discriminator = 'resource';
    END IF;
END $EF$;
...
BEGIN
    ...
    VALUES ('20250204103839_InitialCreate', '8.0.2');
    END IF;
END $EF$;
COMMIT;
