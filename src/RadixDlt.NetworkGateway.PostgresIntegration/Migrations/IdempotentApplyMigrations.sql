...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240207094138_InitialCreate') THEN
    ...
    CREATE TYPE ledger_transaction_marker_operation_type AS ENUM ('resource_in_use', 'account_deposited_into', 'account_withdrawn_from', 'account_owner_method_call');
...
BEGIN
    ...
    CREATE TABLE entities (
        ...
        assigned_module_ids module_id[] NULL,
...
BEGIN
    ...
    CREATE TABLE ledger_transaction_markers (
        ...
        manifest_class ledger_transaction_manifest_class NULL,
        is_most_specific boolean NULL,
...
BEGIN
    ...
    CREATE TABLE ledger_transactions (
        ...
        manifest_classes ledger_transaction_manifest_class[] NULL,
...
BEGIN
    ...
    VALUES ('20240207094138_InitialCreate', '7.0.11');
    END IF;
END $EF$;
COMMIT;
