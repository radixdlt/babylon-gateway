...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250130121731_InitialCreate') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250130121731_InitialCreate') THEN
    CREATE TABLE entities_by_role_requirement (
        id bigint GENERATED BY DEFAULT AS IDENTITY,
        entity_id bigint NOT NULL,
        ...
        CONSTRAINT "PK_entities_by_role_requirement" PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250130121731_InitialCreate') THEN
    CREATE INDEX "IX_entities_by_role_requirement_first_seen_state_version_id_e~1" ON entities_by_role_requirement (first_seen_state_version, id, entity_id, resource_entity_id, non_fungible_local_id) WHERE discriminator = 'non_fungible';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250130121731_InitialCreate') THEN
    CREATE INDEX "IX_entities_by_role_requirement_first_seen_state_version_id_en~" ON entities_by_role_requirement (first_seen_state_version, id, entity_id, resource_entity_id) WHERE discriminator = 'resource';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250130121731_InitialCreate') THEN
    CREATE INDEX "IX_entities_by_role_requirement_resource_entity_id" ON entities_by_role_requirement (resource_entity_id) WHERE discriminator = 'resource';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250130121731_InitialCreate') THEN
    CREATE INDEX "IX_entities_by_role_requirement_resource_entity_id_non_fungibl~" ON entities_by_role_requirement (resource_entity_id, non_fungible_local_id) WHERE discriminator = 'non_fungible';
    END IF;
END $EF$;
...
BEGIN
    ...
    VALUES ('20250130121731_InitialCreate', '8.0.2');
    END IF;
END $EF$;
COMMIT;
