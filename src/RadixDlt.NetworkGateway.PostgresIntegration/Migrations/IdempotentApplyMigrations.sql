...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240319155548_InitialCreate') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240319155548_InitialCreate') THEN
    CREATE TABLE account_authorized_depositor_history (
        id bigint GENERATED BY DEFAULT AS IDENTITY,
        from_state_version bigint NOT NULL,
        account_entity_id bigint NOT NULL,
        is_deleted boolean NOT NULL,
        discriminator authorized_depositor_badge_type NOT NULL,
        non_fungible_resource_entity_id bigint,
        non_fungible_id_data_id bigint,
        resource_entity_id bigint,
        CONSTRAINT "PK_account_authorized_depositor_history" PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240319155548_InitialCreate') THEN
    CREATE INDEX "IX_account_authorized_depositor_history_account_entity_id_from~" ON account_authorized_depositor_history (account_entity_id, from_state_version);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240319155548_InitialCreate') THEN
    CREATE INDEX "IX_account_authorized_depositor_history_account_entity_id_non_~" ON account_authorized_depositor_history (account_entity_id, non_fungible_resource_entity_id, non_fungible_id_data_id, from_state_version) WHERE discriminator = 'non_fungible';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240319155548_InitialCreate') THEN
    CREATE INDEX "IX_account_authorized_depositor_history_account_entity_id_reso~" ON account_authorized_depositor_history (account_entity_id, resource_entity_id, from_state_version) WHERE discriminator = 'resource';
    END IF;
END $EF$;
...
BEGIN
    ...
    VALUES ('20240319155548_InitialCreate', '8.0.2');
    END IF;
END $EF$;
COMMIT;
