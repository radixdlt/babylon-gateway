...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250210145717_InitialCreate') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250210145717_InitialCreate') THEN
    CREATE INDEX "IX_implicit_requirements_discriminator_hash" ON implicit_requirements (discriminator, hash);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250210145717_InitialCreate') THEN
    CREATE UNIQUE INDEX "IX_implicit_requirements_ed25519public_key" ON implicit_requirements (hash) WHERE discriminator = 'ed25519public_key';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250210145717_InitialCreate') THEN
    CREATE UNIQUE INDEX "IX_implicit_requirements_global_caller_blueprint" ON implicit_requirements (hash, entity_id, blueprint_name) WHERE discriminator = 'global_caller_blueprint';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250210145717_InitialCreate') THEN
    CREATE UNIQUE INDEX "IX_implicit_requirements_global_caller_entity" ON implicit_requirements (hash, entity_id) WHERE discriminator = 'global_caller_entity';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250210145717_InitialCreate') THEN
    CREATE UNIQUE INDEX "IX_implicit_requirements_package_of_direct_caller" ON implicit_requirements (hash, entity_id) WHERE discriminator = 'package_of_direct_caller';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250210145717_InitialCreate') THEN
    CREATE UNIQUE INDEX "IX_implicit_requirements_secp256k1public_key" ON implicit_requirements (hash) WHERE discriminator = 'secp256k1public_key';
    END IF;
END $EF$;
...
BEGIN
    ...
    VALUES ('20250210145717_InitialCreate', '8.0.2');
    END IF;
END $EF$;
COMMIT;
