...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240105125008_InitialCreate') THEN
...
BEGIN
    ...
    CREATE TABLE ledger_transaction_markers (
        ...
        manifest_class ledger_transaction_marker_manifest_class NULL,
...
BEGIN
    ...
    CREATE TABLE network_configuration (
        ...
        network_hrp_suffix text NOT NULL,
...
BEGIN
    ...
    VALUES ('20240105125008_InitialCreate', '7.0.11');
    END IF;
END $EF$;
COMMIT;
