...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240812134330_InitialCreate') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240812134330_InitialCreate') THEN
    CREATE TABLE component_fungible_resource_definition (
        id bigint GENERATED BY DEFAULT AS IDENTITY,
        from_state_version bigint NOT NULL,
        component_entity_id bigint NOT NULL,
        resource_entity_id bigint NOT NULL,
        CONSTRAINT "PK_component_fungible_resource_definition" PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240812134330_InitialCreate') THEN
    CREATE TABLE component_fungible_resource_totals_history (
        id bigint GENERATED BY DEFAULT AS IDENTITY,
        from_state_version bigint NOT NULL,
        component_entity_id bigint NOT NULL,
        total_count bigint NOT NULL,
        CONSTRAINT "PK_component_fungible_resource_totals_history" PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240812134330_InitialCreate') THEN
    CREATE TABLE component_non_fungible_resource_definition (
        id bigint GENERATED BY DEFAULT AS IDENTITY,
        from_state_version bigint NOT NULL,
        component_entity_id bigint NOT NULL,
        resource_entity_id bigint NOT NULL,
        CONSTRAINT "PK_component_non_fungible_resource_definition" PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240812134330_InitialCreate') THEN
    CREATE TABLE component_non_fungible_resource_totals_history (
        id bigint GENERATED BY DEFAULT AS IDENTITY,
        from_state_version bigint NOT NULL,
        component_entity_id bigint NOT NULL,
        total_count bigint NOT NULL,
        CONSTRAINT "PK_component_non_fungible_resource_totals_history" PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240812134330_InitialCreate') THEN
    CREATE TABLE component_resource_vault_definition (
        id bigint GENERATED BY DEFAULT AS IDENTITY,
        from_state_version bigint NOT NULL,
        component_entity_id bigint NOT NULL,
        resource_entity_id bigint NOT NULL,
        vault_entity_id bigint NOT NULL,
        CONSTRAINT "PK_component_resource_vault_definition" PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240812134330_InitialCreate') THEN
    CREATE TABLE component_resource_vault_totals_history (
        id bigint GENERATED BY DEFAULT AS IDENTITY,
        from_state_version bigint NOT NULL,
        component_entity_id bigint NOT NULL,
        resource_entity_id bigint NOT NULL,
        total_count bigint NOT NULL,
        CONSTRAINT "PK_component_resource_vault_totals_history" PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240812134330_InitialCreate') THEN
    CREATE INDEX "IX_component_fungible_resource_definition_component_entity_id_~" ON component_fungible_resource_definition (component_entity_id, from_state_version);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240812134330_InitialCreate') THEN
    CREATE INDEX "IX_component_fungible_resource_totals_history_component_entity~" ON component_fungible_resource_totals_history (component_entity_id, from_state_version);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240812134330_InitialCreate') THEN
    CREATE INDEX "IX_component_non_fungible_resource_definition_component_entity~" ON component_non_fungible_resource_definition (component_entity_id, from_state_version);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240812134330_InitialCreate') THEN
    CREATE INDEX "IX_component_non_fungible_resource_totals_history_component_en~" ON component_non_fungible_resource_totals_history (component_entity_id, from_state_version);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240812134330_InitialCreate') THEN
    CREATE INDEX "IX_component_resource_vault_definition_component_entity_id_res~" ON component_resource_vault_definition (component_entity_id, resource_entity_id, from_state_version);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240812134330_InitialCreate') THEN
    CREATE INDEX "IX_component_resource_vault_totals_history_component_entity_id~" ON component_resource_vault_totals_history (component_entity_id, resource_entity_id, from_state_version);
    END IF;
END $EF$;
...
BEGIN
    ...
    VALUES ('20240812134330_InitialCreate', '8.0.2');
    END IF;
END $EF$;
COMMIT;
