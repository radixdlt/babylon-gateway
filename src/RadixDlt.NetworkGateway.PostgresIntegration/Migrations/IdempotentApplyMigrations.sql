...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240404135952_InitialCreate') THEN
...
BEGIN
    ...
    VALUES ('20240404135952_InitialCreate', '8.0.2');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240513111653_NewAccountLockerEntityType') THEN
    ALTER TYPE entity_type ADD VALUE 'global_account_locker';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240513111653_NewAccountLockerEntityType') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20240513111653_NewAccountLockerEntityType', '8.0.2');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240513151413_AddAccountLockers') THEN
    DROP INDEX "IX_entity_vault_history_vault_entity_id_from_state_version";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240513151413_AddAccountLockers') THEN
    ALTER TABLE entities ADD account_locker_of_account_entity_id bigint;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240513151413_AddAccountLockers') THEN
    ALTER TABLE entities ADD account_locker_of_account_locker_entity_id bigint;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240513151413_AddAccountLockers') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20240513151413_AddAccountLockers', '8.0.2');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240802115042_RemoveNfIdStoreAggregate') THEN
    ALTER TABLE non_fungible_id_data RENAME TO non_fungible_id_definition;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240802115042_RemoveNfIdStoreAggregate') THEN
    ALTER INDEX "IX_non_fungible_id_data_non_fungible_resource_entity_id_from_s~" RENAME TO "IX_non_fungible_id_definition_nfreid_fsv";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240802115042_RemoveNfIdStoreAggregate') THEN
    ALTER INDEX "IX_non_fungible_id_data_non_fungible_resource_entity_id_non_fu~" RENAME TO "IX_non_fungible_id_definition_nfreid_nfid_fsv";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240802115042_RemoveNfIdStoreAggregate') THEN
    ALTER INDEX "PK_non_fungible_id_data" RENAME TO "PK_non_fungible_id_definition";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240802115042_RemoveNfIdStoreAggregate') THEN
    ALTER SEQUENCE non_fungible_id_data_id_seq RENAME TO non_fungible_id_definition_id_seq;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240802115042_RemoveNfIdStoreAggregate') THEN
    DROP TABLE non_fungible_id_store_history;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240802115042_RemoveNfIdStoreAggregate') THEN
    ALTER TABLE non_fungible_id_location_history RENAME COLUMN non_fungible_id_data_id TO non_fungible_id_definition_id;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240802115042_RemoveNfIdStoreAggregate') THEN
    ALTER INDEX "IX_non_fungible_id_location_history_non_fungible_id_data_id_fr~" RENAME TO "IX_non_fungible_id_location_history_non_fungible_id_definition~";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240802115042_RemoveNfIdStoreAggregate') THEN
    ALTER TABLE non_fungible_id_data_history RENAME COLUMN non_fungible_id_data_id TO non_fungible_id_definition_id;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240802115042_RemoveNfIdStoreAggregate') THEN
    ALTER INDEX "IX_non_fungible_id_data_history_non_fungible_id_data_id_from_s~" RENAME TO "IX_non_fungible_id_data_history_non_fungible_id_definition_id_~";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240802115042_RemoveNfIdStoreAggregate') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20240802115042_RemoveNfIdStoreAggregate', '8.0.2');
    END IF;
END $EF$;
COMMIT;
