...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240730120829_InitialCreate') THEN
...
BEGIN
    ...
    CREATE TABLE entity_vault_history (
        ...
        total_count_including_deleted bigint,
        total_count_excluding_deleted bigint,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240730120829_InitialCreate') THEN
    CREATE INDEX "IX_non_fungible_id_location_history_lookup" ON non_fungible_id_location_history (non_fungible_id_data_id, from_state_version);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240730120829_InitialCreate') THEN
    CREATE INDEX "IX_non_fungible_id_location_history_lookup_non_deleted" ON non_fungible_id_location_history (non_fungible_id_data_id, from_state_version) WHERE is_deleted = FALSE;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240730120829_InitialCreate') THEN
    CREATE INDEX "IX_non_fungible_vault_entry_definition_vault_entity_id_non_fun~" ON non_fungible_vault_entry_definition (vault_entity_id, non_fungible_id_definition_id);
    END IF;
END $EF$;
...
BEGIN
    ...
    VALUES ('20240730120829_InitialCreate', '8.0.2');
    END IF;
END $EF$;
COMMIT;
