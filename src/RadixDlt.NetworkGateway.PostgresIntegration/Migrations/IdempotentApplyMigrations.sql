...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241014144709_InitialCreate') THEN
    ...
    CREATE TYPE ledger_transaction_marker_transaction_type AS ENUM ('user', 'epoch_change', 'round_change', 'genesis_flash', 'genesis_transaction', 'protocol_update_flash', 'protocol_update_transaction');
    CREATE TYPE ledger_transaction_marker_type AS ENUM ('transaction_type', 'event', 'manifest_address', 'affected_global_entity', 'manifest_class', 'event_global_emitter');
...
BEGIN
    ...
    VALUES ('20241014144709_InitialCreate', '8.0.2');
    END IF;
END $EF$;
COMMIT;
