...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230921073622_InitialCreate') THEN
...
BEGIN
    ...
    CREATE TABLE pending_transactions (
        ...
        latest_failure_timestamp timestamp with time zone NULL,
...
BEGIN
    ...
    VALUES ('20230921073622_InitialCreate', '7.0.11');
    END IF;
END $EF$;
COMMIT;
