...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240807102112_InitialCreate') THEN
...
BEGIN
    ...
    CREATE TABLE resource_owners (
        ...
        balance numeric(1000),
        total_count bigint,
        CONSTRAINT "PK_resource_owners" PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240807102112_InitialCreate') THEN
    CREATE UNIQUE INDEX "IX_resource_owners_entity_id_resource_entity_id" ON resource_owners (entity_id, resource_entity_id);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240807102112_InitialCreate') THEN
    CREATE INDEX "IX_resource_owners_entity_id_resource_entity_id_balance" ON resource_owners (entity_id, resource_entity_id, balance) WHERE discriminator = 'fungible';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240807102112_InitialCreate') THEN
    CREATE INDEX "IX_resource_owners_entity_id_resource_entity_id_total_count" ON resource_owners (entity_id, resource_entity_id, total_count) WHERE discriminator = 'non_fungible';
    END IF;
END $EF$;
...
BEGIN
    ...
    VALUES ('20240807102112_InitialCreate', '8.0.2');
    END IF;
END $EF$;
COMMIT;
