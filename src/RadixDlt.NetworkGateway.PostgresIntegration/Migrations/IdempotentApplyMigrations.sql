...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240813145617_InitialCreate') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240813145617_InitialCreate') THEN
    CREATE TABLE entity_resource_definition (
        id bigint GENERATED BY DEFAULT AS IDENTITY,
        from_state_version bigint NOT NULL,
        entity_id bigint NOT NULL,
        resource_entity_id bigint NOT NULL,
        resource_type resource_type NOT NULL,
        CONSTRAINT "PK_entity_resource_definition" PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240813145617_InitialCreate') THEN
    CREATE TABLE entity_resource_vault_definition (
        id bigint GENERATED BY DEFAULT AS IDENTITY,
        from_state_version bigint NOT NULL,
        entity_id bigint NOT NULL,
        resource_entity_id bigint NOT NULL,
        vault_entity_id bigint NOT NULL,
        CONSTRAINT "PK_entity_resource_vault_definition" PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE entity_resource_vault_totals_history (
        ...
        resource_entity_id bigint NOT NULL,
        total_count bigint NOT NULL,
        total_balance numeric(1000) NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240813145617_InitialCreate') THEN
    CREATE INDEX "IX_entity_resource_definition_entity_id_from_state_version" ON entity_resource_definition (entity_id, from_state_version);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240813145617_InitialCreate') THEN
    CREATE INDEX "IX_entity_resource_definition_fungibles" ON entity_resource_definition (entity_id, from_state_version) WHERE resource_type = 'fungible';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240813145617_InitialCreate') THEN
    CREATE INDEX "IX_entity_resource_definition_non_fungibles" ON entity_resource_definition (entity_id, from_state_version) WHERE resource_type = 'non_fungible';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240813145617_InitialCreate') THEN
    CREATE INDEX "IX_entity_resource_vault_definition_entity_id_resource_entity_~" ON entity_resource_vault_definition (entity_id, resource_entity_id, from_state_version);
    END IF;
END $EF$;
...
BEGIN
    ...
    VALUES ('20240813145617_InitialCreate', '8.0.2');
    END IF;
END $EF$;
COMMIT;
