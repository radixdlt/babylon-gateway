    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                ...
                .Annotation("Npgsql:Enum:entity_relationship", "component_package,validator_stake_vault,validator_pending_xrd_withdraw_vault,validator_locked_owner_stake_unit_vault,validator_pending_owner_stake_unit_unlock_vault,validator_stake_unit_validator,validator_claim_token_validator,vault_resource,vault_royalty,vault_resource_pool,account_locker_locker,account_locker_account,resource_pool_resource,resource_pool_resource_vault,resource_pool_unit,resource_pool_unit_resource_pool,access_controller_recovery_badge,access_controller_recovery_badge_access_controller")
