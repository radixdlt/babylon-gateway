...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "entity_type",
                new[]
                {
                    "global_consensus_manager", "global_fungible_resource", "global_non_fungible_resource", "global_generic_component", "internal_generic_component", "global_account_component",
                    "internal_account_component", "global_package", "internal_key_value_store", "internal_fungible_vault", "internal_non_fungible_vault", "global_validator",
                    "global_access_controller", "global_identity", "global_one_resource_pool", "global_two_resource_pool", "global_multi_resource_pool", "global_transaction_tracker"
                });
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "pending_transaction_status",
                new[] { "submitted_or_known_in_node_mempool", "missing", "rejected_temporarily", "rejected_permanently", "committed_success", "committed_failure" });
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.AccountDefaultDepositRuleHistory", b =>
            {
                ...
                b
                    .Property<long>("AccountEntityId")
                    .HasColumnType("bigint")
                    .HasColumnName("account_entity_id");

                b
                    .Property<AccountDefaultDepositRule>("DefaultDepositRule")
                    .HasColumnType("account_default_deposit_rule")
                    .HasColumnName("default_deposit_rule");

                b
                    .Property<long>("FromStateVersion")
                    .HasColumnType("bigint")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.AccountResourcePreferenceRuleHistory", b =>
            {
                ...
                b
                    .Property<AccountResourcePreferenceRule?>("AccountResourcePreferenceRule")
                ...
                b
                    .Property<long>("ResourceEntityId")
                    .HasColumnType("bigint")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.Entity", b =>
            {
                ...
                b
                    .Property<List<long>>("AncestorIds")
                    .HasColumnType("bigint[]")
                    .HasColumnName("ancestor_ids");

                b
                    .Property<List<long>>("CorrelatedEntities")
                    .IsRequired()
                    .HasColumnType("bigint[]")
                ...
                b
                    .Property<long?>("GlobalAncestorId")
                    .HasColumnType("bigint")
                ...
                b
                    .Property<long?>("OwnerAncestorId")
                    .HasColumnType("bigint")
                    .HasColumnName("owner_ancestor_id");

                b
                    .Property<long?>("ParentAncestorId")
                    .HasColumnType("bigint")
                    .HasColumnName("parent_ancestor_id");

                b
                    .Property<EntityType>("discriminator")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.EntityMetadataAggregateHistory", b =>
            {
                ...
                b
                    .Property<List<long>>("MetadataIds")
                    .IsRequired()
                    .HasColumnType("bigint[]")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.EntityResourceAggregateHistory", b =>
            {
                ...
                b
                    .Property<List<long>>("FungibleResourceEntityIds")
                    .IsRequired()
                    .HasColumnType("bigint[]")
                    .HasColumnName("fungible_resource_entity_ids");

                b
                    .Property<List<long>>("FungibleResourceSignificantUpdateStateVersions")
                    .IsRequired()
                    .HasColumnType("bigint[]")
                    .HasColumnName("fungible_resource_significant_update_state_versions");

                b
                    .Property<List<long>>("NonFungibleResourceEntityIds")
                    .IsRequired()
                    .HasColumnType("bigint[]")
                    .HasColumnName("non_fungible_resource_entity_ids");

                b
                    .Property<List<long>>("NonFungibleResourceSignificantUpdateStateVersions")
                    .IsRequired()
                    .HasColumnType("bigint[]")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.EntityResourceAggregatedVaultsHistory", b =>
            {
                ...
                b
                    .Property<ResourceType>("discriminator")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.EntityResourceVaultAggregateHistory", b =>
            {
                ...
                b
                    .Property<List<long>>("VaultEntityIds")
                    .IsRequired()
                    .HasColumnType("bigint[]")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.EntityRoleAssignmentsEntryHistory", b =>
            {
                ...
                b
                    .Property<ObjectModuleId>("KeyModule")
                ...
                b
                    .Property<string>("RoleAssignments")
                    .HasColumnType("jsonb")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.EntityVaultHistory", b =>
            {
                ...
                b
                    .Property<long>("GlobalEntityId")
                    .HasColumnType("bigint")
                    .HasColumnName("global_entity_id");

                b
                    .Property<long>("OwnerEntityId")
                    .HasColumnType("bigint")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.KeyValueStoreEntryHistory", b =>
            {
                ...
                b
                    .Property<long>("KeyValueStoreEntityId")
                    .HasColumnType("bigint")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.KeyValueStoreSchemaHistory", b =>
            {
                ...
                b
                    .Property<SborTypeKind>("KeySborTypeKind")
                    .HasColumnType("sbor_type_kind")
                    .HasColumnName("key_sbor_type_kind");

                b
                    .Property<int>("KeyTypeIndex")
                ...
                b
                    .Property<SborTypeKind>("ValueSborTypeKind")
                    .HasColumnType("sbor_type_kind")
                    .HasColumnName("value_sbor_type_kind");

                b
                    .Property<int>("ValueTypeIndex")
                    .HasColumnType("integer")
            ...
            {
                b
                    .Property<long>("StateVersion")
                    .HasColumnType("bigint")
                    .HasColumnName("state_version");

                b
                    .Property<long[]>("AffectedGlobalEntities")
                    .IsRequired()
                    .HasColumnType("bigint[]")
                ...
                b
                    .Property<BigInteger?>("FeePaid")
                    .HasPrecision(1000)
                    .HasColumnType("numeric")
                    .HasColumnName("fee_paid");

                b
                    .Property<long>("IndexInEpoch")
                    .HasColumnType("bigint")
                    .HasColumnName("index_in_epoch");

                b
                    .Property<long>("IndexInRound")
                    .HasColumnType("bigint")
                    .HasColumnName("index_in_round");

                b
                    .Property<DateTime>("NormalizedRoundTimestamp")
                    .HasColumnType("timestamp with time zone")
                    .HasColumnName("normalized_round_timestamp");

                b
                    .Property<byte[]>("RawPayload")
                    .IsRequired()
                    .HasColumnType("bytea")
                    .HasColumnName("raw_payload");

                b
                    .Property<long>("RoundInEpoch")
                    .HasColumnType("bigint")
                    .HasColumnName("round_in_epoch");

                b
                    .Property<DateTime>("RoundTimestamp")
                    .HasColumnType("timestamp with time zone")
                    .HasColumnName("round_timestamp");

                b
                    .Property<BigInteger?>("TipPaid")
                    .HasPrecision(1000)
                    .HasColumnType("numeric")
                    .HasColumnName("tip_paid");

                b
                    .Property<LedgerTransactionType>("discriminator")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.LedgerTransactionMarker", b =>
            {
                ...
                b
                    .Property<LedgerTransactionMarkerType>("discriminator")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.NetworkConfiguration", b =>
            {
                ...
                b
                    .Property<AddressTypeDefinition[]>("AddressTypeDefinitions")
                    .IsRequired()
                    .HasColumnType("jsonb")
                    .HasColumnName("address_type_definitions");

                b
                    .Property<long>("GenesisEpoch")
                    .HasColumnType("bigint")
                    .HasColumnName("genesis_epoch");

                b
                    .Property<long>("GenesisRound")
                    .HasColumnType("bigint")
                    .HasColumnName("genesis_round");

                b
                    .Property<HrpDefinition>("HrpDefinition")
                    .IsRequired()
                    .HasColumnType("jsonb")
                    .HasColumnName("hrp_definition");

                b
                    .Property<byte>("NetworkId")
                ...
                b
                    .Property<WellKnownAddresses>("WellKnownAddresses")
                    .IsRequired()
                    .HasColumnType("jsonb")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.NonFungibleIdData", b =>
            {
                ...
                b
                    .Property<string>("NonFungibleId")
                    .IsRequired()
                    .HasColumnType("text")
                    .HasColumnName("non_fungible_id");

                b
                    .Property<long>("NonFungibleResourceEntityId")
                    .HasColumnType("bigint")
                ...
                b
                    .HasIndex("NonFungibleResourceEntityId", "NonFungibleId", "FromStateVersion")
                    .IsUnique();
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.NonFungibleIdDataHistory", b =>
            {
                ...
                b
                    .Property<long>("NonFungibleIdDataId")
                    .HasColumnType("bigint")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.NonFungibleIdStoreHistory", b =>
            {
                ...
                b
                    .Property<List<long>>("NonFungibleIdDataIds")
                    .IsRequired()
                    .HasColumnType("bigint[]")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.NonFungibleSchemaHistory", b =>
            {
                ...
                b
                    .Property<SborTypeKind>("SborTypeKind")
                    .HasColumnType("sbor_type_kind")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.PackageBlueprintHistory", b =>
            {
                ...
                b
                    .Property<string>("AuthTemplate")
                    .HasColumnType("jsonb")
                    .HasColumnName("auth_template");

                b
                    .Property<bool?>("AuthTemplateIsLocked")
                    .HasColumnType("boolean")
                ...
                b
                    .Property<List<long>>("DependantEntityIds")
                    .HasColumnType("bigint[]")
                ...
                b
                    .Property<long>("PackageEntityId")
                    .HasColumnType("bigint")
                    .HasColumnName("package_entity_id");

                b
                    .Property<string>("RoyaltyConfig")
                    .HasColumnType("jsonb")
                    .HasColumnName("royalty_config");

                b
                    .Property<bool?>("RoyaltyConfigIsLocked")
                    .HasColumnType("boolean")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.PendingTransaction", b =>
            {
                ...
                b
                    .Property<DateTime?>("FirstSeenInMempoolTimestamp")
                    .HasColumnType("timestamp with time zone")
                    .HasColumnName("first_seen_in_mempool_timestamp");

                b
                    .Property<DateTime?>("FirstSubmittedToGatewayTimestamp")
                    .HasColumnType("timestamp with time zone")
                    .HasColumnName("first_submitted_to_gateway_timestamp");

                b
                    .Property<string>("IntentHash")
                    .IsRequired()
                    .HasColumnType("text")
                    .HasColumnName("intent_hash");

                b
                    .Property<DateTime?>("LastDroppedOutOfMempoolTimestamp")
                    .HasColumnType("timestamp with time zone")
                ...
                b
                    .Property<DateTime?>("LastFailureTimestamp")
                    .HasColumnType("timestamp with time zone")
                    .HasColumnName("last_failure_timestamp");

                b
                    .Property<DateTime?>("LastSubmittedToGatewayTimestamp")
                    .HasColumnType("timestamp with time zone")
                    .HasColumnName("last_submitted_to_gateway_timestamp");

                b
                    .Property<string>("LastSubmittedToNodeName")
                    .HasColumnType("text")
                    .HasColumnName("last_submitted_to_node_name");

                b
                    .Property<DateTime?>("LastSubmittedToNodeTimestamp")
                    .HasColumnType("timestamp with time zone")
                    .HasColumnName("last_submitted_to_node_timestamp");

                b
                    .Property<byte[]>("NotarizedTransactionBlob")
                    .IsRequired()
                    .HasColumnType("bytea")
                ...
                b
                    .Property<int>("SubmissionToNodesCount")
                    .HasColumnType("integer")
                    .HasColumnName("submission_count");

                b
                    .Property<bool>("SubmittedByThisGateway")
                    .HasColumnType("boolean")
                    .HasColumnName("submitted_by_this_gateway");

                b
                    .Property<uint>("VersionControl")
                    .IsConcurrencyToken()
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.ResourceEntitySupplyHistory", b =>
            {
                ...
                b
                    .Property<BigInteger>("TotalBurned")
                    .HasPrecision(1000)
                    .HasColumnType("numeric")
                    .HasColumnName("total_burned");

                b
                    .Property<BigInteger>("TotalMinted")
                    .HasPrecision(1000)
                    .HasColumnType("numeric")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.StateHistory", b =>
            {
                ...
                b
                    .Property<string>("JsonState")
                    .HasColumnType("jsonb")
                    .HasColumnName("json_state");

                b
                    .Property<byte[]>("SborState")
                    .HasColumnType("bytea")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.ValidatorActiveSetHistory", b =>
            {
                ...
                b
                    .Property<BigInteger>("Stake")
                    .HasPrecision(1000)
                    .HasColumnType("numeric")
                    .HasColumnName("stake");

                b
                    .Property<long>("ValidatorPublicKeyHistoryId")
                    .HasColumnType("bigint")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.ValidatorEmissionStatistics", b =>
            {
                ...
                b
                    .Property<long>("EpochNumber")
                    .HasColumnType("bigint")
                    .HasColumnName("epoch_number");

                b
                    .Property<long>("ProposalsMade")
                    .HasColumnType("bigint")
                    .HasColumnName("proposals_made");

                b
                    .Property<long>("ProposalsMissed")
                    .HasColumnType("bigint")
                    .HasColumnName("proposals_missed");

                b
                    .Property<long>("ValidatorEntityId")
                    .HasColumnType("bigint")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.GlobalNonFungibleResourceEntity", b =>
            {
                ...
                b
                    .Property<NonFungibleIdType>("NonFungibleIdType")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.GlobalValidatorEntity", b =>
            {
                ...
                b
                    .Property<long>("LockedOwnerStakeUnitVault")
                    .HasColumnType("bigint")
                ...
                b
                    .Property<long>("PendingOwnerStakeUnitUnlockVault")
                    .HasColumnType("bigint")
                    .HasColumnName("pending_owner_stake_unit_unlock_vault_entity_id");

                b
                    .Property<long>("PendingXrdWithdrawVault")
                    .HasColumnType("bigint")
                    .HasColumnName("pending_xrd_withdraw_vault_entity_id");

                b
                    .Property<long>("StakeVaultEntityId")
                    .HasColumnType("bigint")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.InternalAccountEntity", b =>
            {
                b.HasBaseType("RadixDlt.NetworkGateway.PostgresIntegration.Models.Entity");
                ...
                b.HasDiscriminator().HasValue(EntityType.InternalAccountComponent);
            });
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.InternalFungibleVaultEntity", b =>
            {
                ...
                b
                    .Property<long?>("RoyaltyVaultOfEntityId")
                    .HasColumnType("bigint")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.EntityNonFungibleVaultHistory", b =>
            {
                ...
                b
                    .Property<List<long>>("NonFungibleIds")
                    .IsRequired()
                    .HasColumnType("bigint[]")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.UserLedgerTransaction", b =>
            {
                ...
                b
                    .Property<string>("SignedIntentHash")
                    .IsRequired()
                    .HasColumnType("text")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.AffectedGlobalEntityTransactionMarker", b =>
            {
                ...
                b
                    .HasIndex("EntityId", "StateVersion")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.EventLedgerTransactionMarker", b =>
            {
                ...
                b
                    .Property<LedgerTransactionMarkerEventType>("EventType")
                ...
                b
                    .HasIndex("EventType", "EntityId", "StateVersion")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.ManifestAddressLedgerTransactionMarker", b =>
            {
                ...
                b
                    .Property<LedgerTransactionMarkerOperationType>("OperationType")
                    .HasColumnType("ledger_transaction_marker_operation_type")
                    .HasColumnName("operation_type");

                b
                    .HasIndex("OperationType", "EntityId", "StateVersion")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.OriginLedgerTransactionMarker", b =>
            {
                ...
                b
                    .Property<LedgerTransactionMarkerOriginType>("OriginType")
                    .HasColumnType("ledger_transaction_marker_origin_type")
                    .HasColumnName("origin_type");

                b
                    .HasIndex("OriginType", "StateVersion")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.LedgerTransaction", b =>
            {
                ...
                {
                    b1
                        .Property<long>("LedgerTransactionStateVersion")
                        .HasColumnType("bigint");
            ...
            {
                b
                    .HasOne("RadixDlt.NetworkGateway.PostgresIntegration.Models.ValidatorPublicKeyHistory", "PublicKey")
                    .WithMany()
