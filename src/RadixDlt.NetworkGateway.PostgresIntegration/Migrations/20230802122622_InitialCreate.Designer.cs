...
namespace RadixDlt.NetworkGateway.PostgresIntegration.Migrations
{
    ...
    [Migration("20230802122622_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "account_resource_deposit_rule", new[] { "neither", "allowed", "disallowed" });
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.AccountResourceDepositRuleHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<AccountResourceDepositRule?>("ResourceDepositRule")
                        .HasColumnType("account_resource_deposit_rule")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.EntityResourceVaultAggregateHistory", b =>
                {
                    ...
                    b.Property<List<long>>("VaultEntityIdSignificantUpdateStateVersions")
                        .IsRequired()
                        .HasColumnType("bigint[]")
                        .HasColumnName("vault_entity_id_significant_update_state_versions");
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.NonFungibleId", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("SimpleRepresentation")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("simple_representation");

                    b.HasKey("Id");

                    b.HasIndex("NonFungibleResourceEntityId", "FromStateVersion");

                    b.HasIndex("NonFungibleResourceEntityId", "SimpleRepresentation", "FromStateVersion")
                        .IsUnique();

                    b.ToTable("non_fungible_ids");
                });
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.NonFungibleIdStoreHistory", b =>
                {
                    ...
                    b.Property<List<long>>("NonFungibleIdIds")
                        .IsRequired()
                        .HasColumnType("bigint[]")
                        .HasColumnName("non_fungible_id_ids");
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.ValidatorStateHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("validator_state_history");
                });

            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.VaultHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.FungibleVaultHistory", b =>
                {
                    b.HasBaseType("RadixDlt.NetworkGateway.PostgresIntegration.Models.VaultHistory");
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.PostgresIntegration.Models.NonFungibleVaultHistory", b =>
                {
                    b.HasBaseType("RadixDlt.NetworkGateway.PostgresIntegration.Models.VaultHistory");
