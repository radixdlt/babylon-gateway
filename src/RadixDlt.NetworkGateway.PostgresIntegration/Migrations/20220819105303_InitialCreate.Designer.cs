...
namespace RadixDlt.NetworkGateway.PostgresIntegration.Migrations
{
    ...
    [Migration("20220819105303_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.History.AccountResourceBalanceHistory", b =>
                {
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.History.AccountValidatorStakeHistory", b =>
                {
                    b.Property<long>("AccountId")
                        .HasColumnType("bigint")
                        .HasColumnName("account_id");
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.History.ResourceSupplyHistory", b =>
                {
                    b.Property<long>("ResourceId")
                        .HasColumnType("bigint")
                        .HasColumnName("resource_id");
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.History.ValidatorStakeHistory", b =>
                {
                    b.Property<long>("ValidatorId")
                        .HasColumnType("bigint")
                        .HasColumnName("validator_id");
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.Joins.AccountTransaction", b =>
                {
                    b.Property<long>("AccountId")
                        .HasColumnType("bigint")
                        .HasColumnName("account_id");
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.LedgerTransaction", b =>
                {
                    b.Property<long>("ResultantStateVersion")
                        .HasColumnType("bigint")
                        .HasColumnName("state_version");
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.Normalization.Account", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.Normalization.Resource", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.Normalization.Validator", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.RawTransaction", b =>
                {
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.Records.ValidatorProposalRecord", b =>
                {
                    b.Property<long>("Epoch")
                        .HasColumnType("bigint")
                        .HasColumnName("epoch");
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.Mempool.MempoolTransaction", b =>
                {
                    b.Property<byte[]>("PayloadHash")
                        .HasColumnType("bytea")
                        .HasColumnName("payload_hash");
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.SingleEntries.LedgerStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.SingleEntries.NetworkConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.History.AccountResourceBalanceHistory", b =>
                {
                    b.HasOne("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.Normalization.Account", "Account")
                        .WithMany()
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.LedgerTransaction", "FromLedgerTransaction")
                        .WithMany()
                    ...
                    b.HasOne("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.Normalization.Resource", "Resource")
                        .WithMany()
                        .HasForeignKey("ResourceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.LedgerTransaction", "ToLedgerTransaction")
                        .WithMany()
                        .HasForeignKey("ToStateVersion")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("FK_account_resource_balance_history_to_transaction");

                    b.OwnsOne("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.History.BalanceEntry", "BalanceEntry", b1 =>
                        {
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.History.AccountValidatorStakeHistory", b =>
                {
                    ...
                    b.HasOne("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.Normalization.Validator", "Validator")
                        .WithMany()
                        .HasForeignKey("ValidatorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.History.AccountValidatorStakeSnapshot", "StakeSnapshot", b1 =>
                        {
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.History.ResourceSupplyHistory", b =>
                {
                    ...
                    b.OwnsOne("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.History.ResourceSupply", "ResourceSupply", b1 =>
                        {
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.History.ValidatorStakeHistory", b =>
                {
                    ...
                    b.OwnsOne("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.History.ValidatorStakeSnapshot", "StakeSnapshot", b1 =>
                        {
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.Joins.AccountTransaction", b =>
                {
                    ...
                    b.HasOne("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.LedgerTransaction", "LedgerTransaction")
                        .WithMany()
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.LedgerTransaction", b =>
                {
                    b.HasOne("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.RawTransaction", "RawTransaction")
                        .WithMany()
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.Records.ValidatorProposalRecord", b =>
                {
                    b.HasOne("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.LedgerTransaction", "LastUpdatedAtLedgerTransaction")
                        .WithMany()
                    ...
                    b.OwnsOne("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.Records.ProposalRecord", "ProposalRecord", b1 =>
                        {
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.SingleEntries.LedgerStatus", b =>
                {
                    b.HasOne("RadixDlt.NetworkGateway.Common.Database.Models.Ledger.LedgerTransaction", "TopOfLedgerTransaction")
                        .WithMany()
                    ...
                    b.OwnsOne("RadixDlt.NetworkGateway.Common.Database.Models.SingleEntries.SyncTarget", "SyncTarget", b1 =>
                        {
            ...
            modelBuilder.Entity("RadixDlt.NetworkGateway.Common.Database.Models.SingleEntries.NetworkConfiguration", b =>
                {
                    b.OwnsOne("RadixDlt.NetworkGateway.Common.Database.Models.SingleEntries.NetworkAddressHrps", "NetworkAddressHrps", b1 =>
                        {
                    ...
                    b.OwnsOne("RadixDlt.NetworkGateway.Common.Database.Models.SingleEntries.NetworkDefinition", "NetworkDefinition", b1 =>
                        {
                            b1.Property<int>("NetworkConfigurationId")
                                .HasColumnType("integer");
                    ...
                    b.OwnsOne("RadixDlt.NetworkGateway.Common.Database.Models.SingleEntries.WellKnownAddresses", "WellKnownAddresses", b1 =>
                        {
                            b1.Property<int>("NetworkConfigurationId")
                                .HasColumnType("integer");
