...
internal class RoleAssignmentQuerier : IRoleAssignmentQuerier
{
        ...
        CancellationToken token = default)
    {
        ...
        var blueprintDefinitions = await _blueprintQuerier.GetBlueprints(blueprintLookup, ledgerState, token);
