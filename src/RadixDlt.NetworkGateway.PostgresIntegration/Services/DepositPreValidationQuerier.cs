...
internal class DepositPreValidationQuerier : IDepositPreValidationQuerier
{
    ...
    public DepositPreValidationQuerier(IDapperWrapper dapperWrapper, ReadOnlyDbContext dbContext, INetworkConfigurationProvider networkConfigurationProvider)
    {
    ...
    )
    {
        ...
        var entityAddressToIdDictionary = await QueryHelper.ResolveEntityIds(_dbContext, addressesToResolve, ledgerState, token);
