...
using RadixDlt.CoreApiSdk.Kiota.StreamNamespace;
...
using System;
namespace RadixDlt.CoreApiSdk.Kiota {
    /// <summary>
    /// The main entry point of the SDK, exposes the configuration and the fluent API.
    /// </summary>
    public class MyClass : BaseRequestBuilder 
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="MyClass"/> and sets the default values.
        /// </summary>
        /// <param name="backingStore">The backing store to use for the models.</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MyClass(IRequestAdapter requestAdapter, IBackingStoreFactory backingStore = default) : base(requestAdapter, "{+baseurl}", new Dictionary<string, object>())
        {
