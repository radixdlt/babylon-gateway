...
namespace RadixDlt.CoreApiSdk.Kiota.Models {
    public class TransactionSubmitErrorResponse : ApiException, IParsable 
    {
...
#nullable enable
        public TransactionSubmitErrorDetails? Details {
            get { return BackingStore?.Get<TransactionSubmitErrorDetails?>("details"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="TransactionSubmitErrorResponse"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="TransactionSubmitErrorResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static TransactionSubmitErrorResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new TransactionSubmitErrorResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"details", n => { Details = n.GetObjectValue<TransactionSubmitErrorDetails>(TransactionSubmitErrorDetails.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<TransactionSubmitErrorDetails>("details", Details);
