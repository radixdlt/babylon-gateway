...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValidatorAllowDelegation_allOf")]
    public partial class ValidatorAllowDelegationAllOf : IEquatable<ValidatorAllowDelegationAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatorAllowDelegationAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValidatorAllowDelegationAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatorAllowDelegationAllOf" /> class.
        /// </summary>
        ...
        public ValidatorAllowDelegationAllOf(bool allowDelegation = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ValidatorAllowDelegationAllOf {\n");
        ...
        {
            return this.Equals(input as ValidatorAllowDelegationAllOf);
        }

        /// <summary>
        /// Returns true if ValidatorAllowDelegationAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ValidatorAllowDelegationAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValidatorAllowDelegationAllOf input)
        {
            if (input == null)
            {
                return false;
