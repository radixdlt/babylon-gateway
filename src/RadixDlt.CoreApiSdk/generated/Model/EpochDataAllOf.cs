...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// EpochDataAllOf
    /// </summary>
    [DataContract(Name = "EpochData_allOf")]
    public partial class EpochDataAllOf : IEquatable<EpochDataAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EpochDataAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EpochDataAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EpochDataAllOf" /> class.
        /// </summary>
        /// <param name="epoch">epoch (required).</param>
        public EpochDataAllOf(long epoch = default(long))
        {
            this.Epoch = epoch;
        }
        ...
        {
            return this.Equals(input as EpochDataAllOf);
        }

        /// <summary>
        /// Returns true if EpochDataAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of EpochDataAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EpochDataAllOf input)
        {
            if (input == null)
            {
                return false;
