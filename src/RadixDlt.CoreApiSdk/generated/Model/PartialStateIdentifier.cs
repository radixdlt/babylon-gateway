...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PartialStateIdentifier")]
    public partial class PartialStateIdentifier : IEquatable<PartialStateIdentifier>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PartialStateIdentifier" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PartialStateIdentifier() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PartialStateIdentifier" /> class.
        /// </summary>
        /// <param name="stateVersion">stateVersion (required).</param>
        /// <param name="transactionAccumulator">Accumulator hash representing all transactions which occurred up to &#x60;state_version&#x60;. Hex encoded..</param>
        public PartialStateIdentifier(long stateVersion = default(long), string transactionAccumulator = default(string))
        {
        ...
        /// </summary>
        /// <value>Accumulator hash representing all transactions which occurred up to &#x60;state_version&#x60;. Hex encoded.</value>
        [DataMember(Name = "transaction_accumulator", EmitDefaultValue = true)]
        public string TransactionAccumulator { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TransactionAccumulator: ").Append(TransactionAccumulator).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as PartialStateIdentifier);
        }

        /// <summary>
        /// Returns true if PartialStateIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of PartialStateIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PartialStateIdentifier input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.TransactionAccumulator == input.TransactionAccumulator ||
                    (this.TransactionAccumulator != null &&
                    this.TransactionAccumulator.Equals(input.TransactionAccumulator))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TransactionAccumulator != null)
                {
                    hashCode = (hashCode * 59) + this.TransactionAccumulator.GetHashCode();
                }
                return hashCode;
            }
        }
