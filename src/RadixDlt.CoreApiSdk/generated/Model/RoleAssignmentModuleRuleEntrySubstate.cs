...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RoleAssignmentModuleRuleEntrySubstate")]
    ...
    public partial class RoleAssignmentModuleRuleEntrySubstate : Substate, IEquatable<RoleAssignmentModuleRuleEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoleAssignmentModuleRuleEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RoleAssignmentModuleRuleEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RoleAssignmentModuleRuleEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value.</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.RoleAssignmentModuleRuleEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public RoleAssignmentModuleRuleEntrySubstate(ObjectRoleKey key = default(ObjectRoleKey), RoleAssignmentModuleRuleEntryValue value = default(RoleAssignmentModuleRuleEntryValue), SubstateType substateType = SubstateType.RoleAssignmentModuleRuleEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for RoleAssignmentModuleRuleEntrySubstate and cannot be null");
            }
            this.Key = key;
            this.Value = value;
        }
        ...
        public RoleAssignmentModuleRuleEntryValue Value { get; set; }
        ...
        {
            return this.Equals(input as RoleAssignmentModuleRuleEntrySubstate);
        }

        /// <summary>
        /// Returns true if RoleAssignmentModuleRuleEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of RoleAssignmentModuleRuleEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoleAssignmentModuleRuleEntrySubstate input)
        {
            if (input == null)
            {
                return false;
