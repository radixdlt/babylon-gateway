...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class ClockCurrentMinuteSubstate : Substate, IEquatable<ClockCurrentMinuteSubstate>
    {
        ...
        /// <param name="substateType">substateType (required) (default to &quot;ClockCurrentMinuteSubstate&quot;).</param>
        public ClockCurrentMinuteSubstate(Instant timestampRoundedDownToMinute = default(Instant), SubstateType substateType = Model.SubstateType.ClockCurrentMinute) : base(substateType)
        {
