...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// AccountSubstate
    /// </summary>
    [DataContract(Name = "AccountSubstate")]
    ...
    public partial class AccountSubstate : Substate, IEquatable<AccountSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountSubstate" /> class.
        /// </summary>
        /// <param name="dataStruct">dataStruct (required).</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.Account).</param>
        public AccountSubstate(DataStruct dataStruct = default(DataStruct), SubstateType substateType = SubstateType.Account) : base(substateType)
        {
            // to ensure "dataStruct" is required (not null)
            if (dataStruct == null)
            {
                throw new ArgumentNullException("dataStruct is a required property for AccountSubstate and cannot be null");
            }
        ...
        {
            return this.Equals(input as AccountSubstate);
        }

        /// <summary>
        /// Returns true if AccountSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountSubstate input)
        {
            if (input == null)
            {
                return false;
