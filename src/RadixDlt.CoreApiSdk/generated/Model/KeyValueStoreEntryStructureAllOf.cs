...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class KeyValueStoreEntryStructureAllOf : IEquatable<KeyValueStoreEntryStructureAllOf>
    {
        ...
        public KeyValueStoreEntryStructureAllOf(string keyValueStoreAddress = default(string), string keySchemaHash = default(string), LocalTypeIndex keyLocalTypeIndex = default(LocalTypeIndex), string valueSchemaHash = default(string), LocalTypeIndex valueLocalTypeIndex = default(LocalTypeIndex))
        {
            // to ensure "keyValueStoreAddress" is required (not null)
            if (keyValueStoreAddress == null)
            {
                throw new ArgumentNullException("keyValueStoreAddress is a required property for KeyValueStoreEntryStructureAllOf and cannot be null");
            }
            this.KeyValueStoreAddress = keyValueStoreAddress;
            // to ensure "keySchemaHash" is required (not null)
            if (keySchemaHash == null)
            {
                throw new ArgumentNullException("keySchemaHash is a required property for KeyValueStoreEntryStructureAllOf and cannot be null");
            }
            this.KeySchemaHash = keySchemaHash;
            // to ensure "keyLocalTypeIndex" is required (not null)
            if (keyLocalTypeIndex == null)
            {
                throw new ArgumentNullException("keyLocalTypeIndex is a required property for KeyValueStoreEntryStructureAllOf and cannot be null");
            }
            this.KeyLocalTypeIndex = keyLocalTypeIndex;
            // to ensure "valueSchemaHash" is required (not null)
            if (valueSchemaHash == null)
            {
                throw new ArgumentNullException("valueSchemaHash is a required property for KeyValueStoreEntryStructureAllOf and cannot be null");
            }
            this.ValueSchemaHash = valueSchemaHash;
            // to ensure "valueLocalTypeIndex" is required (not null)
            if (valueLocalTypeIndex == null)
            {
                throw new ArgumentNullException("valueLocalTypeIndex is a required property for KeyValueStoreEntryStructureAllOf and cannot be null");
            }
