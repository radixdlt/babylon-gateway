...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EngineConfigurationRequest")]
    public partial class EngineConfigurationRequest : IEquatable<EngineConfigurationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EngineConfigurationRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EngineConfigurationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EngineConfigurationRequest" /> class.
        /// </summary>
        /// <param name="networkIdentifier">networkIdentifier (required).</param>
        public EngineConfigurationRequest(NetworkIdentifier networkIdentifier = default(NetworkIdentifier))
        {
            // to ensure "networkIdentifier" is required (not null)
            if (networkIdentifier == null)
            {
                throw new ArgumentNullException("networkIdentifier is a required property for EngineConfigurationRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as EngineConfigurationRequest);
        }

        /// <summary>
        /// Returns true if EngineConfigurationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EngineConfigurationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EngineConfigurationRequest input)
        {
            if (input == null)
            {
                return false;
