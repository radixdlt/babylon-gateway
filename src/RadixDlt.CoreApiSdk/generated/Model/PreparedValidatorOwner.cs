...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PreparedValidatorOwner")]
    ...
    public partial class PreparedValidatorOwner : DataObject, IEquatable<PreparedValidatorOwner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PreparedValidatorOwner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PreparedValidatorOwner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PreparedValidatorOwner" /> class.
        /// </summary>
        /// <param name="owner">owner (required).</param>
        /// <param name="epoch">epoch.</param>
        /// <param name="type">The type of the data object. Each address may own up to one current object of a given type. (required) (default to &quot;PreparedValidatorOwner&quot;).</param>
        public PreparedValidatorOwner(EntityIdentifier owner = default(EntityIdentifier), long epoch = default(long), string type = "PreparedValidatorOwner") : base(type)
        {
            // to ensure "owner" is required (not null)
            if (owner == null)
            {
                throw new ArgumentNullException("owner is a required property for PreparedValidatorOwner and cannot be null");
            }
            this.Owner = owner;
            this.Epoch = epoch;
        }
        ...
        {
            return this.Equals(input as PreparedValidatorOwner);
        }

        /// <summary>
        /// Returns true if PreparedValidatorOwner instances are equal
        /// </summary>
        /// <param name="input">Instance of PreparedValidatorOwner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreparedValidatorOwner input)
        {
            if (input == null)
            {
                return false;
