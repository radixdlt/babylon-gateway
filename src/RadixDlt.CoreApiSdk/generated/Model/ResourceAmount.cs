...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class ResourceAmount : IEquatable<ResourceAmount>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="resourceIdentifier">resourceIdentifier (required).</param>
        public ResourceAmount(string value = default(string), ResourceIdentifier resourceIdentifier = default(ResourceIdentifier))
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for ResourceAmount and cannot be null");
            }
            this.Value = value;
            // to ensure "resourceIdentifier" is required (not null)
            if (resourceIdentifier == null)
            {
                throw new ArgumentNullException("resourceIdentifier is a required property for ResourceAmount and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "resource_identifier", IsRequired = true, EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as ResourceAmount);
        }

        /// <summary>
        /// Returns true if ResourceAmount instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceAmount to be compared</param>
        /// <returns>Boolean</returns>
