...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ParsedSignedTransactionIntent_allOf")]
    public partial class ParsedSignedTransactionIntentAllOf : IEquatable<ParsedSignedTransactionIntentAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParsedSignedTransactionIntentAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ParsedSignedTransactionIntentAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ParsedSignedTransactionIntentAllOf" /> class.
        /// </summary>
        ...
        public ParsedSignedTransactionIntentAllOf(SignedTransactionIntent signedIntent = default(SignedTransactionIntent), ParsedSignedTransactionIntentIdentifiers identifiers = default(ParsedSignedTransactionIntentIdentifiers))
        {
            ...
            if (identifiers == null)
            {
                throw new ArgumentNullException("identifiers is a required property for ParsedSignedTransactionIntentAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as ParsedSignedTransactionIntentAllOf);
        }

        /// <summary>
        /// Returns true if ParsedSignedTransactionIntentAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ParsedSignedTransactionIntentAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParsedSignedTransactionIntentAllOf input)
        {
            if (input == null)
            {
                return false;
