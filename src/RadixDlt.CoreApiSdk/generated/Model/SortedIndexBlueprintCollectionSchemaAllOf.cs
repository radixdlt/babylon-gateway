...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SortedIndexBlueprintCollectionSchema_allOf")]
    public partial class SortedIndexBlueprintCollectionSchemaAllOf : IEquatable<SortedIndexBlueprintCollectionSchemaAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SortedIndexBlueprintCollectionSchemaAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SortedIndexBlueprintCollectionSchemaAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SortedIndexBlueprintCollectionSchemaAllOf" /> class.
        /// </summary>
        ...
        public SortedIndexBlueprintCollectionSchemaAllOf(BlueprintPayloadDef keyTypeRef = default(BlueprintPayloadDef), BlueprintPayloadDef valueTypeRef = default(BlueprintPayloadDef), bool allowOwnership = default(bool))
        {
            // to ensure "keyTypeRef" is required (not null)
            if (keyTypeRef == null)
            {
                throw new ArgumentNullException("keyTypeRef is a required property for SortedIndexBlueprintCollectionSchemaAllOf and cannot be null");
            }
            this.KeyTypeRef = keyTypeRef;
            // to ensure "valueTypeRef" is required (not null)
            if (valueTypeRef == null)
            {
                throw new ArgumentNullException("valueTypeRef is a required property for SortedIndexBlueprintCollectionSchemaAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as SortedIndexBlueprintCollectionSchemaAllOf);
        }

        /// <summary>
        /// Returns true if SortedIndexBlueprintCollectionSchemaAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SortedIndexBlueprintCollectionSchemaAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SortedIndexBlueprintCollectionSchemaAllOf input)
        {
            if (input == null)
            {
                return false;
