...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class PackageInfoSubstate : Substate, IEquatable<PackageInfoSubstate>
    {
        ...
        /// <param name="substateType">substateType (required) (default to &quot;PackageInfoSubstate&quot;).</param>
        public PackageInfoSubstate(string codeHex = default(string), Dictionary<string, BlueprintData> blueprints = default(Dictionary<string, BlueprintData>), SubstateType substateType = Model.SubstateType.PackageInfo) : base(substateType)
        {
            // to ensure "codeHex" is required (not null)
            if (codeHex == null)
            {
                throw new ArgumentNullException("codeHex is a required property for PackageInfoSubstate and cannot be null");
            }
