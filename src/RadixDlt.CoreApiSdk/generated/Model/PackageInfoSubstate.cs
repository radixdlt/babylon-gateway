...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class PackageInfoSubstate : Substate, IEquatable<PackageInfoSubstate>
    {
        ...
        public PackageInfoSubstate(string codeHex = default(string), Dictionary<string, BlueprintData> blueprints = default(Dictionary<string, BlueprintData>), SubstateType substateType = SubstateType.PackageInfo) : base(substateType)
        {
