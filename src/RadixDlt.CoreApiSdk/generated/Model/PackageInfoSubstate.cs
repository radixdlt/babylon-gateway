...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class PackageInfoSubstate : IEquatable<PackageInfoSubstate>, IValidatableObject
    {
        ...
        public PackageInfoSubstate(SubstateType substateType = default(SubstateType), string codeHex = default(string), Dictionary<string, BlueprintData> blueprints = default(Dictionary<string, BlueprintData>))
        {
