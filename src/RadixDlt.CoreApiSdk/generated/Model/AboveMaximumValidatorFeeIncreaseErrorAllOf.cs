...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AboveMaximumValidatorFeeIncreaseError_allOf")]
    public partial class AboveMaximumValidatorFeeIncreaseErrorAllOf : IEquatable<AboveMaximumValidatorFeeIncreaseErrorAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AboveMaximumValidatorFeeIncreaseErrorAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AboveMaximumValidatorFeeIncreaseErrorAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AboveMaximumValidatorFeeIncreaseErrorAllOf" /> class.
        /// </summary>
        ...
        public AboveMaximumValidatorFeeIncreaseErrorAllOf(int maximumValidatorFeeIncrease = default(int), int attemptedValidatorFeeIncrease = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AboveMaximumValidatorFeeIncreaseErrorAllOf {\n");
        ...
        {
            return this.Equals(input as AboveMaximumValidatorFeeIncreaseErrorAllOf);
        }

        /// <summary>
        /// Returns true if AboveMaximumValidatorFeeIncreaseErrorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AboveMaximumValidatorFeeIncreaseErrorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AboveMaximumValidatorFeeIncreaseErrorAllOf input)
        {
            if (input == null)
            {
                return false;
