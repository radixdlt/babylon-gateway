...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValidatorAllowDelegation")]
    ...
    public partial class ValidatorAllowDelegation : DataObject, IEquatable<ValidatorAllowDelegation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatorAllowDelegation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValidatorAllowDelegation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatorAllowDelegation" /> class.
        /// </summary>
        /// <param name="allowDelegation">Flag indicating whether stakers besides the owner of the validator can stake to this validator. (required).</param>
        /// <param name="type">The type of the data object. Each address may own up to one current object of a given type. (required) (default to &quot;ValidatorAllowDelegation&quot;).</param>
        public ValidatorAllowDelegation(bool allowDelegation = default(bool), string type = "ValidatorAllowDelegation") : base(type)
        {
        ...
        /// </summary>
        /// <value>Flag indicating whether stakers besides the owner of the validator can stake to this validator.</value>
        [DataMember(Name = "allow_delegation", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AllowDelegation: ").Append(AllowDelegation).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ValidatorAllowDelegation);
        }

        /// <summary>
        /// Returns true if ValidatorAllowDelegation instances are equal
        /// </summary>
        /// <param name="input">Instance of ValidatorAllowDelegation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValidatorAllowDelegation input)
        {
            if (input == null)
            {
                return false;
            ...
            return base.Equals(input) && 
                (
                    this.AllowDelegation == input.AllowDelegation ||
                    this.AllowDelegation.Equals(input.AllowDelegation)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AllowDelegation.GetHashCode();
                return hashCode;
            }
        }
