...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccessRulesModuleFieldAccessRulesSubstate_allOf")]
    public partial class AccessRulesModuleFieldAccessRulesSubstateAllOf : IEquatable<AccessRulesModuleFieldAccessRulesSubstateAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccessRulesModuleFieldAccessRulesSubstateAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccessRulesModuleFieldAccessRulesSubstateAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccessRulesModuleFieldAccessRulesSubstateAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AccessRulesModuleFieldAccessRulesSubstateAllOf);
        }

        /// <summary>
        /// Returns true if AccessRulesModuleFieldAccessRulesSubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AccessRulesModuleFieldAccessRulesSubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccessRulesModuleFieldAccessRulesSubstateAllOf input)
        {
            if (input == null)
            {
                return false;
