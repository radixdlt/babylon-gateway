...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PackageCodeVmTypeEntrySubstate")]
    ...
    public partial class PackageCodeVmTypeEntrySubstate : Substate, IEquatable<PackageCodeVmTypeEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageCodeVmTypeEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PackageCodeVmTypeEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageCodeVmTypeEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.PackageCodeVmTypeEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public PackageCodeVmTypeEntrySubstate(PackageCodeKey key = default(PackageCodeKey), PackageCodeVmTypeEntryValue value = default(PackageCodeVmTypeEntryValue), SubstateType substateType = SubstateType.PackageCodeVmTypeEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for PackageCodeVmTypeEntrySubstate and cannot be null");
            }
            this.Key = key;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for PackageCodeVmTypeEntrySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public PackageCodeVmTypeEntryValue Value { get; set; }
        ...
        {
            return this.Equals(input as PackageCodeVmTypeEntrySubstate);
        }

        /// <summary>
        /// Returns true if PackageCodeVmTypeEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of PackageCodeVmTypeEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PackageCodeVmTypeEntrySubstate input)
        {
            if (input == null)
            {
                return false;
