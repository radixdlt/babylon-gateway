...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccessRulesModuleFieldOwnerRoleSubstate")]
    ...
    public partial class AccessRulesModuleFieldOwnerRoleSubstate : Substate, IEquatable<AccessRulesModuleFieldOwnerRoleSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccessRulesModuleFieldOwnerRoleSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccessRulesModuleFieldOwnerRoleSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccessRulesModuleFieldOwnerRoleSubstate" /> class.
        /// </summary>
        ...
        public AccessRulesModuleFieldOwnerRoleSubstate(OwnerRole ownerRole = default(OwnerRole), SubstateType substateType = SubstateType.AccessRulesModuleFieldOwnerRole) : base(substateType)
        {
        ...
        {
            return this.Equals(input as AccessRulesModuleFieldOwnerRoleSubstate);
        }

        /// <summary>
        /// Returns true if AccessRulesModuleFieldOwnerRoleSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of AccessRulesModuleFieldOwnerRoleSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccessRulesModuleFieldOwnerRoleSubstate input)
        {
            if (input == null)
            {
                return false;
