...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InvalidFeePayerEntityError_allOf")]
    public partial class InvalidFeePayerEntityErrorAllOf : IEquatable<InvalidFeePayerEntityErrorAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidFeePayerEntityErrorAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvalidFeePayerEntityErrorAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidFeePayerEntityErrorAllOf" /> class.
        /// </summary>
        /// <param name="invalidFeePayerEntity">invalidFeePayerEntity (required).</param>
        public InvalidFeePayerEntityErrorAllOf(EntityIdentifier invalidFeePayerEntity = default(EntityIdentifier))
        {
            // to ensure "invalidFeePayerEntity" is required (not null)
            if (invalidFeePayerEntity == null)
            {
                throw new ArgumentNullException("invalidFeePayerEntity is a required property for InvalidFeePayerEntityErrorAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvalidFeePayerEntityErrorAllOf {\n");
        ...
        {
            return this.Equals(input as InvalidFeePayerEntityErrorAllOf);
        }

        /// <summary>
        /// Returns true if InvalidFeePayerEntityErrorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidFeePayerEntityErrorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidFeePayerEntityErrorAllOf input)
        {
            if (input == null)
            {
                return false;
