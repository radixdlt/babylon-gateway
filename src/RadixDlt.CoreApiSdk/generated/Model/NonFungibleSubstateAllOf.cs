...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NonFungibleSubstate_allOf")]
    public partial class NonFungibleSubstateAllOf : IEquatable<NonFungibleSubstateAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NonFungibleSubstateAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NonFungibleSubstateAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NonFungibleSubstateAllOf" /> class.
        /// </summary>
        ...
        public NonFungibleSubstateAllOf(string nonFungibleIdHex = default(string), bool isDeleted = default(bool), NonFungibleData nonFungibleData = default(NonFungibleData))
        {
            // to ensure "nonFungibleIdHex" is required (not null)
            if (nonFungibleIdHex == null)
            {
                throw new ArgumentNullException("nonFungibleIdHex is a required property for NonFungibleSubstateAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as NonFungibleSubstateAllOf);
        }

        /// <summary>
        /// Returns true if NonFungibleSubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of NonFungibleSubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NonFungibleSubstateAllOf input)
        {
            if (input == null)
            {
                return false;
