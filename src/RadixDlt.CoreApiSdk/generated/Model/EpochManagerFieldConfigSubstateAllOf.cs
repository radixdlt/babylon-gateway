...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EpochManagerFieldConfigSubstate_allOf")]
    public partial class EpochManagerFieldConfigSubstateAllOf : IEquatable<EpochManagerFieldConfigSubstateAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EpochManagerFieldConfigSubstateAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EpochManagerFieldConfigSubstateAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EpochManagerFieldConfigSubstateAllOf" /> class.
        /// </summary>
        ...
        public EpochManagerFieldConfigSubstateAllOf(long maxValidators = default(long), long roundsPerEpoch = default(long), long numUnstakeEpochs = default(long))
        {
        ...
        {
            return this.Equals(input as EpochManagerFieldConfigSubstateAllOf);
        }

        /// <summary>
        /// Returns true if EpochManagerFieldConfigSubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of EpochManagerFieldConfigSubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EpochManagerFieldConfigSubstateAllOf input)
        {
            if (input == null)
            {
                return false;
