...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConstructionDeriveRequestMetadataExitingUnstakes_allOf")]
    public partial class ConstructionDeriveRequestMetadataExitingUnstakesAllOf : IEquatable<ConstructionDeriveRequestMetadataExitingUnstakesAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionDeriveRequestMetadataExitingUnstakesAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConstructionDeriveRequestMetadataExitingUnstakesAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionDeriveRequestMetadataExitingUnstakesAllOf" /> class.
        /// </summary>
        /// <param name="validator">validator (required).</param>
        /// <param name="epochUnlock">epochUnlock (required).</param>
        public ConstructionDeriveRequestMetadataExitingUnstakesAllOf(EntityIdentifier validator = default(EntityIdentifier), long epochUnlock = default(long))
        {
            // to ensure "validator" is required (not null)
            if (validator == null)
            {
                throw new ArgumentNullException("validator is a required property for ConstructionDeriveRequestMetadataExitingUnstakesAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConstructionDeriveRequestMetadataExitingUnstakesAllOf {\n");
        ...
        {
            return this.Equals(input as ConstructionDeriveRequestMetadataExitingUnstakesAllOf);
        }

        /// <summary>
        /// Returns true if ConstructionDeriveRequestMetadataExitingUnstakesAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ConstructionDeriveRequestMetadataExitingUnstakesAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConstructionDeriveRequestMetadataExitingUnstakesAllOf input)
        {
            if (input == null)
            {
                return false;
