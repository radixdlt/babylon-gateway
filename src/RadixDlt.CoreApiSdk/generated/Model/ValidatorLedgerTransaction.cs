...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class ValidatorLedgerTransaction : LedgerTransaction, IEquatable<ValidatorLedgerTransaction>
    {
        ...
        protected ValidatorLedgerTransaction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatorLedgerTransaction" /> class.
        /// </summary>
        ...
        public ValidatorLedgerTransaction(ValidatorTransaction validatorTransaction = default(ValidatorTransaction), LedgerTransactionType type = LedgerTransactionType.Validator, string payloadHex = default(string)) : base(type, payloadHex)
        {
            ...
            {
                throw new ArgumentNullException("validatorTransaction is a required property for ValidatorLedgerTransaction and cannot be null");
            }
        ...
        {
            return this.Equals(input as ValidatorLedgerTransaction);
        }

        /// <summary>
        /// Returns true if ValidatorLedgerTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of ValidatorLedgerTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValidatorLedgerTransaction input)
        {
            if (input == null)
            {
                return false;
