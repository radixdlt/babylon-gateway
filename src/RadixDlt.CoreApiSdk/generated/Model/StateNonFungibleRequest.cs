...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StateNonFungibleRequest")]
    public partial class StateNonFungibleRequest : IEquatable<StateNonFungibleRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StateNonFungibleRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StateNonFungibleRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StateNonFungibleRequest" /> class.
        /// </summary>
        ...
        /// <param name="nonFungibleId">The simple string representation of the non-fungible id. * For string ids, this is &#x60;&lt;the-string-id&gt;&#x60; * For integer ids, this is &#x60;#the-integer-id#&#x60; * For bytes ids, this is &#x60;[the-lower-case-hex-representation]&#x60; * For RUID ids, this is &#x60;{...-...-...-...}&#x60; where &#x60;...&#x60; are each 16 hex characters. A given non-fungible resource has a fixed &#x60;NonFungibleIdType&#x60;, so this representation uniquely identifies this non-fungible under the given resource address.  (required).</param>
        public StateNonFungibleRequest(string network = default(string), string resourceAddress = default(string), string nonFungibleId = default(string))
        {
            // to ensure "network" is required (not null)
            if (network == null)
            {
                throw new ArgumentNullException("network is a required property for StateNonFungibleRequest and cannot be null");
            }
            this.Network = network;
            // to ensure "resourceAddress" is required (not null)
            if (resourceAddress == null)
            {
                throw new ArgumentNullException("resourceAddress is a required property for StateNonFungibleRequest and cannot be null");
            }
            this.ResourceAddress = resourceAddress;
            // to ensure "nonFungibleId" is required (not null)
            if (nonFungibleId == null)
            {
                throw new ArgumentNullException("nonFungibleId is a required property for StateNonFungibleRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as StateNonFungibleRequest);
        }

        /// <summary>
        /// Returns true if StateNonFungibleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of StateNonFungibleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StateNonFungibleRequest input)
        {
            if (input == null)
            {
                return false;
