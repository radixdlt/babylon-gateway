...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InvalidHexError_allOf")]
    public partial class InvalidHexErrorAllOf : IEquatable<InvalidHexErrorAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidHexErrorAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvalidHexErrorAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidHexErrorAllOf" /> class.
        /// </summary>
        /// <param name="invalidHex">invalidHex (required).</param>
        public InvalidHexErrorAllOf(string invalidHex = default(string))
        {
            // to ensure "invalidHex" is required (not null)
            if (invalidHex == null)
            {
                throw new ArgumentNullException("invalidHex is a required property for InvalidHexErrorAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as InvalidHexErrorAllOf);
        }

        /// <summary>
        /// Returns true if InvalidHexErrorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidHexErrorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidHexErrorAllOf input)
        {
            if (input == null)
            {
                return false;
