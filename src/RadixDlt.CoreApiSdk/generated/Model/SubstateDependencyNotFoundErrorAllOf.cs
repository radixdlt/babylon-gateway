...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubstateDependencyNotFoundError_allOf")]
    public partial class SubstateDependencyNotFoundErrorAllOf : IEquatable<SubstateDependencyNotFoundErrorAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubstateDependencyNotFoundErrorAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SubstateDependencyNotFoundErrorAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SubstateDependencyNotFoundErrorAllOf" /> class.
        /// </summary>
        /// <param name="substateIdentifierNotFound">substateIdentifierNotFound (required).</param>
        public SubstateDependencyNotFoundErrorAllOf(SubstateIdentifier substateIdentifierNotFound = default(SubstateIdentifier))
        {
            // to ensure "substateIdentifierNotFound" is required (not null)
            if (substateIdentifierNotFound == null)
            {
                throw new ArgumentNullException("substateIdentifierNotFound is a required property for SubstateDependencyNotFoundErrorAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubstateDependencyNotFoundErrorAllOf {\n");
        ...
        {
            return this.Equals(input as SubstateDependencyNotFoundErrorAllOf);
        }

        /// <summary>
        /// Returns true if SubstateDependencyNotFoundErrorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SubstateDependencyNotFoundErrorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubstateDependencyNotFoundErrorAllOf input)
        {
            if (input == null)
            {
                return false;
