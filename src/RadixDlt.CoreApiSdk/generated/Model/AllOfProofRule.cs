...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class AllOfProofRule : IEquatable<AllOfProofRule>, IValidatableObject
    {
        ...
        public AllOfProofRule(ProofRuleType type = default(ProofRuleType), DynamicResourceDescriptorList list = default(DynamicResourceDescriptorList))
        {
            this.Type = type;
