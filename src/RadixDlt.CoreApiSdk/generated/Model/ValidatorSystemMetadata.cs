...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValidatorSystemMetadata")]
    ...
    public partial class ValidatorSystemMetadata : DataObject, IEquatable<ValidatorSystemMetadata>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatorSystemMetadata" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValidatorSystemMetadata() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatorSystemMetadata" /> class.
        /// </summary>
        /// <param name="data">A hex encoded byte array. (required).</param>
        /// <param name="type">The type of the data object. Each address may own up to one current object of a given type. (required) (default to &quot;ValidatorSystemMetadata&quot;).</param>
        public ValidatorSystemMetadata(string data = default(string), string type = "ValidatorSystemMetadata") : base(type)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ValidatorSystemMetadata and cannot be null");
            }
            this.Data = data;
        }
        ...
        /// </summary>
        /// <value>A hex encoded byte array.</value>
        ...
        {
            return this.Equals(input as ValidatorSystemMetadata);
        }

        /// <summary>
        /// Returns true if ValidatorSystemMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of ValidatorSystemMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValidatorSystemMetadata input)
        {
            if (input == null)
            {
                return false;
