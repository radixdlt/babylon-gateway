...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubstateIdentifier")]
    public partial class SubstateIdentifier : IEquatable<SubstateIdentifier>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubstateIdentifier" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SubstateIdentifier() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SubstateIdentifier" /> class.
        /// </summary>
        /// <param name="identifier">identifier (required).</param>
        public SubstateIdentifier(string identifier = default(string))
        {
            // to ensure "identifier" is required (not null)
            if (identifier == null)
            {
                throw new ArgumentNullException("identifier is a required property for SubstateIdentifier and cannot be null");
            }
        ...
        {
            return this.Equals(input as SubstateIdentifier);
        }

        /// <summary>
        /// Returns true if SubstateIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of SubstateIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubstateIdentifier input)
        {
            if (input == null)
            {
                return false;
