...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class AccessRulesModuleRuleEntrySubstateAllOf : IEquatable<AccessRulesModuleRuleEntrySubstateAllOf>
    {
        ...
        protected AccessRulesModuleRuleEntrySubstateAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccessRulesModuleRuleEntrySubstateAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AccessRulesModuleRuleEntrySubstateAllOf);
        }

        /// <summary>
        /// Returns true if AccessRulesModuleRuleEntrySubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AccessRulesModuleRuleEntrySubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccessRulesModuleRuleEntrySubstateAllOf input)
        {
            if (input == null)
            {
                return false;
