...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class CountOfProofRule : IEquatable<CountOfProofRule>, IValidatableObject
    {
        ...
        public CountOfProofRule(ProofRuleType type = default(ProofRuleType), DynamicCount count = default(DynamicCount), DynamicResourceDescriptorList list = default(DynamicResourceDescriptorList))
        {
            this.Type = type;
