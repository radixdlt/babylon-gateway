...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class CountOfProofRule : ProofRule, IEquatable<CountOfProofRule>
    {
        ...
        /// <param name="type">type (required) (default to &quot;CountOfProofRule&quot;).</param>
        public CountOfProofRule(DynamicCount count = default(DynamicCount), DynamicResourceDescriptorList list = default(DynamicResourceDescriptorList), ProofRuleType type = "CountOfProofRule") : base(type)
        {
