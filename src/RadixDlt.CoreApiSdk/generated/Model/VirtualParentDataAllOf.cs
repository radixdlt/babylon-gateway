...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VirtualParentData_allOf")]
    public partial class VirtualParentDataAllOf : IEquatable<VirtualParentDataAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VirtualParentDataAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VirtualParentDataAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VirtualParentDataAllOf" /> class.
        /// </summary>
        ...
        public VirtualParentDataAllOf(EntitySetIdentifier entitySetIdentifier = default(EntitySetIdentifier), DataObject virtualDataObject = default(DataObject))
        {
            // to ensure "entitySetIdentifier" is required (not null)
            if (entitySetIdentifier == null)
            {
                throw new ArgumentNullException("entitySetIdentifier is a required property for VirtualParentDataAllOf and cannot be null");
            }
            this.EntitySetIdentifier = entitySetIdentifier;
            // to ensure "virtualDataObject" is required (not null)
            if (virtualDataObject == null)
            {
                throw new ArgumentNullException("virtualDataObject is a required property for VirtualParentDataAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VirtualParentDataAllOf {\n");
        ...
        {
            return this.Equals(input as VirtualParentDataAllOf);
        }

        /// <summary>
        /// Returns true if VirtualParentDataAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of VirtualParentDataAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VirtualParentDataAllOf input)
        {
            if (input == null)
            {
                return false;
