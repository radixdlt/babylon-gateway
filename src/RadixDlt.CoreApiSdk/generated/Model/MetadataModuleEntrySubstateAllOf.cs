...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MetadataModuleEntrySubstate_allOf")]
    public partial class MetadataModuleEntrySubstateAllOf : IEquatable<MetadataModuleEntrySubstateAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataModuleEntrySubstateAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataModuleEntrySubstateAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataModuleEntrySubstateAllOf" /> class.
        /// </summary>
        ...
        public MetadataModuleEntrySubstateAllOf(string fieldName = default(string), bool isDeleted = default(bool), DataStruct dataStruct = default(DataStruct), bool isLocked = default(bool))
        {
        ...
        {
            return this.Equals(input as MetadataModuleEntrySubstateAllOf);
        }

        /// <summary>
        /// Returns true if MetadataModuleEntrySubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataModuleEntrySubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataModuleEntrySubstateAllOf input)
        {
            if (input == null)
            {
                return false;
