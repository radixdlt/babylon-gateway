...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class FungibleVaultFieldFrozenStatusSubstate : Substate, IEquatable<FungibleVaultFieldFrozenStatusSubstate>
    {
        ...
        public FungibleVaultFieldFrozenStatusSubstate(FrozenStatus frozenStatus = default(FrozenStatus), SubstateType substateType = SubstateType.FungibleVaultFieldFrozenStatus) : base(substateType)
        {
