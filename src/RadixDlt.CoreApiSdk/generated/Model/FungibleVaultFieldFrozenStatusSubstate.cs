...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class FungibleVaultFieldFrozenStatusSubstate : Substate, IEquatable<FungibleVaultFieldFrozenStatusSubstate>
    {
        ...
        public FungibleVaultFieldFrozenStatusSubstate(FrozenStatus frozenStatus = default(FrozenStatus), SubstateType substateType = SubstateType.FungibleVaultFieldFrozenStatus, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "frozenStatus" is required (not null)
            if (frozenStatus == null)
            {
                throw new ArgumentNullException("frozenStatus is a required property for FungibleVaultFieldFrozenStatusSubstate and cannot be null");
            }
