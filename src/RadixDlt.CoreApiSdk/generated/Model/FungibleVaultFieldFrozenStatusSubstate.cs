...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FungibleVaultFieldFrozenStatusSubstate")]
    ...
    public partial class FungibleVaultFieldFrozenStatusSubstate : Substate, IEquatable<FungibleVaultFieldFrozenStatusSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FungibleVaultFieldFrozenStatusSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FungibleVaultFieldFrozenStatusSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FungibleVaultFieldFrozenStatusSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.FungibleVaultFieldFrozenStatus).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public FungibleVaultFieldFrozenStatusSubstate(FungibleVaultFieldFrozenStatusValue value = default(FungibleVaultFieldFrozenStatusValue), SubstateType substateType = SubstateType.FungibleVaultFieldFrozenStatus, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for FungibleVaultFieldFrozenStatusSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as FungibleVaultFieldFrozenStatusSubstate);
        }

        /// <summary>
        /// Returns true if FungibleVaultFieldFrozenStatusSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of FungibleVaultFieldFrozenStatusSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FungibleVaultFieldFrozenStatusSubstate input)
        {
            if (input == null)
            {
                return false;
