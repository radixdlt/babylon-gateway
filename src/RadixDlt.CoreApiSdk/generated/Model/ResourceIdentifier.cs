...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(StakeUnitResourceIdentifier), "StakeUnitResourceIdentifier")]
    [JsonSubtypes.KnownSubType(typeof(TokenResourceIdentifier), "Token")]
    [JsonSubtypes.KnownSubType(typeof(TokenResourceIdentifier), "TokenResourceIdentifier")]
    public partial class ResourceIdentifier : IEquatable<ResourceIdentifier>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceIdentifier(string type = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for ResourceIdentifier and cannot be null");
            }
            this.Type = type;
        }
        ...
        /// <summary>
        /// Returns true if ResourceIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceIdentifier to be compared</param>
        /// <returns>Boolean</returns>
