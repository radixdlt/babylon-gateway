...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RoyaltyModuleFieldAccumulatorSubstate")]
    ...
    public partial class RoyaltyModuleFieldAccumulatorSubstate : Substate, IEquatable<RoyaltyModuleFieldAccumulatorSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoyaltyModuleFieldAccumulatorSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RoyaltyModuleFieldAccumulatorSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RoyaltyModuleFieldAccumulatorSubstate" /> class.
        /// </summary>
        /// <param name="vaultEntity">vaultEntity.</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.RoyaltyModuleFieldAccumulator).</param>
        public RoyaltyModuleFieldAccumulatorSubstate(EntityReference vaultEntity = default(EntityReference), SubstateType substateType = SubstateType.RoyaltyModuleFieldAccumulator) : base(substateType)
        {
        ...
        {
            return this.Equals(input as RoyaltyModuleFieldAccumulatorSubstate);
        }

        /// <summary>
        /// Returns true if RoyaltyModuleFieldAccumulatorSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of RoyaltyModuleFieldAccumulatorSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoyaltyModuleFieldAccumulatorSubstate input)
        {
            if (input == null)
            {
                return false;
