...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class RoyaltyPayment : IEquatable<RoyaltyPayment>
    {
        ...
        /// <param name="costUnitAmount">An integer between &#x60;0&#x60; and &#x60;2^32 - 1&#x60;, representing the amount of cost units of royalty paid to this receiver. (required).</param>
        public RoyaltyPayment(GlobalEntityReference royaltyReceiver = default(GlobalEntityReference), long costUnitAmount = default(long))
        {
        ...
        /// </summary>
        /// <value>An integer between &#x60;0&#x60; and &#x60;2^32 - 1&#x60;, representing the amount of cost units of royalty paid to this receiver.</value>
        [DataMember(Name = "cost_unit_amount", IsRequired = true, EmitDefaultValue = true)]
        public long CostUnitAmount { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CostUnitAmount: ").Append(CostUnitAmount).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(RoyaltyPayment input)
        {
            ...
            return 
                ...
                (
                    this.CostUnitAmount == input.CostUnitAmount ||
                    this.CostUnitAmount.Equals(input.CostUnitAmount)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CostUnitAmount.GetHashCode();
                return hashCode;
            }
        }
