...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConsensusManagerFieldConfigSubstate_allOf")]
    public partial class ConsensusManagerFieldConfigSubstateAllOf : IEquatable<ConsensusManagerFieldConfigSubstateAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsensusManagerFieldConfigSubstateAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConsensusManagerFieldConfigSubstateAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsensusManagerFieldConfigSubstateAllOf" /> class.
        /// </summary>
        ...
        public ConsensusManagerFieldConfigSubstateAllOf(long maxValidators = default(long), EpochChangeCondition epochChangeCondition = default(EpochChangeCondition), long numUnstakeEpochs = default(long), string totalEmissionXrdPerEpoch = default(string), string minValidatorReliability = default(string), long numOwnerStakeUnitsUnlockEpochs = default(long), long numFeeIncreaseDelayEpochs = default(long), string validatorCreationXrdCost = default(string))
        {
            this.MaxValidators = maxValidators;
            // to ensure "epochChangeCondition" is required (not null)
            if (epochChangeCondition == null)
            {
                throw new ArgumentNullException("epochChangeCondition is a required property for ConsensusManagerFieldConfigSubstateAllOf and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("totalEmissionXrdPerEpoch is a required property for ConsensusManagerFieldConfigSubstateAllOf and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("minValidatorReliability is a required property for ConsensusManagerFieldConfigSubstateAllOf and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("validatorCreationXrdCost is a required property for ConsensusManagerFieldConfigSubstateAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as ConsensusManagerFieldConfigSubstateAllOf);
        }

        /// <summary>
        /// Returns true if ConsensusManagerFieldConfigSubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ConsensusManagerFieldConfigSubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConsensusManagerFieldConfigSubstateAllOf input)
        {
            if (input == null)
            {
                return false;
