...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class RoundData : DataObject, IEquatable<RoundData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoundData" /> class.
        /// </summary>
        ...
        /// <param name="type">The type of the data object. Each address may own up to one current object of a given type. (required) (default to &quot;RoundData&quot;).</param>
        public RoundData(long round = default(long), long timestamp = default(long), string type = "RoundData") : base(type)
        {
            this.Round = round;
        ...
        {
            return this.Equals(input as RoundData);
        }

        /// <summary>
        /// Returns true if RoundData instances are equal
        /// </summary>
        /// <param name="input">Instance of RoundData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoundData input)
        {
            if (input == null)
            {
                return false;
