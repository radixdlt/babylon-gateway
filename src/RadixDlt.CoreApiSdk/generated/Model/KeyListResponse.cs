...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// KeyListResponse
    /// </summary>
    [DataContract(Name = "KeyListResponse")]
    public partial class KeyListResponse : IEquatable<KeyListResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KeyListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KeyListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KeyListResponse" /> class.
        /// </summary>
        /// <param name="publicKeys">List of keys the node supports. (required).</param>
        public KeyListResponse(List<PublicKeyEntry> publicKeys = default(List<PublicKeyEntry>))
        {
            // to ensure "publicKeys" is required (not null)
            if (publicKeys == null)
            {
                throw new ArgumentNullException("publicKeys is a required property for KeyListResponse and cannot be null");
            }
        ...
        /// </summary>
        /// <value>List of keys the node supports.</value>
        [DataMember(Name = "public_keys", IsRequired = true, EmitDefaultValue = true)]
        public List<PublicKeyEntry> PublicKeys { get; set; }
        ...
        {
            return this.Equals(input as KeyListResponse);
        }

        /// <summary>
        /// Returns true if KeyListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of KeyListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KeyListResponse input)
        {
            if (input == null)
            {
                return false;
