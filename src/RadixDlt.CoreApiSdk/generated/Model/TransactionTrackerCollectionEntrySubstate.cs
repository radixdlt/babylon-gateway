...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionTrackerCollectionEntrySubstate")]
    ...
    public partial class TransactionTrackerCollectionEntrySubstate : Substate, IEquatable<TransactionTrackerCollectionEntrySubstate>
    {
        ...
        protected TransactionTrackerCollectionEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionTrackerCollectionEntrySubstate" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TransactionTrackerCollectionEntrySubstate);
        }

        /// <summary>
        /// Returns true if TransactionTrackerCollectionEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionTrackerCollectionEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionTrackerCollectionEntrySubstate input)
        {
            if (input == null)
            {
                return false;
