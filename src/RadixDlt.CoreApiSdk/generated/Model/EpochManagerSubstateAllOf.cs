...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class EpochManagerSubstateAllOf : IEquatable<EpochManagerSubstateAllOf>
    {
        ...
        /// <param name="validatorOwnerResource">The Bech32m-encoded human readable version of the resource address (required).</param>
        ...
        public EpochManagerSubstateAllOf(string address = default(string), string validatorOwnerResource = default(string), long epoch = default(long), long round = default(long), long roundsPerEpoch = default(long), long numUnstakeEpochs = default(long))
        {
            ...
            // to ensure "validatorOwnerResource" is required (not null)
            if (validatorOwnerResource == null)
            {
                throw new ArgumentNullException("validatorOwnerResource is a required property for EpochManagerSubstateAllOf and cannot be null");
            }
        ...
        [DataMember(Name = "validator_owner_resource", IsRequired = true, EmitDefaultValue = true)]
        public string ValidatorOwnerResource { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ValidatorOwnerResource: ").Append(ValidatorOwnerResource).Append("\n");
        ...
        public bool Equals(EpochManagerSubstateAllOf input)
        {
            ...
            return 
                ...
                (
                    this.ValidatorOwnerResource == input.ValidatorOwnerResource ||
                    (this.ValidatorOwnerResource != null &&
                    this.ValidatorOwnerResource.Equals(input.ValidatorOwnerResource))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ValidatorOwnerResource != null)
                {
                    hashCode = (hashCode * 59) + this.ValidatorOwnerResource.GetHashCode();
                }
