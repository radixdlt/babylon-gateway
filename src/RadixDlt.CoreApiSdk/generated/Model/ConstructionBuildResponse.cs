...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConstructionBuildResponse")]
    public partial class ConstructionBuildResponse : IEquatable<ConstructionBuildResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionBuildResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConstructionBuildResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionBuildResponse" /> class.
        /// </summary>
        /// <param name="unsignedTransaction">Hex encoded unsigned transaction. (required).</param>
        /// <param name="payloadToSign">Hex encoded hash payload to sign. (required).</param>
        public ConstructionBuildResponse(string unsignedTransaction = default(string), string payloadToSign = default(string))
        {
            // to ensure "unsignedTransaction" is required (not null)
            if (unsignedTransaction == null)
            {
                throw new ArgumentNullException("unsignedTransaction is a required property for ConstructionBuildResponse and cannot be null");
            }
            this.UnsignedTransaction = unsignedTransaction;
            // to ensure "payloadToSign" is required (not null)
            if (payloadToSign == null)
            {
                throw new ArgumentNullException("payloadToSign is a required property for ConstructionBuildResponse and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Hex encoded hash payload to sign.</value>
        ...
        {
            return this.Equals(input as ConstructionBuildResponse);
        }

        /// <summary>
        /// Returns true if ConstructionBuildResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ConstructionBuildResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConstructionBuildResponse input)
        {
            if (input == null)
            {
                return false;
