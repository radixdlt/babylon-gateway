...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConstructionDeriveRequestMetadataPreparedStakes")]
    ...
    public partial class ConstructionDeriveRequestMetadataPreparedStakes : ConstructionDeriveRequestMetadata, IEquatable<ConstructionDeriveRequestMetadataPreparedStakes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionDeriveRequestMetadataPreparedStakes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConstructionDeriveRequestMetadataPreparedStakes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionDeriveRequestMetadataPreparedStakes" /> class.
        /// </summary>
        /// <param name="validator">validator (required).</param>
        /// <param name="type">type (required) (default to &quot;ConstructionDeriveRequestMetadataPreparedStakes&quot;).</param>
        public ConstructionDeriveRequestMetadataPreparedStakes(EntityIdentifier validator = default(EntityIdentifier), string type = "ConstructionDeriveRequestMetadataPreparedStakes") : base(type)
        {
            // to ensure "validator" is required (not null)
            if (validator == null)
            {
                throw new ArgumentNullException("validator is a required property for ConstructionDeriveRequestMetadataPreparedStakes and cannot be null");
            }
        ...
        {
            return this.Equals(input as ConstructionDeriveRequestMetadataPreparedStakes);
        }

        /// <summary>
        /// Returns true if ConstructionDeriveRequestMetadataPreparedStakes instances are equal
        /// </summary>
        /// <param name="input">Instance of ConstructionDeriveRequestMetadataPreparedStakes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConstructionDeriveRequestMetadataPreparedStakes input)
        {
            if (input == null)
            {
                return false;
