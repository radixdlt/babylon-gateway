...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InvalidJsonError_allOf")]
    public partial class InvalidJsonErrorAllOf : IEquatable<InvalidJsonErrorAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidJsonErrorAllOf" /> class.
        /// </summary>
        /// <param name="cause">cause.</param>
        public InvalidJsonErrorAllOf(string cause = default(string))
        {
            this.Cause = cause;
        }
        ...
        {
            return this.Equals(input as InvalidJsonErrorAllOf);
        }

        /// <summary>
        /// Returns true if InvalidJsonErrorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidJsonErrorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidJsonErrorAllOf input)
        {
            if (input == null)
            {
                return false;
