...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// VaultBalance
    /// </summary>
    [DataContract(Name = "VaultBalance")]
    public partial class VaultBalance : IEquatable<VaultBalance>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VaultBalance" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VaultBalance() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VaultBalance" /> class.
        /// </summary>
        /// <param name="vaultEntity">vaultEntity (required).</param>
        /// <param name="resourceAmount">resourceAmount (required).</param>
        public VaultBalance(EntityReference vaultEntity = default(EntityReference), ResourceAmount resourceAmount = default(ResourceAmount))
        {
            // to ensure "vaultEntity" is required (not null)
            if (vaultEntity == null)
            {
                throw new ArgumentNullException("vaultEntity is a required property for VaultBalance and cannot be null");
            }
            this.VaultEntity = vaultEntity;
            // to ensure "resourceAmount" is required (not null)
            if (resourceAmount == null)
            {
                throw new ArgumentNullException("resourceAmount is a required property for VaultBalance and cannot be null");
            }
        ...
        {
            return this.Equals(input as VaultBalance);
        }

        /// <summary>
        /// Returns true if VaultBalance instances are equal
        /// </summary>
        /// <param name="input">Instance of VaultBalance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VaultBalance input)
        {
            if (input == null)
            {
                return false;
