...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PackageInfoSubstate_allOf")]
    public partial class PackageInfoSubstateAllOf : IEquatable<PackageInfoSubstateAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageInfoSubstateAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PackageInfoSubstateAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageInfoSubstateAllOf" /> class.
        /// </summary>
        ...
        public PackageInfoSubstateAllOf(PackageSchema packageSchema = default(PackageSchema), List<string> dependentResources = default(List<string>), List<string> dependentComponents = default(List<string>))
        {
            // to ensure "packageSchema" is required (not null)
            if (packageSchema == null)
            {
                throw new ArgumentNullException("packageSchema is a required property for PackageInfoSubstateAllOf and cannot be null");
            }
            this.PackageSchema = packageSchema;
            // to ensure "dependentResources" is required (not null)
            if (dependentResources == null)
            {
                throw new ArgumentNullException("dependentResources is a required property for PackageInfoSubstateAllOf and cannot be null");
            }
            this.DependentResources = dependentResources;
            // to ensure "dependentComponents" is required (not null)
            if (dependentComponents == null)
            {
                throw new ArgumentNullException("dependentComponents is a required property for PackageInfoSubstateAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as PackageInfoSubstateAllOf);
        }

        /// <summary>
        /// Returns true if PackageInfoSubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PackageInfoSubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PackageInfoSubstateAllOf input)
        {
            if (input == null)
            {
                return false;
