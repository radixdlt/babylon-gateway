...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class PackageInfoSubstateAllOf : IEquatable<PackageInfoSubstateAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public PackageInfoSubstateAllOf(string codeHex = default(string), Dictionary<string, BlueprintData> blueprints = default(Dictionary<string, BlueprintData>))
        {
            // to ensure "codeHex" is required (not null)
            if (codeHex == null)
            {
                throw new ArgumentNullException("codeHex is a required property for PackageInfoSubstateAllOf and cannot be null");
            }
