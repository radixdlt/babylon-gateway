...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ParsedNotarizedTransactionIdentifiers")]
    public partial class ParsedNotarizedTransactionIdentifiers : IEquatable<ParsedNotarizedTransactionIdentifiers>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParsedNotarizedTransactionIdentifiers" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ParsedNotarizedTransactionIdentifiers() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ParsedNotarizedTransactionIdentifiers" /> class.
        /// </summary>
        ...
        public ParsedNotarizedTransactionIdentifiers(string intentHash = default(string), string intentHashBech32m = default(string), string signedIntentHash = default(string), string signedIntentHashBech32m = default(string), string payloadHash = default(string), string payloadHashBech32m = default(string), string ledgerHash = default(string), string ledgerHashBech32m = default(string))
        {
            ...
            if (intentHash == null)
            {
                throw new ArgumentNullException("intentHash is a required property for ParsedNotarizedTransactionIdentifiers and cannot be null");
            }
            this.IntentHash = intentHash;
            // to ensure "intentHashBech32m" is required (not null)
            if (intentHashBech32m == null)
            {
                throw new ArgumentNullException("intentHashBech32m is a required property for ParsedNotarizedTransactionIdentifiers and cannot be null");
            }
            this.IntentHashBech32m = intentHashBech32m;
            // to ensure "signedIntentHash" is required (not null)
            if (signedIntentHash == null)
            {
                throw new ArgumentNullException("signedIntentHash is a required property for ParsedNotarizedTransactionIdentifiers and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("signedIntentHashBech32m is a required property for ParsedNotarizedTransactionIdentifiers and cannot be null");
            }
            this.SignedIntentHashBech32m = signedIntentHashBech32m;
            // to ensure "payloadHash" is required (not null)
            if (payloadHash == null)
            {
                throw new ArgumentNullException("payloadHash is a required property for ParsedNotarizedTransactionIdentifiers and cannot be null");
            }
            this.PayloadHash = payloadHash;
            // to ensure "payloadHashBech32m" is required (not null)
            if (payloadHashBech32m == null)
            {
                throw new ArgumentNullException("payloadHashBech32m is a required property for ParsedNotarizedTransactionIdentifiers and cannot be null");
            }
            this.PayloadHashBech32m = payloadHashBech32m;
            // to ensure "ledgerHash" is required (not null)
            if (ledgerHash == null)
            {
                throw new ArgumentNullException("ledgerHash is a required property for ParsedNotarizedTransactionIdentifiers and cannot be null");
            }
            this.LedgerHash = ledgerHash;
            // to ensure "ledgerHashBech32m" is required (not null)
            if (ledgerHashBech32m == null)
            {
                throw new ArgumentNullException("ledgerHashBech32m is a required property for ParsedNotarizedTransactionIdentifiers and cannot be null");
            }
        ...
        {
            return this.Equals(input as ParsedNotarizedTransactionIdentifiers);
        }

        /// <summary>
        /// Returns true if ParsedNotarizedTransactionIdentifiers instances are equal
        /// </summary>
        /// <param name="input">Instance of ParsedNotarizedTransactionIdentifiers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParsedNotarizedTransactionIdentifiers input)
        {
            if (input == null)
            {
                return false;
