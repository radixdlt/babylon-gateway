...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class MempoolTransactionRequest : IEquatable<MempoolTransactionRequest>, IValidatableObject
    {
        ...
        public MempoolTransactionRequest(NetworkIdentifier networkIdentifier = default(NetworkIdentifier), TransactionIdentifier transactionIdentifier = default(TransactionIdentifier))
        {
            ...
            {
                throw new ArgumentNullException("networkIdentifier is a required property for MempoolTransactionRequest and cannot be null");
            }
            this.NetworkIdentifier = networkIdentifier;
            // to ensure "transactionIdentifier" is required (not null)
            if (transactionIdentifier == null)
            {
                throw new ArgumentNullException("transactionIdentifier is a required property for MempoolTransactionRequest and cannot be null");
            }
