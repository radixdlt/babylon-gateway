...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class DataObject : IEquatable<DataObject>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="DataObject" /> class.
        /// </summary>
        /// <param name="type">The type of the data object. Each address may own up to one current object of a given type. (required).</param>
        public DataObject(string type = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for DataObject and cannot be null");
            }
            this.Type = type;
        }
        ...
        /// </summary>
        /// <value>The type of the data object. Each address may own up to one current object of a given type.</value>
