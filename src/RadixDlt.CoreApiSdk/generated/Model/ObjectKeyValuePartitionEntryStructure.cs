...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ObjectKeyValuePartitionEntryStructure")]
    ...
    public partial class ObjectKeyValuePartitionEntryStructure : SubstateSystemStructure, IEquatable<ObjectKeyValuePartitionEntryStructure>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectKeyValuePartitionEntryStructure" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ObjectKeyValuePartitionEntryStructure() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectKeyValuePartitionEntryStructure" /> class.
        /// </summary>
        /// <param name="keySchema">keySchema (required).</param>
        /// <param name="valueSchema">valueSchema (required).</param>
        /// <param name="type">type (required) (default to SubstateSystemStructureType.ObjectKeyValuePartitionEntry).</param>
        public ObjectKeyValuePartitionEntryStructure(ObjectSubstateTypeReference keySchema = default(ObjectSubstateTypeReference), ObjectSubstateTypeReference valueSchema = default(ObjectSubstateTypeReference), SubstateSystemStructureType type = SubstateSystemStructureType.ObjectKeyValuePartitionEntry) : base(type)
        {
            // to ensure "keySchema" is required (not null)
            if (keySchema == null)
            {
                throw new ArgumentNullException("keySchema is a required property for ObjectKeyValuePartitionEntryStructure and cannot be null");
            }
            this.KeySchema = keySchema;
            // to ensure "valueSchema" is required (not null)
            if (valueSchema == null)
            {
                throw new ArgumentNullException("valueSchema is a required property for ObjectKeyValuePartitionEntryStructure and cannot be null");
            }
        ...
        {
            return this.Equals(input as ObjectKeyValuePartitionEntryStructure);
        }

        /// <summary>
        /// Returns true if ObjectKeyValuePartitionEntryStructure instances are equal
        /// </summary>
        /// <param name="input">Instance of ObjectKeyValuePartitionEntryStructure to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ObjectKeyValuePartitionEntryStructure input)
        {
            if (input == null)
            {
                return false;
