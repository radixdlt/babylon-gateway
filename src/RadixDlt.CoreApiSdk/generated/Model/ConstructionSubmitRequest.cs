...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConstructionSubmitRequest")]
    public partial class ConstructionSubmitRequest : IEquatable<ConstructionSubmitRequest>, IValidatableObject
    {
        ...
        protected ConstructionSubmitRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionSubmitRequest" /> class.
        /// </summary>
        /// <param name="networkIdentifier">networkIdentifier (required).</param>
        /// <param name="signedTransaction">Hex encoded signed transaction to be submitted. (required).</param>
        public ConstructionSubmitRequest(NetworkIdentifier networkIdentifier = default(NetworkIdentifier), string signedTransaction = default(string))
        {
            ...
            {
                throw new ArgumentNullException("networkIdentifier is a required property for ConstructionSubmitRequest and cannot be null");
            }
            this.NetworkIdentifier = networkIdentifier;
            // to ensure "signedTransaction" is required (not null)
            if (signedTransaction == null)
            {
                throw new ArgumentNullException("signedTransaction is a required property for ConstructionSubmitRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Hex encoded signed transaction to be submitted.</value>
