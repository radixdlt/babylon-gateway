...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PackageFieldCodeSubstate")]
    ...
    public partial class PackageFieldCodeSubstate : Substate, IEquatable<PackageFieldCodeSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageFieldCodeSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PackageFieldCodeSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageFieldCodeSubstate" /> class.
        /// </summary>
        /// <param name="codeHex">The hex-encoded package code (required).</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.PackageFieldCode).</param>
        public PackageFieldCodeSubstate(string codeHex = default(string), SubstateType substateType = SubstateType.PackageFieldCode) : base(substateType)
        {
            // to ensure "codeHex" is required (not null)
            if (codeHex == null)
            {
                throw new ArgumentNullException("codeHex is a required property for PackageFieldCodeSubstate and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PackageFieldCodeSubstate {\n");
        ...
        {
            return this.Equals(input as PackageFieldCodeSubstate);
        }

        /// <summary>
        /// Returns true if PackageFieldCodeSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of PackageFieldCodeSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PackageFieldCodeSubstate input)
        {
            if (input == null)
            {
                return false;
