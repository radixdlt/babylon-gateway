...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LtsFeeFungibleResourceBalanceChange")]
    public partial class LtsFeeFungibleResourceBalanceChange : IEquatable<LtsFeeFungibleResourceBalanceChange>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LtsFeeFungibleResourceBalanceChange" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LtsFeeFungibleResourceBalanceChange() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LtsFeeFungibleResourceBalanceChange" /> class.
        /// </summary>
        ...
        public LtsFeeFungibleResourceBalanceChange(LtsFeeFungibleResourceBalanceChangeType type = default(LtsFeeFungibleResourceBalanceChangeType), string resourceAddress = default(string), string balanceChange = default(string))
        {
            ...
            {
                throw new ArgumentNullException("resourceAddress is a required property for LtsFeeFungibleResourceBalanceChange and cannot be null");
            }
            this.ResourceAddress = resourceAddress;
            // to ensure "balanceChange" is required (not null)
            if (balanceChange == null)
            {
                throw new ArgumentNullException("balanceChange is a required property for LtsFeeFungibleResourceBalanceChange and cannot be null");
            }
        ...
        {
            return this.Equals(input as LtsFeeFungibleResourceBalanceChange);
        }

        /// <summary>
        /// Returns true if LtsFeeFungibleResourceBalanceChange instances are equal
        /// </summary>
        /// <param name="input">Instance of LtsFeeFungibleResourceBalanceChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LtsFeeFungibleResourceBalanceChange input)
        {
            if (input == null)
            {
                return false;
