...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class InvalidTransactionError : CoreError, IEquatable<InvalidTransactionError>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="type">type (required) (default to &quot;InvalidTransactionError&quot;).</param>
        public InvalidTransactionError(string message = default(string), string type = "InvalidTransactionError") : base(type)
        {
