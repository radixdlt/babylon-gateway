...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// KeyListRequest
    /// </summary>
    [DataContract(Name = "KeyListRequest")]
    public partial class KeyListRequest : IEquatable<KeyListRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KeyListRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KeyListRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KeyListRequest" /> class.
        /// </summary>
        /// <param name="networkIdentifier">networkIdentifier (required).</param>
        public KeyListRequest(NetworkIdentifier networkIdentifier = default(NetworkIdentifier))
        {
            // to ensure "networkIdentifier" is required (not null)
            if (networkIdentifier == null)
            {
                throw new ArgumentNullException("networkIdentifier is a required property for KeyListRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as KeyListRequest);
        }

        /// <summary>
        /// Returns true if KeyListRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of KeyListRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KeyListRequest input)
        {
            if (input == null)
            {
                return false;
