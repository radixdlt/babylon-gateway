...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class ValidatorSetSubstate : Substate, IEquatable<ValidatorSetSubstate>
    {
        ...
        public ValidatorSetSubstate(List<EcdsaSecp256k1PublicKey> validatorSet = default(List<EcdsaSecp256k1PublicKey>), long epoch = default(long), SubstateType substateType = Model.SubstateType.ValidatorSet) : base(substateType)
        {
