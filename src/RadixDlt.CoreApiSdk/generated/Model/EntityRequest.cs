...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class EntityRequest : IEquatable<EntityRequest>, IValidatableObject
    {
        ...
        public EntityRequest(NetworkIdentifier networkIdentifier = default(NetworkIdentifier), EntityIdentifier entityIdentifier = default(EntityIdentifier))
        {
            // to ensure "networkIdentifier" is required (not null)
            if (networkIdentifier == null)
            {
                throw new ArgumentNullException("networkIdentifier is a required property for EntityRequest and cannot be null");
            }
            this.NetworkIdentifier = networkIdentifier;
            // to ensure "entityIdentifier" is required (not null)
            if (entityIdentifier == null)
            {
                throw new ArgumentNullException("entityIdentifier is a required property for EntityRequest and cannot be null");
            }
