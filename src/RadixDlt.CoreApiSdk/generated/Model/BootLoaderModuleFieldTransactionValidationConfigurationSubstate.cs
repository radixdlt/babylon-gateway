...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BootLoaderModuleFieldTransactionValidationConfigurationSubstate")]
    ...
    public partial class BootLoaderModuleFieldTransactionValidationConfigurationSubstate : Substate, IEquatable<BootLoaderModuleFieldTransactionValidationConfigurationSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BootLoaderModuleFieldTransactionValidationConfigurationSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BootLoaderModuleFieldTransactionValidationConfigurationSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BootLoaderModuleFieldTransactionValidationConfigurationSubstate" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as BootLoaderModuleFieldTransactionValidationConfigurationSubstate);
        }

        /// <summary>
        /// Returns true if BootLoaderModuleFieldTransactionValidationConfigurationSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of BootLoaderModuleFieldTransactionValidationConfigurationSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BootLoaderModuleFieldTransactionValidationConfigurationSubstate input)
        {
            if (input == null)
            {
                return false;
