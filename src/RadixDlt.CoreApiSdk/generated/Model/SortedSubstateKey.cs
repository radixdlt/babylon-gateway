...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class SortedSubstateKey : SubstateKey, IEquatable<SortedSubstateKey>
    {
        ...
        public SortedSubstateKey(int sortPrefix = default(int), string keyHex = default(string), SubstateKeyType keyType = SubstateKeyType.Sorted, string dbSortKeyHex = default(string)) : base(keyType, dbSortKeyHex)
        {
