...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ParsedTransactionIntent")]
    ...
    public partial class ParsedTransactionIntent : ParsedTransaction, IEquatable<ParsedTransactionIntent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParsedTransactionIntent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ParsedTransactionIntent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ParsedTransactionIntent" /> class.
        /// </summary>
        /// <param name="intent">intent.</param>
        /// <param name="identifiers">identifiers (required).</param>
        /// <param name="type">type (required) (default to ParsedTransactionType.TransactionIntent).</param>
        public ParsedTransactionIntent(TransactionIntent intent = default(TransactionIntent), ParsedTransactionIntentIdentifiers identifiers = default(ParsedTransactionIntentIdentifiers), ParsedTransactionType type = ParsedTransactionType.TransactionIntent) : base(type)
        {
        ...
        {
            return this.Equals(input as ParsedTransactionIntent);
        }

        /// <summary>
        /// Returns true if ParsedTransactionIntent instances are equal
        /// </summary>
        /// <param name="input">Instance of ParsedTransactionIntent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParsedTransactionIntent input)
        {
            if (input == null)
            {
                return false;
