...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class CoreError : IEquatable<CoreError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreError" /> class.
        /// </summary>
        ...
        public CoreError(string type = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for CoreError and cannot be null");
            }
            this.Type = type;
        }
        ...
        {
            return this.Equals(input as CoreError);
        }

        /// <summary>
        /// Returns true if CoreError instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreError input)
        {
            if (input == null)
            {
                return false;
