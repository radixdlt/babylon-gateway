...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConstructionDeriveRequestMetadata")]
    [JsonConverter(typeof(JsonSubtypes), "Type")]
    [JsonSubtypes.KnownSubType(typeof(ConstructionDeriveRequestMetadataAccount), "Account")]
    [JsonSubtypes.KnownSubType(typeof(ConstructionDeriveRequestMetadataAccount), "ConstructionDeriveRequestMetadataAccount")]
    [JsonSubtypes.KnownSubType(typeof(ConstructionDeriveRequestMetadataExitingUnstakes), "ConstructionDeriveRequestMetadataExitingUnstakes")]
    [JsonSubtypes.KnownSubType(typeof(ConstructionDeriveRequestMetadataPreparedStakes), "ConstructionDeriveRequestMetadataPreparedStakes")]
    [JsonSubtypes.KnownSubType(typeof(ConstructionDeriveRequestMetadataPreparedUnstakes), "ConstructionDeriveRequestMetadataPreparedUnstakes")]
    [JsonSubtypes.KnownSubType(typeof(ConstructionDeriveRequestMetadataToken), "ConstructionDeriveRequestMetadataToken")]
    [JsonSubtypes.KnownSubType(typeof(ConstructionDeriveRequestMetadataValidator), "ConstructionDeriveRequestMetadataValidator")]
    [JsonSubtypes.KnownSubType(typeof(ConstructionDeriveRequestMetadataValidatorSystem), "ConstructionDeriveRequestMetadataValidatorSystem")]
    [JsonSubtypes.KnownSubType(typeof(ConstructionDeriveRequestMetadataExitingUnstakes), "ExitingUnstakes")]
    [JsonSubtypes.KnownSubType(typeof(ConstructionDeriveRequestMetadataPreparedStakes), "PreparedStakes")]
    [JsonSubtypes.KnownSubType(typeof(ConstructionDeriveRequestMetadataPreparedUnstakes), "PreparedUnstakes")]
    [JsonSubtypes.KnownSubType(typeof(ConstructionDeriveRequestMetadataToken), "Token")]
    [JsonSubtypes.KnownSubType(typeof(ConstructionDeriveRequestMetadataValidator), "Validator")]
    [JsonSubtypes.KnownSubType(typeof(ConstructionDeriveRequestMetadataValidatorSystem), "ValidatorSystem")]
    public partial class ConstructionDeriveRequestMetadata : IEquatable<ConstructionDeriveRequestMetadata>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionDeriveRequestMetadata" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConstructionDeriveRequestMetadata() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionDeriveRequestMetadata" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        public ConstructionDeriveRequestMetadata(string type = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for ConstructionDeriveRequestMetadata and cannot be null");
            }
            this.Type = type;
        }
        ...
        {
            return this.Equals(input as ConstructionDeriveRequestMetadata);
        }

        /// <summary>
        /// Returns true if ConstructionDeriveRequestMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of ConstructionDeriveRequestMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConstructionDeriveRequestMetadata input)
        {
            if (input == null)
            {
                return false;
