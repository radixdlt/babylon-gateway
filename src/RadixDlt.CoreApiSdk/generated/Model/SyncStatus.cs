...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class SyncStatus : IEquatable<SyncStatus>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="SyncStatus" /> class.
        /// </summary>
        /// <param name="currentStateVersion">currentStateVersion (required).</param>
        /// <param name="targetStateVersion">targetStateVersion (required).</param>
        public SyncStatus(long currentStateVersion = default(long), long targetStateVersion = default(long))
        {
        ...
        /// <summary>
        /// Gets or Sets CurrentStateVersion
        /// </summary>
        [DataMember(Name = "current_state_version", IsRequired = true, EmitDefaultValue = true)]
        public long CurrentStateVersion { get; set; }

        /// <summary>
        /// Gets or Sets TargetStateVersion
        /// </summary>
        [DataMember(Name = "target_state_version", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CurrentStateVersion: ").Append(CurrentStateVersion).Append("\n");
            sb.Append("  TargetStateVersion: ").Append(TargetStateVersion).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(SyncStatus input)
        {
            ...
            return 
                (
                    ...
                    this.CurrentStateVersion.Equals(input.CurrentStateVersion)
                ) && 
                (
                    this.TargetStateVersion == input.TargetStateVersion ||
                    this.TargetStateVersion.Equals(input.TargetStateVersion)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = (hashCode * 59) + this.CurrentStateVersion.GetHashCode();
                hashCode = (hashCode * 59) + this.TargetStateVersion.GetHashCode();
                return hashCode;
            }
        }
