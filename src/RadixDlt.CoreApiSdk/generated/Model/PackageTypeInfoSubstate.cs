...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PackageTypeInfoSubstate")]
    ...
    public partial class PackageTypeInfoSubstate : Substate, IEquatable<PackageTypeInfoSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageTypeInfoSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PackageTypeInfoSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageTypeInfoSubstate" /> class.
        /// </summary>
        /// <param name="substateType">substateType (required) (default to SubstateType.PackageTypeInfo).</param>
        public PackageTypeInfoSubstate(SubstateType substateType = SubstateType.PackageTypeInfo) : base(substateType)
        {
        }
        ...
        {
            return this.Equals(input as PackageTypeInfoSubstate);
        }

        /// <summary>
        /// Returns true if PackageTypeInfoSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of PackageTypeInfoSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PackageTypeInfoSubstate input)
        {
            if (input == null)
            {
                return false;
