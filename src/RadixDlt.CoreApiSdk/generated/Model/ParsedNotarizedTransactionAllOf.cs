...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ParsedNotarizedTransaction_allOf")]
    public partial class ParsedNotarizedTransactionAllOf : IEquatable<ParsedNotarizedTransactionAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParsedNotarizedTransactionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ParsedNotarizedTransactionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ParsedNotarizedTransactionAllOf" /> class.
        /// </summary>
        ...
        public ParsedNotarizedTransactionAllOf(NotarizedTransaction notarizedTransaction = default(NotarizedTransaction), ParsedNotarizedTransactionIdentifiers identifiers = default(ParsedNotarizedTransactionIdentifiers), ParsedNotarizedTransactionAllOfValidationError validationError = default(ParsedNotarizedTransactionAllOfValidationError))
        {
            ...
            if (identifiers == null)
            {
                throw new ArgumentNullException("identifiers is a required property for ParsedNotarizedTransactionAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as ParsedNotarizedTransactionAllOf);
        }

        /// <summary>
        /// Returns true if ParsedNotarizedTransactionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ParsedNotarizedTransactionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParsedNotarizedTransactionAllOf input)
        {
            if (input == null)
            {
                return false;
