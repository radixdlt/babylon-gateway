...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class ParsedNotarizedTransactionAllOf : IEquatable<ParsedNotarizedTransactionAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public ParsedNotarizedTransactionAllOf(NotarizedTransaction notarizedTransaction = default(NotarizedTransaction), bool isStaticallyValid = default(bool), string validityError = default(string))
        {
            // to ensure "notarizedTransaction" is required (not null)
            if (notarizedTransaction == null)
            {
                throw new ArgumentNullException("notarizedTransaction is a required property for ParsedNotarizedTransactionAllOf and cannot be null");
            }
