...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InvalidAddressError_allOf")]
    public partial class InvalidAddressErrorAllOf : IEquatable<InvalidAddressErrorAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidAddressErrorAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvalidAddressErrorAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidAddressErrorAllOf" /> class.
        /// </summary>
        /// <param name="invalidAddress">invalidAddress (required).</param>
        public InvalidAddressErrorAllOf(string invalidAddress = default(string))
        {
            // to ensure "invalidAddress" is required (not null)
            if (invalidAddress == null)
            {
                throw new ArgumentNullException("invalidAddress is a required property for InvalidAddressErrorAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvalidAddressErrorAllOf {\n");
        ...
        {
            return this.Equals(input as InvalidAddressErrorAllOf);
        }

        /// <summary>
        /// Returns true if InvalidAddressErrorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidAddressErrorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidAddressErrorAllOf input)
        {
            if (input == null)
            {
                return false;
