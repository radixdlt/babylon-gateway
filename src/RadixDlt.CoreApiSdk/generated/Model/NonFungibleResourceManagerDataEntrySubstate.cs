...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NonFungibleResourceManagerDataEntrySubstate")]
    ...
    public partial class NonFungibleResourceManagerDataEntrySubstate : Substate, IEquatable<NonFungibleResourceManagerDataEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NonFungibleResourceManagerDataEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NonFungibleResourceManagerDataEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NonFungibleResourceManagerDataEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="dataStruct">dataStruct.</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.NonFungibleResourceManagerDataEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public NonFungibleResourceManagerDataEntrySubstate(LocalNonFungibleKey key = default(LocalNonFungibleKey), DataStruct dataStruct = default(DataStruct), SubstateType substateType = SubstateType.NonFungibleResourceManagerDataEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for NonFungibleResourceManagerDataEntrySubstate and cannot be null");
            }
            this.Key = key;
        ...
        {
            return this.Equals(input as NonFungibleResourceManagerDataEntrySubstate);
        }

        /// <summary>
        /// Returns true if NonFungibleResourceManagerDataEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of NonFungibleResourceManagerDataEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NonFungibleResourceManagerDataEntrySubstate input)
        {
            if (input == null)
            {
                return false;
