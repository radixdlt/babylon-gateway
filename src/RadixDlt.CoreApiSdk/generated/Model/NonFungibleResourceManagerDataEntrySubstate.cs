...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class NonFungibleResourceManagerDataEntrySubstate : Substate, IEquatable<NonFungibleResourceManagerDataEntrySubstate>
    {
        ...
        public NonFungibleResourceManagerDataEntrySubstate(LocalNonFungibleKey key = default(LocalNonFungibleKey), NonFungibleResourceManagerDataEntryValue value = default(NonFungibleResourceManagerDataEntryValue), SubstateType substateType = SubstateType.NonFungibleResourceManagerDataEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
