...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class MessageTooLongError : CoreError, IEquatable<MessageTooLongError>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="attemptedMessageLength">attemptedMessageLength (required).</param>
        /// <param name="type">type (required) (default to &quot;MessageTooLongError&quot;).</param>
        public MessageTooLongError(int maximumMessageLength = default(int), int attemptedMessageLength = default(int), string type = "MessageTooLongError") : base(type)
        {
        ...
        /// <summary>
        /// Gets or Sets AttemptedMessageLength
        /// </summary>
        [DataMember(Name = "attempted_message_length", IsRequired = true, EmitDefaultValue = true)]
        public int AttemptedMessageLength { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AttemptedMessageLength: ").Append(AttemptedMessageLength).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(MessageTooLongError input)
        {
            ...
            return base.Equals(input) && 
                ...
                (
                    this.AttemptedMessageLength == input.AttemptedMessageLength ||
                    this.AttemptedMessageLength.Equals(input.AttemptedMessageLength)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AttemptedMessageLength.GetHashCode();
                return hashCode;
            }
        }
