...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccessRulesModuleFieldAccessRulesSubstate")]
    ...
    public partial class AccessRulesModuleFieldAccessRulesSubstate : Substate, IEquatable<AccessRulesModuleFieldAccessRulesSubstate>
    {
        ...
        protected AccessRulesModuleFieldAccessRulesSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccessRulesModuleFieldAccessRulesSubstate" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AccessRulesModuleFieldAccessRulesSubstate);
        }

        /// <summary>
        /// Returns true if AccessRulesModuleFieldAccessRulesSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of AccessRulesModuleFieldAccessRulesSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccessRulesModuleFieldAccessRulesSubstate input)
        {
            if (input == null)
            {
                return false;
