...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ParsedTransactionIntentIdentifiers")]
    public partial class ParsedTransactionIntentIdentifiers : IEquatable<ParsedTransactionIntentIdentifiers>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParsedTransactionIntentIdentifiers" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ParsedTransactionIntentIdentifiers() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ParsedTransactionIntentIdentifiers" /> class.
        /// </summary>
        ...
        public ParsedTransactionIntentIdentifiers(string intentHash = default(string), string intentHashBech32m = default(string))
        {
            // to ensure "intentHash" is required (not null)
            if (intentHash == null)
            {
                throw new ArgumentNullException("intentHash is a required property for ParsedTransactionIntentIdentifiers and cannot be null");
            }
            this.IntentHash = intentHash;
            // to ensure "intentHashBech32m" is required (not null)
            if (intentHashBech32m == null)
            {
                throw new ArgumentNullException("intentHashBech32m is a required property for ParsedTransactionIntentIdentifiers and cannot be null");
            }
        ...
        {
            return this.Equals(input as ParsedTransactionIntentIdentifiers);
        }

        /// <summary>
        /// Returns true if ParsedTransactionIntentIdentifiers instances are equal
        /// </summary>
        /// <param name="input">Instance of ParsedTransactionIntentIdentifiers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParsedTransactionIntentIdentifiers input)
        {
            if (input == null)
            {
                return false;
