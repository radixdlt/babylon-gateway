...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// InvalidAddressError
    /// </summary>
    [DataContract(Name = "InvalidAddressError")]
    ...
    public partial class InvalidAddressError : CoreError, IEquatable<InvalidAddressError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidAddressError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvalidAddressError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidAddressError" /> class.
        /// </summary>
        /// <param name="invalidAddress">invalidAddress (required).</param>
        /// <param name="type">type (required) (default to &quot;InvalidAddressError&quot;).</param>
        public InvalidAddressError(string invalidAddress = default(string), string type = "InvalidAddressError") : base(type)
        {
            // to ensure "invalidAddress" is required (not null)
            if (invalidAddress == null)
            {
                throw new ArgumentNullException("invalidAddress is a required property for InvalidAddressError and cannot be null");
            }
            this.InvalidAddress = invalidAddress;
        }

        /// <summary>
        /// Gets or Sets InvalidAddress
        /// </summary>
        [DataMember(Name = "invalid_address", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InvalidAddress: ").Append(InvalidAddress).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as InvalidAddressError);
        }

        /// <summary>
        /// Returns true if InvalidAddressError instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidAddressError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidAddressError input)
        {
            if (input == null)
            {
                return false;
            ...
            return base.Equals(input) && 
                (
                    this.InvalidAddress == input.InvalidAddress ||
                    (this.InvalidAddress != null &&
                    this.InvalidAddress.Equals(input.InvalidAddress))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.InvalidAddress.GetHashCode();
                }
                return hashCode;
            }
        }
