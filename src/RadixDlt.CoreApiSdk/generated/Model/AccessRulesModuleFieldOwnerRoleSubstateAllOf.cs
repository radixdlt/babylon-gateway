...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccessRulesModuleFieldOwnerRoleSubstate_allOf")]
    public partial class AccessRulesModuleFieldOwnerRoleSubstateAllOf : IEquatable<AccessRulesModuleFieldOwnerRoleSubstateAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccessRulesModuleFieldOwnerRoleSubstateAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccessRulesModuleFieldOwnerRoleSubstateAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccessRulesModuleFieldOwnerRoleSubstateAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AccessRulesModuleFieldOwnerRoleSubstateAllOf);
        }

        /// <summary>
        /// Returns true if AccessRulesModuleFieldOwnerRoleSubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AccessRulesModuleFieldOwnerRoleSubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccessRulesModuleFieldOwnerRoleSubstateAllOf input)
        {
            if (input == null)
            {
                return false;
