...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class ParsedTransactionManifest : ParsedTransaction, IEquatable<ParsedTransactionManifest>
    {
        ...
        /// <param name="type">type (required) (default to ParsedTransactionType.TransactionManifest).</param>
        public ParsedTransactionManifest(TransactionManifest manifest = default(TransactionManifest), ParsedTransactionType type = ParsedTransactionType.TransactionManifest) : base(type)
        {
        ...
        {
            return this.Equals(input as ParsedTransactionManifest);
        }

        /// <summary>
        /// Returns true if ParsedTransactionManifest instances are equal
        /// </summary>
        /// <param name="input">Instance of ParsedTransactionManifest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParsedTransactionManifest input)
        {
            if (input == null)
            {
                return false;
