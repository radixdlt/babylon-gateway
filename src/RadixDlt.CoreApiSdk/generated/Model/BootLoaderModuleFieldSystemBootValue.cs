...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class BootLoaderModuleFieldSystemBootValue : IEquatable<BootLoaderModuleFieldSystemBootValue>
    {
        ...
        public BootLoaderModuleFieldSystemBootValue(SystemCostingParameters costingParameters = default(SystemCostingParameters))
        {
            // to ensure "costingParameters" is required (not null)
            if (costingParameters == null)
            {
                throw new ArgumentNullException("costingParameters is a required property for BootLoaderModuleFieldSystemBootValue and cannot be null");
            }
