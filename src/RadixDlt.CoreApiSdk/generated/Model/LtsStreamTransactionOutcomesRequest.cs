...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LtsStreamTransactionOutcomesRequest")]
    public partial class LtsStreamTransactionOutcomesRequest : IEquatable<LtsStreamTransactionOutcomesRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LtsStreamTransactionOutcomesRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LtsStreamTransactionOutcomesRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LtsStreamTransactionOutcomesRequest" /> class.
        /// </summary>
        ...
        public LtsStreamTransactionOutcomesRequest(string network = default(string), long fromStateVersion = default(long), int limit = default(int))
        {
            ...
            if (network == null)
            {
                throw new ArgumentNullException("network is a required property for LtsStreamTransactionOutcomesRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as LtsStreamTransactionOutcomesRequest);
        }

        /// <summary>
        /// Returns true if LtsStreamTransactionOutcomesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of LtsStreamTransactionOutcomesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LtsStreamTransactionOutcomesRequest input)
        {
            if (input == null)
            {
                return false;
