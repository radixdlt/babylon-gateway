...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class CommittedTransactionsRequest : IEquatable<CommittedTransactionsRequest>, IValidatableObject
    {
        ...
        public CommittedTransactionsRequest(NetworkIdentifier networkIdentifier = default(NetworkIdentifier), PartialStateIdentifier stateIdentifier = default(PartialStateIdentifier), long limit = default(long))
        {
            ...
            {
                throw new ArgumentNullException("stateIdentifier is a required property for CommittedTransactionsRequest and cannot be null");
            }
