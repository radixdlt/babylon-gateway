...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PublicKeyNotSupportedError_allOf")]
    public partial class PublicKeyNotSupportedErrorAllOf : IEquatable<PublicKeyNotSupportedErrorAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicKeyNotSupportedErrorAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublicKeyNotSupportedErrorAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicKeyNotSupportedErrorAllOf" /> class.
        /// </summary>
        /// <param name="unsupportedPublicKey">unsupportedPublicKey (required).</param>
        public PublicKeyNotSupportedErrorAllOf(PublicKey unsupportedPublicKey = default(PublicKey))
        {
            // to ensure "unsupportedPublicKey" is required (not null)
            if (unsupportedPublicKey == null)
            {
                throw new ArgumentNullException("unsupportedPublicKey is a required property for PublicKeyNotSupportedErrorAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PublicKeyNotSupportedErrorAllOf {\n");
        ...
        {
            return this.Equals(input as PublicKeyNotSupportedErrorAllOf);
        }

        /// <summary>
        /// Returns true if PublicKeyNotSupportedErrorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PublicKeyNotSupportedErrorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PublicKeyNotSupportedErrorAllOf input)
        {
            if (input == null)
            {
                return false;
