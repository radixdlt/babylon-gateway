...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class NotEnoughNativeTokensForFeesError : CoreError, IEquatable<NotEnoughNativeTokensForFeesError>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="feeEstimate">feeEstimate (required).</param>
        /// <param name="type">type (required) (default to &quot;NotEnoughNativeTokensForFeesError&quot;).</param>
        public NotEnoughNativeTokensForFeesError(ResourceAmount available = default(ResourceAmount), ResourceAmount feeEstimate = default(ResourceAmount), string type = "NotEnoughNativeTokensForFeesError") : base(type)
        {
            // to ensure "available" is required (not null)
            if (available == null)
            {
                throw new ArgumentNullException("available is a required property for NotEnoughNativeTokensForFeesError and cannot be null");
            }
            this.Available = available;
            // to ensure "feeEstimate" is required (not null)
            if (feeEstimate == null)
            {
                throw new ArgumentNullException("feeEstimate is a required property for NotEnoughNativeTokensForFeesError and cannot be null");
            }
        ...
        /// <summary>
        /// Gets or Sets FeeEstimate
        /// </summary>
        [DataMember(Name = "fee_estimate", IsRequired = true, EmitDefaultValue = true)]
        public ResourceAmount FeeEstimate { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FeeEstimate: ").Append(FeeEstimate).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(NotEnoughNativeTokensForFeesError input)
        {
            ...
            return base.Equals(input) && 
                ...
                (
                    this.FeeEstimate == input.FeeEstimate ||
                    (this.FeeEstimate != null &&
                    this.FeeEstimate.Equals(input.FeeEstimate))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.FeeEstimate.GetHashCode();
                }
                return hashCode;
            }
        }
