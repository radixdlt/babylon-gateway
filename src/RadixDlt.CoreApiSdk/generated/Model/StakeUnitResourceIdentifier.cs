...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StakeUnitResourceIdentifier")]
    ...
    public partial class StakeUnitResourceIdentifier : ResourceIdentifier, IEquatable<StakeUnitResourceIdentifier>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StakeUnitResourceIdentifier" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StakeUnitResourceIdentifier() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StakeUnitResourceIdentifier" /> class.
        /// </summary>
        /// <param name="validatorAddress">The validator associated with this stake unit. (required).</param>
        /// <param name="type">The type of resource. (required) (default to &quot;StakeUnitResourceIdentifier&quot;).</param>
        public StakeUnitResourceIdentifier(string validatorAddress = default(string), string type = "StakeUnitResourceIdentifier") : base(type)
        {
            // to ensure "validatorAddress" is required (not null)
            if (validatorAddress == null)
            {
                throw new ArgumentNullException("validatorAddress is a required property for StakeUnitResourceIdentifier and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The validator associated with this stake unit.</value>
        ...
        {
            return this.Equals(input as StakeUnitResourceIdentifier);
        }

        /// <summary>
        /// Returns true if StakeUnitResourceIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of StakeUnitResourceIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StakeUnitResourceIdentifier input)
        {
            if (input == null)
            {
                return false;
