...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountResourcePreferenceEntrySubstate")]
    ...
    public partial class AccountResourcePreferenceEntrySubstate : Substate, IEquatable<AccountResourcePreferenceEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountResourcePreferenceEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountResourcePreferenceEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountResourcePreferenceEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value.</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.AccountResourcePreferenceEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public AccountResourcePreferenceEntrySubstate(ResourceKey key = default(ResourceKey), AccountResourcePreferenceEntryValue value = default(AccountResourcePreferenceEntryValue), SubstateType substateType = SubstateType.AccountResourcePreferenceEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for AccountResourcePreferenceEntrySubstate and cannot be null");
            }
            this.Key = key;
            this.Value = value;
        }
        ...
        public AccountResourcePreferenceEntryValue Value { get; set; }
        ...
        {
            return this.Equals(input as AccountResourcePreferenceEntrySubstate);
        }

        /// <summary>
        /// Returns true if AccountResourcePreferenceEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountResourcePreferenceEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountResourcePreferenceEntrySubstate input)
        {
            if (input == null)
            {
                return false;
