...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// ProposerReward
    /// </summary>
    [DataContract(Name = "ProposerReward")]
    public partial class ProposerReward : IEquatable<ProposerReward>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProposerReward" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProposerReward() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProposerReward" /> class.
        /// </summary>
        ...
        public ProposerReward(ActiveValidatorIndex validatorIndex = default(ActiveValidatorIndex), string xrdAmount = default(string))
        {
            ...
            {
                throw new ArgumentNullException("validatorIndex is a required property for ProposerReward and cannot be null");
            }
            this.ValidatorIndex = validatorIndex;
            // to ensure "xrdAmount" is required (not null)
            if (xrdAmount == null)
            {
                throw new ArgumentNullException("xrdAmount is a required property for ProposerReward and cannot be null");
            }
        ...
        {
            return this.Equals(input as ProposerReward);
        }

        /// <summary>
        /// Returns true if ProposerReward instances are equal
        /// </summary>
        /// <param name="input">Instance of ProposerReward to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProposerReward input)
        {
            if (input == null)
            {
                return false;
