...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// Fork
    /// </summary>
    [DataContract(Name = "Fork")]
    public partial class Fork : IEquatable<Fork>, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="Fork" /> class.
        /// </summary>
        /// <param name="forkIdentifier">forkIdentifier (required).</param>
        /// <param name="engineIdentifier">engineIdentifier (required).</param>
        /// <param name="engineConfiguration">engineConfiguration (required).</param>
        public Fork(ForkIdentifier forkIdentifier = default(ForkIdentifier), EngineIdentifier engineIdentifier = default(EngineIdentifier), EngineConfiguration engineConfiguration = default(EngineConfiguration))
        {
            // to ensure "forkIdentifier" is required (not null)
            if (forkIdentifier == null)
            {
                throw new ArgumentNullException("forkIdentifier is a required property for Fork and cannot be null");
            }
            this.ForkIdentifier = forkIdentifier;
            // to ensure "engineIdentifier" is required (not null)
            if (engineIdentifier == null)
            {
                throw new ArgumentNullException("engineIdentifier is a required property for Fork and cannot be null");
            }
            this.EngineIdentifier = engineIdentifier;
            // to ensure "engineConfiguration" is required (not null)
            if (engineConfiguration == null)
            {
                throw new ArgumentNullException("engineConfiguration is a required property for Fork and cannot be null");
            }
            this.EngineConfiguration = engineConfiguration;
        }

        /// <summary>
        /// Gets or Sets ForkIdentifier
        /// </summary>
        [DataMember(Name = "fork_identifier", IsRequired = true, EmitDefaultValue = true)]
        public ForkIdentifier ForkIdentifier { get; set; }

        /// <summary>
        /// Gets or Sets EngineIdentifier
        /// </summary>
        [DataMember(Name = "engine_identifier", IsRequired = true, EmitDefaultValue = true)]
        public EngineIdentifier EngineIdentifier { get; set; }

        /// <summary>
        /// Gets or Sets EngineConfiguration
        /// </summary>
        [DataMember(Name = "engine_configuration", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ForkIdentifier: ").Append(ForkIdentifier).Append("\n");
            sb.Append("  EngineIdentifier: ").Append(EngineIdentifier).Append("\n");
        ...
        {
            return this.Equals(input as Fork);
        }

        /// <summary>
        /// Returns true if Fork instances are equal
        /// </summary>
        /// <param name="input">Instance of Fork to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Fork input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.ForkIdentifier == input.ForkIdentifier ||
                    (this.ForkIdentifier != null &&
                    this.ForkIdentifier.Equals(input.ForkIdentifier))
                ) && 
                (
                    this.EngineIdentifier == input.EngineIdentifier ||
                    (this.EngineIdentifier != null &&
                    this.EngineIdentifier.Equals(input.EngineIdentifier))
                ) && 
                (
                    this.EngineConfiguration == input.EngineConfiguration ||
                    (this.EngineConfiguration != null &&
                    this.EngineConfiguration.Equals(input.EngineConfiguration))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.ForkIdentifier != null)
                {
                    hashCode = (hashCode * 59) + this.ForkIdentifier.GetHashCode();
                }
                if (this.EngineIdentifier != null)
                {
                    hashCode = (hashCode * 59) + this.EngineIdentifier.GetHashCode();
                }
                if (this.EngineConfiguration != null)
                {
                    hashCode = (hashCode * 59) + this.EngineConfiguration.GetHashCode();
                }
                return hashCode;
            }
        }
