...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConstructionSubmitResponse")]
    public partial class ConstructionSubmitResponse : IEquatable<ConstructionSubmitResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionSubmitResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConstructionSubmitResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionSubmitResponse" /> class.
        /// </summary>
        ...
        public ConstructionSubmitResponse(TransactionIdentifier transactionIdentifier = default(TransactionIdentifier), bool duplicate = default(bool))
        {
            // to ensure "transactionIdentifier" is required (not null)
            if (transactionIdentifier == null)
            {
                throw new ArgumentNullException("transactionIdentifier is a required property for ConstructionSubmitResponse and cannot be null");
            }
        ...
        {
            return this.Equals(input as ConstructionSubmitResponse);
        }

        /// <summary>
        /// Returns true if ConstructionSubmitResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ConstructionSubmitResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConstructionSubmitResponse input)
        {
            if (input == null)
            {
                return false;
