...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValidatorBFTData_allOf")]
    public partial class ValidatorBFTDataAllOf : IEquatable<ValidatorBFTDataAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatorBFTDataAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValidatorBFTDataAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatorBFTDataAllOf" /> class.
        /// </summary>
        /// <param name="proposalsCompleted">proposalsCompleted (required).</param>
        /// <param name="proposalsMissed">proposalsMissed (required).</param>
        public ValidatorBFTDataAllOf(long proposalsCompleted = default(long), long proposalsMissed = default(long))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ValidatorBFTDataAllOf {\n");
        ...
        {
            return this.Equals(input as ValidatorBFTDataAllOf);
        }

        /// <summary>
        /// Returns true if ValidatorBFTDataAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ValidatorBFTDataAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValidatorBFTDataAllOf input)
        {
            if (input == null)
            {
                return false;
