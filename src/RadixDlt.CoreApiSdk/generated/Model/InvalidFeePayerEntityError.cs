...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InvalidFeePayerEntityError")]
    ...
    public partial class InvalidFeePayerEntityError : CoreError, IEquatable<InvalidFeePayerEntityError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidFeePayerEntityError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvalidFeePayerEntityError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidFeePayerEntityError" /> class.
        /// </summary>
        /// <param name="invalidFeePayerEntity">invalidFeePayerEntity (required).</param>
        /// <param name="type">type (required) (default to &quot;InvalidFeePayerEntityError&quot;).</param>
        public InvalidFeePayerEntityError(EntityIdentifier invalidFeePayerEntity = default(EntityIdentifier), string type = "InvalidFeePayerEntityError") : base(type)
        {
            // to ensure "invalidFeePayerEntity" is required (not null)
            if (invalidFeePayerEntity == null)
            {
                throw new ArgumentNullException("invalidFeePayerEntity is a required property for InvalidFeePayerEntityError and cannot be null");
            }
            this.InvalidFeePayerEntity = invalidFeePayerEntity;
        }

        /// <summary>
        /// Gets or Sets InvalidFeePayerEntity
        /// </summary>
        [DataMember(Name = "invalid_fee_payer_entity", IsRequired = true, EmitDefaultValue = true)]
        public EntityIdentifier InvalidFeePayerEntity { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InvalidFeePayerEntity: ").Append(InvalidFeePayerEntity).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as InvalidFeePayerEntityError);
        }

        /// <summary>
        /// Returns true if InvalidFeePayerEntityError instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidFeePayerEntityError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidFeePayerEntityError input)
        {
            if (input == null)
            {
                return false;
            ...
            return base.Equals(input) && 
                (
                    this.InvalidFeePayerEntity == input.InvalidFeePayerEntity ||
                    (this.InvalidFeePayerEntity != null &&
                    this.InvalidFeePayerEntity.Equals(input.InvalidFeePayerEntity))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InvalidFeePayerEntity != null)
                {
                    hashCode = (hashCode * 59) + this.InvalidFeePayerEntity.GetHashCode();
                }
                return hashCode;
            }
        }
