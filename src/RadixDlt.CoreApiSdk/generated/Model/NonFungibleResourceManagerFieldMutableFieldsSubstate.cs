...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NonFungibleResourceManagerFieldMutableFieldsSubstate")]
    ...
    public partial class NonFungibleResourceManagerFieldMutableFieldsSubstate : Substate, IEquatable<NonFungibleResourceManagerFieldMutableFieldsSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NonFungibleResourceManagerFieldMutableFieldsSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NonFungibleResourceManagerFieldMutableFieldsSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NonFungibleResourceManagerFieldMutableFieldsSubstate" /> class.
        /// </summary>
        ...
        public NonFungibleResourceManagerFieldMutableFieldsSubstate(List<string> mutableFields = default(List<string>), SubstateType substateType = SubstateType.NonFungibleResourceManagerFieldMutableFields) : base(substateType)
        {
        ...
        {
            return this.Equals(input as NonFungibleResourceManagerFieldMutableFieldsSubstate);
        }

        /// <summary>
        /// Returns true if NonFungibleResourceManagerFieldMutableFieldsSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of NonFungibleResourceManagerFieldMutableFieldsSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NonFungibleResourceManagerFieldMutableFieldsSubstate input)
        {
            if (input == null)
            {
                return false;
