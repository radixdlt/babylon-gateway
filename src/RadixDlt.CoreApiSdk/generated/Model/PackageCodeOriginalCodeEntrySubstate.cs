...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PackageCodeOriginalCodeEntrySubstate")]
    ...
    public partial class PackageCodeOriginalCodeEntrySubstate : Substate, IEquatable<PackageCodeOriginalCodeEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageCodeOriginalCodeEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PackageCodeOriginalCodeEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageCodeOriginalCodeEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.PackageCodeOriginalCodeEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public PackageCodeOriginalCodeEntrySubstate(PackageCodeKey key = default(PackageCodeKey), PackageCodeOriginalCodeEntryValue value = default(PackageCodeOriginalCodeEntryValue), SubstateType substateType = SubstateType.PackageCodeOriginalCodeEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for PackageCodeOriginalCodeEntrySubstate and cannot be null");
            }
            this.Key = key;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for PackageCodeOriginalCodeEntrySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public PackageCodeOriginalCodeEntryValue Value { get; set; }
        ...
        {
            return this.Equals(input as PackageCodeOriginalCodeEntrySubstate);
        }

        /// <summary>
        /// Returns true if PackageCodeOriginalCodeEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of PackageCodeOriginalCodeEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PackageCodeOriginalCodeEntrySubstate input)
        {
            if (input == null)
            {
                return false;
