...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OneResourcePoolSubstate")]
    ...
    public partial class OneResourcePoolSubstate : Substate, IEquatable<OneResourcePoolSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneResourcePoolSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OneResourcePoolSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OneResourcePoolSubstate" /> class.
        /// </summary>
        ...
        /// <param name="substateType">substateType (required) (default to SubstateType.OneResourcePool).</param>
        public OneResourcePoolSubstate(EntityReference vault = default(EntityReference), string poolUnitResourceAddress = default(string), SubstateType substateType = SubstateType.OneResourcePool) : base(substateType)
        {
            // to ensure "vault" is required (not null)
            if (vault == null)
            {
                throw new ArgumentNullException("vault is a required property for OneResourcePoolSubstate and cannot be null");
            }
            this.Vault = vault;
            // to ensure "poolUnitResourceAddress" is required (not null)
            if (poolUnitResourceAddress == null)
            {
                throw new ArgumentNullException("poolUnitResourceAddress is a required property for OneResourcePoolSubstate and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OneResourcePoolSubstate {\n");
        ...
        {
            return this.Equals(input as OneResourcePoolSubstate);
        }

        /// <summary>
        /// Returns true if OneResourcePoolSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of OneResourcePoolSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneResourcePoolSubstate input)
        {
            if (input == null)
            {
                return false;
