...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountVaultEntrySubstate")]
    ...
    public partial class AccountVaultEntrySubstate : Substate, IEquatable<AccountVaultEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountVaultEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountVaultEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountVaultEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.AccountVaultEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public AccountVaultEntrySubstate(ResourceKey key = default(ResourceKey), AccountVaultEntryValue value = default(AccountVaultEntryValue), SubstateType substateType = SubstateType.AccountVaultEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for AccountVaultEntrySubstate and cannot be null");
            }
            this.Key = key;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for AccountVaultEntrySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public AccountVaultEntryValue Value { get; set; }
        ...
        {
            return this.Equals(input as AccountVaultEntrySubstate);
        }

        /// <summary>
        /// Returns true if AccountVaultEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountVaultEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountVaultEntrySubstate input)
        {
            if (input == null)
            {
                return false;
