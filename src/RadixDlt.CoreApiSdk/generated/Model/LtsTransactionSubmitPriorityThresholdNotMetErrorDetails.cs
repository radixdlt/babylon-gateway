...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class LtsTransactionSubmitPriorityThresholdNotMetErrorDetails : LtsTransactionSubmitErrorDetails, IEquatable<LtsTransactionSubmitPriorityThresholdNotMetErrorDetails>
    {
        ...
        public LtsTransactionSubmitPriorityThresholdNotMetErrorDetails(int tipPercentage = default(int), int minTipPercentageRequired = default(int), string tipProportion = default(string), string minTipProportionRequired = default(string), LtsTransactionSubmitErrorDetailsType type = LtsTransactionSubmitErrorDetailsType.PriorityThresholdNotMet) : base(type)
        {
