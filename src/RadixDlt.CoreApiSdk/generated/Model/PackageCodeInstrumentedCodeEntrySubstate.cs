...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PackageCodeInstrumentedCodeEntrySubstate")]
    ...
    public partial class PackageCodeInstrumentedCodeEntrySubstate : Substate, IEquatable<PackageCodeInstrumentedCodeEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageCodeInstrumentedCodeEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PackageCodeInstrumentedCodeEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageCodeInstrumentedCodeEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.PackageCodeInstrumentedCodeEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public PackageCodeInstrumentedCodeEntrySubstate(PackageCodeKey key = default(PackageCodeKey), PackageCodeInstrumentedCodeEntryValue value = default(PackageCodeInstrumentedCodeEntryValue), SubstateType substateType = SubstateType.PackageCodeInstrumentedCodeEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for PackageCodeInstrumentedCodeEntrySubstate and cannot be null");
            }
            this.Key = key;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for PackageCodeInstrumentedCodeEntrySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as PackageCodeInstrumentedCodeEntrySubstate);
        }

        /// <summary>
        /// Returns true if PackageCodeInstrumentedCodeEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of PackageCodeInstrumentedCodeEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PackageCodeInstrumentedCodeEntrySubstate input)
        {
            if (input == null)
            {
                return false;
