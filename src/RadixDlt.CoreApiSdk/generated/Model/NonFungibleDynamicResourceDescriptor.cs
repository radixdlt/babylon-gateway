...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class NonFungibleDynamicResourceDescriptor : DynamicResourceDescriptor, IEquatable<NonFungibleDynamicResourceDescriptor>
    {
        ...
        protected NonFungibleDynamicResourceDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NonFungibleDynamicResourceDescriptor" /> class.
        /// </summary>
        ...
        /// <param name="type">type (required) (default to DynamicResourceDescriptorType.NonFungible).</param>
        public NonFungibleDynamicResourceDescriptor(string resourceAddress = default(string), NonFungibleId nonFungibleId = default(NonFungibleId), DynamicResourceDescriptorType type = DynamicResourceDescriptorType.NonFungible) : base(type)
        {
        ...
        {
            return this.Equals(input as NonFungibleDynamicResourceDescriptor);
        }

        /// <summary>
        /// Returns true if NonFungibleDynamicResourceDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of NonFungibleDynamicResourceDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NonFungibleDynamicResourceDescriptor input)
        {
            if (input == null)
            {
                return false;
