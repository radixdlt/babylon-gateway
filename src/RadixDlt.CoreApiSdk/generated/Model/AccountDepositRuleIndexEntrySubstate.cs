...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class AccountDepositRuleIndexEntrySubstate : Substate, IEquatable<AccountDepositRuleIndexEntrySubstate>
    {
        ...
        protected AccountDepositRuleIndexEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountDepositRuleIndexEntrySubstate" /> class.
        /// </summary>
        ...
        public AccountDepositRuleIndexEntrySubstate(string resourceAddress = default(string), DepositRule? depositRule = default(DepositRule?), bool isLocked = default(bool), SubstateType substateType = SubstateType.AccountDepositRuleIndexEntry) : base(substateType)
        {
        ...
        {
            return this.Equals(input as AccountDepositRuleIndexEntrySubstate);
        }

        /// <summary>
        /// Returns true if AccountDepositRuleIndexEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountDepositRuleIndexEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountDepositRuleIndexEntrySubstate input)
        {
            if (input == null)
            {
                return false;
