...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PackageSchemaEntrySubstate")]
    ...
    public partial class PackageSchemaEntrySubstate : Substate, IEquatable<PackageSchemaEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageSchemaEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PackageSchemaEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageSchemaEntrySubstate" /> class.
        /// </summary>
        ...
        public PackageSchemaEntrySubstate(SchemaKey key = default(SchemaKey), PackageSchemaEntryValue value = default(PackageSchemaEntryValue), SubstateType substateType = SubstateType.PackageSchemaEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            ...
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for PackageSchemaEntrySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as PackageSchemaEntrySubstate);
        }

        /// <summary>
        /// Returns true if PackageSchemaEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of PackageSchemaEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PackageSchemaEntrySubstate input)
        {
            if (input == null)
            {
                return false;
