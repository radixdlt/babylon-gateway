...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PackageFieldRoyaltyAccumulatorSubstate")]
    ...
    public partial class PackageFieldRoyaltyAccumulatorSubstate : Substate, IEquatable<PackageFieldRoyaltyAccumulatorSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageFieldRoyaltyAccumulatorSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PackageFieldRoyaltyAccumulatorSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageFieldRoyaltyAccumulatorSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.PackageFieldRoyaltyAccumulator).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public PackageFieldRoyaltyAccumulatorSubstate(PackageFieldRoyaltyAccumulatorValue value = default(PackageFieldRoyaltyAccumulatorValue), SubstateType substateType = SubstateType.PackageFieldRoyaltyAccumulator, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for PackageFieldRoyaltyAccumulatorSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as PackageFieldRoyaltyAccumulatorSubstate);
        }

        /// <summary>
        /// Returns true if PackageFieldRoyaltyAccumulatorSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of PackageFieldRoyaltyAccumulatorSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PackageFieldRoyaltyAccumulatorSubstate input)
        {
            if (input == null)
            {
                return false;
