...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class PackageFieldRoyaltyAccumulatorSubstate : Substate, IEquatable<PackageFieldRoyaltyAccumulatorSubstate>
    {
        ...
        public PackageFieldRoyaltyAccumulatorSubstate(EntityReference vaultEntity = default(EntityReference), SubstateType substateType = SubstateType.PackageFieldRoyaltyAccumulator, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "vaultEntity" is required (not null)
            if (vaultEntity == null)
            {
                throw new ArgumentNullException("vaultEntity is a required property for PackageFieldRoyaltyAccumulatorSubstate and cannot be null");
            }
