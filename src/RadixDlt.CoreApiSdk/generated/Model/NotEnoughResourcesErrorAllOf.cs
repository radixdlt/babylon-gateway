...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NotEnoughResourcesError_allOf")]
    public partial class NotEnoughResourcesErrorAllOf : IEquatable<NotEnoughResourcesErrorAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotEnoughResourcesErrorAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NotEnoughResourcesErrorAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NotEnoughResourcesErrorAllOf" /> class.
        /// </summary>
        ...
        public NotEnoughResourcesErrorAllOf(ResourceAmount fee = default(ResourceAmount), ResourceAmount available = default(ResourceAmount), ResourceAmount attemptedToTake = default(ResourceAmount))
        {
            // to ensure "fee" is required (not null)
            if (fee == null)
            {
                throw new ArgumentNullException("fee is a required property for NotEnoughResourcesErrorAllOf and cannot be null");
            }
            this.Fee = fee;
            // to ensure "available" is required (not null)
            if (available == null)
            {
                throw new ArgumentNullException("available is a required property for NotEnoughResourcesErrorAllOf and cannot be null");
            }
            this.Available = available;
            // to ensure "attemptedToTake" is required (not null)
            if (attemptedToTake == null)
            {
                throw new ArgumentNullException("attemptedToTake is a required property for NotEnoughResourcesErrorAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NotEnoughResourcesErrorAllOf {\n");
        ...
        {
            return this.Equals(input as NotEnoughResourcesErrorAllOf);
        }

        /// <summary>
        /// Returns true if NotEnoughResourcesErrorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of NotEnoughResourcesErrorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotEnoughResourcesErrorAllOf input)
        {
            if (input == null)
            {
                return false;
