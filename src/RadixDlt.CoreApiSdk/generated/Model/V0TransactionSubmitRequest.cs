...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class V0TransactionSubmitRequest : IEquatable<V0TransactionSubmitRequest>
    {
        ...
        public V0TransactionSubmitRequest(string notarizedTransactionHex = default(string))
        {
            // to ensure "notarizedTransactionHex" is required (not null)
            if (notarizedTransactionHex == null)
            {
                throw new ArgumentNullException("notarizedTransactionHex is a required property for V0TransactionSubmitRequest and cannot be null");
            }
