...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionFormatOptions")]
    public partial class TransactionFormatOptions : IEquatable<TransactionFormatOptions>
    {
        /// <summary>
        ...
        /// <param name="blobs">Whether to return the raw manifest (default false).</param>
        ...
        public TransactionFormatOptions(bool manifest = default(bool), bool blobs = default(bool), bool rawSystemTransaction = default(bool), bool rawNotarizedTransaction = default(bool), bool rawLedgerTransaction = default(bool))
        {
        ...
        /// </summary>
        /// <value>Whether to return the raw manifest (default false)</value>
        ...
        [DataMember(Name = "raw_system_transaction", EmitDefaultValue = true)]
        public bool RawSystemTransaction { get; set; }
        ...
        [DataMember(Name = "raw_notarized_transaction", EmitDefaultValue = true)]
        public bool RawNotarizedTransaction { get; set; }
        ...
        [DataMember(Name = "raw_ledger_transaction", EmitDefaultValue = true)]
        public bool RawLedgerTransaction { get; set; }
        ...
        {
            return this.Equals(input as TransactionFormatOptions);
        }

        /// <summary>
        /// Returns true if TransactionFormatOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionFormatOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionFormatOptions input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.RawNotarizedTransaction == input.RawNotarizedTransaction ||
                    this.RawNotarizedTransaction.Equals(input.RawNotarizedTransaction)
                ) && 
                (
                    this.RawLedgerTransaction == input.RawLedgerTransaction ||
                    this.RawLedgerTransaction.Equals(input.RawLedgerTransaction)
                );
        }
