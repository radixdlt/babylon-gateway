...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "KeyValueBasedStructure")]
    public partial class KeyValueBasedStructure : IEquatable<KeyValueBasedStructure>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KeyValueBasedStructure" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KeyValueBasedStructure() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KeyValueBasedStructure" /> class.
        /// </summary>
        /// <param name="keySchema">keySchema (required).</param>
        /// <param name="valueSchema">valueSchema (required).</param>
        public KeyValueBasedStructure(ObjectSubstateTypeReference keySchema = default(ObjectSubstateTypeReference), ObjectSubstateTypeReference valueSchema = default(ObjectSubstateTypeReference))
        {
            // to ensure "keySchema" is required (not null)
            if (keySchema == null)
            {
                throw new ArgumentNullException("keySchema is a required property for KeyValueBasedStructure and cannot be null");
            }
            this.KeySchema = keySchema;
            // to ensure "valueSchema" is required (not null)
            if (valueSchema == null)
            {
                throw new ArgumentNullException("valueSchema is a required property for KeyValueBasedStructure and cannot be null");
            }
        ...
        {
            return this.Equals(input as KeyValueBasedStructure);
        }

        /// <summary>
        /// Returns true if KeyValueBasedStructure instances are equal
        /// </summary>
        /// <param name="input">Instance of KeyValueBasedStructure to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KeyValueBasedStructure input)
        {
            if (input == null)
            {
                return false;
