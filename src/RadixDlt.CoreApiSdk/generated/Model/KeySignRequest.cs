...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// KeySignRequest
    /// </summary>
    [DataContract(Name = "KeySignRequest")]
    public partial class KeySignRequest : IEquatable<KeySignRequest>, IValidatableObject
    {
        ...
        /// <param name="unsignedTransaction">Byte array of the unsigned transaction encoded in hex. (required).</param>
        /// <param name="publicKey">publicKey (required).</param>
        public KeySignRequest(NetworkIdentifier networkIdentifier = default(NetworkIdentifier), string unsignedTransaction = default(string), PublicKey publicKey = default(PublicKey))
        {
            // to ensure "networkIdentifier" is required (not null)
            if (networkIdentifier == null)
            {
                throw new ArgumentNullException("networkIdentifier is a required property for KeySignRequest and cannot be null");
            }
            this.NetworkIdentifier = networkIdentifier;
            // to ensure "unsignedTransaction" is required (not null)
            if (unsignedTransaction == null)
            {
                throw new ArgumentNullException("unsignedTransaction is a required property for KeySignRequest and cannot be null");
            }
            this.UnsignedTransaction = unsignedTransaction;
            // to ensure "publicKey" is required (not null)
            if (publicKey == null)
            {
                throw new ArgumentNullException("publicKey is a required property for KeySignRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Byte array of the unsigned transaction encoded in hex.</value>
        ...
        {
            return this.Equals(input as KeySignRequest);
        }

        /// <summary>
        /// Returns true if KeySignRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of KeySignRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KeySignRequest input)
        {
            if (input == null)
            {
                return false;
