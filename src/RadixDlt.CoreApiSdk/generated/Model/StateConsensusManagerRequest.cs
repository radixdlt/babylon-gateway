...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StateConsensusManagerRequest")]
    public partial class StateConsensusManagerRequest : IEquatable<StateConsensusManagerRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StateConsensusManagerRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StateConsensusManagerRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StateConsensusManagerRequest" /> class.
        /// </summary>
        ...
        public StateConsensusManagerRequest(string network = default(string), bool includeReadinessSignals = default(bool))
        {
            ...
            if (network == null)
            {
                throw new ArgumentNullException("network is a required property for StateConsensusManagerRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IncludeReadinessSignals: ").Append(IncludeReadinessSignals).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as StateConsensusManagerRequest);
        }

        /// <summary>
        /// Returns true if StateConsensusManagerRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of StateConsensusManagerRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StateConsensusManagerRequest input)
        {
            if (input == null)
            {
                return false;
