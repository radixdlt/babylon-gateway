...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class ValidatorTransaction : AbstractOpenAPISchema, IEquatable<ValidatorTransaction>
    {
        ...
        /// with the <see cref="EpochUpdateValidatorTransaction" /> class
        /// </summary>
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(EpochUpdateValidatorTransaction))
                {
        ...
        /// </summary>
        /// <returns>An instance of EpochUpdateValidatorTransaction</returns>
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, ValidatorTransaction.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of ValidatorTransaction
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of ValidatorTransaction</returns>
        public static ValidatorTransaction FromJson(string jsonString)
        {
            ValidatorTransaction newValidatorTransaction = null;
            ...
            try
            {
                ...
                if (typeof(EpochUpdateValidatorTransaction).GetProperty("AdditionalProperties") == null)
                {
                    newValidatorTransaction = new ValidatorTransaction(JsonConvert.DeserializeObject<EpochUpdateValidatorTransaction>(jsonString, ValidatorTransaction.SerializerSettings));
                }
                else
                {
                    newValidatorTransaction = new ValidatorTransaction(JsonConvert.DeserializeObject<EpochUpdateValidatorTransaction>(jsonString, ValidatorTransaction.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("EpochUpdateValidatorTransaction");
                match++;
            }
    ...
    /// <summary>
    /// Custom JSON converter for ValidatorTransaction
    /// </summary>
    public class ValidatorTransactionJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(ValidatorTransaction).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return ValidatorTransaction.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
