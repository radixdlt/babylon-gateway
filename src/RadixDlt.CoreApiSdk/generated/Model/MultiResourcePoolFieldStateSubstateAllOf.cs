...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MultiResourcePoolFieldStateSubstate_allOf")]
    public partial class MultiResourcePoolFieldStateSubstateAllOf : IEquatable<MultiResourcePoolFieldStateSubstateAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiResourcePoolFieldStateSubstateAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MultiResourcePoolFieldStateSubstateAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiResourcePoolFieldStateSubstateAllOf" /> class.
        /// </summary>
        ...
        public MultiResourcePoolFieldStateSubstateAllOf(List<PoolVault> vaults = default(List<PoolVault>), string poolUnitResourceAddress = default(string))
        {
            // to ensure "vaults" is required (not null)
            if (vaults == null)
            {
                throw new ArgumentNullException("vaults is a required property for MultiResourcePoolFieldStateSubstateAllOf and cannot be null");
            }
            this.Vaults = vaults;
            // to ensure "poolUnitResourceAddress" is required (not null)
            if (poolUnitResourceAddress == null)
            {
                throw new ArgumentNullException("poolUnitResourceAddress is a required property for MultiResourcePoolFieldStateSubstateAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as MultiResourcePoolFieldStateSubstateAllOf);
        }

        /// <summary>
        /// Returns true if MultiResourcePoolFieldStateSubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of MultiResourcePoolFieldStateSubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MultiResourcePoolFieldStateSubstateAllOf input)
        {
            if (input == null)
            {
                return false;
