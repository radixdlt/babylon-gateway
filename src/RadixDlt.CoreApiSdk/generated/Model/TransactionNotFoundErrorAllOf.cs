...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class TransactionNotFoundErrorAllOf : IEquatable<TransactionNotFoundErrorAllOf>, IValidatableObject
    {
        ...
        public TransactionNotFoundErrorAllOf(TransactionIdentifier transactionIdentifier = default(TransactionIdentifier))
        {
            // to ensure "transactionIdentifier" is required (not null)
            if (transactionIdentifier == null)
            {
                throw new ArgumentNullException("transactionIdentifier is a required property for TransactionNotFoundErrorAllOf and cannot be null");
            }
