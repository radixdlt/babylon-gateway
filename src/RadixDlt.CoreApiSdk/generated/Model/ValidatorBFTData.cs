...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// ValidatorBFTData
    /// </summary>
    [DataContract(Name = "ValidatorBFTData")]
    ...
    public partial class ValidatorBFTData : DataObject, IEquatable<ValidatorBFTData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatorBFTData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValidatorBFTData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatorBFTData" /> class.
        /// </summary>
        /// <param name="proposalsCompleted">proposalsCompleted (required).</param>
        /// <param name="proposalsMissed">proposalsMissed (required).</param>
        /// <param name="type">The type of the data object. Each address may own up to one current object of a given type. (required) (default to &quot;ValidatorBFTData&quot;).</param>
        public ValidatorBFTData(long proposalsCompleted = default(long), long proposalsMissed = default(long), string type = "ValidatorBFTData") : base(type)
        {
        ...
        /// <summary>
        /// Gets or Sets ProposalsCompleted
        /// </summary>
        [DataMember(Name = "proposals_completed", IsRequired = true, EmitDefaultValue = true)]
        public long ProposalsCompleted { get; set; }

        /// <summary>
        /// Gets or Sets ProposalsMissed
        /// </summary>
        [DataMember(Name = "proposals_missed", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProposalsCompleted: ").Append(ProposalsCompleted).Append("\n");
        ...
        {
            return this.Equals(input as ValidatorBFTData);
        }

        /// <summary>
        /// Returns true if ValidatorBFTData instances are equal
        /// </summary>
        /// <param name="input">Instance of ValidatorBFTData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValidatorBFTData input)
        {
            if (input == null)
            {
                return false;
            ...
            return base.Equals(input) && 
                (
                    this.ProposalsCompleted == input.ProposalsCompleted ||
                    this.ProposalsCompleted.Equals(input.ProposalsCompleted)
                ) && base.Equals(input) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ProposalsCompleted.GetHashCode();
