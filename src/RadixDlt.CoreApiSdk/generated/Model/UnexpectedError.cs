...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class UnexpectedError : IEquatable<UnexpectedError>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="UnexpectedError" /> class.
        /// </summary>
        /// <param name="code">High level error code, similar to HTTP status codes, e.g. NOT_FOUND&#x3D;404 (required).</param>
        /// <param name="message">Message describing the error code (required).</param>
        /// <param name="details">details.</param>
        public UnexpectedError(int code = default(int), string message = default(string), CoreError details = default(CoreError))
        {
            this.Code = code;
            // to ensure "message" is required (not null)
            if (message == null)
            {
                throw new ArgumentNullException("message is a required property for UnexpectedError and cannot be null");
            }
        ...
        /// </summary>
        /// <value>High level error code, similar to HTTP status codes, e.g. NOT_FOUND&#x3D;404</value>
        ...
        /// </summary>
        /// <value>Message describing the error code</value>
        ...
        public CoreError Details { get; set; }
