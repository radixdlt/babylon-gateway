...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GlobalAddressPhantom")]
    public partial class GlobalAddressPhantom : IEquatable<GlobalAddressPhantom>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GlobalAddressPhantom" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GlobalAddressPhantom() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GlobalAddressPhantom" /> class.
        /// </summary>
        ...
        public GlobalAddressPhantom(string packageAddress = default(string), string blueprintName = default(string))
        {
            // to ensure "packageAddress" is required (not null)
            if (packageAddress == null)
            {
                throw new ArgumentNullException("packageAddress is a required property for GlobalAddressPhantom and cannot be null");
            }
            this.PackageAddress = packageAddress;
            // to ensure "blueprintName" is required (not null)
            if (blueprintName == null)
            {
                throw new ArgumentNullException("blueprintName is a required property for GlobalAddressPhantom and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlobalAddressPhantom {\n");
        ...
        {
            return this.Equals(input as GlobalAddressPhantom);
        }

        /// <summary>
        /// Returns true if GlobalAddressPhantom instances are equal
        /// </summary>
        /// <param name="input">Instance of GlobalAddressPhantom to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlobalAddressPhantom input)
        {
            if (input == null)
            {
                return false;
