...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemFieldStructure_allOf")]
    public partial class SystemFieldStructureAllOf : IEquatable<SystemFieldStructureAllOf>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemFieldStructureAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SystemFieldStructureAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemFieldStructureAllOf" /> class.
        /// </summary>
        /// <param name="fieldKind">fieldKind (required).</param>
        /// <param name="bootLoaderType">bootLoaderType.</param>
        public SystemFieldStructureAllOf(SystemFieldKind fieldKind = default(SystemFieldKind), BootLoaderType? bootLoaderType = default(BootLoaderType?))
        {
        ...
        {
            return this.Equals(input as SystemFieldStructureAllOf);
        }

        /// <summary>
        /// Returns true if SystemFieldStructureAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemFieldStructureAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemFieldStructureAllOf input)
        {
            if (input == null)
            {
                return false;
