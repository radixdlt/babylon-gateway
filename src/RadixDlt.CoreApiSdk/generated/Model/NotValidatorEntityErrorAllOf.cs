...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NotValidatorEntityError_allOf")]
    public partial class NotValidatorEntityErrorAllOf : IEquatable<NotValidatorEntityErrorAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotValidatorEntityErrorAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NotValidatorEntityErrorAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NotValidatorEntityErrorAllOf" /> class.
        /// </summary>
        /// <param name="entity">entity (required).</param>
        public NotValidatorEntityErrorAllOf(EntityIdentifier entity = default(EntityIdentifier))
        {
            // to ensure "entity" is required (not null)
            if (entity == null)
            {
                throw new ArgumentNullException("entity is a required property for NotValidatorEntityErrorAllOf and cannot be null");
            }
            this.Entity = entity;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NotValidatorEntityErrorAllOf {\n");
        ...
        {
            return this.Equals(input as NotValidatorEntityErrorAllOf);
        }

        /// <summary>
        /// Returns true if NotValidatorEntityErrorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of NotValidatorEntityErrorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotValidatorEntityErrorAllOf input)
        {
            if (input == null)
            {
                return false;
