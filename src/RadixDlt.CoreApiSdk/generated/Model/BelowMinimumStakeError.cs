...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class BelowMinimumStakeError : CoreError, IEquatable<BelowMinimumStakeError>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="type">type (required) (default to &quot;BelowMinimumStakeError&quot;).</param>
        public BelowMinimumStakeError(ResourceAmount minimumStake = default(ResourceAmount), ResourceAmount attemptedToStake = default(ResourceAmount), string type = "BelowMinimumStakeError") : base(type)
        {
            // to ensure "minimumStake" is required (not null)
            if (minimumStake == null)
            {
                throw new ArgumentNullException("minimumStake is a required property for BelowMinimumStakeError and cannot be null");
            }
            this.MinimumStake = minimumStake;
            // to ensure "attemptedToStake" is required (not null)
            if (attemptedToStake == null)
            {
                throw new ArgumentNullException("attemptedToStake is a required property for BelowMinimumStakeError and cannot be null");
            }
