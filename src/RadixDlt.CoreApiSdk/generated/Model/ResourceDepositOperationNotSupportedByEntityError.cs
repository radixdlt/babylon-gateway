...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceDepositOperationNotSupportedByEntityError")]
    ...
    public partial class ResourceDepositOperationNotSupportedByEntityError : CoreError, IEquatable<ResourceDepositOperationNotSupportedByEntityError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceDepositOperationNotSupportedByEntityError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceDepositOperationNotSupportedByEntityError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceDepositOperationNotSupportedByEntityError" /> class.
        /// </summary>
        /// <param name="entityIdentifier">entityIdentifier (required).</param>
        /// <param name="resourceDepositNotSupported">resourceDepositNotSupported (required).</param>
        /// <param name="type">type (required) (default to &quot;ResourceDepositOperationNotSupportedByEntityError&quot;).</param>
        public ResourceDepositOperationNotSupportedByEntityError(EntityIdentifier entityIdentifier = default(EntityIdentifier), ResourceIdentifier resourceDepositNotSupported = default(ResourceIdentifier), string type = "ResourceDepositOperationNotSupportedByEntityError") : base(type)
        {
            // to ensure "entityIdentifier" is required (not null)
            if (entityIdentifier == null)
            {
                throw new ArgumentNullException("entityIdentifier is a required property for ResourceDepositOperationNotSupportedByEntityError and cannot be null");
            }
            this.EntityIdentifier = entityIdentifier;
            // to ensure "resourceDepositNotSupported" is required (not null)
            if (resourceDepositNotSupported == null)
            {
                throw new ArgumentNullException("resourceDepositNotSupported is a required property for ResourceDepositOperationNotSupportedByEntityError and cannot be null");
            }
        ...
        /// <summary>
        /// Gets or Sets ResourceDepositNotSupported
        /// </summary>
        [DataMember(Name = "resource_deposit_not_supported", IsRequired = true, EmitDefaultValue = true)]
        public ResourceIdentifier ResourceDepositNotSupported { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ResourceDepositNotSupported: ").Append(ResourceDepositNotSupported).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ResourceDepositOperationNotSupportedByEntityError);
        }

        /// <summary>
        /// Returns true if ResourceDepositOperationNotSupportedByEntityError instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceDepositOperationNotSupportedByEntityError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceDepositOperationNotSupportedByEntityError input)
        {
            if (input == null)
            {
                return false;
            ...
            return base.Equals(input) && 
                ...
                (
                    this.ResourceDepositNotSupported == input.ResourceDepositNotSupported ||
                    (this.ResourceDepositNotSupported != null &&
                    this.ResourceDepositNotSupported.Equals(input.ResourceDepositNotSupported))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ResourceDepositNotSupported != null)
                {
                    hashCode = (hashCode * 59) + this.ResourceDepositNotSupported.GetHashCode();
                }
                return hashCode;
            }
        }
