...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// InvalidJsonError
    /// </summary>
    [DataContract(Name = "InvalidJsonError")]
    ...
    public partial class InvalidJsonError : CoreError, IEquatable<InvalidJsonError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidJsonError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvalidJsonError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidJsonError" /> class.
        /// </summary>
        /// <param name="cause">cause.</param>
        /// <param name="type">type (required) (default to &quot;InvalidJsonError&quot;).</param>
        public InvalidJsonError(string cause = default(string), string type = "InvalidJsonError") : base(type)
        {
            this.Cause = cause;
        }
        ...
        {
            return this.Equals(input as InvalidJsonError);
        }

        /// <summary>
        /// Returns true if InvalidJsonError instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidJsonError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidJsonError input)
        {
            if (input == null)
            {
                return false;
