...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class PackageRoyaltyConfigSubstate : Substate, IEquatable<PackageRoyaltyConfigSubstate>
    {
        ...
        /// <param name="substateType">substateType (required) (default to &quot;PackageRoyaltyConfigSubstate&quot;).</param>
        public PackageRoyaltyConfigSubstate(List<BlueprintRoyaltyConfig> blueprintRoyalties = default(List<BlueprintRoyaltyConfig>), SubstateType substateType = Model.SubstateType.PackageRoyaltyConfig) : base(substateType)
        {
