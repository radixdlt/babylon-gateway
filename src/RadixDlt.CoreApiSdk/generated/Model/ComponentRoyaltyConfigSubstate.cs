...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ComponentRoyaltyConfigSubstate")]
    ...
    public partial class ComponentRoyaltyConfigSubstate : Substate, IEquatable<ComponentRoyaltyConfigSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComponentRoyaltyConfigSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ComponentRoyaltyConfigSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ComponentRoyaltyConfigSubstate" /> class.
        /// </summary>
        /// <param name="royaltyConfig">royaltyConfig (required).</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.ComponentRoyaltyConfig).</param>
        public ComponentRoyaltyConfigSubstate(RoyaltyConfig royaltyConfig = default(RoyaltyConfig), SubstateType substateType = SubstateType.ComponentRoyaltyConfig) : base(substateType)
        {
            // to ensure "royaltyConfig" is required (not null)
            if (royaltyConfig == null)
            {
                throw new ArgumentNullException("royaltyConfig is a required property for ComponentRoyaltyConfigSubstate and cannot be null");
            }
        ...
        {
            return this.Equals(input as ComponentRoyaltyConfigSubstate);
        }

        /// <summary>
        /// Returns true if ComponentRoyaltyConfigSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of ComponentRoyaltyConfigSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComponentRoyaltyConfigSubstate input)
        {
            if (input == null)
            {
                return false;
