...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NetworkNotSupportedError")]
    ...
    public partial class NetworkNotSupportedError : CoreError, IEquatable<NetworkNotSupportedError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NetworkNotSupportedError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NetworkNotSupportedError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NetworkNotSupportedError" /> class.
        /// </summary>
        /// <param name="supportedNetworks">supportedNetworks (required).</param>
        /// <param name="type">type (required) (default to &quot;NetworkNotSupportedError&quot;).</param>
        public NetworkNotSupportedError(List<NetworkIdentifier> supportedNetworks = default(List<NetworkIdentifier>), string type = "NetworkNotSupportedError") : base(type)
        {
            // to ensure "supportedNetworks" is required (not null)
            if (supportedNetworks == null)
            {
                throw new ArgumentNullException("supportedNetworks is a required property for NetworkNotSupportedError and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "supported_networks", IsRequired = true, EmitDefaultValue = true)]
        public List<NetworkIdentifier> SupportedNetworks { get; set; }
        ...
        {
            return this.Equals(input as NetworkNotSupportedError);
        }

        /// <summary>
        /// Returns true if NetworkNotSupportedError instances are equal
        /// </summary>
        /// <param name="input">Instance of NetworkNotSupportedError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NetworkNotSupportedError input)
        {
            if (input == null)
            {
                return false;
            ...
            return base.Equals(input) && 
                (
                    this.SupportedNetworks == input.SupportedNetworks ||
                    this.SupportedNetworks != null &&
                    input.SupportedNetworks != null &&
                    this.SupportedNetworks.SequenceEqual(input.SupportedNetworks)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.SupportedNetworks.GetHashCode();
                }
                return hashCode;
            }
        }
