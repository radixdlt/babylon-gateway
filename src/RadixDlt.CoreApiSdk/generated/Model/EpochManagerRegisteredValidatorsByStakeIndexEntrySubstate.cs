...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EpochManagerRegisteredValidatorsByStakeIndexEntrySubstate")]
    ...
    public partial class EpochManagerRegisteredValidatorsByStakeIndexEntrySubstate : Substate, IEquatable<EpochManagerRegisteredValidatorsByStakeIndexEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EpochManagerRegisteredValidatorsByStakeIndexEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EpochManagerRegisteredValidatorsByStakeIndexEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EpochManagerRegisteredValidatorsByStakeIndexEntrySubstate" /> class.
        /// </summary>
        /// <param name="activeValidator">activeValidator (required).</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.EpochManagerRegisteredValidatorsByStakeIndexEntry).</param>
        public EpochManagerRegisteredValidatorsByStakeIndexEntrySubstate(ActiveValidator activeValidator = default(ActiveValidator), SubstateType substateType = SubstateType.EpochManagerRegisteredValidatorsByStakeIndexEntry) : base(substateType)
        {
            // to ensure "activeValidator" is required (not null)
            if (activeValidator == null)
            {
                throw new ArgumentNullException("activeValidator is a required property for EpochManagerRegisteredValidatorsByStakeIndexEntrySubstate and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EpochManagerRegisteredValidatorsByStakeIndexEntrySubstate {\n");
        ...
        {
            return this.Equals(input as EpochManagerRegisteredValidatorsByStakeIndexEntrySubstate);
        }

        /// <summary>
        /// Returns true if EpochManagerRegisteredValidatorsByStakeIndexEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of EpochManagerRegisteredValidatorsByStakeIndexEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EpochManagerRegisteredValidatorsByStakeIndexEntrySubstate input)
        {
            if (input == null)
            {
                return false;
