...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MempoolFullError_allOf")]
    public partial class MempoolFullErrorAllOf : IEquatable<MempoolFullErrorAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MempoolFullErrorAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MempoolFullErrorAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MempoolFullErrorAllOf" /> class.
        /// </summary>
        /// <param name="mempoolTransactionCount">mempoolTransactionCount (required).</param>
        public MempoolFullErrorAllOf(int mempoolTransactionCount = default(int))
        {
        ...
        {
            return this.Equals(input as MempoolFullErrorAllOf);
        }

        /// <summary>
        /// Returns true if MempoolFullErrorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of MempoolFullErrorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MempoolFullErrorAllOf input)
        {
            if (input == null)
            {
                return false;
