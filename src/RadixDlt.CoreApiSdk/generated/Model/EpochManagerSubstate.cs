...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class EpochManagerSubstate : Substate, IEquatable<EpochManagerSubstate>
    {
        ...
        public EpochManagerSubstate(long epoch = default(long), long round = default(long), long roundsPerEpoch = default(long), SubstateType substateType = Model.SubstateType.EpochManager) : base(substateType)
        {
            this.Epoch = epoch;
            this.Round = round;
