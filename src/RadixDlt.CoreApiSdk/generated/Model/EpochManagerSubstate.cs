...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class EpochManagerSubstate : Substate, IEquatable<EpochManagerSubstate>
    {
        ...
        public EpochManagerSubstate(string address = default(string), long epoch = default(long), long round = default(long), long roundsPerEpoch = default(long), SubstateType substateType = SubstateType.EpochManager) : base(substateType)
        {
