...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class EpochManagerSubstate : Substate, IEquatable<EpochManagerSubstate>
    {
        ...
        public EpochManagerSubstate(string address = default(string), string validatorOwnerResource = default(string), long epoch = default(long), long round = default(long), long roundsPerEpoch = default(long), long numUnstakeEpochs = default(long), SubstateType substateType = SubstateType.EpochManager) : base(substateType)
        {
            ...
            {
                throw new ArgumentNullException("validatorOwnerResource is a required property for EpochManagerSubstate and cannot be null");
            }
