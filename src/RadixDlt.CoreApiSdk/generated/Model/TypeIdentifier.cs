...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// TypeIdentifier
    /// </summary>
    [DataContract(Name = "TypeIdentifier")]
    public partial class TypeIdentifier : IEquatable<TypeIdentifier>
    {
        /// <summary>
        ...
        public TypeIdentifier(string schemaHash = default(string), LocalTypeIndex localTypeIndex = default(LocalTypeIndex))
        {
            // to ensure "schemaHash" is required (not null)
            if (schemaHash == null)
            {
                throw new ArgumentNullException("schemaHash is a required property for TypeIdentifier and cannot be null");
            }
            this.SchemaHash = schemaHash;
            // to ensure "localTypeIndex" is required (not null)
            if (localTypeIndex == null)
            {
                throw new ArgumentNullException("localTypeIndex is a required property for TypeIdentifier and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TypeIdentifier {\n");
        ...
        {
            return this.Equals(input as TypeIdentifier);
        }

        /// <summary>
        /// Returns true if TypeIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of TypeIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TypeIdentifier input)
        {
            if (input == null)
            {
                return false;
