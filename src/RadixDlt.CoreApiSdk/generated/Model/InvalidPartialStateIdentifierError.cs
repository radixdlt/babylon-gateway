...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InvalidPartialStateIdentifierError")]
    ...
    public partial class InvalidPartialStateIdentifierError : CoreError, IEquatable<InvalidPartialStateIdentifierError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidPartialStateIdentifierError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvalidPartialStateIdentifierError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidPartialStateIdentifierError" /> class.
        /// </summary>
        /// <param name="invalidPartialStateIdentifier">invalidPartialStateIdentifier (required).</param>
        /// <param name="type">type (required) (default to &quot;InvalidPartialStateIdentifierError&quot;).</param>
        public InvalidPartialStateIdentifierError(PartialStateIdentifier invalidPartialStateIdentifier = default(PartialStateIdentifier), string type = "InvalidPartialStateIdentifierError") : base(type)
        {
            // to ensure "invalidPartialStateIdentifier" is required (not null)
            if (invalidPartialStateIdentifier == null)
            {
                throw new ArgumentNullException("invalidPartialStateIdentifier is a required property for InvalidPartialStateIdentifierError and cannot be null");
            }
            this.InvalidPartialStateIdentifier = invalidPartialStateIdentifier;
        }

        /// <summary>
        /// Gets or Sets InvalidPartialStateIdentifier
        /// </summary>
        [DataMember(Name = "invalid_partial_state_identifier", IsRequired = true, EmitDefaultValue = true)]
        public PartialStateIdentifier InvalidPartialStateIdentifier { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InvalidPartialStateIdentifier: ").Append(InvalidPartialStateIdentifier).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as InvalidPartialStateIdentifierError);
        }

        /// <summary>
        /// Returns true if InvalidPartialStateIdentifierError instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidPartialStateIdentifierError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidPartialStateIdentifierError input)
        {
            if (input == null)
            {
                return false;
            ...
            return base.Equals(input) && 
                (
                    this.InvalidPartialStateIdentifier == input.InvalidPartialStateIdentifier ||
                    (this.InvalidPartialStateIdentifier != null &&
                    this.InvalidPartialStateIdentifier.Equals(input.InvalidPartialStateIdentifier))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InvalidPartialStateIdentifier != null)
                {
                    hashCode = (hashCode * 59) + this.InvalidPartialStateIdentifier.GetHashCode();
                }
                return hashCode;
            }
        }
