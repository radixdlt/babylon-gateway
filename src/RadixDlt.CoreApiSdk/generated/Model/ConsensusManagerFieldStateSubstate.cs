...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class ConsensusManagerFieldStateSubstate : Substate, IEquatable<ConsensusManagerFieldStateSubstate>
    {
        ...
        protected ConsensusManagerFieldStateSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsensusManagerFieldStateSubstate" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ConsensusManagerFieldStateSubstate);
        }

        /// <summary>
        /// Returns true if ConsensusManagerFieldStateSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of ConsensusManagerFieldStateSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConsensusManagerFieldStateSubstate input)
        {
            if (input == null)
            {
                return false;
