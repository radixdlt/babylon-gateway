...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// ParsedTransaction
    /// </summary>
    [DataContract(Name = "ParsedTransaction")]
    ...
    [JsonSubtypes.KnownSubType(typeof(ParsedLedgerTransaction), "ParsedLedgerTransaction")]
    [JsonSubtypes.KnownSubType(typeof(ParsedNotarizedTransaction), "ParsedNotarizedTransaction")]
    [JsonSubtypes.KnownSubType(typeof(ParsedNotarizedTransactionV2), "ParsedNotarizedTransactionV2")]
    ...
    public partial class ParsedTransaction : IEquatable<ParsedTransaction>
    {
        ...
        protected ParsedTransaction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ParsedTransaction" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        public ParsedTransaction(ParsedTransactionType type = default(ParsedTransactionType))
        {
            this.Type = type;
        }
        ...
        {
            return this.Equals(input as ParsedTransaction);
        }

        /// <summary>
        /// Returns true if ParsedTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of ParsedTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParsedTransaction input)
        {
            if (input == null)
            {
                return false;
