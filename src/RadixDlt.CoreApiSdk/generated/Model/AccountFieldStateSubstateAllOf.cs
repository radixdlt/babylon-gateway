...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class AccountFieldStateSubstateAllOf : IEquatable<AccountFieldStateSubstateAllOf>
    {
        ...
        protected AccountFieldStateSubstateAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountFieldStateSubstateAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AccountFieldStateSubstateAllOf);
        }

        /// <summary>
        /// Returns true if AccountFieldStateSubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountFieldStateSubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountFieldStateSubstateAllOf input)
        {
            if (input == null)
            {
                return false;
