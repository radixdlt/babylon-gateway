...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConstructionFinalizeRequest")]
    public partial class ConstructionFinalizeRequest : IEquatable<ConstructionFinalizeRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionFinalizeRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConstructionFinalizeRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionFinalizeRequest" /> class.
        /// </summary>
        /// <param name="networkIdentifier">networkIdentifier (required).</param>
        /// <param name="unsignedTransaction">Hex encoded unsigned transaction. (required).</param>
        /// <param name="signature">signature (required).</param>
        public ConstructionFinalizeRequest(NetworkIdentifier networkIdentifier = default(NetworkIdentifier), string unsignedTransaction = default(string), Signature signature = default(Signature))
        {
            // to ensure "networkIdentifier" is required (not null)
            if (networkIdentifier == null)
            {
                throw new ArgumentNullException("networkIdentifier is a required property for ConstructionFinalizeRequest and cannot be null");
            }
            this.NetworkIdentifier = networkIdentifier;
            // to ensure "unsignedTransaction" is required (not null)
            if (unsignedTransaction == null)
            {
                throw new ArgumentNullException("unsignedTransaction is a required property for ConstructionFinalizeRequest and cannot be null");
            }
            this.UnsignedTransaction = unsignedTransaction;
            // to ensure "signature" is required (not null)
            if (signature == null)
            {
                throw new ArgumentNullException("signature is a required property for ConstructionFinalizeRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Hex encoded unsigned transaction.</value>
        ...
        {
            return this.Equals(input as ConstructionFinalizeRequest);
        }

        /// <summary>
        /// Returns true if ConstructionFinalizeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ConstructionFinalizeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConstructionFinalizeRequest input)
        {
            if (input == null)
            {
                return false;
