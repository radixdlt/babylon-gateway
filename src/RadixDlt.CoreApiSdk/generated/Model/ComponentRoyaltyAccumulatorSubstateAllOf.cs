...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ComponentRoyaltyAccumulatorSubstate_allOf")]
    public partial class ComponentRoyaltyAccumulatorSubstateAllOf : IEquatable<ComponentRoyaltyAccumulatorSubstateAllOf>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ComponentRoyaltyAccumulatorSubstateAllOf);
        }

        /// <summary>
        /// Returns true if ComponentRoyaltyAccumulatorSubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ComponentRoyaltyAccumulatorSubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComponentRoyaltyAccumulatorSubstateAllOf input)
        {
            if (input == null)
            {
                return false;
