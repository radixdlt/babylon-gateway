...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class ComponentRoyaltyAccumulatorSubstateAllOf : IEquatable<ComponentRoyaltyAccumulatorSubstateAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public ComponentRoyaltyAccumulatorSubstateAllOf(string xrdAmount = default(string))
        {
            // to ensure "xrdAmount" is required (not null)
            if (xrdAmount == null)
            {
                throw new ArgumentNullException("xrdAmount is a required property for ComponentRoyaltyAccumulatorSubstateAllOf and cannot be null");
            }
