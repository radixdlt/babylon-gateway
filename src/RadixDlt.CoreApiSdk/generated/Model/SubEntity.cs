...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// SubEntity
    /// </summary>
    [DataContract(Name = "SubEntity")]
    public partial class SubEntity : IEquatable<SubEntity>, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="SubEntity" /> class.
        /// </summary>
        /// <param name="address">The subentity. (required).</param>
        /// <param name="metadata">metadata.</param>
        public SubEntity(string address = default(string), SubEntityMetadata metadata = default(SubEntityMetadata))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for SubEntity and cannot be null");
            }
        ...
        public SubEntityMetadata Metadata { get; set; }
        ...
        {
            return this.Equals(input as SubEntity);
        }

        /// <summary>
        /// Returns true if SubEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of SubEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubEntity input)
        {
            if (input == null)
            {
                return false;
