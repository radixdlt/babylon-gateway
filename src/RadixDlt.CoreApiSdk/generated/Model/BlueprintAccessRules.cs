...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BlueprintAccessRules")]
    public partial class BlueprintAccessRules : IEquatable<BlueprintAccessRules>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BlueprintAccessRules" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BlueprintAccessRules() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BlueprintAccessRules" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as BlueprintAccessRules);
        }

        /// <summary>
        /// Returns true if BlueprintAccessRules instances are equal
        /// </summary>
        /// <param name="input">Instance of BlueprintAccessRules to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BlueprintAccessRules input)
        {
            if (input == null)
            {
                return false;
