...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InvalidTransactionHashError")]
    ...
    public partial class InvalidTransactionHashError : CoreError, IEquatable<InvalidTransactionHashError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidTransactionHashError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvalidTransactionHashError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidTransactionHashError" /> class.
        /// </summary>
        /// <param name="invalidTransactionHash">invalidTransactionHash (required).</param>
        /// <param name="type">type (required) (default to &quot;InvalidTransactionHashError&quot;).</param>
        public InvalidTransactionHashError(string invalidTransactionHash = default(string), string type = "InvalidTransactionHashError") : base(type)
        {
            // to ensure "invalidTransactionHash" is required (not null)
            if (invalidTransactionHash == null)
            {
                throw new ArgumentNullException("invalidTransactionHash is a required property for InvalidTransactionHashError and cannot be null");
            }
            this.InvalidTransactionHash = invalidTransactionHash;
        }

        /// <summary>
        /// Gets or Sets InvalidTransactionHash
        /// </summary>
        [DataMember(Name = "invalid_transaction_hash", IsRequired = true, EmitDefaultValue = true)]
        public string InvalidTransactionHash { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InvalidTransactionHash: ").Append(InvalidTransactionHash).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as InvalidTransactionHashError);
        }

        /// <summary>
        /// Returns true if InvalidTransactionHashError instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidTransactionHashError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidTransactionHashError input)
        {
            if (input == null)
            {
                return false;
            ...
            return base.Equals(input) && 
                (
                    this.InvalidTransactionHash == input.InvalidTransactionHash ||
                    (this.InvalidTransactionHash != null &&
                    this.InvalidTransactionHash.Equals(input.InvalidTransactionHash))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InvalidTransactionHash != null)
                {
                    hashCode = (hashCode * 59) + this.InvalidTransactionHash.GetHashCode();
                }
                return hashCode;
            }
        }
