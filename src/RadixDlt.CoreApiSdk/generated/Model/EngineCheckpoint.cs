...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// EngineCheckpoint
    /// </summary>
    [DataContract(Name = "EngineCheckpoint")]
    public partial class EngineCheckpoint : IEquatable<EngineCheckpoint>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EngineCheckpoint" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EngineCheckpoint() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EngineCheckpoint" /> class.
        /// </summary>
        /// <param name="engineStateIdentifier">engineStateIdentifier (required).</param>
        /// <param name="checkpointTransaction">checkpointTransaction.</param>
        public EngineCheckpoint(EngineStateIdentifier engineStateIdentifier = default(EngineStateIdentifier), string checkpointTransaction = default(string))
        {
            // to ensure "engineStateIdentifier" is required (not null)
            if (engineStateIdentifier == null)
            {
                throw new ArgumentNullException("engineStateIdentifier is a required property for EngineCheckpoint and cannot be null");
            }
        ...
        /// <summary>
        /// Gets or Sets EngineStateIdentifier
        /// </summary>
        [DataMember(Name = "engine_state_identifier", IsRequired = true, EmitDefaultValue = true)]
        public EngineStateIdentifier EngineStateIdentifier { get; set; }

        /// <summary>
        /// Gets or Sets CheckpointTransaction
        /// </summary>
        [DataMember(Name = "checkpoint_transaction", EmitDefaultValue = true)]
        public string CheckpointTransaction { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EngineStateIdentifier: ").Append(EngineStateIdentifier).Append("\n");
            sb.Append("  CheckpointTransaction: ").Append(CheckpointTransaction).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as EngineCheckpoint);
        }

        /// <summary>
        /// Returns true if EngineCheckpoint instances are equal
        /// </summary>
        /// <param name="input">Instance of EngineCheckpoint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EngineCheckpoint input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.EngineStateIdentifier == input.EngineStateIdentifier ||
                    (this.EngineStateIdentifier != null &&
                    this.EngineStateIdentifier.Equals(input.EngineStateIdentifier))
                ) && 
                (
                    this.CheckpointTransaction == input.CheckpointTransaction ||
                    (this.CheckpointTransaction != null &&
                    this.CheckpointTransaction.Equals(input.CheckpointTransaction))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.EngineStateIdentifier != null)
                {
                    hashCode = (hashCode * 59) + this.EngineStateIdentifier.GetHashCode();
                }
                if (this.CheckpointTransaction != null)
                {
                    hashCode = (hashCode * 59) + this.CheckpointTransaction.GetHashCode();
                }
                return hashCode;
            }
        }
