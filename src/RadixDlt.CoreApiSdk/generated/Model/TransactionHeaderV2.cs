...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// TransactionHeaderV2
    /// </summary>
    [DataContract(Name = "TransactionHeaderV2")]
    public partial class TransactionHeaderV2 : IEquatable<TransactionHeaderV2>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionHeaderV2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionHeaderV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionHeaderV2" /> class.
        /// </summary>
        ...
        /// <param name="tipBasisPoints">An integer between &#x60;0&#x60; and &#x60;2^32 - 1 &#x3D; 4294967295&#x60;, giving the validator tip as a basis points amount. That is, a value of &#x60;1&#x60; corresponds to an additional tip on 0.01% of the base fee.  (required).</param>
        public TransactionHeaderV2(PublicKey notaryPublicKey = default(PublicKey), bool notaryIsSignatory = default(bool), long tipBasisPoints = default(long))
        {
            // to ensure "notaryPublicKey" is required (not null)
            if (notaryPublicKey == null)
            {
                throw new ArgumentNullException("notaryPublicKey is a required property for TransactionHeaderV2 and cannot be null");
            }
        ...
        /// </summary>
        /// <value>An integer between &#x60;0&#x60; and &#x60;2^32 - 1 &#x3D; 4294967295&#x60;, giving the validator tip as a basis points amount. That is, a value of &#x60;1&#x60; corresponds to an additional tip on 0.01% of the base fee. </value>
        [DataMember(Name = "tip_basis_points", IsRequired = true, EmitDefaultValue = true)]
        public long TipBasisPoints { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TipBasisPoints: ").Append(TipBasisPoints).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransactionHeaderV2);
        }

        /// <summary>
        /// Returns true if TransactionHeaderV2 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionHeaderV2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionHeaderV2 input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.TipBasisPoints == input.TipBasisPoints ||
                    this.TipBasisPoints.Equals(input.TipBasisPoints)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.TipBasisPoints.GetHashCode();
                return hashCode;
            }
        }
