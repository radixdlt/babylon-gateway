...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// VirtualParentData
    /// </summary>
    [DataContract(Name = "VirtualParentData")]
    ...
    public partial class VirtualParentData : DataObject, IEquatable<VirtualParentData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VirtualParentData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VirtualParentData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VirtualParentData" /> class.
        /// </summary>
        /// <param name="entitySetIdentifier">entitySetIdentifier (required).</param>
        /// <param name="virtualDataObject">virtualDataObject (required).</param>
        /// <param name="type">The type of the data object. Each address may own up to one current object of a given type. (required) (default to &quot;VirtualParentData&quot;).</param>
        public VirtualParentData(EntitySetIdentifier entitySetIdentifier = default(EntitySetIdentifier), DataObject virtualDataObject = default(DataObject), string type = "VirtualParentData") : base(type)
        {
            // to ensure "entitySetIdentifier" is required (not null)
            if (entitySetIdentifier == null)
            {
                throw new ArgumentNullException("entitySetIdentifier is a required property for VirtualParentData and cannot be null");
            }
            this.EntitySetIdentifier = entitySetIdentifier;
            // to ensure "virtualDataObject" is required (not null)
            if (virtualDataObject == null)
            {
                throw new ArgumentNullException("virtualDataObject is a required property for VirtualParentData and cannot be null");
            }
            this.VirtualDataObject = virtualDataObject;
        }

        /// <summary>
        /// Gets or Sets EntitySetIdentifier
        /// </summary>
        [DataMember(Name = "entity_set_identifier", IsRequired = true, EmitDefaultValue = true)]
        public EntitySetIdentifier EntitySetIdentifier { get; set; }

        /// <summary>
        /// Gets or Sets VirtualDataObject
        /// </summary>
        [DataMember(Name = "virtual_data_object", IsRequired = true, EmitDefaultValue = true)]
        public DataObject VirtualDataObject { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EntitySetIdentifier: ").Append(EntitySetIdentifier).Append("\n");
            sb.Append("  VirtualDataObject: ").Append(VirtualDataObject).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as VirtualParentData);
        }

        /// <summary>
        /// Returns true if VirtualParentData instances are equal
        /// </summary>
        /// <param name="input">Instance of VirtualParentData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VirtualParentData input)
        {
            if (input == null)
            {
                return false;
            ...
            return base.Equals(input) && 
                (
                    this.EntitySetIdentifier == input.EntitySetIdentifier ||
                    (this.EntitySetIdentifier != null &&
                    this.EntitySetIdentifier.Equals(input.EntitySetIdentifier))
                ) && base.Equals(input) && 
                (
                    this.VirtualDataObject == input.VirtualDataObject ||
                    (this.VirtualDataObject != null &&
                    this.VirtualDataObject.Equals(input.VirtualDataObject))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EntitySetIdentifier != null)
                {
                    hashCode = (hashCode * 59) + this.EntitySetIdentifier.GetHashCode();
                }
                if (this.VirtualDataObject != null)
                {
                    hashCode = (hashCode * 59) + this.VirtualDataObject.GetHashCode();
                }
                return hashCode;
            }
        }
