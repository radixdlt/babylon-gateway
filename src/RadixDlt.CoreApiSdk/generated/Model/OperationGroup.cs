...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// OperationGroup
    /// </summary>
    [DataContract(Name = "OperationGroup")]
    public partial class OperationGroup : IEquatable<OperationGroup>, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="OperationGroup" /> class.
        /// </summary>
        /// <param name="operations">A group of operations representing a complete state update. (required).</param>
        /// <param name="metadata">Metadata for the operation group..</param>
        public OperationGroup(List<Operation> operations = default(List<Operation>), Object metadata = default(Object))
        {
            // to ensure "operations" is required (not null)
            if (operations == null)
            {
                throw new ArgumentNullException("operations is a required property for OperationGroup and cannot be null");
            }
        ...
        /// </summary>
        /// <value>A group of operations representing a complete state update.</value>
        ...
        /// </summary>
        /// <value>Metadata for the operation group.</value>
        ...
        {
            return this.Equals(input as OperationGroup);
        }

        /// <summary>
        /// Returns true if OperationGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of OperationGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OperationGroup input)
        {
            if (input == null)
            {
                return false;
