...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LtsStreamTransactionOutcomesResponse")]
    public partial class LtsStreamTransactionOutcomesResponse : IEquatable<LtsStreamTransactionOutcomesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LtsStreamTransactionOutcomesResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LtsStreamTransactionOutcomesResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LtsStreamTransactionOutcomesResponse" /> class.
        /// </summary>
        ...
        public LtsStreamTransactionOutcomesResponse(long fromStateVersion = default(long), int count = default(int), long maxLedgerStateVersion = default(long), List<LtsCommittedTransactionOutcome> committedTransactionOutcomes = default(List<LtsCommittedTransactionOutcome>))
        {
            ...
            {
                throw new ArgumentNullException("committedTransactionOutcomes is a required property for LtsStreamTransactionOutcomesResponse and cannot be null");
            }
        ...
        {
            return this.Equals(input as LtsStreamTransactionOutcomesResponse);
        }

        /// <summary>
        /// Returns true if LtsStreamTransactionOutcomesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of LtsStreamTransactionOutcomesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LtsStreamTransactionOutcomesResponse input)
        {
            if (input == null)
            {
                return false;
