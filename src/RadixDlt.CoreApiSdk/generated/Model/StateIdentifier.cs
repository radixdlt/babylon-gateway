...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class StateIdentifier : IEquatable<StateIdentifier>, IValidatableObject
    {
        ...
        /// <param name="transactionAccumulator">Accumulator hash representing all transactions which occurred up to &#x60;state_version&#x60;. Hex encoded. (required).</param>
        public StateIdentifier(long stateVersion = default(long), string transactionAccumulator = default(string))
        {
            this.StateVersion = stateVersion;
            // to ensure "transactionAccumulator" is required (not null)
            if (transactionAccumulator == null)
            {
                throw new ArgumentNullException("transactionAccumulator is a required property for StateIdentifier and cannot be null");
            }
        ...
        [DataMember(Name = "transaction_accumulator", IsRequired = true, EmitDefaultValue = true)]
