...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ParsedLedgerTransaction")]
    ...
    public partial class ParsedLedgerTransaction : ParsedTransaction, IEquatable<ParsedLedgerTransaction>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParsedLedgerTransaction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ParsedLedgerTransaction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ParsedLedgerTransaction" /> class.
        /// </summary>
        ...
        public ParsedLedgerTransaction(LedgerTransaction ledgerTransaction = default(LedgerTransaction), ParsedLedgerTransactionIdentifiers identifiers = default(ParsedLedgerTransactionIdentifiers), ParsedTransactionType type = ParsedTransactionType.LedgerTransaction) : base(type)
        {
            ...
            if (identifiers == null)
            {
                throw new ArgumentNullException("identifiers is a required property for ParsedLedgerTransaction and cannot be null");
            }
        ...
        {
            return this.Equals(input as ParsedLedgerTransaction);
        }

        /// <summary>
        /// Returns true if ParsedLedgerTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of ParsedLedgerTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParsedLedgerTransaction input)
        {
            if (input == null)
            {
                return false;
