...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class ParsedLedgerTransaction : ParsedTransaction, IEquatable<ParsedLedgerTransaction>
    {
        ...
        /// <param name="type">type (required) (default to &quot;ParsedLedgerTransaction&quot;).</param>
        public ParsedLedgerTransaction(LedgerTransaction ledgerTransaction = default(LedgerTransaction), ParsedLedgerTransactionAllOfIdentifiers identifiers = default(ParsedLedgerTransactionAllOfIdentifiers), ParsedTransactionType type = "ParsedLedgerTransaction") : base(type)
        {
