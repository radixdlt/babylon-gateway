...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class Signature : IEquatable<Signature>, IValidatableObject
    {
        ...
        /// <param name="bytes">An ECDSA signature of with the given &#x60;public_key&#x60;. The ECDSA signature should be created using the secp256k1 curve and should be encoded in DER format, and then encoded as a hex string. (required).</param>
        ...
        /// </summary>
        /// <value>An ECDSA signature of with the given &#x60;public_key&#x60;. The ECDSA signature should be created using the secp256k1 curve and should be encoded in DER format, and then encoded as a hex string.</value>
