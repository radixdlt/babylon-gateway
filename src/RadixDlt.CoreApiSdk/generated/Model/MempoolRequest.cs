...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// MempoolRequest
    /// </summary>
    [DataContract(Name = "MempoolRequest")]
    public partial class MempoolRequest : IEquatable<MempoolRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MempoolRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MempoolRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MempoolRequest" /> class.
        /// </summary>
        /// <param name="networkIdentifier">networkIdentifier (required).</param>
        public MempoolRequest(NetworkIdentifier networkIdentifier = default(NetworkIdentifier))
        {
            // to ensure "networkIdentifier" is required (not null)
            if (networkIdentifier == null)
            {
                throw new ArgumentNullException("networkIdentifier is a required property for MempoolRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as MempoolRequest);
        }

        /// <summary>
        /// Returns true if MempoolRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MempoolRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MempoolRequest input)
        {
            if (input == null)
            {
                return false;
