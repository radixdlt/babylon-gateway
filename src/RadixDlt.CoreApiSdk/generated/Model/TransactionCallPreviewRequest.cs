...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class TransactionCallPreviewRequest : IEquatable<TransactionCallPreviewRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public TransactionCallPreviewRequest(TransactionCallPreviewRequestTarget target = default(TransactionCallPreviewRequestTarget), List<string> arguments = default(List<string>))
        {
