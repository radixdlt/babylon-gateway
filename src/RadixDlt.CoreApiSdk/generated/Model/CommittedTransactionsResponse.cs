...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class CommittedTransactionsResponse : IEquatable<CommittedTransactionsResponse>, IValidatableObject
    {
        ...
        /// <param name="transactions">A committed transactions list starting from the &#x60;state_identifier&#x60;. (required).</param>
        public CommittedTransactionsResponse(StateIdentifier stateIdentifier = default(StateIdentifier), List<CommittedTransaction> transactions = default(List<CommittedTransaction>))
        {
            // to ensure "stateIdentifier" is required (not null)
            if (stateIdentifier == null)
            {
                throw new ArgumentNullException("stateIdentifier is a required property for CommittedTransactionsResponse and cannot be null");
            }
        ...
        /// </summary>
        /// <value>A committed transactions list starting from the &#x60;state_identifier&#x60;.</value>
