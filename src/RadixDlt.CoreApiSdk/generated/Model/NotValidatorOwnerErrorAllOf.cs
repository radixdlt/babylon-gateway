...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NotValidatorOwnerError_allOf")]
    public partial class NotValidatorOwnerErrorAllOf : IEquatable<NotValidatorOwnerErrorAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotValidatorOwnerErrorAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NotValidatorOwnerErrorAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NotValidatorOwnerErrorAllOf" /> class.
        /// </summary>
        /// <param name="owner">owner (required).</param>
        /// <param name="user">user (required).</param>
        public NotValidatorOwnerErrorAllOf(EntityIdentifier owner = default(EntityIdentifier), EntityIdentifier user = default(EntityIdentifier))
        {
            // to ensure "owner" is required (not null)
            if (owner == null)
            {
                throw new ArgumentNullException("owner is a required property for NotValidatorOwnerErrorAllOf and cannot be null");
            }
            this.Owner = owner;
            // to ensure "user" is required (not null)
            if (user == null)
            {
                throw new ArgumentNullException("user is a required property for NotValidatorOwnerErrorAllOf and cannot be null");
            }
            this.User = user;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NotValidatorOwnerErrorAllOf {\n");
        ...
        {
            return this.Equals(input as NotValidatorOwnerErrorAllOf);
        }

        /// <summary>
        /// Returns true if NotValidatorOwnerErrorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of NotValidatorOwnerErrorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotValidatorOwnerErrorAllOf input)
        {
            if (input == null)
            {
                return false;
