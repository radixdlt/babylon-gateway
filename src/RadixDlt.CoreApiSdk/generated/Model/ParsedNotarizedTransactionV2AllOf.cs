...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ParsedNotarizedTransactionV2_allOf")]
    public partial class ParsedNotarizedTransactionV2AllOf : IEquatable<ParsedNotarizedTransactionV2AllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParsedNotarizedTransactionV2AllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ParsedNotarizedTransactionV2AllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ParsedNotarizedTransactionV2AllOf" /> class.
        /// </summary>
        ...
        public ParsedNotarizedTransactionV2AllOf(NotarizedTransactionV2 notarizedTransaction = default(NotarizedTransactionV2), ParsedNotarizedTransactionIdentifiers identifiers = default(ParsedNotarizedTransactionIdentifiers), ParsedNotarizedTransactionAllOfValidationError validationError = default(ParsedNotarizedTransactionAllOfValidationError))
        {
            // to ensure "identifiers" is required (not null)
            if (identifiers == null)
            {
                throw new ArgumentNullException("identifiers is a required property for ParsedNotarizedTransactionV2AllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as ParsedNotarizedTransactionV2AllOf);
        }

        /// <summary>
        /// Returns true if ParsedNotarizedTransactionV2AllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ParsedNotarizedTransactionV2AllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParsedNotarizedTransactionV2AllOf input)
        {
            if (input == null)
            {
                return false;
