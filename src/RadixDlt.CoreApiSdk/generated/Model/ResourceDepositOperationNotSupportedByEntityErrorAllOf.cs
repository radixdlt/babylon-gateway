...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceDepositOperationNotSupportedByEntityError_allOf")]
    public partial class ResourceDepositOperationNotSupportedByEntityErrorAllOf : IEquatable<ResourceDepositOperationNotSupportedByEntityErrorAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceDepositOperationNotSupportedByEntityErrorAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceDepositOperationNotSupportedByEntityErrorAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceDepositOperationNotSupportedByEntityErrorAllOf" /> class.
        /// </summary>
        ...
        public ResourceDepositOperationNotSupportedByEntityErrorAllOf(EntityIdentifier entityIdentifier = default(EntityIdentifier), ResourceIdentifier resourceDepositNotSupported = default(ResourceIdentifier))
        {
            // to ensure "entityIdentifier" is required (not null)
            if (entityIdentifier == null)
            {
                throw new ArgumentNullException("entityIdentifier is a required property for ResourceDepositOperationNotSupportedByEntityErrorAllOf and cannot be null");
            }
            this.EntityIdentifier = entityIdentifier;
            // to ensure "resourceDepositNotSupported" is required (not null)
            if (resourceDepositNotSupported == null)
            {
                throw new ArgumentNullException("resourceDepositNotSupported is a required property for ResourceDepositOperationNotSupportedByEntityErrorAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceDepositOperationNotSupportedByEntityErrorAllOf {\n");
        ...
        {
            return this.Equals(input as ResourceDepositOperationNotSupportedByEntityErrorAllOf);
        }

        /// <summary>
        /// Returns true if ResourceDepositOperationNotSupportedByEntityErrorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceDepositOperationNotSupportedByEntityErrorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceDepositOperationNotSupportedByEntityErrorAllOf input)
        {
            if (input == null)
            {
                return false;
