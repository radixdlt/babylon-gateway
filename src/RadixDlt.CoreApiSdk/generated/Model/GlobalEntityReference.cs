...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class GlobalEntityReference : IEquatable<GlobalEntityReference>
    {
        /// <summary>
        ...
        public GlobalEntityReference(string globalAddressHex = default(string), string globalAddress = default(string), EntityReference entityReference = default(EntityReference))
        {
            ...
            {
                throw new ArgumentNullException("entityReference is a required property for GlobalEntityReference and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "entity_reference", IsRequired = true, EmitDefaultValue = true)]
