...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ObjectFieldStructure")]
    ...
    public partial class ObjectFieldStructure : SubstateSystemStructure, IEquatable<ObjectFieldStructure>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectFieldStructure" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ObjectFieldStructure() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectFieldStructure" /> class.
        /// </summary>
        /// <param name="valueSchema">valueSchema (required).</param>
        /// <param name="type">type (required) (default to SubstateSystemStructureType.ObjectField).</param>
        public ObjectFieldStructure(ObjectSubstateTypeReference valueSchema = default(ObjectSubstateTypeReference), SubstateSystemStructureType type = SubstateSystemStructureType.ObjectField) : base(type)
        {
            // to ensure "valueSchema" is required (not null)
            if (valueSchema == null)
            {
                throw new ArgumentNullException("valueSchema is a required property for ObjectFieldStructure and cannot be null");
            }
        ...
        {
            return this.Equals(input as ObjectFieldStructure);
        }

        /// <summary>
        /// Returns true if ObjectFieldStructure instances are equal
        /// </summary>
        /// <param name="input">Instance of ObjectFieldStructure to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ObjectFieldStructure input)
        {
            if (input == null)
            {
                return false;
