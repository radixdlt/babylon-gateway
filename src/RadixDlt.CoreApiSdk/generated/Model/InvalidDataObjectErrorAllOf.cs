...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InvalidDataObjectError_allOf")]
    public partial class InvalidDataObjectErrorAllOf : IEquatable<InvalidDataObjectErrorAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidDataObjectErrorAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvalidDataObjectErrorAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidDataObjectErrorAllOf" /> class.
        /// </summary>
        /// <param name="invalidDataObject">invalidDataObject (required).</param>
        /// <param name="message">message (required).</param>
        public InvalidDataObjectErrorAllOf(DataObject invalidDataObject = default(DataObject), string message = default(string))
        {
            // to ensure "invalidDataObject" is required (not null)
            if (invalidDataObject == null)
            {
                throw new ArgumentNullException("invalidDataObject is a required property for InvalidDataObjectErrorAllOf and cannot be null");
            }
            this.InvalidDataObject = invalidDataObject;
            // to ensure "message" is required (not null)
            if (message == null)
            {
                throw new ArgumentNullException("message is a required property for InvalidDataObjectErrorAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvalidDataObjectErrorAllOf {\n");
        ...
        {
            return this.Equals(input as InvalidDataObjectErrorAllOf);
        }

        /// <summary>
        /// Returns true if InvalidDataObjectErrorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidDataObjectErrorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidDataObjectErrorAllOf input)
        {
            if (input == null)
            {
                return false;
