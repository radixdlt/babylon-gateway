...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class KeyValueStoreEntrySubstate : Substate, IEquatable<KeyValueStoreEntrySubstate>
    {
        ...
        public KeyValueStoreEntrySubstate(string keyHex = default(string), bool isDeleted = default(bool), DataStruct dataStruct = default(DataStruct), SubstateType substateType = "KeyValueStoreEntrySubstate") : base(substateType)
        {
