...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class KeyValueStoreEntrySubstate : Substate, IEquatable<KeyValueStoreEntrySubstate>
    {
        ...
        /// <param name="substateType">substateType (required) (default to &quot;KeyValueStoreEntrySubstate&quot;).</param>
        public KeyValueStoreEntrySubstate(string keyHex = default(string), bool isDeleted = default(bool), DataStruct dataStruct = default(DataStruct), SubstateType substateType = Model.SubstateType.KeyValueStoreEntry) : base(substateType)
        {
