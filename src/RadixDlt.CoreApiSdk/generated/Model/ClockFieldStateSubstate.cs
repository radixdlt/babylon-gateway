...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ClockFieldStateSubstate")]
    ...
    public partial class ClockFieldStateSubstate : Substate, IEquatable<ClockFieldStateSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClockFieldStateSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClockFieldStateSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ClockFieldStateSubstate" /> class.
        /// </summary>
        /// <param name="timestampRoundedDownToMinute">timestampRoundedDownToMinute (required).</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.ClockFieldState).</param>
        public ClockFieldStateSubstate(Instant timestampRoundedDownToMinute = default(Instant), SubstateType substateType = SubstateType.ClockFieldState) : base(substateType)
        {
            // to ensure "timestampRoundedDownToMinute" is required (not null)
            if (timestampRoundedDownToMinute == null)
            {
                throw new ArgumentNullException("timestampRoundedDownToMinute is a required property for ClockFieldStateSubstate and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClockFieldStateSubstate {\n");
        ...
        {
            return this.Equals(input as ClockFieldStateSubstate);
        }

        /// <summary>
        /// Returns true if ClockFieldStateSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of ClockFieldStateSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClockFieldStateSubstate input)
        {
            if (input == null)
            {
                return false;
