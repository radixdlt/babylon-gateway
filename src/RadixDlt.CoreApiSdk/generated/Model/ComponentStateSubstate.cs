...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class ComponentStateSubstate : Substate, IEquatable<ComponentStateSubstate>
    {
        ...
        protected ComponentStateSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ComponentStateSubstate" /> class.
        /// </summary>
        /// <param name="dataStruct">dataStruct (required).</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.ComponentState).</param>
        public ComponentStateSubstate(DataStruct dataStruct = default(DataStruct), SubstateType substateType = SubstateType.ComponentState) : base(substateType)
        {
        ...
        {
            return this.Equals(input as ComponentStateSubstate);
        }

        /// <summary>
        /// Returns true if ComponentStateSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of ComponentStateSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComponentStateSubstate input)
        {
            if (input == null)
            {
                return false;
