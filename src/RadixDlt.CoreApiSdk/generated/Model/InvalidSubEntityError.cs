...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InvalidSubEntityError")]
    ...
    public partial class InvalidSubEntityError : CoreError, IEquatable<InvalidSubEntityError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidSubEntityError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvalidSubEntityError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidSubEntityError" /> class.
        /// </summary>
        /// <param name="invalidSubEntity">invalidSubEntity (required).</param>
        /// <param name="type">type (required) (default to &quot;InvalidSubEntityError&quot;).</param>
        public InvalidSubEntityError(SubEntity invalidSubEntity = default(SubEntity), string type = "InvalidSubEntityError") : base(type)
        {
            // to ensure "invalidSubEntity" is required (not null)
            if (invalidSubEntity == null)
            {
                throw new ArgumentNullException("invalidSubEntity is a required property for InvalidSubEntityError and cannot be null");
            }
            this.InvalidSubEntity = invalidSubEntity;
        }

        /// <summary>
        /// Gets or Sets InvalidSubEntity
        /// </summary>
        [DataMember(Name = "invalid_sub_entity", IsRequired = true, EmitDefaultValue = true)]
        public SubEntity InvalidSubEntity { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InvalidSubEntity: ").Append(InvalidSubEntity).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as InvalidSubEntityError);
        }

        /// <summary>
        /// Returns true if InvalidSubEntityError instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidSubEntityError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidSubEntityError input)
        {
            if (input == null)
            {
                return false;
            ...
            return base.Equals(input) && 
                (
                    this.InvalidSubEntity == input.InvalidSubEntity ||
                    (this.InvalidSubEntity != null &&
                    this.InvalidSubEntity.Equals(input.InvalidSubEntity))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InvalidSubEntity != null)
                {
                    hashCode = (hashCode * 59) + this.InvalidSubEntity.GetHashCode();
                }
                return hashCode;
            }
        }
