...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class PackageSubstate : IEquatable<PackageSubstate>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as PackageSubstate);
        }

        /// <summary>
        /// Returns true if PackageSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of PackageSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PackageSubstate input)
        {
            if (input == null)
            {
                return false;
