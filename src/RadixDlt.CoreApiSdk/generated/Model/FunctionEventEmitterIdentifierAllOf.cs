...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FunctionEventEmitterIdentifier_allOf")]
    public partial class FunctionEventEmitterIdentifierAllOf : IEquatable<FunctionEventEmitterIdentifierAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FunctionEventEmitterIdentifierAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FunctionEventEmitterIdentifierAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FunctionEventEmitterIdentifierAllOf" /> class.
        /// </summary>
        ...
        public FunctionEventEmitterIdentifierAllOf(string packageAddress = default(string), string blueprintName = default(string))
        {
            // to ensure "packageAddress" is required (not null)
            if (packageAddress == null)
            {
                throw new ArgumentNullException("packageAddress is a required property for FunctionEventEmitterIdentifierAllOf and cannot be null");
            }
            this.PackageAddress = packageAddress;
            // to ensure "blueprintName" is required (not null)
            if (blueprintName == null)
            {
                throw new ArgumentNullException("blueprintName is a required property for FunctionEventEmitterIdentifierAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as FunctionEventEmitterIdentifierAllOf);
        }

        /// <summary>
        /// Returns true if FunctionEventEmitterIdentifierAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of FunctionEventEmitterIdentifierAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FunctionEventEmitterIdentifierAllOf input)
        {
            if (input == null)
            {
                return false;
