...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConstructionDeriveRequestMetadataPreparedUnstakes")]
    ...
    public partial class ConstructionDeriveRequestMetadataPreparedUnstakes : ConstructionDeriveRequestMetadata, IEquatable<ConstructionDeriveRequestMetadataPreparedUnstakes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionDeriveRequestMetadataPreparedUnstakes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConstructionDeriveRequestMetadataPreparedUnstakes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionDeriveRequestMetadataPreparedUnstakes" /> class.
        /// </summary>
        /// <param name="type">type (required) (default to &quot;ConstructionDeriveRequestMetadataPreparedUnstakes&quot;).</param>
        public ConstructionDeriveRequestMetadataPreparedUnstakes(string type = "ConstructionDeriveRequestMetadataPreparedUnstakes") : base(type)
        {
        }
        ...
        {
            return this.Equals(input as ConstructionDeriveRequestMetadataPreparedUnstakes);
        }

        /// <summary>
        /// Returns true if ConstructionDeriveRequestMetadataPreparedUnstakes instances are equal
        /// </summary>
        /// <param name="input">Instance of ConstructionDeriveRequestMetadataPreparedUnstakes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConstructionDeriveRequestMetadataPreparedUnstakes input)
        {
            if (input == null)
            {
                return false;
