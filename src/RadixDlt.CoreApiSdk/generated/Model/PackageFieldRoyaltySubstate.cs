...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PackageFieldRoyaltySubstate")]
    ...
    public partial class PackageFieldRoyaltySubstate : Substate, IEquatable<PackageFieldRoyaltySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageFieldRoyaltySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PackageFieldRoyaltySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageFieldRoyaltySubstate" /> class.
        /// </summary>
        /// <param name="vaultEntity">vaultEntity.</param>
        /// <param name="blueprintRoyalties">blueprintRoyalties (required).</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.PackageFieldRoyalty).</param>
        public PackageFieldRoyaltySubstate(EntityReference vaultEntity = default(EntityReference), List<BlueprintRoyaltyConfig> blueprintRoyalties = default(List<BlueprintRoyaltyConfig>), SubstateType substateType = SubstateType.PackageFieldRoyalty) : base(substateType)
        {
            // to ensure "blueprintRoyalties" is required (not null)
            if (blueprintRoyalties == null)
            {
                throw new ArgumentNullException("blueprintRoyalties is a required property for PackageFieldRoyaltySubstate and cannot be null");
            }
        ...
        {
            return this.Equals(input as PackageFieldRoyaltySubstate);
        }

        /// <summary>
        /// Returns true if PackageFieldRoyaltySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of PackageFieldRoyaltySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PackageFieldRoyaltySubstate input)
        {
            if (input == null)
            {
                return false;
