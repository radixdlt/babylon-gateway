...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// ForkIdentifier
    /// </summary>
    [DataContract(Name = "ForkIdentifier")]
    public partial class ForkIdentifier : IEquatable<ForkIdentifier>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForkIdentifier" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ForkIdentifier() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ForkIdentifier" /> class.
        /// </summary>
        /// <param name="epoch">epoch (required).</param>
        /// <param name="fork">fork (required).</param>
        public ForkIdentifier(long epoch = default(long), string fork = default(string))
        {
            this.Epoch = epoch;
            // to ensure "fork" is required (not null)
            if (fork == null)
            {
                throw new ArgumentNullException("fork is a required property for ForkIdentifier and cannot be null");
            }
            this.Fork = fork;
        }
        ...
        /// Gets or Sets Fork
        /// </summary>
        [DataMember(Name = "fork", IsRequired = true, EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as ForkIdentifier);
        }

        /// <summary>
        /// Returns true if ForkIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of ForkIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForkIdentifier input)
        {
            if (input == null)
            {
                return false;
