...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BlueprintMethodRoyalty")]
    public partial class BlueprintMethodRoyalty : IEquatable<BlueprintMethodRoyalty>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BlueprintMethodRoyalty" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BlueprintMethodRoyalty() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BlueprintMethodRoyalty" /> class.
        /// </summary>
        /// <param name="methodName">methodName (required).</param>
        /// <param name="royaltyAmount">royaltyAmount.</param>
        public BlueprintMethodRoyalty(string methodName = default(string), RoyaltyAmount royaltyAmount = default(RoyaltyAmount))
        {
            // to ensure "methodName" is required (not null)
            if (methodName == null)
            {
                throw new ArgumentNullException("methodName is a required property for BlueprintMethodRoyalty and cannot be null");
            }
        ...
        {
            return this.Equals(input as BlueprintMethodRoyalty);
        }

        /// <summary>
        /// Returns true if BlueprintMethodRoyalty instances are equal
        /// </summary>
        /// <param name="input">Instance of BlueprintMethodRoyalty to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BlueprintMethodRoyalty input)
        {
            if (input == null)
            {
                return false;
