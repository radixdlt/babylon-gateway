...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConstructionDeriveRequestMetadataValidatorSystem")]
    ...
    public partial class ConstructionDeriveRequestMetadataValidatorSystem : ConstructionDeriveRequestMetadata, IEquatable<ConstructionDeriveRequestMetadataValidatorSystem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionDeriveRequestMetadataValidatorSystem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConstructionDeriveRequestMetadataValidatorSystem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionDeriveRequestMetadataValidatorSystem" /> class.
        /// </summary>
        /// <param name="type">type (required) (default to &quot;ConstructionDeriveRequestMetadataValidatorSystem&quot;).</param>
        public ConstructionDeriveRequestMetadataValidatorSystem(string type = "ConstructionDeriveRequestMetadataValidatorSystem") : base(type)
        {
        }
        ...
        {
            return this.Equals(input as ConstructionDeriveRequestMetadataValidatorSystem);
        }

        /// <summary>
        /// Returns true if ConstructionDeriveRequestMetadataValidatorSystem instances are equal
        /// </summary>
        /// <param name="input">Instance of ConstructionDeriveRequestMetadataValidatorSystem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConstructionDeriveRequestMetadataValidatorSystem input)
        {
            if (input == null)
            {
                return false;
