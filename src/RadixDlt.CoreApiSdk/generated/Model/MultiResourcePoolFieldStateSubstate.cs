...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MultiResourcePoolFieldStateSubstate")]
    ...
    public partial class MultiResourcePoolFieldStateSubstate : Substate, IEquatable<MultiResourcePoolFieldStateSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiResourcePoolFieldStateSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MultiResourcePoolFieldStateSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiResourcePoolFieldStateSubstate" /> class.
        /// </summary>
        ...
        /// <param name="substateType">substateType (required) (default to SubstateType.MultiResourcePoolFieldState).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public MultiResourcePoolFieldStateSubstate(List<PoolVault> vaults = default(List<PoolVault>), string poolUnitResourceAddress = default(string), SubstateType substateType = SubstateType.MultiResourcePoolFieldState, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "vaults" is required (not null)
            if (vaults == null)
            {
                throw new ArgumentNullException("vaults is a required property for MultiResourcePoolFieldStateSubstate and cannot be null");
            }
            this.Vaults = vaults;
            // to ensure "poolUnitResourceAddress" is required (not null)
            if (poolUnitResourceAddress == null)
            {
                throw new ArgumentNullException("poolUnitResourceAddress is a required property for MultiResourcePoolFieldStateSubstate and cannot be null");
            }
        ...
        {
            return this.Equals(input as MultiResourcePoolFieldStateSubstate);
        }

        /// <summary>
        /// Returns true if MultiResourcePoolFieldStateSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of MultiResourcePoolFieldStateSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MultiResourcePoolFieldStateSubstate input)
        {
            if (input == null)
            {
                return false;
