...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class MultiResourcePoolFieldStateSubstate : Substate, IEquatable<MultiResourcePoolFieldStateSubstate>
    {
        ...
        public MultiResourcePoolFieldStateSubstate(MultiResourcePoolFieldStateValue value = default(MultiResourcePoolFieldStateValue), SubstateType substateType = SubstateType.MultiResourcePoolFieldState, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for MultiResourcePoolFieldStateSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public MultiResourcePoolFieldStateValue Value { get; set; }
