...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NonFungibleResourceManagerFieldTotalSupplySubstate")]
    ...
    public partial class NonFungibleResourceManagerFieldTotalSupplySubstate : Substate, IEquatable<NonFungibleResourceManagerFieldTotalSupplySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NonFungibleResourceManagerFieldTotalSupplySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NonFungibleResourceManagerFieldTotalSupplySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NonFungibleResourceManagerFieldTotalSupplySubstate" /> class.
        /// </summary>
        ...
        public NonFungibleResourceManagerFieldTotalSupplySubstate(NonFungibleResourceManagerFieldTotalSupplyValue value = default(NonFungibleResourceManagerFieldTotalSupplyValue), SubstateType substateType = SubstateType.NonFungibleResourceManagerFieldTotalSupply, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for NonFungibleResourceManagerFieldTotalSupplySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public NonFungibleResourceManagerFieldTotalSupplyValue Value { get; set; }
        ...
        {
            return this.Equals(input as NonFungibleResourceManagerFieldTotalSupplySubstate);
        }

        /// <summary>
        /// Returns true if NonFungibleResourceManagerFieldTotalSupplySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of NonFungibleResourceManagerFieldTotalSupplySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NonFungibleResourceManagerFieldTotalSupplySubstate input)
        {
            if (input == null)
            {
                return false;
