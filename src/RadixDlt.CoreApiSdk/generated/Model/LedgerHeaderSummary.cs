...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class LedgerHeaderSummary : IEquatable<LedgerHeaderSummary>
    {
        ...
        public LedgerHeaderSummary(EpochRound epochRound = default(EpochRound), LedgerHashes ledgerHashes = default(LedgerHashes), InstantMs proposerTimestamp = default(InstantMs))
        {
