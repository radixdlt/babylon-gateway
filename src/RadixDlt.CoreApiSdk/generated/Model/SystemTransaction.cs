...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// SystemTransaction
    /// </summary>
    [DataContract(Name = "SystemTransaction")]
    public partial class SystemTransaction : IEquatable<SystemTransaction>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SystemTransaction);
        }

        /// <summary>
        /// Returns true if SystemTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemTransaction input)
        {
            if (input == null)
            {
                return false;
