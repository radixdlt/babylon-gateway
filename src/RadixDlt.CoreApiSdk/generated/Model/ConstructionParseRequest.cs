...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConstructionParseRequest")]
    public partial class ConstructionParseRequest : IEquatable<ConstructionParseRequest>, IValidatableObject
    {
        ...
        protected ConstructionParseRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionParseRequest" /> class.
        /// </summary>
        /// <param name="networkIdentifier">networkIdentifier (required).</param>
        /// <param name="transaction">Hex encoded transaction to parse. (required).</param>
        /// <param name="signed">Whether the transaction is signed or not. If not signed, parsing will skip authorization checks. (required).</param>
        public ConstructionParseRequest(NetworkIdentifier networkIdentifier = default(NetworkIdentifier), string transaction = default(string), bool signed = default(bool))
        {
            // to ensure "networkIdentifier" is required (not null)
            if (networkIdentifier == null)
            {
                throw new ArgumentNullException("networkIdentifier is a required property for ConstructionParseRequest and cannot be null");
            }
            this.NetworkIdentifier = networkIdentifier;
            // to ensure "transaction" is required (not null)
            if (transaction == null)
            {
                throw new ArgumentNullException("transaction is a required property for ConstructionParseRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Hex encoded transaction to parse.</value>
        ...
        /// </summary>
        /// <value>Whether the transaction is signed or not. If not signed, parsing will skip authorization checks.</value>
        [DataMember(Name = "signed", IsRequired = true, EmitDefaultValue = true)]
