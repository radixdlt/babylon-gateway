...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class RoundUpdateTransaction : IEquatable<RoundUpdateTransaction>
    {
        ...
        public RoundUpdateTransaction(Instant proposerTimestamp = default(Instant), long epoch = default(long), long roundInEpoch = default(long), LeaderProposalHistory leaderProposalHistory = default(LeaderProposalHistory))
        {
