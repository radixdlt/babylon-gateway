...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StatePackageResponse")]
    public partial class StatePackageResponse : IEquatable<StatePackageResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StatePackageResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StatePackageResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StatePackageResponse" /> class.
        /// </summary>
        ...
        public StatePackageResponse(LedgerStateSummary atLedgerState = default(LedgerStateSummary), Substate ownerRole = default(Substate), Substate royalty = default(Substate))
        {
            // to ensure "atLedgerState" is required (not null)
            if (atLedgerState == null)
            {
                throw new ArgumentNullException("atLedgerState is a required property for StatePackageResponse and cannot be null");
            }
            this.AtLedgerState = atLedgerState;
            // to ensure "ownerRole" is required (not null)
            if (ownerRole == null)
            {
                throw new ArgumentNullException("ownerRole is a required property for StatePackageResponse and cannot be null");
            }
        ...
        {
            return this.Equals(input as StatePackageResponse);
        }

        /// <summary>
        /// Returns true if StatePackageResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of StatePackageResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StatePackageResponse input)
        {
            if (input == null)
            {
                return false;
