...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConstructionFinalizeResponse")]
    public partial class ConstructionFinalizeResponse : IEquatable<ConstructionFinalizeResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionFinalizeResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConstructionFinalizeResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionFinalizeResponse" /> class.
        /// </summary>
        /// <param name="signedTransaction">Hex encoded signed transaction which can be submitted. (required).</param>
        public ConstructionFinalizeResponse(string signedTransaction = default(string))
        {
            // to ensure "signedTransaction" is required (not null)
            if (signedTransaction == null)
            {
                throw new ArgumentNullException("signedTransaction is a required property for ConstructionFinalizeResponse and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Hex encoded signed transaction which can be submitted.</value>
        ...
        {
            return this.Equals(input as ConstructionFinalizeResponse);
        }

        /// <summary>
        /// Returns true if ConstructionFinalizeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ConstructionFinalizeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConstructionFinalizeResponse input)
        {
            if (input == null)
            {
                return false;
