...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EngineStatusResponse")]
    public partial class EngineStatusResponse : IEquatable<EngineStatusResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EngineStatusResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EngineStatusResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EngineStatusResponse" /> class.
        /// </summary>
        /// <param name="engineStateIdentifier">engineStateIdentifier (required).</param>
        /// <param name="validatorSet">validatorSet (required).</param>
        public EngineStatusResponse(EngineStateIdentifier engineStateIdentifier = default(EngineStateIdentifier), List<Validator> validatorSet = default(List<Validator>))
        {
            // to ensure "engineStateIdentifier" is required (not null)
            if (engineStateIdentifier == null)
            {
                throw new ArgumentNullException("engineStateIdentifier is a required property for EngineStatusResponse and cannot be null");
            }
            this.EngineStateIdentifier = engineStateIdentifier;
            // to ensure "validatorSet" is required (not null)
            if (validatorSet == null)
            {
                throw new ArgumentNullException("validatorSet is a required property for EngineStatusResponse and cannot be null");
            }
        ...
        {
            return this.Equals(input as EngineStatusResponse);
        }

        /// <summary>
        /// Returns true if EngineStatusResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of EngineStatusResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EngineStatusResponse input)
        {
            if (input == null)
            {
                return false;
