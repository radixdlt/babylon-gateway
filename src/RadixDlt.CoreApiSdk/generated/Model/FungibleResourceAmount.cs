...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class FungibleResourceAmount : ResourceAmount, IEquatable<FungibleResourceAmount>
    {
        ...
        /// <param name="resourceType">resourceType (required) (default to &quot;FungibleResourceAmount&quot;).</param>
        /// <param name="resourceAddress">The Bech32m-encoded human readable version of the resource address (required).</param>
        public FungibleResourceAmount(string amount = default(string), ResourceType resourceType = "FungibleResourceAmount", string resourceAddress = default(string)) : base(resourceType, resourceAddress)
        {
