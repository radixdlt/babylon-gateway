...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProtocolUpdateStatusModuleFieldSummarySubstate")]
    ...
    public partial class ProtocolUpdateStatusModuleFieldSummarySubstate : Substate, IEquatable<ProtocolUpdateStatusModuleFieldSummarySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProtocolUpdateStatusModuleFieldSummarySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProtocolUpdateStatusModuleFieldSummarySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProtocolUpdateStatusModuleFieldSummarySubstate" /> class.
        /// </summary>
        /// <param name="protocolVersion">protocolVersion (required).</param>
        /// <param name="updateStatus">updateStatus (required).</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.ProtocolUpdateStatusModuleFieldSummary).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public ProtocolUpdateStatusModuleFieldSummarySubstate(string protocolVersion = default(string), ProtocolUpdateStatus updateStatus = default(ProtocolUpdateStatus), SubstateType substateType = SubstateType.ProtocolUpdateStatusModuleFieldSummary, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "protocolVersion" is required (not null)
            if (protocolVersion == null)
            {
                throw new ArgumentNullException("protocolVersion is a required property for ProtocolUpdateStatusModuleFieldSummarySubstate and cannot be null");
            }
            this.ProtocolVersion = protocolVersion;
            // to ensure "updateStatus" is required (not null)
            if (updateStatus == null)
            {
                throw new ArgumentNullException("updateStatus is a required property for ProtocolUpdateStatusModuleFieldSummarySubstate and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "protocol_version", IsRequired = true, EmitDefaultValue = true)]
        public string ProtocolVersion { get; set; }

        /// <summary>
        /// Gets or Sets UpdateStatus
        /// </summary>
        [DataMember(Name = "update_status", IsRequired = true, EmitDefaultValue = true)]
        public ProtocolUpdateStatus UpdateStatus { get; set; }
        ...
        {
            return this.Equals(input as ProtocolUpdateStatusModuleFieldSummarySubstate);
        }

        /// <summary>
        /// Returns true if ProtocolUpdateStatusModuleFieldSummarySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of ProtocolUpdateStatusModuleFieldSummarySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProtocolUpdateStatusModuleFieldSummarySubstate input)
        {
            if (input == null)
            {
                return false;
