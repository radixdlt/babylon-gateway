...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// TokenDataAllOf
    /// </summary>
    [DataContract(Name = "TokenData_allOf")]
    public partial class TokenDataAllOf : IEquatable<TokenDataAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenDataAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TokenDataAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenDataAllOf" /> class.
        /// </summary>
        ...
        public TokenDataAllOf(string granularity = default(string), bool isMutable = default(bool), EntityIdentifier owner = default(EntityIdentifier))
        {
            // to ensure "granularity" is required (not null)
            if (granularity == null)
            {
                throw new ArgumentNullException("granularity is a required property for TokenDataAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TokenDataAllOf {\n");
        ...
        {
            return this.Equals(input as TokenDataAllOf);
        }

        /// <summary>
        /// Returns true if TokenDataAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenDataAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenDataAllOf input)
        {
            if (input == null)
            {
                return false;
