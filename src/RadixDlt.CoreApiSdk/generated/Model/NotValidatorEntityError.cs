...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NotValidatorEntityError")]
    ...
    public partial class NotValidatorEntityError : CoreError, IEquatable<NotValidatorEntityError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotValidatorEntityError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NotValidatorEntityError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NotValidatorEntityError" /> class.
        /// </summary>
        /// <param name="entity">entity (required).</param>
        /// <param name="type">type (required) (default to &quot;NotValidatorEntityError&quot;).</param>
        public NotValidatorEntityError(EntityIdentifier entity = default(EntityIdentifier), string type = "NotValidatorEntityError") : base(type)
        {
            // to ensure "entity" is required (not null)
            if (entity == null)
            {
                throw new ArgumentNullException("entity is a required property for NotValidatorEntityError and cannot be null");
            }
            this.Entity = entity;
        }
        ...
        public EntityIdentifier Entity { get; set; }
        ...
        {
            return this.Equals(input as NotValidatorEntityError);
        }

        /// <summary>
        /// Returns true if NotValidatorEntityError instances are equal
        /// </summary>
        /// <param name="input">Instance of NotValidatorEntityError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotValidatorEntityError input)
        {
            if (input == null)
            {
                return false;
