...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class EntityIdentifier : IEquatable<EntityIdentifier>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="EntityIdentifier" /> class.
        /// </summary>
        /// <param name="address">The top level identifier for an entity. (required).</param>
        /// <param name="subEntity">subEntity.</param>
        public EntityIdentifier(string address = default(string), SubEntity subEntity = default(SubEntity))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for EntityIdentifier and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The top level identifier for an entity.</value>
        [DataMember(Name = "address", IsRequired = true, EmitDefaultValue = true)]
        public string Address { get; set; }

        /// <summary>
        /// Gets or Sets SubEntity
        /// </summary>
        [DataMember(Name = "sub_entity", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SubEntity: ").Append(SubEntity).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(EntityIdentifier input)
        {
            ...
            return 
                ...
                (
                    this.SubEntity == input.SubEntity ||
                    (this.SubEntity != null &&
                    this.SubEntity.Equals(input.SubEntity))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.SubEntity.GetHashCode();
                }
                return hashCode;
            }
        }
