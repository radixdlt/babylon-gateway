...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionTrackerFieldStateSubstate")]
    ...
    public partial class TransactionTrackerFieldStateSubstate : Substate, IEquatable<TransactionTrackerFieldStateSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionTrackerFieldStateSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionTrackerFieldStateSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionTrackerFieldStateSubstate" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TransactionTrackerFieldStateSubstate);
        }

        /// <summary>
        /// Returns true if TransactionTrackerFieldStateSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionTrackerFieldStateSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionTrackerFieldStateSubstate input)
        {
            if (input == null)
            {
                return false;
