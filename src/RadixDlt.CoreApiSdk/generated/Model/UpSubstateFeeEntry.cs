...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// UpSubstateFeeEntry
    /// </summary>
    [DataContract(Name = "UpSubstateFeeEntry")]
    public partial class UpSubstateFeeEntry : IEquatable<UpSubstateFeeEntry>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpSubstateFeeEntry" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpSubstateFeeEntry() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpSubstateFeeEntry" /> class.
        /// </summary>
        /// <param name="substateTypeIdentifier">substateTypeIdentifier (required).</param>
        /// <param name="fee">fee (required).</param>
        public UpSubstateFeeEntry(SubstateTypeIdentifier substateTypeIdentifier = default(SubstateTypeIdentifier), ResourceAmount fee = default(ResourceAmount))
        {
            // to ensure "substateTypeIdentifier" is required (not null)
            if (substateTypeIdentifier == null)
            {
                throw new ArgumentNullException("substateTypeIdentifier is a required property for UpSubstateFeeEntry and cannot be null");
            }
            this.SubstateTypeIdentifier = substateTypeIdentifier;
            // to ensure "fee" is required (not null)
            if (fee == null)
            {
                throw new ArgumentNullException("fee is a required property for UpSubstateFeeEntry and cannot be null");
            }
            this.Fee = fee;
        }

        /// <summary>
        /// Gets or Sets SubstateTypeIdentifier
        /// </summary>
        [DataMember(Name = "substate_type_identifier", IsRequired = true, EmitDefaultValue = true)]
        public SubstateTypeIdentifier SubstateTypeIdentifier { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SubstateTypeIdentifier: ").Append(SubstateTypeIdentifier).Append("\n");
        ...
        {
            return this.Equals(input as UpSubstateFeeEntry);
        }

        /// <summary>
        /// Returns true if UpSubstateFeeEntry instances are equal
        /// </summary>
        /// <param name="input">Instance of UpSubstateFeeEntry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpSubstateFeeEntry input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.SubstateTypeIdentifier == input.SubstateTypeIdentifier ||
                    (this.SubstateTypeIdentifier != null &&
                    this.SubstateTypeIdentifier.Equals(input.SubstateTypeIdentifier))
                ) && 
                (
                    this.Fee == input.Fee ||
                    (this.Fee != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.SubstateTypeIdentifier != null)
                {
                    hashCode = (hashCode * 59) + this.SubstateTypeIdentifier.GetHashCode();
                }
                if (this.Fee != null)
                {
