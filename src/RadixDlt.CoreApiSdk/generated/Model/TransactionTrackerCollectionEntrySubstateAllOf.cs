...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class TransactionTrackerCollectionEntrySubstateAllOf : IEquatable<TransactionTrackerCollectionEntrySubstateAllOf>
    {
        ...
        protected TransactionTrackerCollectionEntrySubstateAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionTrackerCollectionEntrySubstateAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TransactionTrackerCollectionEntrySubstateAllOf);
        }

        /// <summary>
        /// Returns true if TransactionTrackerCollectionEntrySubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionTrackerCollectionEntrySubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionTrackerCollectionEntrySubstateAllOf input)
        {
            if (input == null)
            {
                return false;
