...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UnclaimedRadixEngineAddress")]
    ...
    public partial class UnclaimedRadixEngineAddress : DataObject, IEquatable<UnclaimedRadixEngineAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnclaimedRadixEngineAddress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UnclaimedRadixEngineAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UnclaimedRadixEngineAddress" /> class.
        /// </summary>
        /// <param name="type">The type of the data object. Each address may own up to one current object of a given type. (required) (default to &quot;UnclaimedRadixEngineAddress&quot;).</param>
        public UnclaimedRadixEngineAddress(string type = "UnclaimedRadixEngineAddress") : base(type)
        {
        }
        ...
        {
            return this.Equals(input as UnclaimedRadixEngineAddress);
        }

        /// <summary>
        /// Returns true if UnclaimedRadixEngineAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of UnclaimedRadixEngineAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnclaimedRadixEngineAddress input)
        {
            if (input == null)
            {
                return false;
