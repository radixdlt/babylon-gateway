...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PackageFieldFunctionAccessRulesSubstate_allOf")]
    public partial class PackageFieldFunctionAccessRulesSubstateAllOf : IEquatable<PackageFieldFunctionAccessRulesSubstateAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageFieldFunctionAccessRulesSubstateAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PackageFieldFunctionAccessRulesSubstateAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageFieldFunctionAccessRulesSubstateAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PackageFieldFunctionAccessRulesSubstateAllOf);
        }

        /// <summary>
        /// Returns true if PackageFieldFunctionAccessRulesSubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PackageFieldFunctionAccessRulesSubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PackageFieldFunctionAccessRulesSubstateAllOf input)
        {
            if (input == null)
            {
                return false;
