...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TwoResourcePoolSubstate")]
    ...
    public partial class TwoResourcePoolSubstate : Substate, IEquatable<TwoResourcePoolSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TwoResourcePoolSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TwoResourcePoolSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TwoResourcePoolSubstate" /> class.
        /// </summary>
        ...
        /// <param name="substateType">substateType (required) (default to SubstateType.TwoResourcePool).</param>
        public TwoResourcePoolSubstate(List<PoolVault> vaults = default(List<PoolVault>), string poolUnitResourceAddress = default(string), SubstateType substateType = SubstateType.TwoResourcePool) : base(substateType)
        {
            // to ensure "vaults" is required (not null)
            if (vaults == null)
            {
                throw new ArgumentNullException("vaults is a required property for TwoResourcePoolSubstate and cannot be null");
            }
            this.Vaults = vaults;
            // to ensure "poolUnitResourceAddress" is required (not null)
            if (poolUnitResourceAddress == null)
            {
                throw new ArgumentNullException("poolUnitResourceAddress is a required property for TwoResourcePoolSubstate and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TwoResourcePoolSubstate {\n");
        ...
        {
            return this.Equals(input as TwoResourcePoolSubstate);
        }

        /// <summary>
        /// Returns true if TwoResourcePoolSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of TwoResourcePoolSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TwoResourcePoolSubstate input)
        {
            if (input == null)
            {
                return false;
