...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LtsStreamTransactionsBasicOutcomesResponse")]
    public partial class LtsStreamTransactionsBasicOutcomesResponse : IEquatable<LtsStreamTransactionsBasicOutcomesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LtsStreamTransactionsBasicOutcomesResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LtsStreamTransactionsBasicOutcomesResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LtsStreamTransactionsBasicOutcomesResponse" /> class.
        /// </summary>
        ...
        public LtsStreamTransactionsBasicOutcomesResponse(long fromStateVersion = default(long), int count = default(int), long maxLedgerStateVersion = default(long), List<LtsCommittedTransactionOutcome> committedTransactionOutcomes = default(List<LtsCommittedTransactionOutcome>))
        {
            ...
            {
                throw new ArgumentNullException("committedTransactionOutcomes is a required property for LtsStreamTransactionsBasicOutcomesResponse and cannot be null");
            }
        ...
        {
            return this.Equals(input as LtsStreamTransactionsBasicOutcomesResponse);
        }

        /// <summary>
        /// Returns true if LtsStreamTransactionsBasicOutcomesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of LtsStreamTransactionsBasicOutcomesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LtsStreamTransactionsBasicOutcomesResponse input)
        {
            if (input == null)
            {
                return false;
