...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NetworkNotSupportedError_allOf")]
    public partial class NetworkNotSupportedErrorAllOf : IEquatable<NetworkNotSupportedErrorAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NetworkNotSupportedErrorAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NetworkNotSupportedErrorAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NetworkNotSupportedErrorAllOf" /> class.
        /// </summary>
        /// <param name="supportedNetworks">supportedNetworks (required).</param>
        public NetworkNotSupportedErrorAllOf(List<NetworkIdentifier> supportedNetworks = default(List<NetworkIdentifier>))
        {
            // to ensure "supportedNetworks" is required (not null)
            if (supportedNetworks == null)
            {
                throw new ArgumentNullException("supportedNetworks is a required property for NetworkNotSupportedErrorAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as NetworkNotSupportedErrorAllOf);
        }

        /// <summary>
        /// Returns true if NetworkNotSupportedErrorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of NetworkNotSupportedErrorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NetworkNotSupportedErrorAllOf input)
        {
            if (input == null)
            {
                return false;
