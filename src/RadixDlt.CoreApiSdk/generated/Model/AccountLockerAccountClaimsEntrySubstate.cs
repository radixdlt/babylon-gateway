...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountLockerAccountClaimsEntrySubstate")]
    ...
    public partial class AccountLockerAccountClaimsEntrySubstate : Substate, IEquatable<AccountLockerAccountClaimsEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountLockerAccountClaimsEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountLockerAccountClaimsEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountLockerAccountClaimsEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.AccountLockerAccountClaimsEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public AccountLockerAccountClaimsEntrySubstate(AccountAddressKey key = default(AccountAddressKey), AccountLockerAccountClaimsEntryValue value = default(AccountLockerAccountClaimsEntryValue), SubstateType substateType = SubstateType.AccountLockerAccountClaimsEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for AccountLockerAccountClaimsEntrySubstate and cannot be null");
            }
            this.Key = key;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for AccountLockerAccountClaimsEntrySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public AccountAddressKey Key { get; set; }

        /// <summary>
        /// Gets or Sets Value
        /// </summary>
        [DataMember(Name = "value", IsRequired = true, EmitDefaultValue = true)]
        public AccountLockerAccountClaimsEntryValue Value { get; set; }
        ...
        {
            return this.Equals(input as AccountLockerAccountClaimsEntrySubstate);
        }

        /// <summary>
        /// Returns true if AccountLockerAccountClaimsEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountLockerAccountClaimsEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountLockerAccountClaimsEntrySubstate input)
        {
            if (input == null)
            {
                return false;
