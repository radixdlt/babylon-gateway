...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NonFungibleResourceManagerFieldMutableFieldsValue")]
    public partial class NonFungibleResourceManagerFieldMutableFieldsValue : IEquatable<NonFungibleResourceManagerFieldMutableFieldsValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NonFungibleResourceManagerFieldMutableFieldsValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NonFungibleResourceManagerFieldMutableFieldsValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NonFungibleResourceManagerFieldMutableFieldsValue" /> class.
        /// </summary>
        ...
        public NonFungibleResourceManagerFieldMutableFieldsValue(List<MutableField> mutableFields = default(List<MutableField>))
        {
            ...
            {
                throw new ArgumentNullException("mutableFields is a required property for NonFungibleResourceManagerFieldMutableFieldsValue and cannot be null");
            }
        ...
        {
            return this.Equals(input as NonFungibleResourceManagerFieldMutableFieldsValue);
        }

        /// <summary>
        /// Returns true if NonFungibleResourceManagerFieldMutableFieldsValue instances are equal
        /// </summary>
        /// <param name="input">Instance of NonFungibleResourceManagerFieldMutableFieldsValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NonFungibleResourceManagerFieldMutableFieldsValue input)
        {
            if (input == null)
            {
                return false;
