...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccessControllerFieldStateSubstate")]
    ...
    public partial class AccessControllerFieldStateSubstate : Substate, IEquatable<AccessControllerFieldStateSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccessControllerFieldStateSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccessControllerFieldStateSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccessControllerFieldStateSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.AccessControllerFieldState).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public AccessControllerFieldStateSubstate(AccessControllerFieldStateValue value = default(AccessControllerFieldStateValue), SubstateType substateType = SubstateType.AccessControllerFieldState, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for AccessControllerFieldStateSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as AccessControllerFieldStateSubstate);
        }

        /// <summary>
        /// Returns true if AccessControllerFieldStateSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of AccessControllerFieldStateSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccessControllerFieldStateSubstate input)
        {
            if (input == null)
            {
                return false;
