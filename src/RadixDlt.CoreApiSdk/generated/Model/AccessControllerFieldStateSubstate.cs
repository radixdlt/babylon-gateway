...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class AccessControllerFieldStateSubstate : Substate, IEquatable<AccessControllerFieldStateSubstate>
    {
        ...
        public AccessControllerFieldStateSubstate(DataStruct dataStruct = default(DataStruct), SubstateType substateType = SubstateType.AccessControllerFieldState, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "dataStruct" is required (not null)
            if (dataStruct == null)
            {
                throw new ArgumentNullException("dataStruct is a required property for AccessControllerFieldStateSubstate and cannot be null");
            }
