...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PreparedValidatorRegistered_allOf")]
    public partial class PreparedValidatorRegisteredAllOf : IEquatable<PreparedValidatorRegisteredAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PreparedValidatorRegisteredAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PreparedValidatorRegisteredAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PreparedValidatorRegisteredAllOf" /> class.
        /// </summary>
        /// <param name="registered">The registered flag of the validator which will be updated by the end of &#x60;epoch&#x60;. (required).</param>
        /// <param name="epoch">epoch.</param>
        public PreparedValidatorRegisteredAllOf(bool registered = default(bool), long epoch = default(long))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PreparedValidatorRegisteredAllOf {\n");
        ...
        {
            return this.Equals(input as PreparedValidatorRegisteredAllOf);
        }

        /// <summary>
        /// Returns true if PreparedValidatorRegisteredAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PreparedValidatorRegisteredAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreparedValidatorRegisteredAllOf input)
        {
            if (input == null)
            {
                return false;
