...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class EpochData : DataObject, IEquatable<EpochData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EpochData" /> class.
        /// </summary>
        ...
        /// <param name="type">The type of the data object. Each address may own up to one current object of a given type. (required) (default to &quot;EpochData&quot;).</param>
        public EpochData(long epoch = default(long), string type = "EpochData") : base(type)
        {
            this.Epoch = epoch;
        }
        ...
        {
            return this.Equals(input as EpochData);
        }

        /// <summary>
        /// Returns true if EpochData instances are equal
        /// </summary>
        /// <param name="input">Instance of EpochData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EpochData input)
        {
            if (input == null)
            {
                return false;
