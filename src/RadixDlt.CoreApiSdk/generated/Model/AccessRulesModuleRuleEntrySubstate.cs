...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccessRulesModuleRuleEntrySubstate")]
    ...
    public partial class AccessRulesModuleRuleEntrySubstate : Substate, IEquatable<AccessRulesModuleRuleEntrySubstate>
    {
        ...
        protected AccessRulesModuleRuleEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccessRulesModuleRuleEntrySubstate" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AccessRulesModuleRuleEntrySubstate);
        }

        /// <summary>
        /// Returns true if AccessRulesModuleRuleEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of AccessRulesModuleRuleEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccessRulesModuleRuleEntrySubstate input)
        {
            if (input == null)
            {
                return false;
