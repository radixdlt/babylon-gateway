...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FullyScopedTypeId")]
    public partial class FullyScopedTypeId : IEquatable<FullyScopedTypeId>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FullyScopedTypeId" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FullyScopedTypeId() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FullyScopedTypeId" /> class.
        /// </summary>
        ...
        public FullyScopedTypeId(string entityAddress = default(string), string schemaHash = default(string), LocalTypeId localTypeId = default(LocalTypeId))
        {
            // to ensure "entityAddress" is required (not null)
            if (entityAddress == null)
            {
                throw new ArgumentNullException("entityAddress is a required property for FullyScopedTypeId and cannot be null");
            }
            this.EntityAddress = entityAddress;
            // to ensure "schemaHash" is required (not null)
            if (schemaHash == null)
            {
                throw new ArgumentNullException("schemaHash is a required property for FullyScopedTypeId and cannot be null");
            }
            this.SchemaHash = schemaHash;
            // to ensure "localTypeId" is required (not null)
            if (localTypeId == null)
            {
                throw new ArgumentNullException("localTypeId is a required property for FullyScopedTypeId and cannot be null");
            }
        ...
        {
            return this.Equals(input as FullyScopedTypeId);
        }

        /// <summary>
        /// Returns true if FullyScopedTypeId instances are equal
        /// </summary>
        /// <param name="input">Instance of FullyScopedTypeId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FullyScopedTypeId input)
        {
            if (input == null)
            {
                return false;
