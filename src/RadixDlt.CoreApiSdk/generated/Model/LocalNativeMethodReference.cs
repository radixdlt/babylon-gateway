...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class LocalNativeMethodReference : IEquatable<LocalNativeMethodReference>, IValidatableObject
    {
        ...
        public LocalNativeMethodReference(LocalMethodReferenceType type = default(LocalMethodReferenceType), string name = default(string))
        {
            this.Type = type;
