...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DataObjectNotSupportedByEntityError")]
    ...
    public partial class DataObjectNotSupportedByEntityError : CoreError, IEquatable<DataObjectNotSupportedByEntityError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DataObjectNotSupportedByEntityError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DataObjectNotSupportedByEntityError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DataObjectNotSupportedByEntityError" /> class.
        /// </summary>
        ...
        /// <param name="type">type (required) (default to &quot;DataObjectNotSupportedByEntityError&quot;).</param>
        public DataObjectNotSupportedByEntityError(EntityIdentifier entityIdentifier = default(EntityIdentifier), DataObject dataObjectNotSupported = default(DataObject), string type = "DataObjectNotSupportedByEntityError") : base(type)
        {
            // to ensure "entityIdentifier" is required (not null)
            if (entityIdentifier == null)
            {
                throw new ArgumentNullException("entityIdentifier is a required property for DataObjectNotSupportedByEntityError and cannot be null");
            }
            this.EntityIdentifier = entityIdentifier;
            // to ensure "dataObjectNotSupported" is required (not null)
            if (dataObjectNotSupported == null)
            {
                throw new ArgumentNullException("dataObjectNotSupported is a required property for DataObjectNotSupportedByEntityError and cannot be null");
            }
        ...
        {
            return this.Equals(input as DataObjectNotSupportedByEntityError);
        }

        /// <summary>
        /// Returns true if DataObjectNotSupportedByEntityError instances are equal
        /// </summary>
        /// <param name="input">Instance of DataObjectNotSupportedByEntityError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataObjectNotSupportedByEntityError input)
        {
            if (input == null)
            {
                return false;
