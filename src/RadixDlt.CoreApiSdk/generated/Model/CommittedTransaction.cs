...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class CommittedTransaction : IEquatable<CommittedTransaction>, IValidatableObject
    {
        ...
        /// <param name="committedStateIdentifier">committedStateIdentifier (required).</param>
        ...
        public CommittedTransaction(TransactionIdentifier transactionIdentifier = default(TransactionIdentifier), StateIdentifier committedStateIdentifier = default(StateIdentifier), List<OperationGroup> operationGroups = default(List<OperationGroup>), CommittedTransactionMetadata metadata = default(CommittedTransactionMetadata))
        {
            // to ensure "transactionIdentifier" is required (not null)
            if (transactionIdentifier == null)
            {
                throw new ArgumentNullException("transactionIdentifier is a required property for CommittedTransaction and cannot be null");
            }
            this.TransactionIdentifier = transactionIdentifier;
            // to ensure "committedStateIdentifier" is required (not null)
            if (committedStateIdentifier == null)
            {
                throw new ArgumentNullException("committedStateIdentifier is a required property for CommittedTransaction and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("operationGroups is a required property for CommittedTransaction and cannot be null");
            }
            this.OperationGroups = operationGroups;
            // to ensure "metadata" is required (not null)
            if (metadata == null)
            {
                throw new ArgumentNullException("metadata is a required property for CommittedTransaction and cannot be null");
            }
        ...
        /// <summary>
        /// Gets or Sets CommittedStateIdentifier
        /// </summary>
        [DataMember(Name = "committed_state_identifier", IsRequired = true, EmitDefaultValue = true)]
        public StateIdentifier CommittedStateIdentifier { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CommittedStateIdentifier: ").Append(CommittedStateIdentifier).Append("\n");
        ...
        public bool Equals(CommittedTransaction input)
        {
            ...
            return 
                ...
                (
                    this.CommittedStateIdentifier == input.CommittedStateIdentifier ||
                    (this.CommittedStateIdentifier != null &&
                    this.CommittedStateIdentifier.Equals(input.CommittedStateIdentifier))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CommittedStateIdentifier != null)
                {
                    hashCode = (hashCode * 59) + this.CommittedStateIdentifier.GetHashCode();
                }
