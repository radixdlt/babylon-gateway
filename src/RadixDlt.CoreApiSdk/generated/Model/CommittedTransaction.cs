...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class CommittedTransaction : IEquatable<CommittedTransaction>, IValidatableObject
    {
        ...
        public CommittedTransaction(string stateVersion = default(string), NotarizedTransaction notarizedTransaction = default(NotarizedTransaction), TransactionReceipt receipt = default(TransactionReceipt))
        {
            // to ensure "stateVersion" is required (not null)
            if (stateVersion == null)
            {
                throw new ArgumentNullException("stateVersion is a required property for CommittedTransaction and cannot be null");
            }
