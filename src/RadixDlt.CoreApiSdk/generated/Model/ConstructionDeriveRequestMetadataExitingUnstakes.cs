...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConstructionDeriveRequestMetadataExitingUnstakes")]
    ...
    public partial class ConstructionDeriveRequestMetadataExitingUnstakes : ConstructionDeriveRequestMetadata, IEquatable<ConstructionDeriveRequestMetadataExitingUnstakes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionDeriveRequestMetadataExitingUnstakes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConstructionDeriveRequestMetadataExitingUnstakes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionDeriveRequestMetadataExitingUnstakes" /> class.
        /// </summary>
        /// <param name="validator">validator (required).</param>
        /// <param name="epochUnlock">epochUnlock (required).</param>
        /// <param name="type">type (required) (default to &quot;ConstructionDeriveRequestMetadataExitingUnstakes&quot;).</param>
        public ConstructionDeriveRequestMetadataExitingUnstakes(EntityIdentifier validator = default(EntityIdentifier), long epochUnlock = default(long), string type = "ConstructionDeriveRequestMetadataExitingUnstakes") : base(type)
        {
            // to ensure "validator" is required (not null)
            if (validator == null)
            {
                throw new ArgumentNullException("validator is a required property for ConstructionDeriveRequestMetadataExitingUnstakes and cannot be null");
            }
        ...
        /// <summary>
        /// Gets or Sets EpochUnlock
        /// </summary>
        [DataMember(Name = "epoch_unlock", IsRequired = true, EmitDefaultValue = true)]
        public long EpochUnlock { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EpochUnlock: ").Append(EpochUnlock).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ConstructionDeriveRequestMetadataExitingUnstakes);
        }

        /// <summary>
        /// Returns true if ConstructionDeriveRequestMetadataExitingUnstakes instances are equal
        /// </summary>
        /// <param name="input">Instance of ConstructionDeriveRequestMetadataExitingUnstakes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConstructionDeriveRequestMetadataExitingUnstakes input)
        {
            if (input == null)
            {
                return false;
            ...
            return base.Equals(input) && 
                ...
                (
                    this.EpochUnlock == input.EpochUnlock ||
                    this.EpochUnlock.Equals(input.EpochUnlock)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.EpochUnlock.GetHashCode();
                return hashCode;
            }
        }
