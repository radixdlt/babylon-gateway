...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// RoundDataAllOf
    /// </summary>
    [DataContract(Name = "RoundData_allOf")]
    public partial class RoundDataAllOf : IEquatable<RoundDataAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoundDataAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RoundDataAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RoundDataAllOf" /> class.
        /// </summary>
        /// <param name="round">round (required).</param>
        /// <param name="timestamp">timestamp (required).</param>
        public RoundDataAllOf(long round = default(long), long timestamp = default(long))
        {
            this.Round = round;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RoundDataAllOf {\n");
        ...
        {
            return this.Equals(input as RoundDataAllOf);
        }

        /// <summary>
        /// Returns true if RoundDataAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of RoundDataAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoundDataAllOf input)
        {
            if (input == null)
            {
                return false;
