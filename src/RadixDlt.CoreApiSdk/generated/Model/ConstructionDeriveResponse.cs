...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConstructionDeriveResponse")]
    public partial class ConstructionDeriveResponse : IEquatable<ConstructionDeriveResponse>, IValidatableObject
    {
        ...
        protected ConstructionDeriveResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionDeriveResponse" /> class.
        /// </summary>
        /// <param name="entityIdentifier">entityIdentifier (required).</param>
        public ConstructionDeriveResponse(EntityIdentifier entityIdentifier = default(EntityIdentifier))
        {
            // to ensure "entityIdentifier" is required (not null)
            if (entityIdentifier == null)
            {
                throw new ArgumentNullException("entityIdentifier is a required property for ConstructionDeriveResponse and cannot be null");
            }
