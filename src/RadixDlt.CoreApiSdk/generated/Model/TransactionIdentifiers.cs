...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class TransactionIdentifiers : IEquatable<TransactionIdentifiers>
    {
        /// <summary>
        ...
        public TransactionIdentifiers(string intentHash = default(string), string intentHashBech32m = default(string), string signedIntentHash = default(string), string signedIntentHashBech32m = default(string), string payloadHash = default(string), string payloadHashBech32m = default(string))
        {
            ...
            {
                throw new ArgumentNullException("intentHashBech32m is a required property for TransactionIdentifiers and cannot be null");
            }
            this.IntentHashBech32m = intentHashBech32m;
            // to ensure "signedIntentHash" is required (not null)
            if (signedIntentHash == null)
            {
                throw new ArgumentNullException("signedIntentHash is a required property for TransactionIdentifiers and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("signedIntentHashBech32m is a required property for TransactionIdentifiers and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("payloadHashBech32m is a required property for TransactionIdentifiers and cannot be null");
            }
