...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StateFungibleResourceManager_allOf")]
    public partial class StateFungibleResourceManagerAllOf : IEquatable<StateFungibleResourceManagerAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StateFungibleResourceManagerAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StateFungibleResourceManagerAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StateFungibleResourceManagerAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as StateFungibleResourceManagerAllOf);
        }

        /// <summary>
        /// Returns true if StateFungibleResourceManagerAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of StateFungibleResourceManagerAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StateFungibleResourceManagerAllOf input)
        {
            if (input == null)
            {
                return false;
