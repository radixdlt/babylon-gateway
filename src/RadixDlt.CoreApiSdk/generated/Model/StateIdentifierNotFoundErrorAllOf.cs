...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StateIdentifierNotFoundError_allOf")]
    public partial class StateIdentifierNotFoundErrorAllOf : IEquatable<StateIdentifierNotFoundErrorAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StateIdentifierNotFoundErrorAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StateIdentifierNotFoundErrorAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StateIdentifierNotFoundErrorAllOf" /> class.
        /// </summary>
        /// <param name="stateIdentifier">stateIdentifier (required).</param>
        public StateIdentifierNotFoundErrorAllOf(PartialStateIdentifier stateIdentifier = default(PartialStateIdentifier))
        {
            // to ensure "stateIdentifier" is required (not null)
            if (stateIdentifier == null)
            {
                throw new ArgumentNullException("stateIdentifier is a required property for StateIdentifierNotFoundErrorAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StateIdentifierNotFoundErrorAllOf {\n");
        ...
        {
            return this.Equals(input as StateIdentifierNotFoundErrorAllOf);
        }

        /// <summary>
        /// Returns true if StateIdentifierNotFoundErrorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of StateIdentifierNotFoundErrorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StateIdentifierNotFoundErrorAllOf input)
        {
            if (input == null)
            {
                return false;
