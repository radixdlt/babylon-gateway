...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PackageBlueprintDependenciesEntrySubstate_allOf")]
    public partial class PackageBlueprintDependenciesEntrySubstateAllOf : IEquatable<PackageBlueprintDependenciesEntrySubstateAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageBlueprintDependenciesEntrySubstateAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PackageBlueprintDependenciesEntrySubstateAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageBlueprintDependenciesEntrySubstateAllOf" /> class.
        /// </summary>
        ...
        public PackageBlueprintDependenciesEntrySubstateAllOf(string blueprintName = default(string), string blueprintVersion = default(string), BlueprintDependencies dependencies = default(BlueprintDependencies))
        {
            // to ensure "blueprintName" is required (not null)
            if (blueprintName == null)
            {
                throw new ArgumentNullException("blueprintName is a required property for PackageBlueprintDependenciesEntrySubstateAllOf and cannot be null");
            }
            this.BlueprintName = blueprintName;
            // to ensure "blueprintVersion" is required (not null)
            if (blueprintVersion == null)
            {
                throw new ArgumentNullException("blueprintVersion is a required property for PackageBlueprintDependenciesEntrySubstateAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as PackageBlueprintDependenciesEntrySubstateAllOf);
        }

        /// <summary>
        /// Returns true if PackageBlueprintDependenciesEntrySubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PackageBlueprintDependenciesEntrySubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PackageBlueprintDependenciesEntrySubstateAllOf input)
        {
            if (input == null)
            {
                return false;
