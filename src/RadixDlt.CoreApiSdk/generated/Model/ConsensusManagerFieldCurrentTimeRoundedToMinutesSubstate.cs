...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate")]
    ...
    public partial class ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate : Substate, IEquatable<ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate" /> class.
        /// </summary>
        ...
        public ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate(ConsensusManagerFieldCurrentTimeRoundedToMinutesValue value = default(ConsensusManagerFieldCurrentTimeRoundedToMinutesValue), SubstateType substateType = SubstateType.ConsensusManagerFieldCurrentTimeRoundedToMinutes, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate);
        }

        /// <summary>
        /// Returns true if ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate input)
        {
            if (input == null)
            {
                return false;
