...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SborFormatOptions")]
    public partial class SborFormatOptions : IEquatable<SborFormatOptions>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Whether to return the raw hex-encoded bytes (default true)</value>
        ...
        {
            return this.Equals(input as SborFormatOptions);
        }

        /// <summary>
        /// Returns true if SborFormatOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of SborFormatOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SborFormatOptions input)
        {
            if (input == null)
            {
                return false;
