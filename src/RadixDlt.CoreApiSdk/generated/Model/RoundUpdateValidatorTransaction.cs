...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RoundUpdateValidatorTransaction")]
    [JsonConverter(typeof(JsonSubtypes), "type")]
    [JsonSubtypes.KnownSubType(typeof(RoundUpdateValidatorTransaction), "RoundUpdate")]
    public partial class RoundUpdateValidatorTransaction : ValidatorTransaction, IEquatable<RoundUpdateValidatorTransaction>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoundUpdateValidatorTransaction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RoundUpdateValidatorTransaction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RoundUpdateValidatorTransaction" /> class.
        /// </summary>
        ...
        /// <param name="type">type (required) (default to ValidatorTransactionType.RoundUpdate).</param>
        public RoundUpdateValidatorTransaction(Instant proposerTimestamp = default(Instant), long consensusEpoch = default(long), long roundInEpoch = default(long), ValidatorTransactionType type = ValidatorTransactionType.RoundUpdate) : base(type)
        {
            // to ensure "proposerTimestamp" is required (not null)
            if (proposerTimestamp == null)
            {
                throw new ArgumentNullException("proposerTimestamp is a required property for RoundUpdateValidatorTransaction and cannot be null");
            }
        ...
        {
            return this.Equals(input as RoundUpdateValidatorTransaction);
        }

        /// <summary>
        /// Returns true if RoundUpdateValidatorTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of RoundUpdateValidatorTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoundUpdateValidatorTransaction input)
        {
            if (input == null)
            {
                return false;
