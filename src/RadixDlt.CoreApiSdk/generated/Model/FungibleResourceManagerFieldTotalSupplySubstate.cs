...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FungibleResourceManagerFieldTotalSupplySubstate")]
    ...
    public partial class FungibleResourceManagerFieldTotalSupplySubstate : Substate, IEquatable<FungibleResourceManagerFieldTotalSupplySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FungibleResourceManagerFieldTotalSupplySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FungibleResourceManagerFieldTotalSupplySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FungibleResourceManagerFieldTotalSupplySubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.FungibleResourceManagerFieldTotalSupply).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public FungibleResourceManagerFieldTotalSupplySubstate(FungibleResourceManagerFieldTotalSupplyValue value = default(FungibleResourceManagerFieldTotalSupplyValue), SubstateType substateType = SubstateType.FungibleResourceManagerFieldTotalSupply, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for FungibleResourceManagerFieldTotalSupplySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as FungibleResourceManagerFieldTotalSupplySubstate);
        }

        /// <summary>
        /// Returns true if FungibleResourceManagerFieldTotalSupplySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of FungibleResourceManagerFieldTotalSupplySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FungibleResourceManagerFieldTotalSupplySubstate input)
        {
            if (input == null)
            {
                return false;
