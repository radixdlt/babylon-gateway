...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class FungibleResourceManagerFieldTotalSupplySubstate : Substate, IEquatable<FungibleResourceManagerFieldTotalSupplySubstate>
    {
        ...
        public FungibleResourceManagerFieldTotalSupplySubstate(string totalSupply = default(string), SubstateType substateType = SubstateType.FungibleResourceManagerFieldTotalSupply) : base(substateType)
        {
