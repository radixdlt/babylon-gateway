...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class FungibleResourceManagerFieldTotalSupplySubstate : Substate, IEquatable<FungibleResourceManagerFieldTotalSupplySubstate>
    {
        ...
        public FungibleResourceManagerFieldTotalSupplySubstate(string totalSupply = default(string), SubstateType substateType = SubstateType.FungibleResourceManagerFieldTotalSupply, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "totalSupply" is required (not null)
            if (totalSupply == null)
            {
                throw new ArgumentNullException("totalSupply is a required property for FungibleResourceManagerFieldTotalSupplySubstate and cannot be null");
            }
