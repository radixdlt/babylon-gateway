...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// ValidatorMetadata
    /// </summary>
    [DataContract(Name = "ValidatorMetadata")]
    ...
    public partial class ValidatorMetadata : DataObject, IEquatable<ValidatorMetadata>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatorMetadata" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="ValidatorMetadata" /> class.
        /// </summary>
        /// <param name="name">The name for the validator. (required).</param>
        /// <param name="url">A url which points to more information about the validator. (required).</param>
        /// <param name="type">The type of the data object. Each address may own up to one current object of a given type. (required) (default to &quot;ValidatorMetadata&quot;).</param>
        public ValidatorMetadata(string name = default(string), string url = default(string), string type = "ValidatorMetadata") : base(type)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ValidatorMetadata and cannot be null");
            }
            this.Name = name;
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for ValidatorMetadata and cannot be null");
            }
            this.Url = url;
        }
        ...
        /// </summary>
        /// <value>The name for the validator.</value>
        ...
        /// </summary>
        /// <value>A url which points to more information about the validator.</value>
        ...
        {
            return this.Equals(input as ValidatorMetadata);
        }

        /// <summary>
        /// Returns true if ValidatorMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of ValidatorMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValidatorMetadata input)
        {
            if (input == null)
            {
                return false;
