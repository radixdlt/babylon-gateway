...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConstructionHashRequest")]
    public partial class ConstructionHashRequest : IEquatable<ConstructionHashRequest>, IValidatableObject
    {
        ...
        protected ConstructionHashRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionHashRequest" /> class.
        /// </summary>
        /// <param name="networkIdentifier">networkIdentifier (required).</param>
        /// <param name="signedTransaction">Hex encoded signed transaction (required).</param>
        public ConstructionHashRequest(NetworkIdentifier networkIdentifier = default(NetworkIdentifier), string signedTransaction = default(string))
        {
            ...
            {
                throw new ArgumentNullException("networkIdentifier is a required property for ConstructionHashRequest and cannot be null");
            }
            this.NetworkIdentifier = networkIdentifier;
            // to ensure "signedTransaction" is required (not null)
            if (signedTransaction == null)
            {
                throw new ArgumentNullException("signedTransaction is a required property for ConstructionHashRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Hex encoded signed transaction</value>
