...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// MethodKey
    /// </summary>
    [DataContract(Name = "MethodKey")]
    public partial class MethodKey : IEquatable<MethodKey>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MethodKey" /> class.
        /// </summary>
        ...
        /// <param name="ident">ident (required).</param>
        public MethodKey(ObjectModuleId objectModuleId = default(ObjectModuleId), string ident = default(string))
        {
            this.ObjectModuleId = objectModuleId;
            // to ensure "ident" is required (not null)
            if (ident == null)
            {
                throw new ArgumentNullException("ident is a required property for MethodKey and cannot be null");
            }
            this.Ident = ident;
        }
        ...
        {
            return this.Equals(input as MethodKey);
        }

        /// <summary>
        /// Returns true if MethodKey instances are equal
        /// </summary>
        /// <param name="input">Instance of MethodKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MethodKey input)
        {
            if (input == null)
            {
                return false;
