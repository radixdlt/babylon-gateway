...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PublicKeyIdentifiers")]
    public partial class PublicKeyIdentifiers : IEquatable<PublicKeyIdentifiers>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicKeyIdentifiers" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublicKeyIdentifiers() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicKeyIdentifiers" /> class.
        /// </summary>
        /// <param name="accountEntityIdentifier">accountEntityIdentifier (required).</param>
        /// <param name="validatorEntityIdentifier">validatorEntityIdentifier (required).</param>
        /// <param name="p2pNode">p2pNode (required).</param>
        public PublicKeyIdentifiers(EntityIdentifier accountEntityIdentifier = default(EntityIdentifier), EntityIdentifier validatorEntityIdentifier = default(EntityIdentifier), Peer p2pNode = default(Peer))
        {
            // to ensure "accountEntityIdentifier" is required (not null)
            if (accountEntityIdentifier == null)
            {
                throw new ArgumentNullException("accountEntityIdentifier is a required property for PublicKeyIdentifiers and cannot be null");
            }
            this.AccountEntityIdentifier = accountEntityIdentifier;
            // to ensure "validatorEntityIdentifier" is required (not null)
            if (validatorEntityIdentifier == null)
            {
                throw new ArgumentNullException("validatorEntityIdentifier is a required property for PublicKeyIdentifiers and cannot be null");
            }
            this.ValidatorEntityIdentifier = validatorEntityIdentifier;
            // to ensure "p2pNode" is required (not null)
            if (p2pNode == null)
            {
                throw new ArgumentNullException("p2pNode is a required property for PublicKeyIdentifiers and cannot be null");
            }
            this.P2pNode = p2pNode;
        }

        /// <summary>
        /// Gets or Sets AccountEntityIdentifier
        /// </summary>
        [DataMember(Name = "account_entity_identifier", IsRequired = true, EmitDefaultValue = true)]
        public EntityIdentifier AccountEntityIdentifier { get; set; }

        /// <summary>
        /// Gets or Sets ValidatorEntityIdentifier
        /// </summary>
        [DataMember(Name = "validator_entity_identifier", IsRequired = true, EmitDefaultValue = true)]
        public EntityIdentifier ValidatorEntityIdentifier { get; set; }

        /// <summary>
        /// Gets or Sets P2pNode
        /// </summary>
        [DataMember(Name = "p2p_node", IsRequired = true, EmitDefaultValue = true)]
        public Peer P2pNode { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AccountEntityIdentifier: ").Append(AccountEntityIdentifier).Append("\n");
            sb.Append("  ValidatorEntityIdentifier: ").Append(ValidatorEntityIdentifier).Append("\n");
            sb.Append("  P2pNode: ").Append(P2pNode).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as PublicKeyIdentifiers);
        }

        /// <summary>
        /// Returns true if PublicKeyIdentifiers instances are equal
        /// </summary>
        /// <param name="input">Instance of PublicKeyIdentifiers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PublicKeyIdentifiers input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.AccountEntityIdentifier == input.AccountEntityIdentifier ||
                    (this.AccountEntityIdentifier != null &&
                    this.AccountEntityIdentifier.Equals(input.AccountEntityIdentifier))
                ) && 
                (
                    this.ValidatorEntityIdentifier == input.ValidatorEntityIdentifier ||
                    (this.ValidatorEntityIdentifier != null &&
                    this.ValidatorEntityIdentifier.Equals(input.ValidatorEntityIdentifier))
                ) && 
                (
                    this.P2pNode == input.P2pNode ||
                    (this.P2pNode != null &&
                    this.P2pNode.Equals(input.P2pNode))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.AccountEntityIdentifier != null)
                {
                    hashCode = (hashCode * 59) + this.AccountEntityIdentifier.GetHashCode();
                }
                if (this.ValidatorEntityIdentifier != null)
                {
                    hashCode = (hashCode * 59) + this.ValidatorEntityIdentifier.GetHashCode();
                }
                if (this.P2pNode != null)
                {
                    hashCode = (hashCode * 59) + this.P2pNode.GetHashCode();
                }
                return hashCode;
            }
        }
