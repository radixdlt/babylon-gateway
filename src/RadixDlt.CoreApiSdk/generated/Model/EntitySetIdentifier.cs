...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// EntitySetIdentifier
    /// </summary>
    [DataContract(Name = "EntitySetIdentifier")]
    public partial class EntitySetIdentifier : IEquatable<EntitySetIdentifier>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EntitySetIdentifier" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EntitySetIdentifier() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EntitySetIdentifier" /> class.
        /// </summary>
        /// <param name="addressRegex">addressRegex (required).</param>
        public EntitySetIdentifier(string addressRegex = default(string))
        {
            // to ensure "addressRegex" is required (not null)
            if (addressRegex == null)
            {
                throw new ArgumentNullException("addressRegex is a required property for EntitySetIdentifier and cannot be null");
            }
            this.AddressRegex = addressRegex;
        }

        /// <summary>
        /// Gets or Sets AddressRegex
        /// </summary>
        [DataMember(Name = "address_regex", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AddressRegex: ").Append(AddressRegex).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as EntitySetIdentifier);
        }

        /// <summary>
        /// Returns true if EntitySetIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of EntitySetIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntitySetIdentifier input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.AddressRegex == input.AddressRegex ||
                    (this.AddressRegex != null &&
                    this.AddressRegex.Equals(input.AddressRegex))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.AddressRegex.GetHashCode();
                }
                return hashCode;
            }
        }
