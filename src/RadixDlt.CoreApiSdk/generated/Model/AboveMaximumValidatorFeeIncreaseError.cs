...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AboveMaximumValidatorFeeIncreaseError")]
    ...
    public partial class AboveMaximumValidatorFeeIncreaseError : CoreError, IEquatable<AboveMaximumValidatorFeeIncreaseError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AboveMaximumValidatorFeeIncreaseError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AboveMaximumValidatorFeeIncreaseError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AboveMaximumValidatorFeeIncreaseError" /> class.
        /// </summary>
        /// <param name="maximumValidatorFeeIncrease">maximumValidatorFeeIncrease (required).</param>
        /// <param name="attemptedValidatorFeeIncrease">attemptedValidatorFeeIncrease (required).</param>
        /// <param name="type">type (required) (default to &quot;AboveMaximumValidatorFeeIncreaseError&quot;).</param>
        public AboveMaximumValidatorFeeIncreaseError(int maximumValidatorFeeIncrease = default(int), int attemptedValidatorFeeIncrease = default(int), string type = "AboveMaximumValidatorFeeIncreaseError") : base(type)
        {
        ...
        /// <summary>
        /// Gets or Sets AttemptedValidatorFeeIncrease
        /// </summary>
        [DataMember(Name = "attempted_validator_fee_increase", IsRequired = true, EmitDefaultValue = true)]
        public int AttemptedValidatorFeeIncrease { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AttemptedValidatorFeeIncrease: ").Append(AttemptedValidatorFeeIncrease).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AboveMaximumValidatorFeeIncreaseError);
        }

        /// <summary>
        /// Returns true if AboveMaximumValidatorFeeIncreaseError instances are equal
        /// </summary>
        /// <param name="input">Instance of AboveMaximumValidatorFeeIncreaseError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AboveMaximumValidatorFeeIncreaseError input)
        {
            if (input == null)
            {
                return false;
            ...
            return base.Equals(input) && 
                ...
                (
                    this.AttemptedValidatorFeeIncrease == input.AttemptedValidatorFeeIncrease ||
                    this.AttemptedValidatorFeeIncrease.Equals(input.AttemptedValidatorFeeIncrease)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AttemptedValidatorFeeIncrease.GetHashCode();
                return hashCode;
            }
        }
