...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class TransactionPreviewV2Request : IEquatable<TransactionPreviewV2Request>
    {
        ...
        public TransactionPreviewV2Request(string network = default(string), LedgerStateSelector atLedgerState = default(LedgerStateSelector), PreviewTransaction previewTransaction = default(PreviewTransaction), PreviewFlags flags = default(PreviewFlags), TransactionPreviewV2ResponseOptions options = default(TransactionPreviewV2ResponseOptions))
        {
            // to ensure "network" is required (not null)
            if (network == null)
            {
                throw new ArgumentNullException("network is a required property for TransactionPreviewV2Request and cannot be null");
            }
        ...
        public TransactionPreviewV2ResponseOptions Options { get; set; }
