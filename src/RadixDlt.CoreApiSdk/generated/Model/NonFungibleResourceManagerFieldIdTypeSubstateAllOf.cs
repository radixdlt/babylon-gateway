...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class NonFungibleResourceManagerFieldIdTypeSubstateAllOf : IEquatable<NonFungibleResourceManagerFieldIdTypeSubstateAllOf>
    {
        ...
        protected NonFungibleResourceManagerFieldIdTypeSubstateAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NonFungibleResourceManagerFieldIdTypeSubstateAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as NonFungibleResourceManagerFieldIdTypeSubstateAllOf);
        }

        /// <summary>
        /// Returns true if NonFungibleResourceManagerFieldIdTypeSubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of NonFungibleResourceManagerFieldIdTypeSubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NonFungibleResourceManagerFieldIdTypeSubstateAllOf input)
        {
            if (input == null)
            {
                return false;
