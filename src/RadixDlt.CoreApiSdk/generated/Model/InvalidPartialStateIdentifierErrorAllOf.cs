...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InvalidPartialStateIdentifierError_allOf")]
    public partial class InvalidPartialStateIdentifierErrorAllOf : IEquatable<InvalidPartialStateIdentifierErrorAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidPartialStateIdentifierErrorAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvalidPartialStateIdentifierErrorAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidPartialStateIdentifierErrorAllOf" /> class.
        /// </summary>
        /// <param name="invalidPartialStateIdentifier">invalidPartialStateIdentifier (required).</param>
        public InvalidPartialStateIdentifierErrorAllOf(PartialStateIdentifier invalidPartialStateIdentifier = default(PartialStateIdentifier))
        {
            // to ensure "invalidPartialStateIdentifier" is required (not null)
            if (invalidPartialStateIdentifier == null)
            {
                throw new ArgumentNullException("invalidPartialStateIdentifier is a required property for InvalidPartialStateIdentifierErrorAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvalidPartialStateIdentifierErrorAllOf {\n");
        ...
        {
            return this.Equals(input as InvalidPartialStateIdentifierErrorAllOf);
        }

        /// <summary>
        /// Returns true if InvalidPartialStateIdentifierErrorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidPartialStateIdentifierErrorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidPartialStateIdentifierErrorAllOf input)
        {
            if (input == null)
            {
                return false;
