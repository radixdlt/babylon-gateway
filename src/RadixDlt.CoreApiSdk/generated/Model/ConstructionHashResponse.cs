...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConstructionHashResponse")]
    public partial class ConstructionHashResponse : IEquatable<ConstructionHashResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionHashResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConstructionHashResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionHashResponse" /> class.
        /// </summary>
        /// <param name="transactionIdentifier">transactionIdentifier (required).</param>
        public ConstructionHashResponse(TransactionIdentifier transactionIdentifier = default(TransactionIdentifier))
        {
            // to ensure "transactionIdentifier" is required (not null)
            if (transactionIdentifier == null)
            {
                throw new ArgumentNullException("transactionIdentifier is a required property for ConstructionHashResponse and cannot be null");
            }
        ...
        {
            return this.Equals(input as ConstructionHashResponse);
        }

        /// <summary>
        /// Returns true if ConstructionHashResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ConstructionHashResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConstructionHashResponse input)
        {
            if (input == null)
            {
                return false;
