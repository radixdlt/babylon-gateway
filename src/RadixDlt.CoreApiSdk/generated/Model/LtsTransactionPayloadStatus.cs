...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LtsTransactionPayloadStatus")]
    public partial class LtsTransactionPayloadStatus : IEquatable<LtsTransactionPayloadStatus>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LtsTransactionPayloadStatus" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LtsTransactionPayloadStatus() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LtsTransactionPayloadStatus" /> class.
        /// </summary>
        ...
        public LtsTransactionPayloadStatus(string payloadHash = default(string), StatusEnum status = default(StatusEnum), string errorMessage = default(string))
        {
            // to ensure "payloadHash" is required (not null)
            if (payloadHash == null)
            {
                throw new ArgumentNullException("payloadHash is a required property for LtsTransactionPayloadStatus and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LtsTransactionPayloadStatus {\n");
        ...
        {
            return this.Equals(input as LtsTransactionPayloadStatus);
        }

        /// <summary>
        /// Returns true if LtsTransactionPayloadStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of LtsTransactionPayloadStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LtsTransactionPayloadStatus input)
        {
            if (input == null)
            {
                return false;
