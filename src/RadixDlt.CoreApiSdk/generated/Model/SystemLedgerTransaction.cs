...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemLedgerTransaction")]
    ...
    public partial class SystemLedgerTransaction : LedgerTransaction, IEquatable<SystemLedgerTransaction>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemLedgerTransaction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SystemLedgerTransaction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemLedgerTransaction" /> class.
        /// </summary>
        ...
        public SystemLedgerTransaction(SystemTransaction systemTransaction = default(SystemTransaction), LedgerTransactionType type = LedgerTransactionType.System, string payloadHex = default(string)) : base(type, payloadHex)
        {
            ...
            {
                throw new ArgumentNullException("systemTransaction is a required property for SystemLedgerTransaction and cannot be null");
            }
        ...
        {
            return this.Equals(input as SystemLedgerTransaction);
        }

        /// <summary>
        /// Returns true if SystemLedgerTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemLedgerTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemLedgerTransaction input)
        {
            if (input == null)
            {
                return false;
