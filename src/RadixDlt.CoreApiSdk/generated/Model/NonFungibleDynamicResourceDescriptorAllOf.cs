...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NonFungibleDynamicResourceDescriptor_allOf")]
    public partial class NonFungibleDynamicResourceDescriptorAllOf : IEquatable<NonFungibleDynamicResourceDescriptorAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NonFungibleDynamicResourceDescriptorAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NonFungibleDynamicResourceDescriptorAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NonFungibleDynamicResourceDescriptorAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as NonFungibleDynamicResourceDescriptorAllOf);
        }

        /// <summary>
        /// Returns true if NonFungibleDynamicResourceDescriptorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of NonFungibleDynamicResourceDescriptorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NonFungibleDynamicResourceDescriptorAllOf input)
        {
            if (input == null)
            {
                return false;
