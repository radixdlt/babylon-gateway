...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// ValidatorDataAllOf
    /// </summary>
    [DataContract(Name = "ValidatorData_allOf")]
    public partial class ValidatorDataAllOf : IEquatable<ValidatorDataAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatorDataAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValidatorDataAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatorDataAllOf" /> class.
        /// </summary>
        ...
        public ValidatorDataAllOf(EntityIdentifier owner = default(EntityIdentifier), bool registered = default(bool), int fee = default(int))
        {
            // to ensure "owner" is required (not null)
            if (owner == null)
            {
                throw new ArgumentNullException("owner is a required property for ValidatorDataAllOf and cannot be null");
            }
            this.Owner = owner;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ValidatorDataAllOf {\n");
        ...
        {
            return this.Equals(input as ValidatorDataAllOf);
        }

        /// <summary>
        /// Returns true if ValidatorDataAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ValidatorDataAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValidatorDataAllOf input)
        {
            if (input == null)
            {
                return false;
