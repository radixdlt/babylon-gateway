...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class ParsedNotarizedTransactionAllOfIdentifiers : IEquatable<ParsedNotarizedTransactionAllOfIdentifiers>
    {
        ...
        public ParsedNotarizedTransactionAllOfIdentifiers(string intentHash = default(string), string signedIntentHash = default(string), string payloadHash = default(string), string ledgerHash = default(string))
        {
            ...
            {
                throw new ArgumentNullException("signedIntentHash is a required property for ParsedNotarizedTransactionAllOfIdentifiers and cannot be null");
            }
