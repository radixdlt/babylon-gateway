...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EpochManagerFieldConfigSubstate")]
    ...
    public partial class EpochManagerFieldConfigSubstate : Substate, IEquatable<EpochManagerFieldConfigSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EpochManagerFieldConfigSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EpochManagerFieldConfigSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EpochManagerFieldConfigSubstate" /> class.
        /// </summary>
        /// <param name="maxValidators">maxValidators (required).</param>
        ...
        /// <param name="substateType">substateType (required) (default to SubstateType.EpochManagerFieldConfig).</param>
        public EpochManagerFieldConfigSubstate(long maxValidators = default(long), long roundsPerEpoch = default(long), long numUnstakeEpochs = default(long), SubstateType substateType = SubstateType.EpochManagerFieldConfig) : base(substateType)
        {
        ...
        {
            return this.Equals(input as EpochManagerFieldConfigSubstate);
        }

        /// <summary>
        /// Returns true if EpochManagerFieldConfigSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of EpochManagerFieldConfigSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EpochManagerFieldConfigSubstate input)
        {
            if (input == null)
            {
                return false;
