...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class MetadataSubstate : Substate, IEquatable<MetadataSubstate>
    {
        ...
        /// <param name="substateType">substateType (required) (default to &quot;MetadataSubstate&quot;).</param>
        public MetadataSubstate(List<MetadataSubstateAllOfMetadata> metadata = default(List<MetadataSubstateAllOfMetadata>), SubstateType substateType = Model.SubstateType.Metadata) : base(substateType)
        {
