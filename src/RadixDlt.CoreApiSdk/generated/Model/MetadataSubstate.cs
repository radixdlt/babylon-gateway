...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class MetadataSubstate : Substate, IEquatable<MetadataSubstate>
    {
        ...
        public MetadataSubstate(List<MetadataSubstateAllOfMetadata> metadata = default(List<MetadataSubstateAllOfMetadata>), SubstateType substateType = "MetadataSubstate") : base(substateType)
        {
