...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class PackageTypeReference : IEquatable<PackageTypeReference>
    {
        ...
        public PackageTypeReference(string packageAddress = default(string), string schemaHash = default(string), LocalTypeIndex localTypeIndex = default(LocalTypeIndex))
        {
            // to ensure "packageAddress" is required (not null)
            if (packageAddress == null)
            {
                throw new ArgumentNullException("packageAddress is a required property for PackageTypeReference and cannot be null");
            }
            this.PackageAddress = packageAddress;
            // to ensure "schemaHash" is required (not null)
            if (schemaHash == null)
            {
                throw new ArgumentNullException("schemaHash is a required property for PackageTypeReference and cannot be null");
            }
            this.SchemaHash = schemaHash;
            // to ensure "localTypeIndex" is required (not null)
            if (localTypeIndex == null)
            {
                throw new ArgumentNullException("localTypeIndex is a required property for PackageTypeReference and cannot be null");
            }
