...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PublicKeyNotSupportedError")]
    ...
    public partial class PublicKeyNotSupportedError : CoreError, IEquatable<PublicKeyNotSupportedError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicKeyNotSupportedError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublicKeyNotSupportedError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicKeyNotSupportedError" /> class.
        /// </summary>
        /// <param name="unsupportedPublicKey">unsupportedPublicKey (required).</param>
        /// <param name="type">type (required) (default to &quot;PublicKeyNotSupportedError&quot;).</param>
        public PublicKeyNotSupportedError(PublicKey unsupportedPublicKey = default(PublicKey), string type = "PublicKeyNotSupportedError") : base(type)
        {
            // to ensure "unsupportedPublicKey" is required (not null)
            if (unsupportedPublicKey == null)
            {
                throw new ArgumentNullException("unsupportedPublicKey is a required property for PublicKeyNotSupportedError and cannot be null");
            }
            this.UnsupportedPublicKey = unsupportedPublicKey;
        }

        /// <summary>
        /// Gets or Sets UnsupportedPublicKey
        /// </summary>
        [DataMember(Name = "unsupported_public_key", IsRequired = true, EmitDefaultValue = true)]
        public PublicKey UnsupportedPublicKey { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  UnsupportedPublicKey: ").Append(UnsupportedPublicKey).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as PublicKeyNotSupportedError);
        }

        /// <summary>
        /// Returns true if PublicKeyNotSupportedError instances are equal
        /// </summary>
        /// <param name="input">Instance of PublicKeyNotSupportedError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PublicKeyNotSupportedError input)
        {
            if (input == null)
            {
                return false;
            ...
            return base.Equals(input) && 
                (
                    this.UnsupportedPublicKey == input.UnsupportedPublicKey ||
                    (this.UnsupportedPublicKey != null &&
                    this.UnsupportedPublicKey.Equals(input.UnsupportedPublicKey))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.UnsupportedPublicKey != null)
                {
                    hashCode = (hashCode * 59) + this.UnsupportedPublicKey.GetHashCode();
                }
                return hashCode;
            }
        }
