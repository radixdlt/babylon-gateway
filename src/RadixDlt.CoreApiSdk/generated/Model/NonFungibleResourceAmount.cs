...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class NonFungibleResourceAmount : ResourceAmount, IEquatable<NonFungibleResourceAmount>
    {
        ...
        protected NonFungibleResourceAmount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NonFungibleResourceAmount" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as NonFungibleResourceAmount);
        }

        /// <summary>
        /// Returns true if NonFungibleResourceAmount instances are equal
        /// </summary>
        /// <param name="input">Instance of NonFungibleResourceAmount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NonFungibleResourceAmount input)
        {
            if (input == null)
            {
                return false;
