...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class EntityResponse : IEquatable<EntityResponse>, IValidatableObject
    {
        ...
        /// <param name="balances">Balances associated with the entity. (required).</param>
        /// <param name="dataObjects">Data associated with the entity. (required).</param>
        public EntityResponse(StateIdentifier stateIdentifier = default(StateIdentifier), List<ResourceAmount> balances = default(List<ResourceAmount>), List<DataObject> dataObjects = default(List<DataObject>))
        {
            // to ensure "stateIdentifier" is required (not null)
            if (stateIdentifier == null)
            {
                throw new ArgumentNullException("stateIdentifier is a required property for EntityResponse and cannot be null");
            }
            this.StateIdentifier = stateIdentifier;
            // to ensure "balances" is required (not null)
            if (balances == null)
            {
                throw new ArgumentNullException("balances is a required property for EntityResponse and cannot be null");
            }
            this.Balances = balances;
            // to ensure "dataObjects" is required (not null)
            if (dataObjects == null)
            {
                throw new ArgumentNullException("dataObjects is a required property for EntityResponse and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Balances associated with the entity.</value>
        [DataMember(Name = "balances", IsRequired = true, EmitDefaultValue = true)]
        public List<ResourceAmount> Balances { get; set; }

        /// <summary>
        /// Data associated with the entity.
        /// </summary>
        /// <value>Data associated with the entity.</value>
        [DataMember(Name = "data_objects", IsRequired = true, EmitDefaultValue = true)]
