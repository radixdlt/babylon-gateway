...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class LocalScryptoMethodReference : IEquatable<LocalScryptoMethodReference>, IValidatableObject
    {
        ...
        public LocalScryptoMethodReference(LocalMethodReferenceType type = default(LocalMethodReferenceType), string name = default(string))
        {
            this.Type = type;
