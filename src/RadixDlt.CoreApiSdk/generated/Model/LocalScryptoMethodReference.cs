...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class LocalScryptoMethodReference : LocalMethodReference, IEquatable<LocalScryptoMethodReference>
    {
        ...
        /// <param name="type">type (required) (default to &quot;LocalScryptoMethodReference&quot;).</param>
        public LocalScryptoMethodReference(string name = default(string), LocalMethodReferenceType type = "LocalScryptoMethodReference") : base(type)
        {
