...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class Data : IEquatable<Data>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Data action to take on &#x60;data_object&#x60;.</value>
        ...
        /// Initializes a new instance of the <see cref="Data" /> class.
        /// </summary>
        /// <param name="action">Data action to take on &#x60;data_object&#x60;. (required).</param>
        /// <param name="dataObject">dataObject (required).</param>
        public Data(ActionEnum action = default(ActionEnum), DataObject dataObject = default(DataObject))
        {
            this.Action = action;
            // to ensure "dataObject" is required (not null)
            if (dataObject == null)
            {
                throw new ArgumentNullException("dataObject is a required property for Data and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "data_object", IsRequired = true, EmitDefaultValue = true)]
