...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class UserLedgerTransaction : LedgerTransaction, IEquatable<UserLedgerTransaction>
    {
        ...
        /// <param name="type">type (required) (default to &quot;UserLedgerTransaction&quot;).</param>
        /// <param name="payloadHex">The hex-encoded full ledger transaction payload (required).</param>
        public UserLedgerTransaction(NotarizedTransaction notarizedTransaction = default(NotarizedTransaction), LedgerTransactionType type = "UserLedgerTransaction", string payloadHex = default(string)) : base(type, payloadHex)
        {
