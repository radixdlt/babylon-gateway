...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class BelowMinimumStakeErrorAllOf : IEquatable<BelowMinimumStakeErrorAllOf>, IValidatableObject
    {
        ...
        /// <param name="attemptedToStake">attemptedToStake (required).</param>
        public BelowMinimumStakeErrorAllOf(ResourceAmount minimumStake = default(ResourceAmount), ResourceAmount attemptedToStake = default(ResourceAmount))
        {
            // to ensure "minimumStake" is required (not null)
            if (minimumStake == null)
            {
                throw new ArgumentNullException("minimumStake is a required property for BelowMinimumStakeErrorAllOf and cannot be null");
            }
            this.MinimumStake = minimumStake;
            // to ensure "attemptedToStake" is required (not null)
            if (attemptedToStake == null)
            {
                throw new ArgumentNullException("attemptedToStake is a required property for BelowMinimumStakeErrorAllOf and cannot be null");
            }
        ...
        /// <summary>
        /// Gets or Sets AttemptedToStake
        /// </summary>
        [DataMember(Name = "attempted_to_stake", IsRequired = true, EmitDefaultValue = true)]
        public ResourceAmount AttemptedToStake { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AttemptedToStake: ").Append(AttemptedToStake).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(BelowMinimumStakeErrorAllOf input)
        {
            ...
            return 
                ...
                (
                    this.AttemptedToStake == input.AttemptedToStake ||
                    (this.AttemptedToStake != null &&
                    this.AttemptedToStake.Equals(input.AttemptedToStake))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AttemptedToStake != null)
                {
                    hashCode = (hashCode * 59) + this.AttemptedToStake.GetHashCode();
                }
                return hashCode;
            }
        }
