...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConstructionDeriveRequest")]
    public partial class ConstructionDeriveRequest : IEquatable<ConstructionDeriveRequest>, IValidatableObject
    {
        ...
        protected ConstructionDeriveRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionDeriveRequest" /> class.
        /// </summary>
        ...
        public ConstructionDeriveRequest(NetworkIdentifier networkIdentifier = default(NetworkIdentifier), PublicKey publicKey = default(PublicKey), ConstructionDeriveRequestMetadata metadata = default(ConstructionDeriveRequestMetadata))
        {
            // to ensure "networkIdentifier" is required (not null)
            if (networkIdentifier == null)
            {
                throw new ArgumentNullException("networkIdentifier is a required property for ConstructionDeriveRequest and cannot be null");
            }
            this.NetworkIdentifier = networkIdentifier;
            // to ensure "publicKey" is required (not null)
            if (publicKey == null)
            {
                throw new ArgumentNullException("publicKey is a required property for ConstructionDeriveRequest and cannot be null");
            }
            this.PublicKey = publicKey;
            // to ensure "metadata" is required (not null)
            if (metadata == null)
            {
                throw new ArgumentNullException("metadata is a required property for ConstructionDeriveRequest and cannot be null");
            }
        ...
        public ConstructionDeriveRequestMetadata Metadata { get; set; }
