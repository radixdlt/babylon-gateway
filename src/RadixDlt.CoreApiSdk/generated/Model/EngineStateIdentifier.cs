...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EngineStateIdentifier")]
    public partial class EngineStateIdentifier : IEquatable<EngineStateIdentifier>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EngineStateIdentifier" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EngineStateIdentifier() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EngineStateIdentifier" /> class.
        /// </summary>
        ...
        public EngineStateIdentifier(StateIdentifier stateIdentifier = default(StateIdentifier), long epoch = default(long), long round = default(long), long timestamp = default(long))
        {
            // to ensure "stateIdentifier" is required (not null)
            if (stateIdentifier == null)
            {
                throw new ArgumentNullException("stateIdentifier is a required property for EngineStateIdentifier and cannot be null");
            }
        ...
        {
            return this.Equals(input as EngineStateIdentifier);
        }

        /// <summary>
        /// Returns true if EngineStateIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of EngineStateIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EngineStateIdentifier input)
        {
            if (input == null)
            {
                return false;
