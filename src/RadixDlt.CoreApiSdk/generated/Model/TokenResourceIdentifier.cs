...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TokenResourceIdentifier")]
    [JsonConverter(typeof(JsonSubtypes), "Type")]
    [JsonSubtypes.KnownSubType(typeof(StakeUnitResourceIdentifier), "StakeUnit")]
    [JsonSubtypes.KnownSubType(typeof(TokenResourceIdentifier), "Token")]
    public partial class TokenResourceIdentifier : ResourceIdentifier, IEquatable<TokenResourceIdentifier>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenResourceIdentifier" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TokenResourceIdentifier() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenResourceIdentifier" /> class.
        /// </summary>
        /// <param name="rri">The Radix Resource Identifier \&quot;RRI\&quot; of the token. (required).</param>
        /// <param name="type">The type of resource. (required) (default to &quot;TokenResourceIdentifier&quot;).</param>
        public TokenResourceIdentifier(string rri = default(string), string type = "TokenResourceIdentifier") : base(type)
        {
            // to ensure "rri" is required (not null)
            if (rri == null)
            {
                throw new ArgumentNullException("rri is a required property for TokenResourceIdentifier and cannot be null");
            }
            this.Rri = rri;
        }
        ...
        /// </summary>
        /// <value>The Radix Resource Identifier \&quot;RRI\&quot; of the token.</value>
        ...
        {
            return this.Equals(input as TokenResourceIdentifier);
        }

        /// <summary>
        /// Returns true if TokenResourceIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenResourceIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenResourceIdentifier input)
        {
            if (input == null)
            {
                return false;
