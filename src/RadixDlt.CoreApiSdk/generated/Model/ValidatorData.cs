...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// ValidatorData
    /// </summary>
    [DataContract(Name = "ValidatorData")]
    ...
    public partial class ValidatorData : DataObject, IEquatable<ValidatorData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatorData" /> class.
        /// </summary>
        ...
        /// <param name="registered">Flag indicating whether a validator is registered to be part of the validator set. (required).</param>
        /// <param name="fee">The fee percentage of the validator in 0.01% subunits (ie 10000 &#x3D;&#x3D; 100%). (required).</param>
        /// <param name="type">The type of the data object. Each address may own up to one current object of a given type. (required) (default to &quot;ValidatorData&quot;).</param>
        public ValidatorData(EntityIdentifier owner = default(EntityIdentifier), bool registered = default(bool), int fee = default(int), string type = "ValidatorData") : base(type)
        {
            // to ensure "owner" is required (not null)
            if (owner == null)
            {
                throw new ArgumentNullException("owner is a required property for ValidatorData and cannot be null");
            }
            this.Owner = owner;
        ...
        /// </summary>
        /// <value>Flag indicating whether a validator is registered to be part of the validator set.</value>
        ...
        /// </summary>
        /// <value>The fee percentage of the validator in 0.01% subunits (ie 10000 &#x3D;&#x3D; 100%).</value>
        ...
        {
            return this.Equals(input as ValidatorData);
        }

        /// <summary>
        /// Returns true if ValidatorData instances are equal
        /// </summary>
        /// <param name="input">Instance of ValidatorData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValidatorData input)
        {
            if (input == null)
            {
                return false;
