...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class EcdsaSecp256k1PublicKey : IEquatable<EcdsaSecp256k1PublicKey>, IValidatableObject
    {
        ...
        /// <param name="keyBytes">The hex-encoded compressed ECDSA Secp256k1 public key (33 bytes) (required).</param>
        public EcdsaSecp256k1PublicKey(PublicKeyType keyType = default(PublicKeyType), string keyBytes = default(string))
        {
            this.KeyType = keyType;
            // to ensure "keyBytes" is required (not null)
            if (keyBytes == null)
            {
                throw new ArgumentNullException("keyBytes is a required property for EcdsaSecp256k1PublicKey and cannot be null");
            }
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (this.KeyBytes != null && this.KeyBytes.Length > 66)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for KeyBytes, length must be less than 66.", new [] { "KeyBytes" });
            }

            // KeyBytes (string) minLength
            if (this.KeyBytes != null && this.KeyBytes.Length < 66)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for KeyBytes, length must be greater than 66.", new [] { "KeyBytes" });
            }
