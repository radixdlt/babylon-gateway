...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UserLedgerTransaction_allOf")]
    public partial class UserLedgerTransactionAllOf : IEquatable<UserLedgerTransactionAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserLedgerTransactionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UserLedgerTransactionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UserLedgerTransactionAllOf" /> class.
        /// </summary>
        /// <param name="notarizedTransaction">notarizedTransaction (required).</param>
        public UserLedgerTransactionAllOf(NotarizedTransaction notarizedTransaction = default(NotarizedTransaction))
        {
            // to ensure "notarizedTransaction" is required (not null)
            if (notarizedTransaction == null)
            {
                throw new ArgumentNullException("notarizedTransaction is a required property for UserLedgerTransactionAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as UserLedgerTransactionAllOf);
        }

        /// <summary>
        /// Returns true if UserLedgerTransactionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of UserLedgerTransactionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserLedgerTransactionAllOf input)
        {
            if (input == null)
            {
                return false;
