...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConstructionDeriveRequestMetadataToken_allOf")]
    public partial class ConstructionDeriveRequestMetadataTokenAllOf : IEquatable<ConstructionDeriveRequestMetadataTokenAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionDeriveRequestMetadataTokenAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConstructionDeriveRequestMetadataTokenAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionDeriveRequestMetadataTokenAllOf" /> class.
        /// </summary>
        /// <param name="symbol">The symbol of the token (required).</param>
        public ConstructionDeriveRequestMetadataTokenAllOf(string symbol = default(string))
        {
            // to ensure "symbol" is required (not null)
            if (symbol == null)
            {
                throw new ArgumentNullException("symbol is a required property for ConstructionDeriveRequestMetadataTokenAllOf and cannot be null");
            }
            this.Symbol = symbol;
        }
        ...
        {
            return this.Equals(input as ConstructionDeriveRequestMetadataTokenAllOf);
        }

        /// <summary>
        /// Returns true if ConstructionDeriveRequestMetadataTokenAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ConstructionDeriveRequestMetadataTokenAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConstructionDeriveRequestMetadataTokenAllOf input)
        {
            if (input == null)
            {
                return false;
