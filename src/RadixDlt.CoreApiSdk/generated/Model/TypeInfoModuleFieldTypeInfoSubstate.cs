...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TypeInfoModuleFieldTypeInfoSubstate")]
    ...
    public partial class TypeInfoModuleFieldTypeInfoSubstate : Substate, IEquatable<TypeInfoModuleFieldTypeInfoSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TypeInfoModuleFieldTypeInfoSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TypeInfoModuleFieldTypeInfoSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TypeInfoModuleFieldTypeInfoSubstate" /> class.
        /// </summary>
        ...
        public TypeInfoModuleFieldTypeInfoSubstate(TypeInfoModuleFieldTypeInfoValue value = default(TypeInfoModuleFieldTypeInfoValue), SubstateType substateType = SubstateType.TypeInfoModuleFieldTypeInfo, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for TypeInfoModuleFieldTypeInfoSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as TypeInfoModuleFieldTypeInfoSubstate);
        }

        /// <summary>
        /// Returns true if TypeInfoModuleFieldTypeInfoSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of TypeInfoModuleFieldTypeInfoSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TypeInfoModuleFieldTypeInfoSubstate input)
        {
            if (input == null)
            {
                return false;
