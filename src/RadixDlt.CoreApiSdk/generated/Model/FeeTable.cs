...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// FeeTable
    /// </summary>
    [DataContract(Name = "FeeTable")]
    public partial class FeeTable : IEquatable<FeeTable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FeeTable" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="FeeTable" /> class.
        /// </summary>
        /// <param name="perUpSubstateFee">perUpSubstateFee (required).</param>
        /// <param name="perByteFee">perByteFee (required).</param>
        public FeeTable(List<UpSubstateFeeEntry> perUpSubstateFee = default(List<UpSubstateFeeEntry>), ResourceAmount perByteFee = default(ResourceAmount))
        {
            // to ensure "perUpSubstateFee" is required (not null)
            if (perUpSubstateFee == null)
            {
                throw new ArgumentNullException("perUpSubstateFee is a required property for FeeTable and cannot be null");
            }
            this.PerUpSubstateFee = perUpSubstateFee;
            // to ensure "perByteFee" is required (not null)
            if (perByteFee == null)
            {
                throw new ArgumentNullException("perByteFee is a required property for FeeTable and cannot be null");
            }
            this.PerByteFee = perByteFee;
        }

        /// <summary>
        /// Gets or Sets PerUpSubstateFee
        /// </summary>
        [DataMember(Name = "per_up_substate_fee", IsRequired = true, EmitDefaultValue = true)]
        public List<UpSubstateFeeEntry> PerUpSubstateFee { get; set; }

        /// <summary>
        /// Gets or Sets PerByteFee
        /// </summary>
        [DataMember(Name = "per_byte_fee", IsRequired = true, EmitDefaultValue = true)]
        public ResourceAmount PerByteFee { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PerUpSubstateFee: ").Append(PerUpSubstateFee).Append("\n");
            sb.Append("  PerByteFee: ").Append(PerByteFee).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as FeeTable);
        }

        /// <summary>
        /// Returns true if FeeTable instances are equal
        /// </summary>
        /// <param name="input">Instance of FeeTable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FeeTable input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.PerUpSubstateFee == input.PerUpSubstateFee ||
                    this.PerUpSubstateFee != null &&
                    input.PerUpSubstateFee != null &&
                    this.PerUpSubstateFee.SequenceEqual(input.PerUpSubstateFee)
                ) && 
                (
                    this.PerByteFee == input.PerByteFee ||
                    (this.PerByteFee != null &&
                    this.PerByteFee.Equals(input.PerByteFee))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.PerUpSubstateFee != null)
                {
                    hashCode = (hashCode * 59) + this.PerUpSubstateFee.GetHashCode();
                }
                if (this.PerByteFee != null)
                {
                    hashCode = (hashCode * 59) + this.PerByteFee.GetHashCode();
                }
                return hashCode;
            }
        }
