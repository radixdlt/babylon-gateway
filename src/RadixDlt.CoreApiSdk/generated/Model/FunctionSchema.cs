...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// FunctionSchema
    /// </summary>
    [DataContract(Name = "FunctionSchema")]
    public partial class FunctionSchema : IEquatable<FunctionSchema>
    {
        ...
        public FunctionSchema(ReceiverInfo receiverInfo = default(ReceiverInfo), BlueprintPayloadDef input = default(BlueprintPayloadDef), BlueprintPayloadDef output = default(BlueprintPayloadDef))
        {
            ...
            if (input == null)
            {
                throw new ArgumentNullException("input is a required property for FunctionSchema and cannot be null");
            }
            this.Input = input;
        ...
        {
            return this.Equals(input as FunctionSchema);
        }

        /// <summary>
        /// Returns true if FunctionSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of FunctionSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FunctionSchema input)
        {
            if (input == null)
            {
                return false;
