...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PackageFieldInfoSubstate_allOf")]
    public partial class PackageFieldInfoSubstateAllOf : IEquatable<PackageFieldInfoSubstateAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageFieldInfoSubstateAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PackageFieldInfoSubstateAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageFieldInfoSubstateAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PackageFieldInfoSubstateAllOf);
        }

        /// <summary>
        /// Returns true if PackageFieldInfoSubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PackageFieldInfoSubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PackageFieldInfoSubstateAllOf input)
        {
            if (input == null)
            {
                return false;
