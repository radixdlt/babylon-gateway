...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ObjectIndexPartitionEntryStructure")]
    ...
    public partial class ObjectIndexPartitionEntryStructure : SubstateSystemStructure, IEquatable<ObjectIndexPartitionEntryStructure>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectIndexPartitionEntryStructure" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ObjectIndexPartitionEntryStructure() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectIndexPartitionEntryStructure" /> class.
        /// </summary>
        /// <param name="keySchema">keySchema (required).</param>
        /// <param name="valueSchema">valueSchema (required).</param>
        /// <param name="type">type (required) (default to SubstateSystemStructureType.ObjectIndexPartitionEntry).</param>
        public ObjectIndexPartitionEntryStructure(ObjectSubstateTypeReference keySchema = default(ObjectSubstateTypeReference), ObjectSubstateTypeReference valueSchema = default(ObjectSubstateTypeReference), SubstateSystemStructureType type = SubstateSystemStructureType.ObjectIndexPartitionEntry) : base(type)
        {
            // to ensure "keySchema" is required (not null)
            if (keySchema == null)
            {
                throw new ArgumentNullException("keySchema is a required property for ObjectIndexPartitionEntryStructure and cannot be null");
            }
            this.KeySchema = keySchema;
            // to ensure "valueSchema" is required (not null)
            if (valueSchema == null)
            {
                throw new ArgumentNullException("valueSchema is a required property for ObjectIndexPartitionEntryStructure and cannot be null");
            }
        ...
        {
            return this.Equals(input as ObjectIndexPartitionEntryStructure);
        }

        /// <summary>
        /// Returns true if ObjectIndexPartitionEntryStructure instances are equal
        /// </summary>
        /// <param name="input">Instance of ObjectIndexPartitionEntryStructure to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ObjectIndexPartitionEntryStructure input)
        {
            if (input == null)
            {
                return false;
