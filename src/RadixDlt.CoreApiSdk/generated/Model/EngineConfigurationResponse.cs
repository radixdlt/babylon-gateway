...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EngineConfigurationResponse")]
    public partial class EngineConfigurationResponse : IEquatable<EngineConfigurationResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EngineConfigurationResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EngineConfigurationResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EngineConfigurationResponse" /> class.
        /// </summary>
        /// <param name="checkpoints">checkpoints (required).</param>
        /// <param name="forks">forks (required).</param>
        public EngineConfigurationResponse(List<EngineCheckpoint> checkpoints = default(List<EngineCheckpoint>), List<Fork> forks = default(List<Fork>))
        {
            // to ensure "checkpoints" is required (not null)
            if (checkpoints == null)
            {
                throw new ArgumentNullException("checkpoints is a required property for EngineConfigurationResponse and cannot be null");
            }
            this.Checkpoints = checkpoints;
            // to ensure "forks" is required (not null)
            if (forks == null)
            {
                throw new ArgumentNullException("forks is a required property for EngineConfigurationResponse and cannot be null");
            }
            this.Forks = forks;
        }
        ...
        /// </summary>
        [DataMember(Name = "checkpoints", IsRequired = true, EmitDefaultValue = true)]
        public List<EngineCheckpoint> Checkpoints { get; set; }

        /// <summary>
        /// Gets or Sets Forks
        /// </summary>
        [DataMember(Name = "forks", IsRequired = true, EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as EngineConfigurationResponse);
        }

        /// <summary>
        /// Returns true if EngineConfigurationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of EngineConfigurationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EngineConfigurationResponse input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    ...
                    input.Checkpoints != null &&
                    this.Checkpoints.SequenceEqual(input.Checkpoints)
                ) && 
                (
                    this.Forks == input.Forks ||
                    this.Forks != null &&
                    input.Forks != null &&
                    this.Forks.SequenceEqual(input.Forks)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.Checkpoints.GetHashCode();
                }
                if (this.Forks != null)
                {
