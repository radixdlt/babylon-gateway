...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class ComponentRoyaltyAccumulatorSubstate : IEquatable<ComponentRoyaltyAccumulatorSubstate>, IValidatableObject
    {
        ...
        public ComponentRoyaltyAccumulatorSubstate(SubstateType substateType = default(SubstateType), string xrdAmount = default(string))
        {
            this.SubstateType = substateType;
            // to ensure "xrdAmount" is required (not null)
            if (xrdAmount == null)
            {
                throw new ArgumentNullException("xrdAmount is a required property for ComponentRoyaltyAccumulatorSubstate and cannot be null");
            }
