...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class ComponentRoyaltyAccumulatorSubstate : Substate, IEquatable<ComponentRoyaltyAccumulatorSubstate>
    {
        ...
        /// <param name="substateType">substateType (required) (default to &quot;ComponentRoyaltyAccumulatorSubstate&quot;).</param>
        public ComponentRoyaltyAccumulatorSubstate(EntityReference vaultEntity = default(EntityReference), SubstateType substateType = Model.SubstateType.ComponentRoyaltyAccumulator) : base(substateType)
        {
            // to ensure "vaultEntity" is required (not null)
            if (vaultEntity == null)
            {
                throw new ArgumentNullException("vaultEntity is a required property for ComponentRoyaltyAccumulatorSubstate and cannot be null");
            }
