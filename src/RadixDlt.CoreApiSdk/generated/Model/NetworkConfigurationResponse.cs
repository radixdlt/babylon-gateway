...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class NetworkConfigurationResponse : IEquatable<NetworkConfigurationResponse>, IValidatableObject
    {
        ...
        /// <param name="bech32HumanReadableParts">bech32HumanReadableParts (required).</param>
        public NetworkConfigurationResponse(NetworkConfigurationResponseVersion version = default(NetworkConfigurationResponseVersion), NetworkIdentifier networkIdentifier = default(NetworkIdentifier), Bech32HRPs bech32HumanReadableParts = default(Bech32HRPs))
        {
            ...
            // to ensure "bech32HumanReadableParts" is required (not null)
            if (bech32HumanReadableParts == null)
            {
                throw new ArgumentNullException("bech32HumanReadableParts is a required property for NetworkConfigurationResponse and cannot be null");
            }
        ...
        /// <summary>
        /// Gets or Sets Bech32HumanReadableParts
        /// </summary>
        [DataMember(Name = "bech32_human_readable_parts", IsRequired = true, EmitDefaultValue = true)]
        public Bech32HRPs Bech32HumanReadableParts { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Bech32HumanReadableParts: ").Append(Bech32HumanReadableParts).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(NetworkConfigurationResponse input)
        {
            ...
            return 
                ...
                (
                    this.Bech32HumanReadableParts == input.Bech32HumanReadableParts ||
                    (this.Bech32HumanReadableParts != null &&
                    this.Bech32HumanReadableParts.Equals(input.Bech32HumanReadableParts))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Bech32HumanReadableParts != null)
                {
                    hashCode = (hashCode * 59) + this.Bech32HumanReadableParts.GetHashCode();
                }
                return hashCode;
            }
        }
