...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RoundUpdateValidatorTransaction_allOf")]
    public partial class RoundUpdateValidatorTransactionAllOf : IEquatable<RoundUpdateValidatorTransactionAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoundUpdateValidatorTransactionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RoundUpdateValidatorTransactionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RoundUpdateValidatorTransactionAllOf" /> class.
        /// </summary>
        ...
        public RoundUpdateValidatorTransactionAllOf(Instant proposerTimestamp = default(Instant), long consensusEpoch = default(long), long roundInEpoch = default(long))
        {
            // to ensure "proposerTimestamp" is required (not null)
            if (proposerTimestamp == null)
            {
                throw new ArgumentNullException("proposerTimestamp is a required property for RoundUpdateValidatorTransactionAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as RoundUpdateValidatorTransactionAllOf);
        }

        /// <summary>
        /// Returns true if RoundUpdateValidatorTransactionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of RoundUpdateValidatorTransactionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoundUpdateValidatorTransactionAllOf input)
        {
            if (input == null)
            {
                return false;
