...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubstateTypeIdentifier")]
    public partial class SubstateTypeIdentifier : IEquatable<SubstateTypeIdentifier>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubstateTypeIdentifier" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SubstateTypeIdentifier() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SubstateTypeIdentifier" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        public SubstateTypeIdentifier(string type = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for SubstateTypeIdentifier and cannot be null");
            }
            this.Type = type;
        }
        ...
        {
            return this.Equals(input as SubstateTypeIdentifier);
        }

        /// <summary>
        /// Returns true if SubstateTypeIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of SubstateTypeIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubstateTypeIdentifier input)
        {
            if (input == null)
            {
                return false;
