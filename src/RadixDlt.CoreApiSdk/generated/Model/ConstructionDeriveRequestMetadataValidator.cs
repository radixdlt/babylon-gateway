...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConstructionDeriveRequestMetadataValidator")]
    ...
    public partial class ConstructionDeriveRequestMetadataValidator : ConstructionDeriveRequestMetadata, IEquatable<ConstructionDeriveRequestMetadataValidator>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionDeriveRequestMetadataValidator" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConstructionDeriveRequestMetadataValidator() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionDeriveRequestMetadataValidator" /> class.
        /// </summary>
        /// <param name="type">type (required) (default to &quot;ConstructionDeriveRequestMetadataValidator&quot;).</param>
        public ConstructionDeriveRequestMetadataValidator(string type = "ConstructionDeriveRequestMetadataValidator") : base(type)
        {
        }
        ...
        {
            return this.Equals(input as ConstructionDeriveRequestMetadataValidator);
        }

        /// <summary>
        /// Returns true if ConstructionDeriveRequestMetadataValidator instances are equal
        /// </summary>
        /// <param name="input">Instance of ConstructionDeriveRequestMetadataValidator to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConstructionDeriveRequestMetadataValidator input)
        {
            if (input == null)
            {
                return false;
