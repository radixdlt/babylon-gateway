...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PreparedValidatorFee")]
    ...
    public partial class PreparedValidatorFee : DataObject, IEquatable<PreparedValidatorFee>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PreparedValidatorFee" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PreparedValidatorFee() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PreparedValidatorFee" /> class.
        /// </summary>
        /// <param name="fee">The fee percentage of the validator which will be updated in the future epoch. (required).</param>
        /// <param name="epoch">epoch.</param>
        /// <param name="type">The type of the data object. Each address may own up to one current object of a given type. (required) (default to &quot;PreparedValidatorFee&quot;).</param>
        public PreparedValidatorFee(int fee = default(int), long epoch = default(long), string type = "PreparedValidatorFee") : base(type)
        {
            this.Fee = fee;
            this.Epoch = epoch;
        }
        ...
        /// </summary>
        /// <value>The fee percentage of the validator which will be updated in the future epoch.</value>
        ...
        {
            return this.Equals(input as PreparedValidatorFee);
        }

        /// <summary>
        /// Returns true if PreparedValidatorFee instances are equal
        /// </summary>
        /// <param name="input">Instance of PreparedValidatorFee to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreparedValidatorFee input)
        {
            if (input == null)
            {
                return false;
