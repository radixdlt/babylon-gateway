...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PackageBlueprintDependenciesEntrySubstate")]
    ...
    public partial class PackageBlueprintDependenciesEntrySubstate : Substate, IEquatable<PackageBlueprintDependenciesEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageBlueprintDependenciesEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PackageBlueprintDependenciesEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageBlueprintDependenciesEntrySubstate" /> class.
        /// </summary>
        ...
        /// <param name="substateType">substateType (required) (default to SubstateType.PackageBlueprintDependenciesEntry).</param>
        public PackageBlueprintDependenciesEntrySubstate(string blueprintName = default(string), string blueprintVersion = default(string), BlueprintDependencies dependencies = default(BlueprintDependencies), SubstateType substateType = SubstateType.PackageBlueprintDependenciesEntry) : base(substateType)
        {
            // to ensure "blueprintName" is required (not null)
            if (blueprintName == null)
            {
                throw new ArgumentNullException("blueprintName is a required property for PackageBlueprintDependenciesEntrySubstate and cannot be null");
            }
            this.BlueprintName = blueprintName;
            // to ensure "blueprintVersion" is required (not null)
            if (blueprintVersion == null)
            {
                throw new ArgumentNullException("blueprintVersion is a required property for PackageBlueprintDependenciesEntrySubstate and cannot be null");
            }
            this.BlueprintVersion = blueprintVersion;
            // to ensure "dependencies" is required (not null)
            if (dependencies == null)
            {
                throw new ArgumentNullException("dependencies is a required property for PackageBlueprintDependenciesEntrySubstate and cannot be null");
            }
        ...
        {
            return this.Equals(input as PackageBlueprintDependenciesEntrySubstate);
        }

        /// <summary>
        /// Returns true if PackageBlueprintDependenciesEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of PackageBlueprintDependenciesEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PackageBlueprintDependenciesEntrySubstate input)
        {
            if (input == null)
            {
                return false;
