...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionCallPreviewResponse")]
    public partial class TransactionCallPreviewResponse : IEquatable<TransactionCallPreviewResponse>
    {
        ...
        protected TransactionCallPreviewResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionCallPreviewResponse" /> class.
        /// </summary>
        ...
        public SborData Output { get; set; }
        ...
        {
            return this.Equals(input as TransactionCallPreviewResponse);
        }

        /// <summary>
        /// Returns true if TransactionCallPreviewResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionCallPreviewResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionCallPreviewResponse input)
        {
            if (input == null)
            {
                return false;
