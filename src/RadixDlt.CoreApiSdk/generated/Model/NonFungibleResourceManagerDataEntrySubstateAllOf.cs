...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class NonFungibleResourceManagerDataEntrySubstateAllOf : IEquatable<NonFungibleResourceManagerDataEntrySubstateAllOf>
    {
        ...
        protected NonFungibleResourceManagerDataEntrySubstateAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NonFungibleResourceManagerDataEntrySubstateAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as NonFungibleResourceManagerDataEntrySubstateAllOf);
        }

        /// <summary>
        /// Returns true if NonFungibleResourceManagerDataEntrySubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of NonFungibleResourceManagerDataEntrySubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NonFungibleResourceManagerDataEntrySubstateAllOf input)
        {
            if (input == null)
            {
                return false;
