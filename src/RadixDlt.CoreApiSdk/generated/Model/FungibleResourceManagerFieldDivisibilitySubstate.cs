...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FungibleResourceManagerFieldDivisibilitySubstate")]
    ...
    public partial class FungibleResourceManagerFieldDivisibilitySubstate : Substate, IEquatable<FungibleResourceManagerFieldDivisibilitySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FungibleResourceManagerFieldDivisibilitySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FungibleResourceManagerFieldDivisibilitySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FungibleResourceManagerFieldDivisibilitySubstate" /> class.
        /// </summary>
        ...
        public FungibleResourceManagerFieldDivisibilitySubstate(FungibleResourceManagerFieldDivisibilityValue value = default(FungibleResourceManagerFieldDivisibilityValue), SubstateType substateType = SubstateType.FungibleResourceManagerFieldDivisibility, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for FungibleResourceManagerFieldDivisibilitySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as FungibleResourceManagerFieldDivisibilitySubstate);
        }

        /// <summary>
        /// Returns true if FungibleResourceManagerFieldDivisibilitySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of FungibleResourceManagerFieldDivisibilitySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FungibleResourceManagerFieldDivisibilitySubstate input)
        {
            if (input == null)
            {
                return false;
