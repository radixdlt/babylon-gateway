...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TokenResourceIdentifier_allOf")]
    public partial class TokenResourceIdentifierAllOf : IEquatable<TokenResourceIdentifierAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenResourceIdentifierAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TokenResourceIdentifierAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenResourceIdentifierAllOf" /> class.
        /// </summary>
        /// <param name="rri">The Radix Resource Identifier \&quot;RRI\&quot; of the token. (required).</param>
        public TokenResourceIdentifierAllOf(string rri = default(string))
        {
            // to ensure "rri" is required (not null)
            if (rri == null)
            {
                throw new ArgumentNullException("rri is a required property for TokenResourceIdentifierAllOf and cannot be null");
            }
            this.Rri = rri;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TokenResourceIdentifierAllOf {\n");
        ...
        {
            return this.Equals(input as TokenResourceIdentifierAllOf);
        }

        /// <summary>
        /// Returns true if TokenResourceIdentifierAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenResourceIdentifierAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenResourceIdentifierAllOf input)
        {
            if (input == null)
            {
                return false;
