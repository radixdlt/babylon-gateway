...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConsensusManagerFieldValidatorRewardsSubstate")]
    ...
    public partial class ConsensusManagerFieldValidatorRewardsSubstate : Substate, IEquatable<ConsensusManagerFieldValidatorRewardsSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsensusManagerFieldValidatorRewardsSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConsensusManagerFieldValidatorRewardsSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsensusManagerFieldValidatorRewardsSubstate" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ConsensusManagerFieldValidatorRewardsSubstate);
        }

        /// <summary>
        /// Returns true if ConsensusManagerFieldValidatorRewardsSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of ConsensusManagerFieldValidatorRewardsSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConsensusManagerFieldValidatorRewardsSubstate input)
        {
            if (input == null)
            {
                return false;
