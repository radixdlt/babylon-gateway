...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubstateDependencyNotFoundError")]
    ...
    public partial class SubstateDependencyNotFoundError : CoreError, IEquatable<SubstateDependencyNotFoundError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubstateDependencyNotFoundError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SubstateDependencyNotFoundError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SubstateDependencyNotFoundError" /> class.
        /// </summary>
        /// <param name="substateIdentifierNotFound">substateIdentifierNotFound (required).</param>
        /// <param name="type">type (required) (default to &quot;SubstateDependencyNotFoundError&quot;).</param>
        public SubstateDependencyNotFoundError(SubstateIdentifier substateIdentifierNotFound = default(SubstateIdentifier), string type = "SubstateDependencyNotFoundError") : base(type)
        {
            // to ensure "substateIdentifierNotFound" is required (not null)
            if (substateIdentifierNotFound == null)
            {
                throw new ArgumentNullException("substateIdentifierNotFound is a required property for SubstateDependencyNotFoundError and cannot be null");
            }
            this.SubstateIdentifierNotFound = substateIdentifierNotFound;
        }

        /// <summary>
        /// Gets or Sets SubstateIdentifierNotFound
        /// </summary>
        [DataMember(Name = "substate_identifier_not_found", IsRequired = true, EmitDefaultValue = true)]
        public SubstateIdentifier SubstateIdentifierNotFound { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SubstateIdentifierNotFound: ").Append(SubstateIdentifierNotFound).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as SubstateDependencyNotFoundError);
        }

        /// <summary>
        /// Returns true if SubstateDependencyNotFoundError instances are equal
        /// </summary>
        /// <param name="input">Instance of SubstateDependencyNotFoundError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubstateDependencyNotFoundError input)
        {
            if (input == null)
            {
                return false;
            ...
            return base.Equals(input) && 
                (
                    this.SubstateIdentifierNotFound == input.SubstateIdentifierNotFound ||
                    (this.SubstateIdentifierNotFound != null &&
                    this.SubstateIdentifierNotFound.Equals(input.SubstateIdentifierNotFound))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SubstateIdentifierNotFound != null)
                {
                    hashCode = (hashCode * 59) + this.SubstateIdentifierNotFound.GetHashCode();
                }
                return hashCode;
            }
        }
