...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RoyaltyModuleFieldConfigSubstate")]
    ...
    public partial class RoyaltyModuleFieldConfigSubstate : Substate, IEquatable<RoyaltyModuleFieldConfigSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoyaltyModuleFieldConfigSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RoyaltyModuleFieldConfigSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RoyaltyModuleFieldConfigSubstate" /> class.
        /// </summary>
        /// <param name="royaltyConfig">royaltyConfig (required).</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.RoyaltyModuleFieldConfig).</param>
        public RoyaltyModuleFieldConfigSubstate(RoyaltyConfig royaltyConfig = default(RoyaltyConfig), SubstateType substateType = SubstateType.RoyaltyModuleFieldConfig) : base(substateType)
        {
            // to ensure "royaltyConfig" is required (not null)
            if (royaltyConfig == null)
            {
                throw new ArgumentNullException("royaltyConfig is a required property for RoyaltyModuleFieldConfigSubstate and cannot be null");
            }
        ...
        {
            return this.Equals(input as RoyaltyModuleFieldConfigSubstate);
        }

        /// <summary>
        /// Returns true if RoyaltyModuleFieldConfigSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of RoyaltyModuleFieldConfigSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoyaltyModuleFieldConfigSubstate input)
        {
            if (input == null)
            {
                return false;
