...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// PublicKeyEntry
    /// </summary>
    [DataContract(Name = "PublicKeyEntry")]
    public partial class PublicKeyEntry : IEquatable<PublicKeyEntry>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicKeyEntry" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublicKeyEntry() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicKeyEntry" /> class.
        /// </summary>
        /// <param name="publicKey">publicKey (required).</param>
        /// <param name="identifiers">identifiers.</param>
        public PublicKeyEntry(PublicKey publicKey = default(PublicKey), PublicKeyIdentifiers identifiers = default(PublicKeyIdentifiers))
        {
            // to ensure "publicKey" is required (not null)
            if (publicKey == null)
            {
                throw new ArgumentNullException("publicKey is a required property for PublicKeyEntry and cannot be null");
            }
        ...
        public PublicKeyIdentifiers Identifiers { get; set; }
        ...
        {
            return this.Equals(input as PublicKeyEntry);
        }

        /// <summary>
        /// Returns true if PublicKeyEntry instances are equal
        /// </summary>
        /// <param name="input">Instance of PublicKeyEntry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PublicKeyEntry input)
        {
            if (input == null)
            {
                return false;
