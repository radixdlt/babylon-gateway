...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PendingOwnerStakeWithdrawal")]
    public partial class PendingOwnerStakeWithdrawal : IEquatable<PendingOwnerStakeWithdrawal>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PendingOwnerStakeWithdrawal" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PendingOwnerStakeWithdrawal() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PendingOwnerStakeWithdrawal" /> class.
        /// </summary>
        ...
        /// <param name="stakeUnitAmount">A string-encoded fixed-precision decimal to 18 decimal places. A decimal is formed of some signed integer &#x60;m&#x60; of attos (&#x60;10^(-18)&#x60;) units, where &#x60;-2^(256 - 1) &lt;&#x3D; m &lt; 2^(256 - 1)&#x60;.  (required).</param>
        public PendingOwnerStakeWithdrawal(long epochUnlocked = default(long), string stakeUnitAmount = default(string))
        {
            this.EpochUnlocked = epochUnlocked;
            // to ensure "stakeUnitAmount" is required (not null)
            if (stakeUnitAmount == null)
            {
                throw new ArgumentNullException("stakeUnitAmount is a required property for PendingOwnerStakeWithdrawal and cannot be null");
            }
        ...
        {
            return this.Equals(input as PendingOwnerStakeWithdrawal);
        }

        /// <summary>
        /// Returns true if PendingOwnerStakeWithdrawal instances are equal
        /// </summary>
        /// <param name="input">Instance of PendingOwnerStakeWithdrawal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PendingOwnerStakeWithdrawal input)
        {
            if (input == null)
            {
                return false;
