...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OneResourcePoolFieldStateSubstate")]
    ...
    public partial class OneResourcePoolFieldStateSubstate : Substate, IEquatable<OneResourcePoolFieldStateSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneResourcePoolFieldStateSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OneResourcePoolFieldStateSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OneResourcePoolFieldStateSubstate" /> class.
        /// </summary>
        ...
        public OneResourcePoolFieldStateSubstate(EntityReference vault = default(EntityReference), string poolUnitResourceAddress = default(string), SubstateType substateType = SubstateType.OneResourcePoolFieldState) : base(substateType)
        {
        ...
        {
            return this.Equals(input as OneResourcePoolFieldStateSubstate);
        }

        /// <summary>
        /// Returns true if OneResourcePoolFieldStateSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of OneResourcePoolFieldStateSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneResourcePoolFieldStateSubstate input)
        {
            if (input == null)
            {
                return false;
