...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class AccountDepositRuleIndexEntrySubstateAllOf : IEquatable<AccountDepositRuleIndexEntrySubstateAllOf>
    {
        ...
        protected AccountDepositRuleIndexEntrySubstateAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountDepositRuleIndexEntrySubstateAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AccountDepositRuleIndexEntrySubstateAllOf);
        }

        /// <summary>
        /// Returns true if AccountDepositRuleIndexEntrySubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountDepositRuleIndexEntrySubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountDepositRuleIndexEntrySubstateAllOf input)
        {
            if (input == null)
            {
                return false;
