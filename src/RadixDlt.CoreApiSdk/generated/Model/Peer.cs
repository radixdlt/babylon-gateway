...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class Peer : IEquatable<Peer>, IValidatableObject
    {
        ...
        public Peer(string peerId = default(string))
        {
            // to ensure "peerId" is required (not null)
            if (peerId == null)
            {
                throw new ArgumentNullException("peerId is a required property for Peer and cannot be null");
            }
            this.PeerId = peerId;
        }
        ...
        /// Gets or Sets PeerId
        /// </summary>
        [DataMember(Name = "peer_id", IsRequired = true, EmitDefaultValue = true)]
