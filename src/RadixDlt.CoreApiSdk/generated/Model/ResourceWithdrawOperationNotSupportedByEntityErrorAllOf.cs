...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceWithdrawOperationNotSupportedByEntityError_allOf")]
    public partial class ResourceWithdrawOperationNotSupportedByEntityErrorAllOf : IEquatable<ResourceWithdrawOperationNotSupportedByEntityErrorAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceWithdrawOperationNotSupportedByEntityErrorAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceWithdrawOperationNotSupportedByEntityErrorAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceWithdrawOperationNotSupportedByEntityErrorAllOf" /> class.
        /// </summary>
        ...
        public ResourceWithdrawOperationNotSupportedByEntityErrorAllOf(EntityIdentifier entityIdentifier = default(EntityIdentifier), ResourceIdentifier resourceWithdrawNotSupported = default(ResourceIdentifier))
        {
            // to ensure "entityIdentifier" is required (not null)
            if (entityIdentifier == null)
            {
                throw new ArgumentNullException("entityIdentifier is a required property for ResourceWithdrawOperationNotSupportedByEntityErrorAllOf and cannot be null");
            }
            this.EntityIdentifier = entityIdentifier;
            // to ensure "resourceWithdrawNotSupported" is required (not null)
            if (resourceWithdrawNotSupported == null)
            {
                throw new ArgumentNullException("resourceWithdrawNotSupported is a required property for ResourceWithdrawOperationNotSupportedByEntityErrorAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceWithdrawOperationNotSupportedByEntityErrorAllOf {\n");
        ...
        {
            return this.Equals(input as ResourceWithdrawOperationNotSupportedByEntityErrorAllOf);
        }

        /// <summary>
        /// Returns true if ResourceWithdrawOperationNotSupportedByEntityErrorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceWithdrawOperationNotSupportedByEntityErrorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceWithdrawOperationNotSupportedByEntityErrorAllOf input)
        {
            if (input == null)
            {
                return false;
