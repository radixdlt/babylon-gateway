...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// InvalidHexError
    /// </summary>
    [DataContract(Name = "InvalidHexError")]
    ...
    public partial class InvalidHexError : CoreError, IEquatable<InvalidHexError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidHexError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvalidHexError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidHexError" /> class.
        /// </summary>
        /// <param name="invalidHex">invalidHex (required).</param>
        /// <param name="type">type (required) (default to &quot;InvalidHexError&quot;).</param>
        public InvalidHexError(string invalidHex = default(string), string type = "InvalidHexError") : base(type)
        {
            // to ensure "invalidHex" is required (not null)
            if (invalidHex == null)
            {
                throw new ArgumentNullException("invalidHex is a required property for InvalidHexError and cannot be null");
            }
            this.InvalidHex = invalidHex;
        }

        /// <summary>
        /// Gets or Sets InvalidHex
        /// </summary>
        [DataMember(Name = "invalid_hex", IsRequired = true, EmitDefaultValue = true)]
        public string InvalidHex { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InvalidHex: ").Append(InvalidHex).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as InvalidHexError);
        }

        /// <summary>
        /// Returns true if InvalidHexError instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidHexError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidHexError input)
        {
            if (input == null)
            {
                return false;
            ...
            return base.Equals(input) && 
                (
                    this.InvalidHex == input.InvalidHex ||
                    (this.InvalidHex != null &&
                    this.InvalidHex.Equals(input.InvalidHex))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.InvalidHex.GetHashCode();
                }
                return hashCode;
            }
        }
