...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class DenyAllAccessRule : AccessRule, IEquatable<DenyAllAccessRule>
    {
        ...
        protected DenyAllAccessRule() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DenyAllAccessRule" /> class.
        /// </summary>
        /// <param name="type">type (required) (default to AccessRuleType.DenyAll).</param>
        public DenyAllAccessRule(AccessRuleType type = AccessRuleType.DenyAll) : base(type)
        {
        }
        ...
        {
            return this.Equals(input as DenyAllAccessRule);
        }

        /// <summary>
        /// Returns true if DenyAllAccessRule instances are equal
        /// </summary>
        /// <param name="input">Instance of DenyAllAccessRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DenyAllAccessRule input)
        {
            if (input == null)
            {
                return false;
