...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class TransactionNotFoundError : CoreError, IEquatable<TransactionNotFoundError>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="type">type (required) (default to &quot;TransactionNotFoundError&quot;).</param>
        public TransactionNotFoundError(TransactionIdentifier transactionIdentifier = default(TransactionIdentifier), string type = "TransactionNotFoundError") : base(type)
        {
            // to ensure "transactionIdentifier" is required (not null)
            if (transactionIdentifier == null)
            {
                throw new ArgumentNullException("transactionIdentifier is a required property for TransactionNotFoundError and cannot be null");
            }
