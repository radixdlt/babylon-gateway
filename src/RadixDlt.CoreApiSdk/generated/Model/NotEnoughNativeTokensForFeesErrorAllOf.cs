...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class NotEnoughNativeTokensForFeesErrorAllOf : IEquatable<NotEnoughNativeTokensForFeesErrorAllOf>, IValidatableObject
    {
        ...
        public NotEnoughNativeTokensForFeesErrorAllOf(ResourceAmount available = default(ResourceAmount), ResourceAmount feeEstimate = default(ResourceAmount))
        {
            // to ensure "available" is required (not null)
            if (available == null)
            {
                throw new ArgumentNullException("available is a required property for NotEnoughNativeTokensForFeesErrorAllOf and cannot be null");
            }
            this.Available = available;
            // to ensure "feeEstimate" is required (not null)
            if (feeEstimate == null)
            {
                throw new ArgumentNullException("feeEstimate is a required property for NotEnoughNativeTokensForFeesErrorAllOf and cannot be null");
            }
