...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class NonFungibleStoreEntrySubstate : Substate, IEquatable<NonFungibleStoreEntrySubstate>
    {
        ...
        /// <param name="substateType">substateType (required) (default to &quot;NonFungibleStoreEntrySubstate&quot;).</param>
        public NonFungibleStoreEntrySubstate(NonFungibleId nonFungibleId = default(NonFungibleId), NonFungibleData nonFungibleData = default(NonFungibleData), bool isDeleted = default(bool), SubstateType substateType = Model.SubstateType.NonFungibleStoreEntry) : base(substateType)
        {
