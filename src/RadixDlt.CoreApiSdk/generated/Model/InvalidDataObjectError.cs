...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InvalidDataObjectError")]
    ...
    public partial class InvalidDataObjectError : CoreError, IEquatable<InvalidDataObjectError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidDataObjectError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvalidDataObjectError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidDataObjectError" /> class.
        /// </summary>
        /// <param name="invalidDataObject">invalidDataObject (required).</param>
        /// <param name="message">message (required).</param>
        /// <param name="type">type (required) (default to &quot;InvalidDataObjectError&quot;).</param>
        public InvalidDataObjectError(DataObject invalidDataObject = default(DataObject), string message = default(string), string type = "InvalidDataObjectError") : base(type)
        {
            // to ensure "invalidDataObject" is required (not null)
            if (invalidDataObject == null)
            {
                throw new ArgumentNullException("invalidDataObject is a required property for InvalidDataObjectError and cannot be null");
            }
            this.InvalidDataObject = invalidDataObject;
            // to ensure "message" is required (not null)
            if (message == null)
            {
                throw new ArgumentNullException("message is a required property for InvalidDataObjectError and cannot be null");
            }
            this.Message = message;
        }

        /// <summary>
        /// Gets or Sets InvalidDataObject
        /// </summary>
        [DataMember(Name = "invalid_data_object", IsRequired = true, EmitDefaultValue = true)]
        public DataObject InvalidDataObject { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InvalidDataObject: ").Append(InvalidDataObject).Append("\n");
        ...
        {
            return this.Equals(input as InvalidDataObjectError);
        }

        /// <summary>
        /// Returns true if InvalidDataObjectError instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidDataObjectError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidDataObjectError input)
        {
            if (input == null)
            {
                return false;
            ...
            return base.Equals(input) && 
                (
                    this.InvalidDataObject == input.InvalidDataObject ||
                    (this.InvalidDataObject != null &&
                    this.InvalidDataObject.Equals(input.InvalidDataObject))
                ) && base.Equals(input) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InvalidDataObject != null)
                {
                    hashCode = (hashCode * 59) + this.InvalidDataObject.GetHashCode();
                }
