...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class IndexBlueprintCollectionSchemaAllOf : IEquatable<IndexBlueprintCollectionSchemaAllOf>
    {
        ...
        public IndexBlueprintCollectionSchemaAllOf(TypePointer keyTypePointer = default(TypePointer), TypePointer valueTypePointer = default(TypePointer), bool canOwn = default(bool))
        {
            // to ensure "keyTypePointer" is required (not null)
            if (keyTypePointer == null)
            {
                throw new ArgumentNullException("keyTypePointer is a required property for IndexBlueprintCollectionSchemaAllOf and cannot be null");
            }
            this.KeyTypePointer = keyTypePointer;
            // to ensure "valueTypePointer" is required (not null)
            if (valueTypePointer == null)
            {
                throw new ArgumentNullException("valueTypePointer is a required property for IndexBlueprintCollectionSchemaAllOf and cannot be null");
            }
