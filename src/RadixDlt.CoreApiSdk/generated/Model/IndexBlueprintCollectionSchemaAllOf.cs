...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IndexBlueprintCollectionSchema_allOf")]
    public partial class IndexBlueprintCollectionSchemaAllOf : IEquatable<IndexBlueprintCollectionSchemaAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IndexBlueprintCollectionSchemaAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IndexBlueprintCollectionSchemaAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IndexBlueprintCollectionSchemaAllOf" /> class.
        /// </summary>
        ...
        public IndexBlueprintCollectionSchemaAllOf(BlueprintPayloadDef keyTypeRef = default(BlueprintPayloadDef), BlueprintPayloadDef valueTypeRef = default(BlueprintPayloadDef), bool allowOwnership = default(bool))
        {
            // to ensure "keyTypeRef" is required (not null)
            if (keyTypeRef == null)
            {
                throw new ArgumentNullException("keyTypeRef is a required property for IndexBlueprintCollectionSchemaAllOf and cannot be null");
            }
            this.KeyTypeRef = keyTypeRef;
            // to ensure "valueTypeRef" is required (not null)
            if (valueTypeRef == null)
            {
                throw new ArgumentNullException("valueTypeRef is a required property for IndexBlueprintCollectionSchemaAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as IndexBlueprintCollectionSchemaAllOf);
        }

        /// <summary>
        /// Returns true if IndexBlueprintCollectionSchemaAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of IndexBlueprintCollectionSchemaAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IndexBlueprintCollectionSchemaAllOf input)
        {
            if (input == null)
            {
                return false;
