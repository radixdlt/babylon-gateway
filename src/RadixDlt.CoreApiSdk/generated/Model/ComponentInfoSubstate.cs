...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class ComponentInfoSubstate : Substate, IEquatable<ComponentInfoSubstate>
    {
        ...
        public ComponentInfoSubstate(string packageAddress = default(string), string blueprintName = default(string), SubstateType substateType = Model.SubstateType.ComponentInfo) : base(substateType)
        {
