...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountAuthorizedDepositorEntrySubstate")]
    ...
    public partial class AccountAuthorizedDepositorEntrySubstate : Substate, IEquatable<AccountAuthorizedDepositorEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountAuthorizedDepositorEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountAuthorizedDepositorEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountAuthorizedDepositorEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value.</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.AccountAuthorizedDepositorEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public AccountAuthorizedDepositorEntrySubstate(AuthorizedDepositorKey key = default(AuthorizedDepositorKey), AccountAuthorizedDepositorEntryValue value = default(AccountAuthorizedDepositorEntryValue), SubstateType substateType = SubstateType.AccountAuthorizedDepositorEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for AccountAuthorizedDepositorEntrySubstate and cannot be null");
            }
            this.Key = key;
            this.Value = value;
        }
        ...
        public AuthorizedDepositorKey Key { get; set; }

        /// <summary>
        /// Gets or Sets Value
        /// </summary>
        [DataMember(Name = "value", EmitDefaultValue = true)]
        public AccountAuthorizedDepositorEntryValue Value { get; set; }
        ...
        {
            return this.Equals(input as AccountAuthorizedDepositorEntrySubstate);
        }

        /// <summary>
        /// Returns true if AccountAuthorizedDepositorEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountAuthorizedDepositorEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountAuthorizedDepositorEntrySubstate input)
        {
            if (input == null)
            {
                return false;
