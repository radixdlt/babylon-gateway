...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// KeySignResponse
    /// </summary>
    [DataContract(Name = "KeySignResponse")]
    public partial class KeySignResponse : IEquatable<KeySignResponse>, IValidatableObject
    {
        ...
        protected KeySignResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KeySignResponse" /> class.
        /// </summary>
        /// <param name="signedTransaction">Byte array of the signed transaction encoded in hex. (required).</param>
        public KeySignResponse(string signedTransaction = default(string))
        {
            // to ensure "signedTransaction" is required (not null)
            if (signedTransaction == null)
            {
                throw new ArgumentNullException("signedTransaction is a required property for KeySignResponse and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Byte array of the signed transaction encoded in hex.</value>
        ...
        {
            return this.Equals(input as KeySignResponse);
        }

        /// <summary>
        /// Returns true if KeySignResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of KeySignResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KeySignResponse input)
        {
            if (input == null)
            {
                return false;
