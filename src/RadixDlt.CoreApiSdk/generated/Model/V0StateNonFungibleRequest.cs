...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class V0StateNonFungibleRequest : IEquatable<V0StateNonFungibleRequest>
    {
        ...
        protected V0StateNonFungibleRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V0StateNonFungibleRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as V0StateNonFungibleRequest);
        }

        /// <summary>
        /// Returns true if V0StateNonFungibleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of V0StateNonFungibleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V0StateNonFungibleRequest input)
        {
            if (input == null)
            {
                return false;
