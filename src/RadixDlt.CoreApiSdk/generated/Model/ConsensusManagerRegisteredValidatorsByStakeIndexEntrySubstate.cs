...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate")]
    ...
    public partial class ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate : Substate, IEquatable<ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate);
        }

        /// <summary>
        /// Returns true if ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate input)
        {
            if (input == null)
            {
                return false;
