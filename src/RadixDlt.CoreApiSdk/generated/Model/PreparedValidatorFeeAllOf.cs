...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PreparedValidatorFee_allOf")]
    public partial class PreparedValidatorFeeAllOf : IEquatable<PreparedValidatorFeeAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PreparedValidatorFeeAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PreparedValidatorFeeAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PreparedValidatorFeeAllOf" /> class.
        /// </summary>
        /// <param name="fee">The fee percentage of the validator which will be updated in the future epoch. (required).</param>
        /// <param name="epoch">epoch.</param>
        public PreparedValidatorFeeAllOf(int fee = default(int), long epoch = default(long))
        {
            this.Fee = fee;
            this.Epoch = epoch;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PreparedValidatorFeeAllOf {\n");
        ...
        {
            return this.Equals(input as PreparedValidatorFeeAllOf);
        }

        /// <summary>
        /// Returns true if PreparedValidatorFeeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PreparedValidatorFeeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreparedValidatorFeeAllOf input)
        {
            if (input == null)
            {
                return false;
