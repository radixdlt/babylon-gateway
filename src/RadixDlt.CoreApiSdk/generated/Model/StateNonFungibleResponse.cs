...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StateNonFungibleResponse")]
    public partial class StateNonFungibleResponse : IEquatable<StateNonFungibleResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StateNonFungibleResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StateNonFungibleResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StateNonFungibleResponse" /> class.
        /// </summary>
        ...
        public StateNonFungibleResponse(LedgerStateSummary atLedgerState = default(LedgerStateSummary), Substate nonFungible = default(Substate))
        {
            ...
            if (nonFungible == null)
            {
                throw new ArgumentNullException("nonFungible is a required property for StateNonFungibleResponse and cannot be null");
            }
        ...
        public Substate NonFungible { get; set; }
        ...
        {
            return this.Equals(input as StateNonFungibleResponse);
        }

        /// <summary>
        /// Returns true if StateNonFungibleResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of StateNonFungibleResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StateNonFungibleResponse input)
        {
            if (input == null)
            {
                return false;
