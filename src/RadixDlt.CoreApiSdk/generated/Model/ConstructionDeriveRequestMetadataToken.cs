...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConstructionDeriveRequestMetadataToken")]
    ...
    public partial class ConstructionDeriveRequestMetadataToken : ConstructionDeriveRequestMetadata, IEquatable<ConstructionDeriveRequestMetadataToken>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionDeriveRequestMetadataToken" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConstructionDeriveRequestMetadataToken() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionDeriveRequestMetadataToken" /> class.
        /// </summary>
        /// <param name="symbol">The symbol of the token (required).</param>
        /// <param name="type">type (required) (default to &quot;ConstructionDeriveRequestMetadataToken&quot;).</param>
        public ConstructionDeriveRequestMetadataToken(string symbol = default(string), string type = "ConstructionDeriveRequestMetadataToken") : base(type)
        {
            // to ensure "symbol" is required (not null)
            if (symbol == null)
            {
                throw new ArgumentNullException("symbol is a required property for ConstructionDeriveRequestMetadataToken and cannot be null");
            }
            this.Symbol = symbol;
        }
        ...
        {
            return this.Equals(input as ConstructionDeriveRequestMetadataToken);
        }

        /// <summary>
        /// Returns true if ConstructionDeriveRequestMetadataToken instances are equal
        /// </summary>
        /// <param name="input">Instance of ConstructionDeriveRequestMetadataToken to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConstructionDeriveRequestMetadataToken input)
        {
            if (input == null)
            {
                return false;
