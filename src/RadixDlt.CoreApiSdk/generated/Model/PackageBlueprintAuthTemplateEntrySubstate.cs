...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PackageBlueprintAuthTemplateEntrySubstate")]
    ...
    public partial class PackageBlueprintAuthTemplateEntrySubstate : Substate, IEquatable<PackageBlueprintAuthTemplateEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageBlueprintAuthTemplateEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PackageBlueprintAuthTemplateEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageBlueprintAuthTemplateEntrySubstate" /> class.
        /// </summary>
        ...
        public PackageBlueprintAuthTemplateEntrySubstate(string blueprintName = default(string), string blueprintVersion = default(string), AuthConfig authConfig = default(AuthConfig), SubstateType substateType = SubstateType.PackageBlueprintAuthTemplateEntry) : base(substateType)
        {
            // to ensure "blueprintName" is required (not null)
            if (blueprintName == null)
            {
                throw new ArgumentNullException("blueprintName is a required property for PackageBlueprintAuthTemplateEntrySubstate and cannot be null");
            }
            this.BlueprintName = blueprintName;
            // to ensure "blueprintVersion" is required (not null)
            if (blueprintVersion == null)
            {
                throw new ArgumentNullException("blueprintVersion is a required property for PackageBlueprintAuthTemplateEntrySubstate and cannot be null");
            }
        ...
        {
            return this.Equals(input as PackageBlueprintAuthTemplateEntrySubstate);
        }

        /// <summary>
        /// Returns true if PackageBlueprintAuthTemplateEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of PackageBlueprintAuthTemplateEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PackageBlueprintAuthTemplateEntrySubstate input)
        {
            if (input == null)
            {
                return false;
