...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StakeUnitResourceIdentifier_allOf")]
    public partial class StakeUnitResourceIdentifierAllOf : IEquatable<StakeUnitResourceIdentifierAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StakeUnitResourceIdentifierAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StakeUnitResourceIdentifierAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StakeUnitResourceIdentifierAllOf" /> class.
        /// </summary>
        /// <param name="validatorAddress">The validator associated with this stake unit. (required).</param>
        public StakeUnitResourceIdentifierAllOf(string validatorAddress = default(string))
        {
            // to ensure "validatorAddress" is required (not null)
            if (validatorAddress == null)
            {
                throw new ArgumentNullException("validatorAddress is a required property for StakeUnitResourceIdentifierAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StakeUnitResourceIdentifierAllOf {\n");
        ...
        {
            return this.Equals(input as StakeUnitResourceIdentifierAllOf);
        }

        /// <summary>
        /// Returns true if StakeUnitResourceIdentifierAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of StakeUnitResourceIdentifierAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StakeUnitResourceIdentifierAllOf input)
        {
            if (input == null)
            {
                return false;
