...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FeeConstructionError")]
    ...
    public partial class FeeConstructionError : CoreError, IEquatable<FeeConstructionError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FeeConstructionError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FeeConstructionError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FeeConstructionError" /> class.
        /// </summary>
        /// <param name="attempts">attempts (required).</param>
        /// <param name="type">type (required) (default to &quot;FeeConstructionError&quot;).</param>
        public FeeConstructionError(int attempts = default(int), string type = "FeeConstructionError") : base(type)
        {
        ...
        {
            return this.Equals(input as FeeConstructionError);
        }

        /// <summary>
        /// Returns true if FeeConstructionError instances are equal
        /// </summary>
        /// <param name="input">Instance of FeeConstructionError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FeeConstructionError input)
        {
            if (input == null)
            {
                return false;
