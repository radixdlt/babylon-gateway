...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConstructionParseResponse")]
    public partial class ConstructionParseResponse : IEquatable<ConstructionParseResponse>, IValidatableObject
    {
        ...
        protected ConstructionParseResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionParseResponse" /> class.
        /// </summary>
        /// <param name="operationGroups">The parsed operation groups. (required).</param>
        /// <param name="metadata">metadata.</param>
        public ConstructionParseResponse(List<OperationGroup> operationGroups = default(List<OperationGroup>), ParsedTransactionMetadata metadata = default(ParsedTransactionMetadata))
        {
            // to ensure "operationGroups" is required (not null)
            if (operationGroups == null)
            {
                throw new ArgumentNullException("operationGroups is a required property for ConstructionParseResponse and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The parsed operation groups.</value>
        ...
        public ParsedTransactionMetadata Metadata { get; set; }
