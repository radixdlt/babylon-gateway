...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// EngineStatusRequest
    /// </summary>
    [DataContract(Name = "EngineStatusRequest")]
    public partial class EngineStatusRequest : IEquatable<EngineStatusRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EngineStatusRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EngineStatusRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EngineStatusRequest" /> class.
        /// </summary>
        /// <param name="networkIdentifier">networkIdentifier (required).</param>
        public EngineStatusRequest(NetworkIdentifier networkIdentifier = default(NetworkIdentifier))
        {
            // to ensure "networkIdentifier" is required (not null)
            if (networkIdentifier == null)
            {
                throw new ArgumentNullException("networkIdentifier is a required property for EngineStatusRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as EngineStatusRequest);
        }

        /// <summary>
        /// Returns true if EngineStatusRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EngineStatusRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EngineStatusRequest input)
        {
            if (input == null)
            {
                return false;
