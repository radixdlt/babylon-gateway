...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PreparedValidatorOwner_allOf")]
    public partial class PreparedValidatorOwnerAllOf : IEquatable<PreparedValidatorOwnerAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PreparedValidatorOwnerAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PreparedValidatorOwnerAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PreparedValidatorOwnerAllOf" /> class.
        /// </summary>
        /// <param name="owner">owner (required).</param>
        /// <param name="epoch">epoch.</param>
        public PreparedValidatorOwnerAllOf(EntityIdentifier owner = default(EntityIdentifier), long epoch = default(long))
        {
            // to ensure "owner" is required (not null)
            if (owner == null)
            {
                throw new ArgumentNullException("owner is a required property for PreparedValidatorOwnerAllOf and cannot be null");
            }
            this.Owner = owner;
            this.Epoch = epoch;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PreparedValidatorOwnerAllOf {\n");
        ...
        {
            return this.Equals(input as PreparedValidatorOwnerAllOf);
        }

        /// <summary>
        /// Returns true if PreparedValidatorOwnerAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PreparedValidatorOwnerAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreparedValidatorOwnerAllOf input)
        {
            if (input == null)
            {
                return false;
