...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class TimeUpdateValidatorTransaction : IEquatable<TimeUpdateValidatorTransaction>
    {
        ...
        public TimeUpdateValidatorTransaction(ValidatorTransactionType type = default(ValidatorTransactionType), long proposerTimestampMs = default(long), long consensusEpoch = default(long), long roundInEpoch = default(long))
        {
            this.Type = type;
