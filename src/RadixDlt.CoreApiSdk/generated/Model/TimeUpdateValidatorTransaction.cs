...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class TimeUpdateValidatorTransaction : ValidatorTransaction, IEquatable<TimeUpdateValidatorTransaction>
    {
        ...
        /// <param name="type">type (required) (default to &quot;TimeUpdateValidatorTransaction&quot;).</param>
        public TimeUpdateValidatorTransaction(Instant proposerTimestamp = default(Instant), long consensusEpoch = default(long), long roundInEpoch = default(long), ValidatorTransactionType type = "TimeUpdateValidatorTransaction") : base(type)
        {
