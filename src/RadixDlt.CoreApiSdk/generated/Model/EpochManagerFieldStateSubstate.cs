...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EpochManagerFieldStateSubstate")]
    ...
    public partial class EpochManagerFieldStateSubstate : Substate, IEquatable<EpochManagerFieldStateSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EpochManagerFieldStateSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EpochManagerFieldStateSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EpochManagerFieldStateSubstate" /> class.
        /// </summary>
        ...
        /// <param name="substateType">substateType (required) (default to SubstateType.EpochManagerFieldState).</param>
        public EpochManagerFieldStateSubstate(long epoch = default(long), long round = default(long), SubstateType substateType = SubstateType.EpochManagerFieldState) : base(substateType)
        {
            this.Epoch = epoch;
            this.Round = round;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EpochManagerFieldStateSubstate {\n");
        ...
        {
            return this.Equals(input as EpochManagerFieldStateSubstate);
        }

        /// <summary>
        /// Returns true if EpochManagerFieldStateSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of EpochManagerFieldStateSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EpochManagerFieldStateSubstate input)
        {
            if (input == null)
            {
                return false;
