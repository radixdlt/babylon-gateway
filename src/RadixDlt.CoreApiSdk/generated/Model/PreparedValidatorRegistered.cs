...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PreparedValidatorRegistered")]
    ...
    public partial class PreparedValidatorRegistered : DataObject, IEquatable<PreparedValidatorRegistered>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PreparedValidatorRegistered" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PreparedValidatorRegistered() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PreparedValidatorRegistered" /> class.
        /// </summary>
        /// <param name="registered">The registered flag of the validator which will be updated by the end of &#x60;epoch&#x60;. (required).</param>
        /// <param name="epoch">epoch.</param>
        /// <param name="type">The type of the data object. Each address may own up to one current object of a given type. (required) (default to &quot;PreparedValidatorRegistered&quot;).</param>
        public PreparedValidatorRegistered(bool registered = default(bool), long epoch = default(long), string type = "PreparedValidatorRegistered") : base(type)
        {
        ...
        /// </summary>
        /// <value>The registered flag of the validator which will be updated by the end of &#x60;epoch&#x60;.</value>
        ...
        {
            return this.Equals(input as PreparedValidatorRegistered);
        }

        /// <summary>
        /// Returns true if PreparedValidatorRegistered instances are equal
        /// </summary>
        /// <param name="input">Instance of PreparedValidatorRegistered to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreparedValidatorRegistered input)
        {
            if (input == null)
            {
                return false;
