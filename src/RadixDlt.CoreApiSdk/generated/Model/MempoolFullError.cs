...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// MempoolFullError
    /// </summary>
    [DataContract(Name = "MempoolFullError")]
    ...
    public partial class MempoolFullError : CoreError, IEquatable<MempoolFullError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MempoolFullError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MempoolFullError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MempoolFullError" /> class.
        /// </summary>
        /// <param name="mempoolTransactionCount">mempoolTransactionCount (required).</param>
        /// <param name="type">type (required) (default to &quot;MempoolFullError&quot;).</param>
        public MempoolFullError(int mempoolTransactionCount = default(int), string type = "MempoolFullError") : base(type)
        {
            this.MempoolTransactionCount = mempoolTransactionCount;
        }

        /// <summary>
        /// Gets or Sets MempoolTransactionCount
        /// </summary>
        [DataMember(Name = "mempool_transaction_count", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MempoolTransactionCount: ").Append(MempoolTransactionCount).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as MempoolFullError);
        }

        /// <summary>
        /// Returns true if MempoolFullError instances are equal
        /// </summary>
        /// <param name="input">Instance of MempoolFullError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MempoolFullError input)
        {
            if (input == null)
            {
                return false;
            ...
            return base.Equals(input) && 
                (
                    this.MempoolTransactionCount == input.MempoolTransactionCount ||
                    this.MempoolTransactionCount.Equals(input.MempoolTransactionCount)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.MempoolTransactionCount.GetHashCode();
                return hashCode;
            }
        }
