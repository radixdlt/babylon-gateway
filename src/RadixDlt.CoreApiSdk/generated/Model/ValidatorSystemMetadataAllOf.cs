...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValidatorSystemMetadata_allOf")]
    public partial class ValidatorSystemMetadataAllOf : IEquatable<ValidatorSystemMetadataAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatorSystemMetadataAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValidatorSystemMetadataAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatorSystemMetadataAllOf" /> class.
        /// </summary>
        /// <param name="data">A hex encoded byte array. (required).</param>
        public ValidatorSystemMetadataAllOf(string data = default(string))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ValidatorSystemMetadataAllOf and cannot be null");
            }
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ValidatorSystemMetadataAllOf {\n");
        ...
        {
            return this.Equals(input as ValidatorSystemMetadataAllOf);
        }

        /// <summary>
        /// Returns true if ValidatorSystemMetadataAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ValidatorSystemMetadataAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValidatorSystemMetadataAllOf input)
        {
            if (input == null)
            {
                return false;
