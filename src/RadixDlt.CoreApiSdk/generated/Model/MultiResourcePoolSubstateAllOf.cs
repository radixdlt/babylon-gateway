...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MultiResourcePoolSubstate_allOf")]
    public partial class MultiResourcePoolSubstateAllOf : IEquatable<MultiResourcePoolSubstateAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiResourcePoolSubstateAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MultiResourcePoolSubstateAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiResourcePoolSubstateAllOf" /> class.
        /// </summary>
        ...
        public MultiResourcePoolSubstateAllOf(List<PoolVault> vaults = default(List<PoolVault>), string poolUnitResourceAddress = default(string))
        {
            // to ensure "vaults" is required (not null)
            if (vaults == null)
            {
                throw new ArgumentNullException("vaults is a required property for MultiResourcePoolSubstateAllOf and cannot be null");
            }
            this.Vaults = vaults;
            // to ensure "poolUnitResourceAddress" is required (not null)
            if (poolUnitResourceAddress == null)
            {
                throw new ArgumentNullException("poolUnitResourceAddress is a required property for MultiResourcePoolSubstateAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as MultiResourcePoolSubstateAllOf);
        }

        /// <summary>
        /// Returns true if MultiResourcePoolSubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of MultiResourcePoolSubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MultiResourcePoolSubstateAllOf input)
        {
            if (input == null)
            {
                return false;
