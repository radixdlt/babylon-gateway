...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// SchemaEntrySubstate
    /// </summary>
    [DataContract(Name = "SchemaEntrySubstate")]
    ...
    public partial class SchemaEntrySubstate : Substate, IEquatable<SchemaEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SchemaEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SchemaEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SchemaEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.SchemaEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public SchemaEntrySubstate(SchemaKey key = default(SchemaKey), SchemaEntryValue value = default(SchemaEntryValue), SubstateType substateType = SubstateType.SchemaEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for SchemaEntrySubstate and cannot be null");
            }
            this.Key = key;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for SchemaEntrySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public SchemaEntryValue Value { get; set; }
        ...
        {
            return this.Equals(input as SchemaEntrySubstate);
        }

        /// <summary>
        /// Returns true if SchemaEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of SchemaEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SchemaEntrySubstate input)
        {
            if (input == null)
            {
                return false;
