...
{
    /// <summary>
    /// OneResourcePoolSubstateAllOf
    /// </summary>
    [DataContract(Name = "OneResourcePoolSubstate_allOf")]
    public partial class OneResourcePoolSubstateAllOf : IEquatable<OneResourcePoolSubstateAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneResourcePoolSubstateAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OneResourcePoolSubstateAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OneResourcePoolSubstateAllOf" /> class.
        /// </summary>
        ...
        public OneResourcePoolSubstateAllOf(EntityReference vault = default(EntityReference), string poolUnitResourceAddress = default(string))
        {
            // to ensure "vault" is required (not null)
            if (vault == null)
            {
                throw new ArgumentNullException("vault is a required property for OneResourcePoolSubstateAllOf and cannot be null");
            }
            this.Vault = vault;
            // to ensure "poolUnitResourceAddress" is required (not null)
            if (poolUnitResourceAddress == null)
            {
                throw new ArgumentNullException("poolUnitResourceAddress is a required property for OneResourcePoolSubstateAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OneResourcePoolSubstateAllOf {\n");
        ...
        {
            return this.Equals(input as OneResourcePoolSubstateAllOf);
        }

        /// <summary>
        /// Returns true if OneResourcePoolSubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of OneResourcePoolSubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneResourcePoolSubstateAllOf input)
        {
            if (input == null)
            {
                return false;
