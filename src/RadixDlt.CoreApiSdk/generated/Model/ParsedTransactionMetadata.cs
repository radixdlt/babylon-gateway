...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ParsedTransactionMetadata")]
    public partial class ParsedTransactionMetadata : IEquatable<ParsedTransactionMetadata>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParsedTransactionMetadata" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ParsedTransactionMetadata() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ParsedTransactionMetadata" /> class.
        /// </summary>
        /// <param name="fee">fee (required).</param>
        /// <param name="message">message.</param>
        public ParsedTransactionMetadata(ResourceAmount fee = default(ResourceAmount), string message = default(string))
        {
            // to ensure "fee" is required (not null)
            if (fee == null)
            {
                throw new ArgumentNullException("fee is a required property for ParsedTransactionMetadata and cannot be null");
            }
            this.Fee = fee;
        ...
        {
            return this.Equals(input as ParsedTransactionMetadata);
        }

        /// <summary>
        /// Returns true if ParsedTransactionMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of ParsedTransactionMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParsedTransactionMetadata input)
        {
            if (input == null)
            {
                return false;
