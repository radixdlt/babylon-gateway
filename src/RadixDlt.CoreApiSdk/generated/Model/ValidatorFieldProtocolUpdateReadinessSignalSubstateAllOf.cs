...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValidatorFieldProtocolUpdateReadinessSignalSubstate_allOf")]
    public partial class ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOf : IEquatable<ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOf>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOf);
        }

        /// <summary>
        /// Returns true if ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOf input)
        {
            if (input == null)
            {
                return false;
