...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GenericKeyValueStoreEntrySubstate")]
    ...
    public partial class GenericKeyValueStoreEntrySubstate : Substate, IEquatable<GenericKeyValueStoreEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenericKeyValueStoreEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GenericKeyValueStoreEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GenericKeyValueStoreEntrySubstate" /> class.
        /// </summary>
        ...
        public GenericKeyValueStoreEntrySubstate(bool isDeleted = default(bool), DataStruct dataStruct = default(DataStruct), bool isMutable = default(bool), SubstateType substateType = SubstateType.GenericKeyValueStoreEntry) : base(substateType)
        {
        ...
        {
            return this.Equals(input as GenericKeyValueStoreEntrySubstate);
        }

        /// <summary>
        /// Returns true if GenericKeyValueStoreEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of GenericKeyValueStoreEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenericKeyValueStoreEntrySubstate input)
        {
            if (input == null)
            {
                return false;
