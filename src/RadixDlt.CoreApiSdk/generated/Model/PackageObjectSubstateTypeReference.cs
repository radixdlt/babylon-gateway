...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class PackageObjectSubstateTypeReference : ObjectSubstateTypeReference, IEquatable<PackageObjectSubstateTypeReference>
    {
        ...
        public PackageObjectSubstateTypeReference(FullyScopedTypeId fullTypeId = default(FullyScopedTypeId), ObjectSubstateTypeReferenceType type = ObjectSubstateTypeReferenceType.Package) : base(type)
        {
            // to ensure "fullTypeId" is required (not null)
            if (fullTypeId == null)
            {
                throw new ArgumentNullException("fullTypeId is a required property for PackageObjectSubstateTypeReference and cannot be null");
            }
