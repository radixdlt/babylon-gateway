...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InvalidSubEntityError_allOf")]
    public partial class InvalidSubEntityErrorAllOf : IEquatable<InvalidSubEntityErrorAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidSubEntityErrorAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvalidSubEntityErrorAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidSubEntityErrorAllOf" /> class.
        /// </summary>
        /// <param name="invalidSubEntity">invalidSubEntity (required).</param>
        public InvalidSubEntityErrorAllOf(SubEntity invalidSubEntity = default(SubEntity))
        {
            // to ensure "invalidSubEntity" is required (not null)
            if (invalidSubEntity == null)
            {
                throw new ArgumentNullException("invalidSubEntity is a required property for InvalidSubEntityErrorAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvalidSubEntityErrorAllOf {\n");
        ...
        {
            return this.Equals(input as InvalidSubEntityErrorAllOf);
        }

        /// <summary>
        /// Returns true if InvalidSubEntityErrorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidSubEntityErrorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidSubEntityErrorAllOf input)
        {
            if (input == null)
            {
                return false;
