...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NonFungibleVaultFieldFrozenStatusSubstate")]
    ...
    public partial class NonFungibleVaultFieldFrozenStatusSubstate : Substate, IEquatable<NonFungibleVaultFieldFrozenStatusSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NonFungibleVaultFieldFrozenStatusSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NonFungibleVaultFieldFrozenStatusSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NonFungibleVaultFieldFrozenStatusSubstate" /> class.
        /// </summary>
        ...
        public NonFungibleVaultFieldFrozenStatusSubstate(FrozenStatus frozenStatus = default(FrozenStatus), SubstateType substateType = SubstateType.NonFungibleVaultFieldFrozenStatus) : base(substateType)
        {
        ...
        {
            return this.Equals(input as NonFungibleVaultFieldFrozenStatusSubstate);
        }

        /// <summary>
        /// Returns true if NonFungibleVaultFieldFrozenStatusSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of NonFungibleVaultFieldFrozenStatusSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NonFungibleVaultFieldFrozenStatusSubstate input)
        {
            if (input == null)
            {
                return false;
