...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PackageBlueprintDefinitionEntrySubstate")]
    ...
    public partial class PackageBlueprintDefinitionEntrySubstate : Substate, IEquatable<PackageBlueprintDefinitionEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageBlueprintDefinitionEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PackageBlueprintDefinitionEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageBlueprintDefinitionEntrySubstate" /> class.
        /// </summary>
        ...
        public PackageBlueprintDefinitionEntrySubstate(string blueprintName = default(string), string blueprintVersion = default(string), BlueprintDefinition definition = default(BlueprintDefinition), SubstateType substateType = SubstateType.PackageBlueprintDefinitionEntry) : base(substateType)
        {
            // to ensure "blueprintName" is required (not null)
            if (blueprintName == null)
            {
                throw new ArgumentNullException("blueprintName is a required property for PackageBlueprintDefinitionEntrySubstate and cannot be null");
            }
            this.BlueprintName = blueprintName;
            // to ensure "blueprintVersion" is required (not null)
            if (blueprintVersion == null)
            {
                throw new ArgumentNullException("blueprintVersion is a required property for PackageBlueprintDefinitionEntrySubstate and cannot be null");
            }
        ...
        {
            return this.Equals(input as PackageBlueprintDefinitionEntrySubstate);
        }

        /// <summary>
        /// Returns true if PackageBlueprintDefinitionEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of PackageBlueprintDefinitionEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PackageBlueprintDefinitionEntrySubstate input)
        {
            if (input == null)
            {
                return false;
