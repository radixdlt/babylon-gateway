...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PackageBlueprintRoyaltyEntrySubstate")]
    ...
    public partial class PackageBlueprintRoyaltyEntrySubstate : Substate, IEquatable<PackageBlueprintRoyaltyEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageBlueprintRoyaltyEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PackageBlueprintRoyaltyEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageBlueprintRoyaltyEntrySubstate" /> class.
        /// </summary>
        ...
        public PackageBlueprintRoyaltyEntrySubstate(BlueprintVersionKey key = default(BlueprintVersionKey), PackageBlueprintRoyaltyEntryValue value = default(PackageBlueprintRoyaltyEntryValue), SubstateType substateType = SubstateType.PackageBlueprintRoyaltyEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            ...
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for PackageBlueprintRoyaltyEntrySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as PackageBlueprintRoyaltyEntrySubstate);
        }

        /// <summary>
        /// Returns true if PackageBlueprintRoyaltyEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of PackageBlueprintRoyaltyEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PackageBlueprintRoyaltyEntrySubstate input)
        {
            if (input == null)
            {
                return false;
