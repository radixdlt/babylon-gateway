...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class TransactionSubmitErrorResponse : ErrorResponse, IEquatable<TransactionSubmitErrorResponse>
    {
        ...
        protected TransactionSubmitErrorResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionSubmitErrorResponse" /> class.
        /// </summary>
        /// <param name="details">details.</param>
        /// <param name="errorType">errorType (required) (default to ErrorResponseType.TransactionSubmit).</param>
        ...
        public TransactionSubmitErrorResponse(TransactionSubmitErrorDetails details = default(TransactionSubmitErrorDetails), ErrorResponseType errorType = ErrorResponseType.TransactionSubmit, int code = default(int), string message = default(string), string traceId = default(string)) : base(errorType, code, message, traceId)
        {
        ...
        public TransactionSubmitErrorDetails Details { get; set; }
        ...
        {
            return this.Equals(input as TransactionSubmitErrorResponse);
        }

        /// <summary>
        /// Returns true if TransactionSubmitErrorResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionSubmitErrorResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionSubmitErrorResponse input)
        {
            if (input == null)
            {
                return false;
