...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class FungibleVaultFieldBalanceSubstate : Substate, IEquatable<FungibleVaultFieldBalanceSubstate>
    {
        ...
        public FungibleVaultFieldBalanceSubstate(string amount = default(string), SubstateType substateType = SubstateType.FungibleVaultFieldBalance, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for FungibleVaultFieldBalanceSubstate and cannot be null");
            }
            this.Amount = amount;
        }
