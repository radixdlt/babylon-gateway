...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FungibleVaultFieldBalanceSubstate")]
    ...
    public partial class FungibleVaultFieldBalanceSubstate : Substate, IEquatable<FungibleVaultFieldBalanceSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FungibleVaultFieldBalanceSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FungibleVaultFieldBalanceSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FungibleVaultFieldBalanceSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.FungibleVaultFieldBalance).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public FungibleVaultFieldBalanceSubstate(FungibleVaultFieldBalanceValue value = default(FungibleVaultFieldBalanceValue), SubstateType substateType = SubstateType.FungibleVaultFieldBalance, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for FungibleVaultFieldBalanceSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as FungibleVaultFieldBalanceSubstate);
        }

        /// <summary>
        /// Returns true if FungibleVaultFieldBalanceSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of FungibleVaultFieldBalanceSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FungibleVaultFieldBalanceSubstate input)
        {
            if (input == null)
            {
                return false;
