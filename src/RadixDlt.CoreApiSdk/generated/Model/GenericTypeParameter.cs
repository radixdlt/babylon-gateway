...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GenericTypeParameter")]
    public partial class GenericTypeParameter : IEquatable<GenericTypeParameter>
    {
        ...
        {
            return this.Equals(input as GenericTypeParameter);
        }

        /// <summary>
        /// Returns true if GenericTypeParameter instances are equal
        /// </summary>
        /// <param name="input">Instance of GenericTypeParameter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenericTypeParameter input)
        {
            if (input == null)
            {
                return false;
