...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PackageFieldCodeTypeSubstate")]
    ...
    public partial class PackageFieldCodeTypeSubstate : Substate, IEquatable<PackageFieldCodeTypeSubstate>
    {
        ...
        public PackageCodeType CodeType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageFieldCodeTypeSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PackageFieldCodeTypeSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageFieldCodeTypeSubstate" /> class.
        /// </summary>
        /// <param name="codeType">codeType (required).</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.PackageFieldCodeType).</param>
        public PackageFieldCodeTypeSubstate(PackageCodeType codeType = default(PackageCodeType), SubstateType substateType = SubstateType.PackageFieldCodeType) : base(substateType)
        {
        ...
        {
            return this.Equals(input as PackageFieldCodeTypeSubstate);
        }

        /// <summary>
        /// Returns true if PackageFieldCodeTypeSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of PackageFieldCodeTypeSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PackageFieldCodeTypeSubstate input)
        {
            if (input == null)
            {
                return false;
