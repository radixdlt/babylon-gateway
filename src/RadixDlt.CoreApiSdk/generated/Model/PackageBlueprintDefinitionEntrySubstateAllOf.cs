...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PackageBlueprintDefinitionEntrySubstate_allOf")]
    public partial class PackageBlueprintDefinitionEntrySubstateAllOf : IEquatable<PackageBlueprintDefinitionEntrySubstateAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageBlueprintDefinitionEntrySubstateAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PackageBlueprintDefinitionEntrySubstateAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageBlueprintDefinitionEntrySubstateAllOf" /> class.
        /// </summary>
        ...
        public PackageBlueprintDefinitionEntrySubstateAllOf(string blueprintName = default(string), string blueprintVersion = default(string), BlueprintDefinition definition = default(BlueprintDefinition))
        {
            // to ensure "blueprintName" is required (not null)
            if (blueprintName == null)
            {
                throw new ArgumentNullException("blueprintName is a required property for PackageBlueprintDefinitionEntrySubstateAllOf and cannot be null");
            }
            this.BlueprintName = blueprintName;
            // to ensure "blueprintVersion" is required (not null)
            if (blueprintVersion == null)
            {
                throw new ArgumentNullException("blueprintVersion is a required property for PackageBlueprintDefinitionEntrySubstateAllOf and cannot be null");
            }
            this.BlueprintVersion = blueprintVersion;
            // to ensure "definition" is required (not null)
            if (definition == null)
            {
                throw new ArgumentNullException("definition is a required property for PackageBlueprintDefinitionEntrySubstateAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as PackageBlueprintDefinitionEntrySubstateAllOf);
        }

        /// <summary>
        /// Returns true if PackageBlueprintDefinitionEntrySubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PackageBlueprintDefinitionEntrySubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PackageBlueprintDefinitionEntrySubstateAllOf input)
        {
            if (input == null)
            {
                return false;
