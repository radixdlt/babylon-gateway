...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RoleAssignmentModuleFieldOwnerRoleSubstate")]
    ...
    public partial class RoleAssignmentModuleFieldOwnerRoleSubstate : Substate, IEquatable<RoleAssignmentModuleFieldOwnerRoleSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoleAssignmentModuleFieldOwnerRoleSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RoleAssignmentModuleFieldOwnerRoleSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RoleAssignmentModuleFieldOwnerRoleSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to SubstateType.RoleAssignmentModuleFieldOwnerRole).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public RoleAssignmentModuleFieldOwnerRoleSubstate(RoleAssignmentModuleFieldOwnerRoleValue value = default(RoleAssignmentModuleFieldOwnerRoleValue), SubstateType substateType = SubstateType.RoleAssignmentModuleFieldOwnerRole, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for RoleAssignmentModuleFieldOwnerRoleSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public RoleAssignmentModuleFieldOwnerRoleValue Value { get; set; }
        ...
        {
            return this.Equals(input as RoleAssignmentModuleFieldOwnerRoleSubstate);
        }

        /// <summary>
        /// Returns true if RoleAssignmentModuleFieldOwnerRoleSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of RoleAssignmentModuleFieldOwnerRoleSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoleAssignmentModuleFieldOwnerRoleSubstate input)
        {
            if (input == null)
            {
                return false;
