...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LtsTransactionSubmitRejectedErrorDetails")]
    ...
    public partial class LtsTransactionSubmitRejectedErrorDetails : LtsTransactionSubmitErrorDetails, IEquatable<LtsTransactionSubmitRejectedErrorDetails>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LtsTransactionSubmitRejectedErrorDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LtsTransactionSubmitRejectedErrorDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LtsTransactionSubmitRejectedErrorDetails" /> class.
        /// </summary>
        ...
        /// <param name="type">type (required) (default to LtsTransactionSubmitErrorDetailsType.Rejected).</param>
        public LtsTransactionSubmitRejectedErrorDetails(string errorMessage = default(string), bool isFresh = default(bool), bool isPayloadRejectionPermanent = default(bool), bool isIntentRejectionPermanent = default(bool), Instant retryFromTimestamp = default(Instant), long retryFromEpoch = default(long), long invalidFromEpoch = default(long), LtsTransactionSubmitErrorDetailsType type = LtsTransactionSubmitErrorDetailsType.Rejected) : base(type)
        {
            // to ensure "errorMessage" is required (not null)
            if (errorMessage == null)
            {
                throw new ArgumentNullException("errorMessage is a required property for LtsTransactionSubmitRejectedErrorDetails and cannot be null");
            }
        ...
        {
            return this.Equals(input as LtsTransactionSubmitRejectedErrorDetails);
        }

        /// <summary>
        /// Returns true if LtsTransactionSubmitRejectedErrorDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of LtsTransactionSubmitRejectedErrorDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LtsTransactionSubmitRejectedErrorDetails input)
        {
            if (input == null)
            {
                return false;
