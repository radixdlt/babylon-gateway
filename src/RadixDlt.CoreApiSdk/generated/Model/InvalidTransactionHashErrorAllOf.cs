...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InvalidTransactionHashError_allOf")]
    public partial class InvalidTransactionHashErrorAllOf : IEquatable<InvalidTransactionHashErrorAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidTransactionHashErrorAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvalidTransactionHashErrorAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidTransactionHashErrorAllOf" /> class.
        /// </summary>
        /// <param name="invalidTransactionHash">invalidTransactionHash (required).</param>
        public InvalidTransactionHashErrorAllOf(string invalidTransactionHash = default(string))
        {
            // to ensure "invalidTransactionHash" is required (not null)
            if (invalidTransactionHash == null)
            {
                throw new ArgumentNullException("invalidTransactionHash is a required property for InvalidTransactionHashErrorAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvalidTransactionHashErrorAllOf {\n");
        ...
        {
            return this.Equals(input as InvalidTransactionHashErrorAllOf);
        }

        /// <summary>
        /// Returns true if InvalidTransactionHashErrorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidTransactionHashErrorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidTransactionHashErrorAllOf input)
        {
            if (input == null)
            {
                return false;
