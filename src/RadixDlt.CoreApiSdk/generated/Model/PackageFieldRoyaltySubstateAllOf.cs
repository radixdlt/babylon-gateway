...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PackageFieldRoyaltySubstate_allOf")]
    public partial class PackageFieldRoyaltySubstateAllOf : IEquatable<PackageFieldRoyaltySubstateAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageFieldRoyaltySubstateAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PackageFieldRoyaltySubstateAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageFieldRoyaltySubstateAllOf" /> class.
        /// </summary>
        /// <param name="vaultEntity">vaultEntity.</param>
        /// <param name="blueprintRoyalties">blueprintRoyalties (required).</param>
        public PackageFieldRoyaltySubstateAllOf(EntityReference vaultEntity = default(EntityReference), List<BlueprintRoyaltyConfig> blueprintRoyalties = default(List<BlueprintRoyaltyConfig>))
        {
            // to ensure "blueprintRoyalties" is required (not null)
            if (blueprintRoyalties == null)
            {
                throw new ArgumentNullException("blueprintRoyalties is a required property for PackageFieldRoyaltySubstateAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as PackageFieldRoyaltySubstateAllOf);
        }

        /// <summary>
        /// Returns true if PackageFieldRoyaltySubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PackageFieldRoyaltySubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PackageFieldRoyaltySubstateAllOf input)
        {
            if (input == null)
            {
                return false;
