...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class MempoolTransactionResponse : IEquatable<MempoolTransactionResponse>, IValidatableObject
    {
        ...
        public MempoolTransactionResponse(Transaction transaction = default(Transaction))
        {
            // to ensure "transaction" is required (not null)
            if (transaction == null)
            {
                throw new ArgumentNullException("transaction is a required property for MempoolTransactionResponse and cannot be null");
            }
