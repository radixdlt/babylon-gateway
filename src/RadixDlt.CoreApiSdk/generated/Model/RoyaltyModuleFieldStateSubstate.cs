...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RoyaltyModuleFieldStateSubstate")]
    ...
    public partial class RoyaltyModuleFieldStateSubstate : Substate, IEquatable<RoyaltyModuleFieldStateSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoyaltyModuleFieldStateSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RoyaltyModuleFieldStateSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RoyaltyModuleFieldStateSubstate" /> class.
        /// </summary>
        ...
        public RoyaltyModuleFieldStateSubstate(RoyaltyModuleFieldStateValue value = default(RoyaltyModuleFieldStateValue), SubstateType substateType = SubstateType.RoyaltyModuleFieldState, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for RoyaltyModuleFieldStateSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as RoyaltyModuleFieldStateSubstate);
        }

        /// <summary>
        /// Returns true if RoyaltyModuleFieldStateSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of RoyaltyModuleFieldStateSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoyaltyModuleFieldStateSubstate input)
        {
            if (input == null)
            {
                return false;
