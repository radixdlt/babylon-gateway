...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// EngineIdentifier
    /// </summary>
    [DataContract(Name = "EngineIdentifier")]
    public partial class EngineIdentifier : IEquatable<EngineIdentifier>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EngineIdentifier" /> class.
        /// </summary>
        ...
        public EngineIdentifier(string engine = default(string))
        {
            // to ensure "engine" is required (not null)
            if (engine == null)
            {
                throw new ArgumentNullException("engine is a required property for EngineIdentifier and cannot be null");
            }
            this.Engine = engine;
        }
        ...
        {
            return this.Equals(input as EngineIdentifier);
        }

        /// <summary>
        /// Returns true if EngineIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of EngineIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EngineIdentifier input)
        {
            if (input == null)
            {
                return false;
