...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// SubEntityMetadata
    /// </summary>
    [DataContract(Name = "SubEntityMetadata")]
    public partial class SubEntityMetadata : IEquatable<SubEntityMetadata>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubEntityMetadata" /> class.
        /// </summary>
        /// <param name="validatorAddress">validatorAddress.</param>
        /// <param name="epochUnlock">epochUnlock.</param>
        public SubEntityMetadata(string validatorAddress = default(string), long epochUnlock = default(long))
        {
        ...
        /// </summary>
        [DataMember(Name = "validator_address", EmitDefaultValue = true)]
        public string ValidatorAddress { get; set; }

        /// <summary>
        /// Gets or Sets EpochUnlock
        /// </summary>
        [DataMember(Name = "epoch_unlock", EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as SubEntityMetadata);
        }

        /// <summary>
        /// Returns true if SubEntityMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of SubEntityMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubEntityMetadata input)
        {
            if (input == null)
            {
                return false;
