...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NetworkStatusRequest")]
    public partial class NetworkStatusRequest : IEquatable<NetworkStatusRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NetworkStatusRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NetworkStatusRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NetworkStatusRequest" /> class.
        /// </summary>
        /// <param name="networkIdentifier">networkIdentifier (required).</param>
        public NetworkStatusRequest(NetworkIdentifier networkIdentifier = default(NetworkIdentifier))
        {
            // to ensure "networkIdentifier" is required (not null)
            if (networkIdentifier == null)
            {
                throw new ArgumentNullException("networkIdentifier is a required property for NetworkStatusRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as NetworkStatusRequest);
        }

        /// <summary>
        /// Returns true if NetworkStatusRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NetworkStatusRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NetworkStatusRequest input)
        {
            if (input == null)
            {
                return false;
