...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class ObjectInstanceTypeReferenceAllOf : IEquatable<ObjectInstanceTypeReferenceAllOf>
    {
        ...
        public ObjectInstanceTypeReferenceAllOf(FullyScopedTypeId resolvedFullTypeId = default(FullyScopedTypeId), int genericIndex = default(int))
        {
            // to ensure "resolvedFullTypeId" is required (not null)
            if (resolvedFullTypeId == null)
            {
                throw new ArgumentNullException("resolvedFullTypeId is a required property for ObjectInstanceTypeReferenceAllOf and cannot be null");
            }
