...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class ReceiverInfo : IEquatable<ReceiverInfo>
    {
        /// <summary>
        /// Defines Receiver
        /// </summary>
        ...
        public ReceiverInfo(ReceiverEnum receiver = default(ReceiverEnum), ReferenceType referenceType = default(ReferenceType))
        {
            this.Receiver = receiver;
            // to ensure "referenceType" is required (not null)
            if (referenceType == null)
            {
                throw new ArgumentNullException("referenceType is a required property for ReceiverInfo and cannot be null");
            }
