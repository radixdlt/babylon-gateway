...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GenericScryptoComponentFieldStateSubstate")]
    ...
    public partial class GenericScryptoComponentFieldStateSubstate : Substate, IEquatable<GenericScryptoComponentFieldStateSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenericScryptoComponentFieldStateSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GenericScryptoComponentFieldStateSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GenericScryptoComponentFieldStateSubstate" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GenericScryptoComponentFieldStateSubstate);
        }

        /// <summary>
        /// Returns true if GenericScryptoComponentFieldStateSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of GenericScryptoComponentFieldStateSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenericScryptoComponentFieldStateSubstate input)
        {
            if (input == null)
            {
                return false;
