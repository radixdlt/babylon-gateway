...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConstructionDeriveRequestMetadataAccount")]
    ...
    public partial class ConstructionDeriveRequestMetadataAccount : ConstructionDeriveRequestMetadata, IEquatable<ConstructionDeriveRequestMetadataAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionDeriveRequestMetadataAccount" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConstructionDeriveRequestMetadataAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionDeriveRequestMetadataAccount" /> class.
        /// </summary>
        /// <param name="type">type (required) (default to &quot;ConstructionDeriveRequestMetadataAccount&quot;).</param>
        public ConstructionDeriveRequestMetadataAccount(string type = "ConstructionDeriveRequestMetadataAccount") : base(type)
        {
        }
        ...
        {
            return this.Equals(input as ConstructionDeriveRequestMetadataAccount);
        }

        /// <summary>
        /// Returns true if ConstructionDeriveRequestMetadataAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of ConstructionDeriveRequestMetadataAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConstructionDeriveRequestMetadataAccount input)
        {
            if (input == null)
            {
                return false;
