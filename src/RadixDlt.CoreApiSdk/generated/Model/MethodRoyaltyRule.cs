...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// MethodRoyaltyRule
    /// </summary>
    [DataContract(Name = "MethodRoyaltyRule")]
    public partial class MethodRoyaltyRule : IEquatable<MethodRoyaltyRule>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MethodRoyaltyRule" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MethodRoyaltyRule() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MethodRoyaltyRule" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as MethodRoyaltyRule);
        }

        /// <summary>
        /// Returns true if MethodRoyaltyRule instances are equal
        /// </summary>
        /// <param name="input">Instance of MethodRoyaltyRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MethodRoyaltyRule input)
        {
            if (input == null)
            {
                return false;
