...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PackageBlueprintAuthTemplateEntrySubstate_allOf")]
    public partial class PackageBlueprintAuthTemplateEntrySubstateAllOf : IEquatable<PackageBlueprintAuthTemplateEntrySubstateAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageBlueprintAuthTemplateEntrySubstateAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PackageBlueprintAuthTemplateEntrySubstateAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageBlueprintAuthTemplateEntrySubstateAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PackageBlueprintAuthTemplateEntrySubstateAllOf);
        }

        /// <summary>
        /// Returns true if PackageBlueprintAuthTemplateEntrySubstateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PackageBlueprintAuthTemplateEntrySubstateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PackageBlueprintAuthTemplateEntrySubstateAllOf input)
        {
            if (input == null)
            {
                return false;
