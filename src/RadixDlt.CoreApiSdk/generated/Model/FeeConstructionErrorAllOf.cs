...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FeeConstructionError_allOf")]
    public partial class FeeConstructionErrorAllOf : IEquatable<FeeConstructionErrorAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FeeConstructionErrorAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FeeConstructionErrorAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FeeConstructionErrorAllOf" /> class.
        /// </summary>
        /// <param name="attempts">attempts (required).</param>
        public FeeConstructionErrorAllOf(int attempts = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FeeConstructionErrorAllOf {\n");
        ...
        {
            return this.Equals(input as FeeConstructionErrorAllOf);
        }

        /// <summary>
        /// Returns true if FeeConstructionErrorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of FeeConstructionErrorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FeeConstructionErrorAllOf input)
        {
            if (input == null)
            {
                return false;
