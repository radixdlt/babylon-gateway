...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountFieldStateSubstate")]
    ...
    public partial class AccountFieldStateSubstate : Substate, IEquatable<AccountFieldStateSubstate>
    {
        ...
        protected AccountFieldStateSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountFieldStateSubstate" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AccountFieldStateSubstate);
        }

        /// <summary>
        /// Returns true if AccountFieldStateSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountFieldStateSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountFieldStateSubstate input)
        {
            if (input == null)
            {
                return false;
