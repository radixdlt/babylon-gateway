...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    public partial class ConsensusManagerFieldCurrentValidatorSetSubstate : Substate, IEquatable<ConsensusManagerFieldCurrentValidatorSetSubstate>
    {
        ...
        protected ConsensusManagerFieldCurrentValidatorSetSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsensusManagerFieldCurrentValidatorSetSubstate" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ConsensusManagerFieldCurrentValidatorSetSubstate);
        }

        /// <summary>
        /// Returns true if ConsensusManagerFieldCurrentValidatorSetSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of ConsensusManagerFieldCurrentValidatorSetSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConsensusManagerFieldCurrentValidatorSetSubstate input)
        {
            if (input == null)
            {
                return false;
