...
namespace RadixDlt.CoreApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TwoResourcePoolFieldStateSubstate")]
    ...
    public partial class TwoResourcePoolFieldStateSubstate : Substate, IEquatable<TwoResourcePoolFieldStateSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TwoResourcePoolFieldStateSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TwoResourcePoolFieldStateSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TwoResourcePoolFieldStateSubstate" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TwoResourcePoolFieldStateSubstate);
        }

        /// <summary>
        /// Returns true if TwoResourcePoolFieldStateSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of TwoResourcePoolFieldStateSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TwoResourcePoolFieldStateSubstate input)
        {
            if (input == null)
            {
                return false;
