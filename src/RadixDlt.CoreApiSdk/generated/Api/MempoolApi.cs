...
namespace RadixDlt.CoreApiSdk.Api
{
    ...
    public interface IMempoolApiSync : IApiAccessor
    {
        ...
        MempoolResponse MempoolPost(MempoolRequest mempoolRequest);
        ...
        ApiResponse<MempoolResponse> MempoolPostWithHttpInfo(MempoolRequest mempoolRequest);
        /// <summary>
    ...
    public interface IMempoolApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<MempoolResponse> MempoolPostAsync(MempoolRequest mempoolRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<MempoolResponse>> MempoolPostWithHttpInfoAsync(MempoolRequest mempoolRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get Mempool Transaction
        /// </summary>
        /// <remarks>
    ...
    public partial class MempoolApi : IDisposable, IMempoolApi
    {
        ...
        /// <summary>
        /// Get Mempool Transactions Gets the transaction identifiers in the mempool
        /// </summary>
        /// <exception cref="RadixDlt.CoreApiSdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="mempoolRequest"></param>
        /// <returns>MempoolResponse</returns>
        public MempoolResponse MempoolPost(MempoolRequest mempoolRequest)
        {
            RadixDlt.CoreApiSdk.Client.ApiResponse<MempoolResponse> localVarResponse = MempoolPostWithHttpInfo(mempoolRequest);
        ...
        /// <param name="mempoolRequest"></param>
        /// <returns>ApiResponse of MempoolResponse</returns>
        public RadixDlt.CoreApiSdk.Client.ApiResponse<MempoolResponse> MempoolPostWithHttpInfo(MempoolRequest mempoolRequest)
        {
            // verify the required parameter 'mempoolRequest' is set
            if (mempoolRequest == null)
                throw new RadixDlt.CoreApiSdk.Client.ApiException(400, "Missing required parameter 'mempoolRequest' when calling MempoolApi->MempoolPost");
            ...
            localVarRequestOptions.Data = mempoolRequest;


            // make the HTTP request
            var localVarResponse = this.Client.Post<MempoolResponse>("/mempool", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("MempoolPost", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MempoolResponse)</returns>
        public async System.Threading.Tasks.Task<RadixDlt.CoreApiSdk.Client.ApiResponse<MempoolResponse>> MempoolPostWithHttpInfoAsync(MempoolRequest mempoolRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'mempoolRequest' is set
            if (mempoolRequest == null)
                throw new RadixDlt.CoreApiSdk.Client.ApiException(400, "Missing required parameter 'mempoolRequest' when calling MempoolApi->MempoolPost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<MempoolResponse>("/mempool", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Get Mempool Transaction Gets the transaction from the mempool
        /// </summary>
        /// <exception cref="RadixDlt.CoreApiSdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="mempoolTransactionRequest"></param>
        /// <returns>MempoolTransactionResponse</returns>
