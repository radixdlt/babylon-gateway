...
namespace RadixDlt.CoreApiSdk.Api
{
    ...
    public interface IEntityApiSync : IApiAccessor
    {
        ...
        EntityResponse EntityPost(EntityRequest entityRequest);
        ...
        ApiResponse<EntityResponse> EntityPostWithHttpInfo(EntityRequest entityRequest);
    ...
    public interface IEntityApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<EntityResponse> EntityPostAsync(EntityRequest entityRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<EntityResponse>> EntityPostWithHttpInfoAsync(EntityRequest entityRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class EntityApi : IDisposable, IEntityApi
    {
        ...
        /// <returns></returns>
        public EntityApi(RadixDlt.CoreApiSdk.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public EntityApi(HttpClient client, RadixDlt.CoreApiSdk.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public EntityApi(RadixDlt.CoreApiSdk.Client.ISynchronousClient client, RadixDlt.CoreApiSdk.Client.IAsynchronousClient asyncClient, RadixDlt.CoreApiSdk.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <summary>
        /// Get Entity Information Gets the balances and data objects at an entity at the current state of the ledger.
        /// </summary>
        /// <exception cref="RadixDlt.CoreApiSdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="entityRequest"></param>
        /// <returns>EntityResponse</returns>
        public EntityResponse EntityPost(EntityRequest entityRequest)
        {
            RadixDlt.CoreApiSdk.Client.ApiResponse<EntityResponse> localVarResponse = EntityPostWithHttpInfo(entityRequest);
        ...
        /// <param name="entityRequest"></param>
        /// <returns>ApiResponse of EntityResponse</returns>
        public RadixDlt.CoreApiSdk.Client.ApiResponse<EntityResponse> EntityPostWithHttpInfo(EntityRequest entityRequest)
        {
            // verify the required parameter 'entityRequest' is set
            if (entityRequest == null)
                throw new RadixDlt.CoreApiSdk.Client.ApiException(400, "Missing required parameter 'entityRequest' when calling EntityApi->EntityPost");
            ...
            var localVarResponse = this.Client.Post<EntityResponse>("/entity", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("EntityPost", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of EntityResponse</returns>
        public async System.Threading.Tasks.Task<EntityResponse> EntityPostAsync(EntityRequest entityRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            RadixDlt.CoreApiSdk.Client.ApiResponse<EntityResponse> localVarResponse = await EntityPostWithHttpInfoAsync(entityRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (EntityResponse)</returns>
        public async System.Threading.Tasks.Task<RadixDlt.CoreApiSdk.Client.ApiResponse<EntityResponse>> EntityPostWithHttpInfoAsync(EntityRequest entityRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'entityRequest' is set
            if (entityRequest == null)
                throw new RadixDlt.CoreApiSdk.Client.ApiException(400, "Missing required parameter 'entityRequest' when calling EntityApi->EntityPost");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<EntityResponse>("/entity", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
