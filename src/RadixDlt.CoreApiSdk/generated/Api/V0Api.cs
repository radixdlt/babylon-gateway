...
namespace RadixDlt.CoreApiSdk.Api
{
    ...
    public partial class V0Api : IDisposable, IV0Api
    {
        ...
        /// <summary>
        /// Get Network Configuration (V0) Returns the network configuration.
        /// </summary>
        /// <exception cref="RadixDlt.CoreApiSdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>NetworkConfigurationResponse</returns>
        ...
        /// <summary>
        /// Transaction Submit (V0) Submits a notarized transaction to the network. Returns whether the transaction submission was already included in the node&#39;s mempool. This will be removed when V0 endpoints are merged into the main API. 
        /// </summary>
        /// <exception cref="RadixDlt.CoreApiSdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="v0TransactionSubmitRequest"></param>
        /// <returns>V0TransactionSubmitResponse</returns>
