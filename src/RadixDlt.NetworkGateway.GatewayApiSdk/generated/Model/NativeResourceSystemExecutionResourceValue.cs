...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NativeResourceSystemExecutionResourceValue")]
    ...
    public partial class NativeResourceSystemExecutionResourceValue : NativeResourceDetails, IEquatable<NativeResourceSystemExecutionResourceValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceSystemExecutionResourceValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NativeResourceSystemExecutionResourceValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceSystemExecutionResourceValue" /> class.
        /// </summary>
        /// <param name="kind">kind (required) (default to NativeResourceKind.SystemExecutionResource).</param>
        public NativeResourceSystemExecutionResourceValue(NativeResourceKind kind = NativeResourceKind.SystemExecutionResource) : base(kind)
        {
        }
        ...
        {
            return this.Equals(input as NativeResourceSystemExecutionResourceValue);
        }

        /// <summary>
        /// Returns true if NativeResourceSystemExecutionResourceValue instances are equal
        /// </summary>
        /// <param name="input">Instance of NativeResourceSystemExecutionResourceValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NativeResourceSystemExecutionResourceValue input)
        {
            if (input == null)
            {
                return false;
