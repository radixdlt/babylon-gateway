...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class ProgrammaticScryptoSborValueBytes : ProgrammaticScryptoSborValue, IEquatable<ProgrammaticScryptoSborValueBytes>
    {
        ...
        /// <param name="kind">kind (required) (default to ProgrammaticScryptoSborValueTypeKind.Bytes).</param>
        /// <param name="typeName">TBD.</param>
        /// <param name="fieldName">TBD.</param>
        public ProgrammaticScryptoSborValueBytes(ProgrammaticScryptoSborValueTypeKind elementValueKind = default(ProgrammaticScryptoSborValueTypeKind), string hex = default(string), ProgrammaticScryptoSborValueTypeKind kind = ProgrammaticScryptoSborValueTypeKind.Bytes, string typeName = default(string), string fieldName = default(string)) : base(kind, typeName, fieldName)
        {
