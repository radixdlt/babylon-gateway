...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MetadataUrlArrayValue")]
    ...
    public partial class MetadataUrlArrayValue : MetadataTypedValue, IEquatable<MetadataUrlArrayValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataUrlArrayValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataUrlArrayValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataUrlArrayValue" /> class.
        /// </summary>
        /// <param name="values">values (required).</param>
        /// <param name="type">type (required) (default to MetadataValueType.UrlArray).</param>
        public MetadataUrlArrayValue(List<string> values = default(List<string>), MetadataValueType type = MetadataValueType.UrlArray) : base(type)
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for MetadataUrlArrayValue and cannot be null");
            }
            this.Values = values;
        }
        ...
        {
            return this.Equals(input as MetadataUrlArrayValue);
        }

        /// <summary>
        /// Returns true if MetadataUrlArrayValue instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataUrlArrayValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataUrlArrayValue input)
        {
            if (input == null)
            {
                return false;
