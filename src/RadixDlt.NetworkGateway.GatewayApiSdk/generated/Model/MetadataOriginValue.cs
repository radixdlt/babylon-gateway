...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// MetadataOriginValue
    /// </summary>
    [DataContract(Name = "MetadataOriginValue")]
    ...
    public partial class MetadataOriginValue : MetadataTypedValue, IEquatable<MetadataOriginValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataOriginValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataOriginValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataOriginValue" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="type">type (required) (default to MetadataValueType.Origin).</param>
        public MetadataOriginValue(string value = default(string), MetadataValueType type = MetadataValueType.Origin) : base(type)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for MetadataOriginValue and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as MetadataOriginValue);
        }

        /// <summary>
        /// Returns true if MetadataOriginValue instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataOriginValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataOriginValue input)
        {
            if (input == null)
            {
                return false;
