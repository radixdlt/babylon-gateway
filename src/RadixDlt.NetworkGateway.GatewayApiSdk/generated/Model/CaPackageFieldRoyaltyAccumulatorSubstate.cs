...
{
    /// <summary>
    /// CaPackageFieldRoyaltyAccumulatorSubstate
    /// </summary>
    [DataContract(Name = "CaPackageFieldRoyaltyAccumulatorSubstate")]
    ...
    public partial class CaPackageFieldRoyaltyAccumulatorSubstate : CaSubstate, IEquatable<CaPackageFieldRoyaltyAccumulatorSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPackageFieldRoyaltyAccumulatorSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaPackageFieldRoyaltyAccumulatorSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPackageFieldRoyaltyAccumulatorSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.PackageFieldRoyaltyAccumulator).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaPackageFieldRoyaltyAccumulatorSubstate(CaPackageFieldRoyaltyAccumulatorValue value = default(CaPackageFieldRoyaltyAccumulatorValue), CaSubstateType substateType = CaSubstateType.PackageFieldRoyaltyAccumulator, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaPackageFieldRoyaltyAccumulatorSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaPackageFieldRoyaltyAccumulatorValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaPackageFieldRoyaltyAccumulatorSubstate {\n");
        ...
        {
            return this.Equals(input as CaPackageFieldRoyaltyAccumulatorSubstate);
        }

        /// <summary>
        /// Returns true if CaPackageFieldRoyaltyAccumulatorSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaPackageFieldRoyaltyAccumulatorSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaPackageFieldRoyaltyAccumulatorSubstate input)
        {
            if (input == null)
            {
                return false;
