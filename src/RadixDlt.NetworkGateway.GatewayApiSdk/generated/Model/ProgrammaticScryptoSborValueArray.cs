...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProgrammaticScryptoSborValueArray")]
    ...
    public partial class ProgrammaticScryptoSborValueArray : ProgrammaticScryptoSborValue
    {
        ...
        protected ProgrammaticScryptoSborValueArray() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgrammaticScryptoSborValueArray" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ProgrammaticScryptoSborValueArray);
        }

        /// <summary>
        /// Returns true if ProgrammaticScryptoSborValueArray instances are equal
        /// </summary>
        /// <param name="input">Instance of ProgrammaticScryptoSborValueArray to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProgrammaticScryptoSborValueArray input)
        {
            if (input == null)
            {
                return false;
