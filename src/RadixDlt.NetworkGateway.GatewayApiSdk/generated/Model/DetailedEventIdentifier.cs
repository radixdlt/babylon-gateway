...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class DetailedEventIdentifier
    {
        ...
        protected DetailedEventIdentifier() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DetailedEventIdentifier" /> class.
        /// </summary>
        ...
        public DetailedEventIdentifier(string package = default(string), string blueprint = default(string), string _event = default(string))
        {
            ...
            if (package == null)
            {
                throw new ArgumentNullException("package is a required property for DetailedEventIdentifier and cannot be null");
            }
            this.Package = package;
            // to ensure "blueprint" is required (not null)
            if (blueprint == null)
            {
                throw new ArgumentNullException("blueprint is a required property for DetailedEventIdentifier and cannot be null");
            }
            this.Blueprint = blueprint;
            // to ensure "_event" is required (not null)
            if (_event == null)
            {
                throw new ArgumentNullException("_event is a required property for DetailedEventIdentifier and cannot be null");
            }
            this.Event = _event;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DetailedEventIdentifier {\n");
        ...
        {
            return this.Equals(input as DetailedEventIdentifier);
        }

        /// <summary>
        /// Returns true if DetailedEventIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of DetailedEventIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DetailedEventIdentifier input)
        {
            if (input == null)
            {
                return false;
