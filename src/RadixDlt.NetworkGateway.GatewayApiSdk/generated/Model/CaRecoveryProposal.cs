...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CaRecoveryProposal
    /// </summary>
    [DataContract(Name = "CaRecoveryProposal")]
    public partial class CaRecoveryProposal : IEquatable<CaRecoveryProposal>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaRecoveryProposal" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaRecoveryProposal() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaRecoveryProposal" /> class.
        /// </summary>
        ...
        public CaRecoveryProposal(CaAccessRule primaryRole = default(CaAccessRule), CaAccessRule recoveryRole = default(CaAccessRule), CaAccessRule confirmationRole = default(CaAccessRule), long timedRecoveryDelayMinutes = default(long))
        {
            // to ensure "primaryRole" is required (not null)
            if (primaryRole == null)
            {
                throw new ArgumentNullException("primaryRole is a required property for CaRecoveryProposal and cannot be null");
            }
            this.PrimaryRole = primaryRole;
            // to ensure "recoveryRole" is required (not null)
            if (recoveryRole == null)
            {
                throw new ArgumentNullException("recoveryRole is a required property for CaRecoveryProposal and cannot be null");
            }
            this.RecoveryRole = recoveryRole;
            // to ensure "confirmationRole" is required (not null)
            if (confirmationRole == null)
            {
                throw new ArgumentNullException("confirmationRole is a required property for CaRecoveryProposal and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaRecoveryProposal {\n");
        ...
        {
            return this.Equals(input as CaRecoveryProposal);
        }

        /// <summary>
        /// Returns true if CaRecoveryProposal instances are equal
        /// </summary>
        /// <param name="input">Instance of CaRecoveryProposal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaRecoveryProposal input)
        {
            if (input == null)
            {
                return false;
