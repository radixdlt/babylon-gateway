...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// MetadataStringValue
    /// </summary>
    [DataContract(Name = "MetadataStringValue")]
    ...
    public partial class MetadataStringValue : MetadataTypedValue, IEquatable<MetadataStringValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataStringValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataStringValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataStringValue" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="type">type (required) (default to MetadataValueType.String).</param>
        public MetadataStringValue(string value = default(string), MetadataValueType type = MetadataValueType.String) : base(type)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for MetadataStringValue and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as MetadataStringValue);
        }

        /// <summary>
        /// Returns true if MetadataStringValue instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataStringValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataStringValue input)
        {
            if (input == null)
            {
                return false;
