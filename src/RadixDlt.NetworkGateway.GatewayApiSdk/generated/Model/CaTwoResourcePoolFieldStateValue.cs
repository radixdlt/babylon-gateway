...
{
    /// <summary>
    /// CaTwoResourcePoolFieldStateValue
    /// </summary>
    [DataContract(Name = "CaTwoResourcePoolFieldStateValue")]
    public partial class CaTwoResourcePoolFieldStateValue : IEquatable<CaTwoResourcePoolFieldStateValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaTwoResourcePoolFieldStateValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaTwoResourcePoolFieldStateValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaTwoResourcePoolFieldStateValue" /> class.
        /// </summary>
        ...
        public CaTwoResourcePoolFieldStateValue(List<CaPoolVault> vaults = default(List<CaPoolVault>), string poolUnitResourceAddress = default(string))
        {
            // to ensure "vaults" is required (not null)
            if (vaults == null)
            {
                throw new ArgumentNullException("vaults is a required property for CaTwoResourcePoolFieldStateValue and cannot be null");
            }
            this.Vaults = vaults;
            // to ensure "poolUnitResourceAddress" is required (not null)
            if (poolUnitResourceAddress == null)
            {
                throw new ArgumentNullException("poolUnitResourceAddress is a required property for CaTwoResourcePoolFieldStateValue and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaTwoResourcePoolFieldStateValue {\n");
        ...
        {
            return this.Equals(input as CaTwoResourcePoolFieldStateValue);
        }

        /// <summary>
        /// Returns true if CaTwoResourcePoolFieldStateValue instances are equal
        /// </summary>
        /// <param name="input">Instance of CaTwoResourcePoolFieldStateValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaTwoResourcePoolFieldStateValue input)
        {
            if (input == null)
            {
                return false;
