...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiKeyValueStoreInfo")]
    public partial class CoreApiKeyValueStoreInfo : IEquatable<CoreApiKeyValueStoreInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiKeyValueStoreInfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiKeyValueStoreInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiKeyValueStoreInfo" /> class.
        /// </summary>
        ...
        public CoreApiKeyValueStoreInfo(CoreApiGenericSubstitution keyGenericSubstitution = default(CoreApiGenericSubstitution), CoreApiGenericSubstitution valueGenericSubstitution = default(CoreApiGenericSubstitution), bool allowOwnership = default(bool))
        {
            // to ensure "keyGenericSubstitution" is required (not null)
            if (keyGenericSubstitution == null)
            {
                throw new ArgumentNullException("keyGenericSubstitution is a required property for CoreApiKeyValueStoreInfo and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("valueGenericSubstitution is a required property for CoreApiKeyValueStoreInfo and cannot be null");
            }
        ...
        public CoreApiGenericSubstitution KeyGenericSubstitution { get; set; }

        /// <summary>
        /// Gets or Sets ValueGenericSubstitution
        /// </summary>
        [DataMember(Name = "value_generic_substitution", IsRequired = true, EmitDefaultValue = true)]
        public CoreApiGenericSubstitution ValueGenericSubstitution { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiKeyValueStoreInfo {\n");
        ...
        {
            return this.Equals(input as CoreApiKeyValueStoreInfo);
        }

        /// <summary>
        /// Returns true if CoreApiKeyValueStoreInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiKeyValueStoreInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiKeyValueStoreInfo input)
        {
            if (input == null)
            {
                return false;
