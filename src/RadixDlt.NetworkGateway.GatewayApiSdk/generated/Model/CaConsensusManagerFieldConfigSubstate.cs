...
{
    /// <summary>
    /// CaConsensusManagerFieldConfigSubstate
    /// </summary>
    [DataContract(Name = "CaConsensusManagerFieldConfigSubstate")]
    ...
    public partial class CaConsensusManagerFieldConfigSubstate : CaSubstate, IEquatable<CaConsensusManagerFieldConfigSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaConsensusManagerFieldConfigSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaConsensusManagerFieldConfigSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaConsensusManagerFieldConfigSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.ConsensusManagerFieldConfig).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaConsensusManagerFieldConfigSubstate(CaConsensusManagerFieldConfigValue value = default(CaConsensusManagerFieldConfigValue), CaSubstateType substateType = CaSubstateType.ConsensusManagerFieldConfig, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaConsensusManagerFieldConfigSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaConsensusManagerFieldConfigValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaConsensusManagerFieldConfigSubstate {\n");
        ...
        {
            return this.Equals(input as CaConsensusManagerFieldConfigSubstate);
        }

        /// <summary>
        /// Returns true if CaConsensusManagerFieldConfigSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaConsensusManagerFieldConfigSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaConsensusManagerFieldConfigSubstate input)
        {
            if (input == null)
            {
                return false;
