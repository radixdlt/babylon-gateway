...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CaBlueprintInfo
    /// </summary>
    [DataContract(Name = "CaBlueprintInfo")]
    public partial class CaBlueprintInfo : IEquatable<CaBlueprintInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaBlueprintInfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaBlueprintInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaBlueprintInfo" /> class.
        /// </summary>
        ...
        public CaBlueprintInfo(string packageAddress = default(string), string blueprintName = default(string), string blueprintVersion = default(string), string outerObject = default(string), List<string> features = default(List<string>), List<CaGenericSubstitution> genericSubstitutions = default(List<CaGenericSubstitution>))
        {
            // to ensure "packageAddress" is required (not null)
            if (packageAddress == null)
            {
                throw new ArgumentNullException("packageAddress is a required property for CaBlueprintInfo and cannot be null");
            }
            this.PackageAddress = packageAddress;
            // to ensure "blueprintName" is required (not null)
            if (blueprintName == null)
            {
                throw new ArgumentNullException("blueprintName is a required property for CaBlueprintInfo and cannot be null");
            }
            this.BlueprintName = blueprintName;
            // to ensure "blueprintVersion" is required (not null)
            if (blueprintVersion == null)
            {
                throw new ArgumentNullException("blueprintVersion is a required property for CaBlueprintInfo and cannot be null");
            }
            this.BlueprintVersion = blueprintVersion;
            // to ensure "features" is required (not null)
            if (features == null)
            {
                throw new ArgumentNullException("features is a required property for CaBlueprintInfo and cannot be null");
            }
            this.Features = features;
            // to ensure "genericSubstitutions" is required (not null)
            if (genericSubstitutions == null)
            {
                throw new ArgumentNullException("genericSubstitutions is a required property for CaBlueprintInfo and cannot be null");
            }
        ...
        public List<CaGenericSubstitution> GenericSubstitutions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaBlueprintInfo {\n");
        ...
        {
            return this.Equals(input as CaBlueprintInfo);
        }

        /// <summary>
        /// Returns true if CaBlueprintInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of CaBlueprintInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaBlueprintInfo input)
        {
            if (input == null)
            {
                return false;
