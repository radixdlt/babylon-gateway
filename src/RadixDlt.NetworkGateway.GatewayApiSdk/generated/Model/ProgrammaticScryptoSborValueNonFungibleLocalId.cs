...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class ProgrammaticScryptoSborValueNonFungibleLocalId : ProgrammaticScryptoSborValue, IEquatable<ProgrammaticScryptoSborValueNonFungibleLocalId>
    {
        ...
        /// <param name="kind">kind (required) (default to ProgrammaticScryptoSborValueKind.NonFungibleLocalId).</param>
        ...
        public ProgrammaticScryptoSborValueNonFungibleLocalId(string value = default(string), ProgrammaticScryptoSborValueKind kind = ProgrammaticScryptoSborValueKind.NonFungibleLocalId, string typeName = default(string), string fieldName = default(string)) : base(kind, typeName, fieldName)
        {
