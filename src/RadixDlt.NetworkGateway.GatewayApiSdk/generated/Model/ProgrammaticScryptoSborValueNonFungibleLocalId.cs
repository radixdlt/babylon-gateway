...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProgrammaticScryptoSborValueNonFungibleLocalId")]
    ...
    public partial class ProgrammaticScryptoSborValueNonFungibleLocalId : ProgrammaticScryptoSborValue, IEquatable<ProgrammaticScryptoSborValueNonFungibleLocalId>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgrammaticScryptoSborValueNonFungibleLocalId" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProgrammaticScryptoSborValueNonFungibleLocalId() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgrammaticScryptoSborValueNonFungibleLocalId" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="kind">kind (required) (default to ProgrammaticScryptoSborValueTypeKind.NonFungibleLocalId).</param>
        ...
        public ProgrammaticScryptoSborValueNonFungibleLocalId(string value = default(string), ProgrammaticScryptoSborValueTypeKind kind = ProgrammaticScryptoSborValueTypeKind.NonFungibleLocalId, string typeName = default(string), string fieldName = default(string)) : base(kind, typeName, fieldName)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for ProgrammaticScryptoSborValueNonFungibleLocalId and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as ProgrammaticScryptoSborValueNonFungibleLocalId);
        }

        /// <summary>
        /// Returns true if ProgrammaticScryptoSborValueNonFungibleLocalId instances are equal
        /// </summary>
        /// <param name="input">Instance of ProgrammaticScryptoSborValueNonFungibleLocalId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProgrammaticScryptoSborValueNonFungibleLocalId input)
        {
            if (input == null)
            {
                return false;
