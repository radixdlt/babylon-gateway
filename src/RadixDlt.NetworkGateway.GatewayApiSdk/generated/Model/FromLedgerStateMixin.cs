...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class FromLedgerStateMixin : IEquatable<FromLedgerStateMixin>
    {
        ...
        public FromLedgerStateMixin(LedgerStateSelector fromLedgerState = default(LedgerStateSelector))
        {
        ...
        {
            return this.Equals(input as FromLedgerStateMixin);
        }

        /// <summary>
        /// Returns true if FromLedgerStateMixin instances are equal
        /// </summary>
        /// <param name="input">Instance of FromLedgerStateMixin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FromLedgerStateMixin input)
        {
            if (input == null)
            {
                return false;
