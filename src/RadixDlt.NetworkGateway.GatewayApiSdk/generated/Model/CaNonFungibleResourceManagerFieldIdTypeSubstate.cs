...
{
    /// <summary>
    /// CaNonFungibleResourceManagerFieldIdTypeSubstate
    /// </summary>
    [DataContract(Name = "CaNonFungibleResourceManagerFieldIdTypeSubstate")]
    ...
    public partial class CaNonFungibleResourceManagerFieldIdTypeSubstate : CaSubstate, IEquatable<CaNonFungibleResourceManagerFieldIdTypeSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaNonFungibleResourceManagerFieldIdTypeSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaNonFungibleResourceManagerFieldIdTypeSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaNonFungibleResourceManagerFieldIdTypeSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.NonFungibleResourceManagerFieldIdType).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaNonFungibleResourceManagerFieldIdTypeSubstate(CaNonFungibleResourceManagerFieldIdTypeValue value = default(CaNonFungibleResourceManagerFieldIdTypeValue), CaSubstateType substateType = CaSubstateType.NonFungibleResourceManagerFieldIdType, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaNonFungibleResourceManagerFieldIdTypeSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaNonFungibleResourceManagerFieldIdTypeValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaNonFungibleResourceManagerFieldIdTypeSubstate {\n");
        ...
        {
            return this.Equals(input as CaNonFungibleResourceManagerFieldIdTypeSubstate);
        }

        /// <summary>
        /// Returns true if CaNonFungibleResourceManagerFieldIdTypeSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaNonFungibleResourceManagerFieldIdTypeSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaNonFungibleResourceManagerFieldIdTypeSubstate input)
        {
            if (input == null)
            {
                return false;
