...
{
    /// <summary>
    /// CaNonFungibleResourceManagerFieldTotalSupplySubstate
    /// </summary>
    [DataContract(Name = "CaNonFungibleResourceManagerFieldTotalSupplySubstate")]
    ...
    public partial class CaNonFungibleResourceManagerFieldTotalSupplySubstate : CaSubstate, IEquatable<CaNonFungibleResourceManagerFieldTotalSupplySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaNonFungibleResourceManagerFieldTotalSupplySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaNonFungibleResourceManagerFieldTotalSupplySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaNonFungibleResourceManagerFieldTotalSupplySubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.NonFungibleResourceManagerFieldTotalSupply).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaNonFungibleResourceManagerFieldTotalSupplySubstate(CaNonFungibleResourceManagerFieldTotalSupplyValue value = default(CaNonFungibleResourceManagerFieldTotalSupplyValue), CaSubstateType substateType = CaSubstateType.NonFungibleResourceManagerFieldTotalSupply, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaNonFungibleResourceManagerFieldTotalSupplySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaNonFungibleResourceManagerFieldTotalSupplyValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaNonFungibleResourceManagerFieldTotalSupplySubstate {\n");
        ...
        {
            return this.Equals(input as CaNonFungibleResourceManagerFieldTotalSupplySubstate);
        }

        /// <summary>
        /// Returns true if CaNonFungibleResourceManagerFieldTotalSupplySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaNonFungibleResourceManagerFieldTotalSupplySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaNonFungibleResourceManagerFieldTotalSupplySubstate input)
        {
            if (input == null)
            {
                return false;
