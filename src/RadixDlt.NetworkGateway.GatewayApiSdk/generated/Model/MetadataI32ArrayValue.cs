...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MetadataI32ArrayValue")]
    ...
    public partial class MetadataI32ArrayValue : MetadataTypedValue, IEquatable<MetadataI32ArrayValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataI32ArrayValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataI32ArrayValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataI32ArrayValue" /> class.
        /// </summary>
        /// <param name="values">values (required).</param>
        /// <param name="type">type (required) (default to MetadataValueType.I32Array).</param>
        public MetadataI32ArrayValue(List<string> values = default(List<string>), MetadataValueType type = MetadataValueType.I32Array) : base(type)
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for MetadataI32ArrayValue and cannot be null");
            }
            this.Values = values;
        }
        ...
        {
            return this.Equals(input as MetadataI32ArrayValue);
        }

        /// <summary>
        /// Returns true if MetadataI32ArrayValue instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataI32ArrayValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataI32ArrayValue input)
        {
            if (input == null)
            {
                return false;
