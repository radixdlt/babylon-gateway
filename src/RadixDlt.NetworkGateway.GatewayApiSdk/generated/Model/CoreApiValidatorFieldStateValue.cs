...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiValidatorFieldStateValue")]
    public partial class CoreApiValidatorFieldStateValue : IEquatable<CoreApiValidatorFieldStateValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiValidatorFieldStateValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiValidatorFieldStateValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiValidatorFieldStateValue" /> class.
        /// </summary>
        ...
        public CoreApiValidatorFieldStateValue(CoreApiSubstateKey sortedKey = default(CoreApiSubstateKey), CoreApiEcdsaSecp256k1PublicKey publicKey = default(CoreApiEcdsaSecp256k1PublicKey), bool isRegistered = default(bool), bool acceptsDelegatedStake = default(bool), string validatorFeeFactor = default(string), CoreApiValidatorFeeChangeRequest validatorFeeChangeRequest = default(CoreApiValidatorFeeChangeRequest), string stakeUnitResourceAddress = default(string), CoreApiEntityReference stakeXrdVault = default(CoreApiEntityReference), string claimTokenResourceAddress = default(string), CoreApiEntityReference pendingXrdWithdrawVault = default(CoreApiEntityReference), CoreApiEntityReference lockedOwnerStakeUnitVault = default(CoreApiEntityReference), CoreApiEntityReference pendingOwnerStakeUnitUnlockVault = default(CoreApiEntityReference), List<CoreApiPendingOwnerStakeWithdrawal> pendingOwnerStakeUnitWithdrawals = default(List<CoreApiPendingOwnerStakeWithdrawal>), string alreadyUnlockedOwnerStakeUnitAmount = default(string))
        {
            // to ensure "publicKey" is required (not null)
            if (publicKey == null)
            {
                throw new ArgumentNullException("publicKey is a required property for CoreApiValidatorFieldStateValue and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("validatorFeeFactor is a required property for CoreApiValidatorFieldStateValue and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("stakeUnitResourceAddress is a required property for CoreApiValidatorFieldStateValue and cannot be null");
            }
            this.StakeUnitResourceAddress = stakeUnitResourceAddress;
            // to ensure "stakeXrdVault" is required (not null)
            if (stakeXrdVault == null)
            {
                throw new ArgumentNullException("stakeXrdVault is a required property for CoreApiValidatorFieldStateValue and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("claimTokenResourceAddress is a required property for CoreApiValidatorFieldStateValue and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("pendingXrdWithdrawVault is a required property for CoreApiValidatorFieldStateValue and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("lockedOwnerStakeUnitVault is a required property for CoreApiValidatorFieldStateValue and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("pendingOwnerStakeUnitUnlockVault is a required property for CoreApiValidatorFieldStateValue and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("pendingOwnerStakeUnitWithdrawals is a required property for CoreApiValidatorFieldStateValue and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("alreadyUnlockedOwnerStakeUnitAmount is a required property for CoreApiValidatorFieldStateValue and cannot be null");
            }
        ...
        public CoreApiSubstateKey SortedKey { get; set; }

        /// <summary>
        /// Gets or Sets PublicKey
        /// </summary>
        [DataMember(Name = "public_key", IsRequired = true, EmitDefaultValue = true)]
        public CoreApiEcdsaSecp256k1PublicKey PublicKey { get; set; }
        ...
        public CoreApiValidatorFeeChangeRequest ValidatorFeeChangeRequest { get; set; }
        ...
        public CoreApiEntityReference StakeXrdVault { get; set; }
        ...
        public CoreApiEntityReference PendingXrdWithdrawVault { get; set; }
        ...
        public CoreApiEntityReference LockedOwnerStakeUnitVault { get; set; }
        ...
        public CoreApiEntityReference PendingOwnerStakeUnitUnlockVault { get; set; }
        ...
        public List<CoreApiPendingOwnerStakeWithdrawal> PendingOwnerStakeUnitWithdrawals { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiValidatorFieldStateValue {\n");
        ...
        {
            return this.Equals(input as CoreApiValidatorFieldStateValue);
        }

        /// <summary>
        /// Returns true if CoreApiValidatorFieldStateValue instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiValidatorFieldStateValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiValidatorFieldStateValue input)
        {
            if (input == null)
            {
                return false;
