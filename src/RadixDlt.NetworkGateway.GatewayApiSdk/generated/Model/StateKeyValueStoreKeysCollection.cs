...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class StateKeyValueStoreKeysCollection : IEquatable<StateKeyValueStoreKeysCollection>
    {
        ...
        public StateKeyValueStoreKeysCollection(long? totalCount = default(long?), string nextCursor = default(string), List<StateKeyValueStoreKeysResponseItem> items = default(List<StateKeyValueStoreKeysResponseItem>))
        {
        ...
        /// </summary>
        /// <param name="input">Instance of StateKeyValueStoreKeysCollection to be compared</param>
        /// <returns>Boolean</returns>
