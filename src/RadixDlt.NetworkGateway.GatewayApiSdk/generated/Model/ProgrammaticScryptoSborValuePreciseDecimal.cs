...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProgrammaticScryptoSborValuePreciseDecimal")]
    ...
    public partial class ProgrammaticScryptoSborValuePreciseDecimal : ProgrammaticScryptoSborValue, IEquatable<ProgrammaticScryptoSborValuePreciseDecimal>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgrammaticScryptoSborValuePreciseDecimal" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProgrammaticScryptoSborValuePreciseDecimal() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgrammaticScryptoSborValuePreciseDecimal" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="kind">kind (required) (default to ProgrammaticScryptoSborValueTypeKind.PreciseDecimal).</param>
        ...
        public ProgrammaticScryptoSborValuePreciseDecimal(string value = default(string), ProgrammaticScryptoSborValueTypeKind kind = ProgrammaticScryptoSborValueTypeKind.PreciseDecimal, string typeName = default(string), string fieldName = default(string)) : base(kind, typeName, fieldName)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for ProgrammaticScryptoSborValuePreciseDecimal and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as ProgrammaticScryptoSborValuePreciseDecimal);
        }

        /// <summary>
        /// Returns true if ProgrammaticScryptoSborValuePreciseDecimal instances are equal
        /// </summary>
        /// <param name="input">Instance of ProgrammaticScryptoSborValuePreciseDecimal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProgrammaticScryptoSborValuePreciseDecimal input)
        {
            if (input == null)
            {
                return false;
