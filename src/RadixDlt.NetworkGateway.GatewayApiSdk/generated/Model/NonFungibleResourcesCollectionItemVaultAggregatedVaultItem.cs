...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NonFungibleResourcesCollectionItemVaultAggregatedVaultItem")]
    public partial class NonFungibleResourcesCollectionItemVaultAggregatedVaultItem : IEquatable<NonFungibleResourcesCollectionItemVaultAggregatedVaultItem>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NonFungibleResourcesCollectionItemVaultAggregatedVaultItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NonFungibleResourcesCollectionItemVaultAggregatedVaultItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NonFungibleResourcesCollectionItemVaultAggregatedVaultItem" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as NonFungibleResourcesCollectionItemVaultAggregatedVaultItem);
        }

        /// <summary>
        /// Returns true if NonFungibleResourcesCollectionItemVaultAggregatedVaultItem instances are equal
        /// </summary>
        /// <param name="input">Instance of NonFungibleResourcesCollectionItemVaultAggregatedVaultItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NonFungibleResourcesCollectionItemVaultAggregatedVaultItem input)
        {
            if (input == null)
            {
                return false;
