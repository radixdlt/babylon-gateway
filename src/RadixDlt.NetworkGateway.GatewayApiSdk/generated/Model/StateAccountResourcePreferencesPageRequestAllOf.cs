...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class StateAccountResourcePreferencesPageRequestAllOf : IEquatable<StateAccountResourcePreferencesPageRequestAllOf>
    {
        ...
        protected StateAccountResourcePreferencesPageRequestAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StateAccountResourcePreferencesPageRequestAllOf" /> class.
        /// </summary>
        /// <param name="accountAddress">Bech32m-encoded human readable version of the address. (required).</param>
        public StateAccountResourcePreferencesPageRequestAllOf(string accountAddress = default(string))
        {
            // to ensure "accountAddress" is required (not null)
            if (accountAddress == null)
            {
                throw new ArgumentNullException("accountAddress is a required property for StateAccountResourcePreferencesPageRequestAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StateAccountResourcePreferencesPageRequestAllOf {\n");
        ...
        {
            return this.Equals(input as StateAccountResourcePreferencesPageRequestAllOf);
        }

        /// <summary>
        /// Returns true if StateAccountResourcePreferencesPageRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of StateAccountResourcePreferencesPageRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StateAccountResourcePreferencesPageRequestAllOf input)
        {
            if (input == null)
            {
                return false;
