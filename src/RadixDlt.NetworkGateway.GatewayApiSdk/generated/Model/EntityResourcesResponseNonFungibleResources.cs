...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class EntityResourcesResponseNonFungibleResources : IEquatable<EntityResourcesResponseNonFungibleResources>, IValidatableObject
    {
        ...
        public EntityResourcesResponseNonFungibleResources(int? totalCount = default(int?), string previousCursor = default(string), string nextCursor = default(string), List<EntityResourcesResponseNonFungibleResourcesItem> items = default(List<EntityResourcesResponseNonFungibleResourcesItem>))
        {
