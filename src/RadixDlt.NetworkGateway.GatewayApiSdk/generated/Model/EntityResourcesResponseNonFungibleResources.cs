...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class EntityResourcesResponseNonFungibleResources : IEquatable<EntityResourcesResponseNonFungibleResources>, IValidatableObject
    {
        ...
        public EntityResourcesResponseNonFungibleResources(decimal totalCount = default(decimal), string previousCursor = default(string), string nextCursor = default(string), List<EntityStateResponseNonFungibleResource> results = default(List<EntityStateResponseNonFungibleResource>))
        {
            this.TotalCount = totalCount;
            // to ensure "results" is required (not null)
            if (results == null)
            {
                throw new ArgumentNullException("results is a required property for EntityResourcesResponseNonFungibleResources and cannot be null");
            }
