...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class ProgrammaticScryptoSborValueI128 : ProgrammaticScryptoSborValue, IEquatable<ProgrammaticScryptoSborValueI128>
    {
        ...
        /// <param name="kind">kind (required) (default to ProgrammaticScryptoSborValueKind.I128).</param>
        ...
        public ProgrammaticScryptoSborValueI128(string value = default(string), ProgrammaticScryptoSborValueKind kind = ProgrammaticScryptoSborValueKind.I128, string typeName = default(string), string fieldName = default(string)) : base(kind, typeName, fieldName)
        {
