...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MetadataBoolArrayValue")]
    ...
    public partial class MetadataBoolArrayValue : MetadataTypedValue, IEquatable<MetadataBoolArrayValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataBoolArrayValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataBoolArrayValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataBoolArrayValue" /> class.
        /// </summary>
        /// <param name="values">values (required).</param>
        /// <param name="type">type (required) (default to MetadataValueType.BoolArray).</param>
        public MetadataBoolArrayValue(List<bool> values = default(List<bool>), MetadataValueType type = MetadataValueType.BoolArray) : base(type)
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for MetadataBoolArrayValue and cannot be null");
            }
            this.Values = values;
        }
        ...
        {
            return this.Equals(input as MetadataBoolArrayValue);
        }

        /// <summary>
        /// Returns true if MetadataBoolArrayValue instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataBoolArrayValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataBoolArrayValue input)
        {
            if (input == null)
            {
                return false;
