...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CaScryptoInstant
    /// </summary>
    [DataContract(Name = "CaScryptoInstant")]
    public partial class CaScryptoInstant : IEquatable<CaScryptoInstant>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaScryptoInstant" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaScryptoInstant() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaScryptoInstant" /> class.
        /// </summary>
        ...
        public CaScryptoInstant(string unixTimestampSeconds = default(string), string dateTime = default(string))
        {
            // to ensure "unixTimestampSeconds" is required (not null)
            if (unixTimestampSeconds == null)
            {
                throw new ArgumentNullException("unixTimestampSeconds is a required property for CaScryptoInstant and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaScryptoInstant {\n");
        ...
        {
            return this.Equals(input as CaScryptoInstant);
        }

        /// <summary>
        /// Returns true if CaScryptoInstant instances are equal
        /// </summary>
        /// <param name="input">Instance of CaScryptoInstant to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaScryptoInstant input)
        {
            if (input == null)
            {
                return false;
