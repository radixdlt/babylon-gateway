...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class StateEntityNonFungibleIdsPageResponse
    {
        /// <summary>
        ...
        public StateEntityNonFungibleIdsPageResponse(LedgerState ledgerState = default(LedgerState), long? totalCount = default(long?), string nextCursor = default(string), List<string> items = default(List<string>), string address = default(string), string resourceAddress = default(string))
        {
