...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MetadataU8ArrayValue")]
    ...
    public partial class MetadataU8ArrayValue : MetadataTypedValue, IEquatable<MetadataU8ArrayValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataU8ArrayValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataU8ArrayValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataU8ArrayValue" /> class.
        /// </summary>
        /// <param name="valueHex">valueHex (required).</param>
        /// <param name="type">type (required) (default to MetadataValueType.U8Array).</param>
        public MetadataU8ArrayValue(string valueHex = default(string), MetadataValueType type = MetadataValueType.U8Array) : base(type)
        {
            // to ensure "valueHex" is required (not null)
            if (valueHex == null)
            {
                throw new ArgumentNullException("valueHex is a required property for MetadataU8ArrayValue and cannot be null");
            }
        ...
        {
            return this.Equals(input as MetadataU8ArrayValue);
        }

        /// <summary>
        /// Returns true if MetadataU8ArrayValue instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataU8ArrayValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataU8ArrayValue input)
        {
            if (input == null)
            {
                return false;
