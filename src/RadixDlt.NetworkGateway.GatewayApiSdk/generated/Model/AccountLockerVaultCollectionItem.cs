...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountLockerVaultCollectionItem")]
    [JsonConverter(typeof(JsonSubtypes), "type")]
    [JsonSubtypes.KnownSubType(typeof(AccountLockerVaultCollectionItemFungible), "AccountLockerVaultCollectionItemFungible")]
    ...
    public partial class AccountLockerVaultCollectionItem
    {
        ...
        public AccountLockerVaultCollectionItemType Type { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountLockerVaultCollectionItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountLockerVaultCollectionItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountLockerVaultCollectionItem" /> class.
        /// </summary>
        ...
        public AccountLockerVaultCollectionItem(AccountLockerVaultCollectionItemType type = default(AccountLockerVaultCollectionItemType), string resourceAddress = default(string), string vaultAddress = default(string), long lastUpdatedAtStateVersion = default(long))
        {
            this.Type = type;
            // to ensure "resourceAddress" is required (not null)
            if (resourceAddress == null)
            {
                throw new ArgumentNullException("resourceAddress is a required property for AccountLockerVaultCollectionItem and cannot be null");
            }
            this.ResourceAddress = resourceAddress;
            // to ensure "vaultAddress" is required (not null)
            if (vaultAddress == null)
            {
                throw new ArgumentNullException("vaultAddress is a required property for AccountLockerVaultCollectionItem and cannot be null");
            }
        ...
        {
            return this.Equals(input as AccountLockerVaultCollectionItem);
        }

        /// <summary>
        /// Returns true if AccountLockerVaultCollectionItem instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountLockerVaultCollectionItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountLockerVaultCollectionItem input)
        {
            if (input == null)
            {
                return false;
