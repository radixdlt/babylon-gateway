...
{
    /// <summary>
    /// CaNonFungibleResourceManagerFieldMutableFieldsSubstate
    /// </summary>
    [DataContract(Name = "CaNonFungibleResourceManagerFieldMutableFieldsSubstate")]
    ...
    public partial class CaNonFungibleResourceManagerFieldMutableFieldsSubstate : CaSubstate, IEquatable<CaNonFungibleResourceManagerFieldMutableFieldsSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaNonFungibleResourceManagerFieldMutableFieldsSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaNonFungibleResourceManagerFieldMutableFieldsSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaNonFungibleResourceManagerFieldMutableFieldsSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.NonFungibleResourceManagerFieldMutableFields).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaNonFungibleResourceManagerFieldMutableFieldsSubstate(CaNonFungibleResourceManagerFieldMutableFieldsValue value = default(CaNonFungibleResourceManagerFieldMutableFieldsValue), CaSubstateType substateType = CaSubstateType.NonFungibleResourceManagerFieldMutableFields, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaNonFungibleResourceManagerFieldMutableFieldsSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaNonFungibleResourceManagerFieldMutableFieldsValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaNonFungibleResourceManagerFieldMutableFieldsSubstate {\n");
        ...
        {
            return this.Equals(input as CaNonFungibleResourceManagerFieldMutableFieldsSubstate);
        }

        /// <summary>
        /// Returns true if CaNonFungibleResourceManagerFieldMutableFieldsSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaNonFungibleResourceManagerFieldMutableFieldsSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaNonFungibleResourceManagerFieldMutableFieldsSubstate input)
        {
            if (input == null)
            {
                return false;
