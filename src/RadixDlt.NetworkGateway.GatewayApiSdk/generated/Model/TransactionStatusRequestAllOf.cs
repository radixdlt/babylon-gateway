...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionStatusRequest_allOf")]
    public partial class TransactionStatusRequestAllOf : IEquatable<TransactionStatusRequestAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionStatusRequestAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionStatusRequestAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionStatusRequestAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TransactionStatusRequestAllOf);
        }

        /// <summary>
        /// Returns true if TransactionStatusRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionStatusRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionStatusRequestAllOf input)
        {
            if (input == null)
            {
                return false;
