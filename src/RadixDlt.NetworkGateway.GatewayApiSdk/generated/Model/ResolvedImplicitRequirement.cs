...
{
    /// <summary>
    /// ResolvedImplicitRequirement
    /// </summary>
    [DataContract(Name = "ResolvedImplicitRequirement")]
    ...
    public partial class ResolvedImplicitRequirement
    {
        ...
        public ResolvedImplicitRequirementType Type { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResolvedImplicitRequirement" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResolvedImplicitRequirement() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResolvedImplicitRequirement" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ResolvedImplicitRequirement);
        }

        /// <summary>
        /// Returns true if ResolvedImplicitRequirement instances are equal
        /// </summary>
        /// <param name="input">Instance of ResolvedImplicitRequirement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResolvedImplicitRequirement input)
        {
            if (input == null)
            {
                return false;
