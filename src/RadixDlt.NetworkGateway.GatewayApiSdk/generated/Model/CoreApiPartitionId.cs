...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CoreApiPartitionId
    /// </summary>
    [DataContract(Name = "CoreApiPartitionId")]
    public partial class CoreApiPartitionId : IEquatable<CoreApiPartitionId>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiPartitionId" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiPartitionId() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiPartitionId" /> class.
        /// </summary>
        ...
        public CoreApiPartitionId(CoreApiEntityType entityType = default(CoreApiEntityType), string entityAddress = default(string), CoreApiEntityModule entityModule = default(CoreApiEntityModule), CoreApiPartitionKind partitionKind = default(CoreApiPartitionKind), int partitionNumber = default(int))
        {
            this.EntityType = entityType;
            // to ensure "entityAddress" is required (not null)
            if (entityAddress == null)
            {
                throw new ArgumentNullException("entityAddress is a required property for CoreApiPartitionId and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiPartitionId {\n");
        ...
        {
            return this.Equals(input as CoreApiPartitionId);
        }

        /// <summary>
        /// Returns true if CoreApiPartitionId instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiPartitionId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiPartitionId input)
        {
            if (input == null)
            {
                return false;
