...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CaFieldSchema
    /// </summary>
    [DataContract(Name = "CaFieldSchema")]
    public partial class CaFieldSchema : IEquatable<CaFieldSchema>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaFieldSchema" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaFieldSchema() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaFieldSchema" /> class.
        /// </summary>
        ...
        public CaFieldSchema(CaBlueprintPayloadDef fieldTypeRef = default(CaBlueprintPayloadDef), CaFieldSchemaFeatureCondition condition = default(CaFieldSchemaFeatureCondition), string transientDefaultValueHex = default(string))
        {
            // to ensure "fieldTypeRef" is required (not null)
            if (fieldTypeRef == null)
            {
                throw new ArgumentNullException("fieldTypeRef is a required property for CaFieldSchema and cannot be null");
            }
        ...
        public CaBlueprintPayloadDef FieldTypeRef { get; set; }

        /// <summary>
        /// Gets or Sets Condition
        /// </summary>
        [DataMember(Name = "condition", EmitDefaultValue = true)]
        public CaFieldSchemaFeatureCondition Condition { get; set; }
        ...
        {
            return this.Equals(input as CaFieldSchema);
        }

        /// <summary>
        /// Returns true if CaFieldSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of CaFieldSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaFieldSchema input)
        {
            if (input == null)
            {
                return false;
