...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProgrammaticScryptoSborValueI8")]
    ...
    public partial class ProgrammaticScryptoSborValueI8 : ProgrammaticScryptoSborValue, IEquatable<ProgrammaticScryptoSborValueI8>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgrammaticScryptoSborValueI8" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProgrammaticScryptoSborValueI8() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgrammaticScryptoSborValueI8" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="kind">kind (required) (default to ProgrammaticScryptoSborValueTypeKind.I8).</param>
        ...
        public ProgrammaticScryptoSborValueI8(string value = default(string), ProgrammaticScryptoSborValueTypeKind kind = ProgrammaticScryptoSborValueTypeKind.I8, string typeName = default(string), string fieldName = default(string)) : base(kind, typeName, fieldName)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for ProgrammaticScryptoSborValueI8 and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as ProgrammaticScryptoSborValueI8);
        }

        /// <summary>
        /// Returns true if ProgrammaticScryptoSborValueI8 instances are equal
        /// </summary>
        /// <param name="input">Instance of ProgrammaticScryptoSborValueI8 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProgrammaticScryptoSborValueI8 input)
        {
            if (input == null)
            {
                return false;
