...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class ProgrammaticScryptoSborValueI8 : ProgrammaticScryptoSborValue, IEquatable<ProgrammaticScryptoSborValueI8>
    {
        ...
        /// <param name="kind">kind (required) (default to ProgrammaticScryptoSborValueKind.I8).</param>
        ...
        public ProgrammaticScryptoSborValueI8(string value = default(string), ProgrammaticScryptoSborValueKind kind = ProgrammaticScryptoSborValueKind.I8, string typeName = default(string), string fieldName = default(string)) : base(kind, typeName, fieldName)
        {
