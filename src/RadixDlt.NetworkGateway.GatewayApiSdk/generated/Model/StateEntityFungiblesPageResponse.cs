...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class StateEntityFungiblesPageResponse
    {
        /// <summary>
        ...
        public StateEntityFungiblesPageResponse(LedgerState ledgerState = default(LedgerState), long? totalCount = default(long?), string nextCursor = default(string), List<FungibleResourcesCollectionItem> items = default(List<FungibleResourcesCollectionItem>), string address = default(string))
        {
