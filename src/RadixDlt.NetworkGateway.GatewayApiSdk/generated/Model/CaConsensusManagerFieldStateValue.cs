...
{
    /// <summary>
    /// CaConsensusManagerFieldStateValue
    /// </summary>
    [DataContract(Name = "CaConsensusManagerFieldStateValue")]
    public partial class CaConsensusManagerFieldStateValue : IEquatable<CaConsensusManagerFieldStateValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaConsensusManagerFieldStateValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaConsensusManagerFieldStateValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaConsensusManagerFieldStateValue" /> class.
        /// </summary>
        ...
        public CaConsensusManagerFieldStateValue(long epoch = default(long), long round = default(long), bool isStarted = default(bool), CaInstantMs effectiveEpochStart = default(CaInstantMs), CaInstantMs actualEpochStart = default(CaInstantMs), CaActiveValidatorIndex currentLeader = default(CaActiveValidatorIndex))
        {
            this.Epoch = epoch;
            this.Round = round;
            ...
            {
                throw new ArgumentNullException("effectiveEpochStart is a required property for CaConsensusManagerFieldStateValue and cannot be null");
            }
            this.EffectiveEpochStart = effectiveEpochStart;
            // to ensure "actualEpochStart" is required (not null)
            if (actualEpochStart == null)
            {
                throw new ArgumentNullException("actualEpochStart is a required property for CaConsensusManagerFieldStateValue and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaConsensusManagerFieldStateValue {\n");
        ...
        {
            return this.Equals(input as CaConsensusManagerFieldStateValue);
        }

        /// <summary>
        /// Returns true if CaConsensusManagerFieldStateValue instances are equal
        /// </summary>
        /// <param name="input">Instance of CaConsensusManagerFieldStateValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaConsensusManagerFieldStateValue input)
        {
            if (input == null)
            {
                return false;
