...
{
    /// <summary>
    /// CaPaymentToRoyaltyRecipient
    /// </summary>
    [DataContract(Name = "CaPaymentToRoyaltyRecipient")]
    public partial class CaPaymentToRoyaltyRecipient : IEquatable<CaPaymentToRoyaltyRecipient>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPaymentToRoyaltyRecipient" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaPaymentToRoyaltyRecipient() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPaymentToRoyaltyRecipient" /> class.
        /// </summary>
        ...
        public CaPaymentToRoyaltyRecipient(CaEntityReference royaltyRecipient = default(CaEntityReference), string xrdAmount = default(string))
        {
            // to ensure "royaltyRecipient" is required (not null)
            if (royaltyRecipient == null)
            {
                throw new ArgumentNullException("royaltyRecipient is a required property for CaPaymentToRoyaltyRecipient and cannot be null");
            }
            this.RoyaltyRecipient = royaltyRecipient;
            // to ensure "xrdAmount" is required (not null)
            if (xrdAmount == null)
            {
                throw new ArgumentNullException("xrdAmount is a required property for CaPaymentToRoyaltyRecipient and cannot be null");
            }
        ...
        public CaEntityReference RoyaltyRecipient { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaPaymentToRoyaltyRecipient {\n");
        ...
        {
            return this.Equals(input as CaPaymentToRoyaltyRecipient);
        }

        /// <summary>
        /// Returns true if CaPaymentToRoyaltyRecipient instances are equal
        /// </summary>
        /// <param name="input">Instance of CaPaymentToRoyaltyRecipient to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaPaymentToRoyaltyRecipient input)
        {
            if (input == null)
            {
                return false;
