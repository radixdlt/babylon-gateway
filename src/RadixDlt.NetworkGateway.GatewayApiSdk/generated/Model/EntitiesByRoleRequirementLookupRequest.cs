...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EntitiesByRoleRequirementLookupRequest")]
    public partial class EntitiesByRoleRequirementLookupRequest : IEquatable<EntitiesByRoleRequirementLookupRequest>
    {
        /// <summary>
        ...
        public EntitiesByRoleRequirementLookupRequest(List<EntitiesByRoleRequirementRequestRequirement> requirements = default(List<EntitiesByRoleRequirementRequestRequirement>))
        {
            ...
            {
                throw new ArgumentNullException("requirements is a required property for EntitiesByRoleRequirementLookupRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as EntitiesByRoleRequirementLookupRequest);
        }

        /// <summary>
        /// Returns true if EntitiesByRoleRequirementLookupRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EntitiesByRoleRequirementLookupRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntitiesByRoleRequirementLookupRequest input)
        {
            if (input == null)
            {
                return false;
