...
{
    /// <summary>
    /// CaKeyValueBlueprintCollectionSchemaAllOf
    /// </summary>
    [DataContract(Name = "CaKeyValueBlueprintCollectionSchema_allOf")]
    public partial class CaKeyValueBlueprintCollectionSchemaAllOf : IEquatable<CaKeyValueBlueprintCollectionSchemaAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaKeyValueBlueprintCollectionSchemaAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaKeyValueBlueprintCollectionSchemaAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaKeyValueBlueprintCollectionSchemaAllOf" /> class.
        /// </summary>
        ...
        public CaKeyValueBlueprintCollectionSchemaAllOf(CaBlueprintPayloadDef keyTypeRef = default(CaBlueprintPayloadDef), CaBlueprintPayloadDef valueTypeRef = default(CaBlueprintPayloadDef), bool allowOwnership = default(bool))
        {
            // to ensure "keyTypeRef" is required (not null)
            if (keyTypeRef == null)
            {
                throw new ArgumentNullException("keyTypeRef is a required property for CaKeyValueBlueprintCollectionSchemaAllOf and cannot be null");
            }
            this.KeyTypeRef = keyTypeRef;
            // to ensure "valueTypeRef" is required (not null)
            if (valueTypeRef == null)
            {
                throw new ArgumentNullException("valueTypeRef is a required property for CaKeyValueBlueprintCollectionSchemaAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaKeyValueBlueprintCollectionSchemaAllOf {\n");
        ...
        {
            return this.Equals(input as CaKeyValueBlueprintCollectionSchemaAllOf);
        }

        /// <summary>
        /// Returns true if CaKeyValueBlueprintCollectionSchemaAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CaKeyValueBlueprintCollectionSchemaAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaKeyValueBlueprintCollectionSchemaAllOf input)
        {
            if (input == null)
            {
                return false;
