...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StateNonFungibleIdsRequest")]
    public partial class StateNonFungibleIdsRequest : IEquatable<StateNonFungibleIdsRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StateNonFungibleIdsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StateNonFungibleIdsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StateNonFungibleIdsRequest" /> class.
        /// </summary>
        ...
        public StateNonFungibleIdsRequest(LedgerStateSelector atLedgerState = default(LedgerStateSelector), string cursor = default(string), int? limitPerPage = default(int?), string resourceAddress = default(string))
        {
            // to ensure "resourceAddress" is required (not null)
            if (resourceAddress == null)
            {
                throw new ArgumentNullException("resourceAddress is a required property for StateNonFungibleIdsRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as StateNonFungibleIdsRequest);
        }

        /// <summary>
        /// Returns true if StateNonFungibleIdsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of StateNonFungibleIdsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StateNonFungibleIdsRequest input)
        {
            if (input == null)
            {
                return false;
