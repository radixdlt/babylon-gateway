...
{
    /// <summary>
    /// SborScryptoDecodeRequest
    /// </summary>
    [DataContract(Name = "SborScryptoDecodeRequest")]
    public partial class SborScryptoDecodeRequest : IEquatable<SborScryptoDecodeRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SborScryptoDecodeRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SborScryptoDecodeRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SborScryptoDecodeRequest" /> class.
        /// </summary>
        /// <param name="valueHex">Hex-encoded binary blob. (required).</param>
        public SborScryptoDecodeRequest(string valueHex = default(string))
        {
            // to ensure "valueHex" is required (not null)
            if (valueHex == null)
            {
                throw new ArgumentNullException("valueHex is a required property for SborScryptoDecodeRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SborScryptoDecodeRequest {\n");
        ...
        {
            return this.Equals(input as SborScryptoDecodeRequest);
        }

        /// <summary>
        /// Returns true if SborScryptoDecodeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SborScryptoDecodeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SborScryptoDecodeRequest input)
        {
            if (input == null)
            {
                return false;
