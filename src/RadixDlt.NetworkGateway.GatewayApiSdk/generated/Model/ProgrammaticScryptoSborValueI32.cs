...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProgrammaticScryptoSborValueI32")]
    ...
    public partial class ProgrammaticScryptoSborValueI32 : ProgrammaticScryptoSborValue, IEquatable<ProgrammaticScryptoSborValueI32>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgrammaticScryptoSborValueI32" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProgrammaticScryptoSborValueI32() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgrammaticScryptoSborValueI32" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="kind">kind (required) (default to ProgrammaticScryptoSborValueTypeKind.I32).</param>
        /// <param name="typeName">TBD.</param>
        /// <param name="fieldName">TBD.</param>
        public ProgrammaticScryptoSborValueI32(string value = default(string), ProgrammaticScryptoSborValueTypeKind kind = ProgrammaticScryptoSborValueTypeKind.I32, string typeName = default(string), string fieldName = default(string)) : base(kind, typeName, fieldName)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for ProgrammaticScryptoSborValueI32 and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as ProgrammaticScryptoSborValueI32);
        }

        /// <summary>
        /// Returns true if ProgrammaticScryptoSborValueI32 instances are equal
        /// </summary>
        /// <param name="input">Instance of ProgrammaticScryptoSborValueI32 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProgrammaticScryptoSborValueI32 input)
        {
            if (input == null)
            {
                return false;
