...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class AccountAuthorizedDepositorsResourceBadge : AccountAuthorizedDepositorsResponseItem, IEquatable<AccountAuthorizedDepositorsResourceBadge>
    {
        ...
        /// <param name="badgeType">badgeType (required) (default to AccountAuthorizedDepositorType.ResourceBadge).</param>
        public AccountAuthorizedDepositorsResourceBadge(string resourceAddress = default(string), long lastUpdatedAtStateVersion = default(long), AccountAuthorizedDepositorType badgeType = AccountAuthorizedDepositorType.ResourceBadge) : base(badgeType)
        {
