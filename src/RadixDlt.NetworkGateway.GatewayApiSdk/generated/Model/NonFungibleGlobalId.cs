...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class NonFungibleGlobalId : IEquatable<NonFungibleGlobalId>
    {
        ...
        public NonFungibleGlobalId(string resourceAddress = default(string), string nonFungibleId = default(string))
        {
            ...
            {
                throw new ArgumentNullException("nonFungibleId is a required property for NonFungibleGlobalId and cannot be null");
            }
