...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PublicKeyEddsaEd25519")]
    ...
    public partial class PublicKeyEddsaEd25519 : PublicKey, IEquatable<PublicKeyEddsaEd25519>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicKeyEddsaEd25519" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublicKeyEddsaEd25519() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicKeyEddsaEd25519" /> class.
        /// </summary>
        ...
        public PublicKeyEddsaEd25519(string keyHex = default(string), PublicKeyType keyType = PublicKeyType.EddsaEd25519) : base(keyType)
        {
            // to ensure "keyHex" is required (not null)
            if (keyHex == null)
            {
                throw new ArgumentNullException("keyHex is a required property for PublicKeyEddsaEd25519 and cannot be null");
            }
            this.KeyHex = keyHex;
        }
        ...
        {
            return this.Equals(input as PublicKeyEddsaEd25519);
        }

        /// <summary>
        /// Returns true if PublicKeyEddsaEd25519 instances are equal
        /// </summary>
        /// <param name="input">Instance of PublicKeyEddsaEd25519 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PublicKeyEddsaEd25519 input)
        {
            if (input == null)
            {
                return false;
