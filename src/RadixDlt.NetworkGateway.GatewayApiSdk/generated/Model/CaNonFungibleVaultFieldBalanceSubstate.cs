...
{
    /// <summary>
    /// CaNonFungibleVaultFieldBalanceSubstate
    /// </summary>
    [DataContract(Name = "CaNonFungibleVaultFieldBalanceSubstate")]
    ...
    public partial class CaNonFungibleVaultFieldBalanceSubstate : CaSubstate, IEquatable<CaNonFungibleVaultFieldBalanceSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaNonFungibleVaultFieldBalanceSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaNonFungibleVaultFieldBalanceSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaNonFungibleVaultFieldBalanceSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.NonFungibleVaultFieldBalance).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaNonFungibleVaultFieldBalanceSubstate(CaNonFungibleVaultFieldBalanceValue value = default(CaNonFungibleVaultFieldBalanceValue), CaSubstateType substateType = CaSubstateType.NonFungibleVaultFieldBalance, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaNonFungibleVaultFieldBalanceSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaNonFungibleVaultFieldBalanceValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaNonFungibleVaultFieldBalanceSubstate {\n");
        ...
        {
            return this.Equals(input as CaNonFungibleVaultFieldBalanceSubstate);
        }

        /// <summary>
        /// Returns true if CaNonFungibleVaultFieldBalanceSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaNonFungibleVaultFieldBalanceSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaNonFungibleVaultFieldBalanceSubstate input)
        {
            if (input == null)
            {
                return false;
