...
{
    /// <summary>
    /// CaAccountVaultEntrySubstate
    /// </summary>
    [DataContract(Name = "CaAccountVaultEntrySubstate")]
    ...
    public partial class CaAccountVaultEntrySubstate : CaSubstate, IEquatable<CaAccountVaultEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaAccountVaultEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaAccountVaultEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaAccountVaultEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.AccountVaultEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaAccountVaultEntrySubstate(CaResourceKey key = default(CaResourceKey), CaAccountVaultEntryValue value = default(CaAccountVaultEntryValue), CaSubstateType substateType = CaSubstateType.AccountVaultEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CaAccountVaultEntrySubstate and cannot be null");
            }
            this.Key = key;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaAccountVaultEntrySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaAccountVaultEntryValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaAccountVaultEntrySubstate {\n");
        ...
        {
            return this.Equals(input as CaAccountVaultEntrySubstate);
        }

        /// <summary>
        /// Returns true if CaAccountVaultEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaAccountVaultEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaAccountVaultEntrySubstate input)
        {
            if (input == null)
            {
                return false;
