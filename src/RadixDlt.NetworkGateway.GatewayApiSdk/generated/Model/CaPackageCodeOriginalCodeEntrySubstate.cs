...
{
    /// <summary>
    /// CaPackageCodeOriginalCodeEntrySubstate
    /// </summary>
    [DataContract(Name = "CaPackageCodeOriginalCodeEntrySubstate")]
    ...
    public partial class CaPackageCodeOriginalCodeEntrySubstate : CaSubstate, IEquatable<CaPackageCodeOriginalCodeEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPackageCodeOriginalCodeEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaPackageCodeOriginalCodeEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPackageCodeOriginalCodeEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.PackageCodeOriginalCodeEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaPackageCodeOriginalCodeEntrySubstate(CaPackageCodeKey key = default(CaPackageCodeKey), CaPackageCodeOriginalCodeEntryValue value = default(CaPackageCodeOriginalCodeEntryValue), CaSubstateType substateType = CaSubstateType.PackageCodeOriginalCodeEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CaPackageCodeOriginalCodeEntrySubstate and cannot be null");
            }
            this.Key = key;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaPackageCodeOriginalCodeEntrySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaPackageCodeOriginalCodeEntryValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaPackageCodeOriginalCodeEntrySubstate {\n");
        ...
        {
            return this.Equals(input as CaPackageCodeOriginalCodeEntrySubstate);
        }

        /// <summary>
        /// Returns true if CaPackageCodeOriginalCodeEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaPackageCodeOriginalCodeEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaPackageCodeOriginalCodeEntrySubstate input)
        {
            if (input == null)
            {
                return false;
