...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MetadataPublicKeyHashValue")]
    ...
    public partial class MetadataPublicKeyHashValue : MetadataTypedValue, IEquatable<MetadataPublicKeyHashValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataPublicKeyHashValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataPublicKeyHashValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataPublicKeyHashValue" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="type">type (required) (default to MetadataValueType.PublicKeyHash).</param>
        public MetadataPublicKeyHashValue(PublicKeyHash value = default(PublicKeyHash), MetadataValueType type = MetadataValueType.PublicKeyHash) : base(type)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for MetadataPublicKeyHashValue and cannot be null");
            }
            this.Value = value;
        }
        ...
        public PublicKeyHash Value { get; set; }
        ...
        {
            return this.Equals(input as MetadataPublicKeyHashValue);
        }

        /// <summary>
        /// Returns true if MetadataPublicKeyHashValue instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataPublicKeyHashValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataPublicKeyHashValue input)
        {
            if (input == null)
            {
                return false;
