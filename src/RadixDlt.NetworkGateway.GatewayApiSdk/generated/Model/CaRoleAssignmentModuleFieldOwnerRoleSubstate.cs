...
{
    /// <summary>
    /// CaRoleAssignmentModuleFieldOwnerRoleSubstate
    /// </summary>
    [DataContract(Name = "CaRoleAssignmentModuleFieldOwnerRoleSubstate")]
    ...
    public partial class CaRoleAssignmentModuleFieldOwnerRoleSubstate : CaSubstate, IEquatable<CaRoleAssignmentModuleFieldOwnerRoleSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaRoleAssignmentModuleFieldOwnerRoleSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaRoleAssignmentModuleFieldOwnerRoleSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaRoleAssignmentModuleFieldOwnerRoleSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.RoleAssignmentModuleFieldOwnerRole).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaRoleAssignmentModuleFieldOwnerRoleSubstate(CaRoleAssignmentModuleFieldOwnerRoleValue value = default(CaRoleAssignmentModuleFieldOwnerRoleValue), CaSubstateType substateType = CaSubstateType.RoleAssignmentModuleFieldOwnerRole, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaRoleAssignmentModuleFieldOwnerRoleSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaRoleAssignmentModuleFieldOwnerRoleValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaRoleAssignmentModuleFieldOwnerRoleSubstate {\n");
        ...
        {
            return this.Equals(input as CaRoleAssignmentModuleFieldOwnerRoleSubstate);
        }

        /// <summary>
        /// Returns true if CaRoleAssignmentModuleFieldOwnerRoleSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaRoleAssignmentModuleFieldOwnerRoleSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaRoleAssignmentModuleFieldOwnerRoleSubstate input)
        {
            if (input == null)
            {
                return false;
