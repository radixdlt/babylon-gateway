...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MetadataPublicKeyValue")]
    ...
    public partial class MetadataPublicKeyValue : MetadataTypedValue, IEquatable<MetadataPublicKeyValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataPublicKeyValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataPublicKeyValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataPublicKeyValue" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="type">type (required) (default to MetadataValueType.PublicKey).</param>
        public MetadataPublicKeyValue(PublicKey value = default(PublicKey), MetadataValueType type = MetadataValueType.PublicKey) : base(type)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for MetadataPublicKeyValue and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as MetadataPublicKeyValue);
        }

        /// <summary>
        /// Returns true if MetadataPublicKeyValue instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataPublicKeyValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataPublicKeyValue input)
        {
            if (input == null)
            {
                return false;
