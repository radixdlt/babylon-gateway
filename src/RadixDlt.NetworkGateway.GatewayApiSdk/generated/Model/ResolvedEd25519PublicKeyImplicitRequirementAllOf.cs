...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class ResolvedEd25519PublicKeyImplicitRequirementAllOf : IEquatable<ResolvedEd25519PublicKeyImplicitRequirementAllOf>
    {
        ...
        public ResolvedEd25519PublicKeyImplicitRequirementAllOf(string publicKeyBytes = default(string))
        {
            // to ensure "publicKeyBytes" is required (not null)
            if (publicKeyBytes == null)
            {
                throw new ArgumentNullException("publicKeyBytes is a required property for ResolvedEd25519PublicKeyImplicitRequirementAllOf and cannot be null");
            }
