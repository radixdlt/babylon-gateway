...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class ResolvedEd25519PublicKeyImplicitRequirementAllOf : IEquatable<ResolvedEd25519PublicKeyImplicitRequirementAllOf>
    {
        ...
        protected ResolvedEd25519PublicKeyImplicitRequirementAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResolvedEd25519PublicKeyImplicitRequirementAllOf" /> class.
        /// </summary>
        ...
        public ResolvedEd25519PublicKeyImplicitRequirementAllOf(long firstSeenStateVersion = default(long), string publicKeyBytesHex = default(string))
        {
            ...
            {
                throw new ArgumentNullException("publicKeyBytesHex is a required property for ResolvedEd25519PublicKeyImplicitRequirementAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResolvedEd25519PublicKeyImplicitRequirementAllOf {\n");
        ...
        {
            return this.Equals(input as ResolvedEd25519PublicKeyImplicitRequirementAllOf);
        }

        /// <summary>
        /// Returns true if ResolvedEd25519PublicKeyImplicitRequirementAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ResolvedEd25519PublicKeyImplicitRequirementAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResolvedEd25519PublicKeyImplicitRequirementAllOf input)
        {
            if (input == null)
            {
                return false;
