...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiEntityReference")]
    public partial class CoreApiEntityReference : IEquatable<CoreApiEntityReference>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiEntityReference" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiEntityReference() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiEntityReference" /> class.
        /// </summary>
        ...
        public CoreApiEntityReference(CoreApiEntityType entityType = default(CoreApiEntityType), bool isGlobal = default(bool), string entityAddress = default(string))
        {
            ...
            {
                throw new ArgumentNullException("entityAddress is a required property for CoreApiEntityReference and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiEntityReference {\n");
        ...
        {
            return this.Equals(input as CoreApiEntityReference);
        }

        /// <summary>
        /// Returns true if CoreApiEntityReference instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiEntityReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiEntityReference input)
        {
            if (input == null)
            {
                return false;
