...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiCostingModuleConfig")]
    public partial class CoreApiCostingModuleConfig : IEquatable<CoreApiCostingModuleConfig>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiCostingModuleConfig" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiCostingModuleConfig() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiCostingModuleConfig" /> class.
        /// </summary>
        ...
        public CoreApiCostingModuleConfig(string xrdMaxPerFunctionRoyalty = default(string), bool applyExecutionCostForAllSystemCalls = default(bool), bool applyBootRefCheckCosting = default(bool))
        {
            // to ensure "xrdMaxPerFunctionRoyalty" is required (not null)
            if (xrdMaxPerFunctionRoyalty == null)
            {
                throw new ArgumentNullException("xrdMaxPerFunctionRoyalty is a required property for CoreApiCostingModuleConfig and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiCostingModuleConfig {\n");
        ...
        {
            return this.Equals(input as CoreApiCostingModuleConfig);
        }

        /// <summary>
        /// Returns true if CoreApiCostingModuleConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiCostingModuleConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiCostingModuleConfig input)
        {
            if (input == null)
            {
                return false;
