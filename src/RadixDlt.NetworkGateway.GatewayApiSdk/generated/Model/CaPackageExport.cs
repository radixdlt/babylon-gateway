...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CaPackageExport
    /// </summary>
    [DataContract(Name = "CaPackageExport")]
    public partial class CaPackageExport : IEquatable<CaPackageExport>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPackageExport" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaPackageExport() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPackageExport" /> class.
        /// </summary>
        ...
        public CaPackageExport(string codeHash = default(string), string exportName = default(string))
        {
            // to ensure "codeHash" is required (not null)
            if (codeHash == null)
            {
                throw new ArgumentNullException("codeHash is a required property for CaPackageExport and cannot be null");
            }
            this.CodeHash = codeHash;
            // to ensure "exportName" is required (not null)
            if (exportName == null)
            {
                throw new ArgumentNullException("exportName is a required property for CaPackageExport and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaPackageExport {\n");
        ...
        {
            return this.Equals(input as CaPackageExport);
        }

        /// <summary>
        /// Returns true if CaPackageExport instances are equal
        /// </summary>
        /// <param name="input">Instance of CaPackageExport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaPackageExport input)
        {
            if (input == null)
            {
                return false;
