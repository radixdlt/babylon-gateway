...
{
    /// <summary>
    /// CaTypeInfoModuleFieldTypeInfoSubstate
    /// </summary>
    [DataContract(Name = "CaTypeInfoModuleFieldTypeInfoSubstate")]
    ...
    public partial class CaTypeInfoModuleFieldTypeInfoSubstate : CaSubstate, IEquatable<CaTypeInfoModuleFieldTypeInfoSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaTypeInfoModuleFieldTypeInfoSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaTypeInfoModuleFieldTypeInfoSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaTypeInfoModuleFieldTypeInfoSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.TypeInfoModuleFieldTypeInfo).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaTypeInfoModuleFieldTypeInfoSubstate(CaTypeInfoModuleFieldTypeInfoValue value = default(CaTypeInfoModuleFieldTypeInfoValue), CaSubstateType substateType = CaSubstateType.TypeInfoModuleFieldTypeInfo, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaTypeInfoModuleFieldTypeInfoSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaTypeInfoModuleFieldTypeInfoValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaTypeInfoModuleFieldTypeInfoSubstate {\n");
        ...
        {
            return this.Equals(input as CaTypeInfoModuleFieldTypeInfoSubstate);
        }

        /// <summary>
        /// Returns true if CaTypeInfoModuleFieldTypeInfoSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaTypeInfoModuleFieldTypeInfoSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaTypeInfoModuleFieldTypeInfoSubstate input)
        {
            if (input == null)
            {
                return false;
