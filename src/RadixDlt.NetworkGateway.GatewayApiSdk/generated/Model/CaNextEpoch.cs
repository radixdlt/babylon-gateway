...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CaNextEpoch
    /// </summary>
    [DataContract(Name = "CaNextEpoch")]
    public partial class CaNextEpoch : IEquatable<CaNextEpoch>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaNextEpoch" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaNextEpoch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaNextEpoch" /> class.
        /// </summary>
        ...
        public CaNextEpoch(long epoch = default(long), List<CaActiveValidator> validators = default(List<CaActiveValidator>), List<CaSignificantProtocolUpdateReadinessEntry> significantProtocolUpdateReadiness = default(List<CaSignificantProtocolUpdateReadinessEntry>))
        {
            this.Epoch = epoch;
            // to ensure "validators" is required (not null)
            if (validators == null)
            {
                throw new ArgumentNullException("validators is a required property for CaNextEpoch and cannot be null");
            }
        ...
        public List<CaActiveValidator> Validators { get; set; }
        ...
        public List<CaSignificantProtocolUpdateReadinessEntry> SignificantProtocolUpdateReadiness { get; set; }
        ...
        {
            return this.Equals(input as CaNextEpoch);
        }

        /// <summary>
        /// Returns true if CaNextEpoch instances are equal
        /// </summary>
        /// <param name="input">Instance of CaNextEpoch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaNextEpoch input)
        {
            if (input == null)
            {
                return false;
