...
{
    /// <summary>
    /// CaNonFungibleLocalId
    /// </summary>
    [DataContract(Name = "CaNonFungibleLocalId")]
    public partial class CaNonFungibleLocalId : IEquatable<CaNonFungibleLocalId>
    {
        ...
        public CaNonFungibleIdType IdType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaNonFungibleLocalId" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaNonFungibleLocalId() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaNonFungibleLocalId" /> class.
        /// </summary>
        ...
        public CaNonFungibleLocalId(string simpleRep = default(string), CaNonFungibleIdType idType = default(CaNonFungibleIdType), string sborHex = default(string))
        {
            // to ensure "simpleRep" is required (not null)
            if (simpleRep == null)
            {
                throw new ArgumentNullException("simpleRep is a required property for CaNonFungibleLocalId and cannot be null");
            }
            ...
            if (sborHex == null)
            {
                throw new ArgumentNullException("sborHex is a required property for CaNonFungibleLocalId and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaNonFungibleLocalId {\n");
        ...
        {
            return this.Equals(input as CaNonFungibleLocalId);
        }

        /// <summary>
        /// Returns true if CaNonFungibleLocalId instances are equal
        /// </summary>
        /// <param name="input">Instance of CaNonFungibleLocalId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaNonFungibleLocalId input)
        {
            if (input == null)
            {
                return false;
