...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class FunctionEmitter
    {
        ...
        protected FunctionEmitter() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FunctionEmitter" /> class.
        /// </summary>
        /// <param name="blueprint">blueprint (required).</param>
        public FunctionEmitter(string blueprint = default(string))
        {
            // to ensure "blueprint" is required (not null)
            if (blueprint == null)
            {
                throw new ArgumentNullException("blueprint is a required property for FunctionEmitter and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FunctionEmitter {\n");
        ...
        {
            return this.Equals(input as FunctionEmitter);
        }

        /// <summary>
        /// Returns true if FunctionEmitter instances are equal
        /// </summary>
        /// <param name="input">Instance of FunctionEmitter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FunctionEmitter input)
        {
            if (input == null)
            {
                return false;
