...
{
    /// <summary>
    /// CaFungibleResourceManagerFieldTotalSupplySubstate
    /// </summary>
    [DataContract(Name = "CaFungibleResourceManagerFieldTotalSupplySubstate")]
    ...
    public partial class CaFungibleResourceManagerFieldTotalSupplySubstate : CaSubstate, IEquatable<CaFungibleResourceManagerFieldTotalSupplySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaFungibleResourceManagerFieldTotalSupplySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaFungibleResourceManagerFieldTotalSupplySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaFungibleResourceManagerFieldTotalSupplySubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.FungibleResourceManagerFieldTotalSupply).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaFungibleResourceManagerFieldTotalSupplySubstate(CaFungibleResourceManagerFieldTotalSupplyValue value = default(CaFungibleResourceManagerFieldTotalSupplyValue), CaSubstateType substateType = CaSubstateType.FungibleResourceManagerFieldTotalSupply, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaFungibleResourceManagerFieldTotalSupplySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaFungibleResourceManagerFieldTotalSupplyValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaFungibleResourceManagerFieldTotalSupplySubstate {\n");
        ...
        {
            return this.Equals(input as CaFungibleResourceManagerFieldTotalSupplySubstate);
        }

        /// <summary>
        /// Returns true if CaFungibleResourceManagerFieldTotalSupplySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaFungibleResourceManagerFieldTotalSupplySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaFungibleResourceManagerFieldTotalSupplySubstate input)
        {
            if (input == null)
            {
                return false;
