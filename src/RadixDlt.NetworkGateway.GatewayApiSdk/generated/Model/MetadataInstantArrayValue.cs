...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MetadataInstantArrayValue")]
    ...
    public partial class MetadataInstantArrayValue : MetadataTypedValue, IEquatable<MetadataInstantArrayValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataInstantArrayValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataInstantArrayValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataInstantArrayValue" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as MetadataInstantArrayValue);
        }

        /// <summary>
        /// Returns true if MetadataInstantArrayValue instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataInstantArrayValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataInstantArrayValue input)
        {
            if (input == null)
            {
                return false;
