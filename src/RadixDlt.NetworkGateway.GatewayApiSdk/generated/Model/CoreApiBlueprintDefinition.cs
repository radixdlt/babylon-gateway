...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiBlueprintDefinition")]
    public partial class CoreApiBlueprintDefinition : IEquatable<CoreApiBlueprintDefinition>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiBlueprintDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiBlueprintDefinition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiBlueprintDefinition" /> class.
        /// </summary>
        ...
        public CoreApiBlueprintDefinition(CoreApiBlueprintInterface _interface = default(CoreApiBlueprintInterface), Dictionary<string, CoreApiPackageExport> functionExports = default(Dictionary<string, CoreApiPackageExport>), List<CoreApiHookExport> hookExports = default(List<CoreApiHookExport>))
        {
            // to ensure "_interface" is required (not null)
            if (_interface == null)
            {
                throw new ArgumentNullException("_interface is a required property for CoreApiBlueprintDefinition and cannot be null");
            }
            this.Interface = _interface;
            // to ensure "functionExports" is required (not null)
            if (functionExports == null)
            {
                throw new ArgumentNullException("functionExports is a required property for CoreApiBlueprintDefinition and cannot be null");
            }
            this.FunctionExports = functionExports;
            // to ensure "hookExports" is required (not null)
            if (hookExports == null)
            {
                throw new ArgumentNullException("hookExports is a required property for CoreApiBlueprintDefinition and cannot be null");
            }
        ...
        public CoreApiBlueprintInterface Interface { get; set; }
        ...
        public Dictionary<string, CoreApiPackageExport> FunctionExports { get; set; }
        ...
        public List<CoreApiHookExport> HookExports { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiBlueprintDefinition {\n");
        ...
        {
            return this.Equals(input as CoreApiBlueprintDefinition);
        }

        /// <summary>
        /// Returns true if CoreApiBlueprintDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiBlueprintDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiBlueprintDefinition input)
        {
            if (input == null)
            {
                return false;
