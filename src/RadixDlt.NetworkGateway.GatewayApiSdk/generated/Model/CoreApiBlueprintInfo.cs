...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiBlueprintInfo")]
    public partial class CoreApiBlueprintInfo : IEquatable<CoreApiBlueprintInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiBlueprintInfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiBlueprintInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiBlueprintInfo" /> class.
        /// </summary>
        ...
        public CoreApiBlueprintInfo(string packageAddress = default(string), string blueprintName = default(string), string blueprintVersion = default(string), string outerObject = default(string), List<string> features = default(List<string>), List<CoreApiGenericSubstitution> genericSubstitutions = default(List<CoreApiGenericSubstitution>))
        {
            // to ensure "packageAddress" is required (not null)
            if (packageAddress == null)
            {
                throw new ArgumentNullException("packageAddress is a required property for CoreApiBlueprintInfo and cannot be null");
            }
            this.PackageAddress = packageAddress;
            // to ensure "blueprintName" is required (not null)
            if (blueprintName == null)
            {
                throw new ArgumentNullException("blueprintName is a required property for CoreApiBlueprintInfo and cannot be null");
            }
            this.BlueprintName = blueprintName;
            // to ensure "blueprintVersion" is required (not null)
            if (blueprintVersion == null)
            {
                throw new ArgumentNullException("blueprintVersion is a required property for CoreApiBlueprintInfo and cannot be null");
            }
            this.BlueprintVersion = blueprintVersion;
            // to ensure "features" is required (not null)
            if (features == null)
            {
                throw new ArgumentNullException("features is a required property for CoreApiBlueprintInfo and cannot be null");
            }
            this.Features = features;
            // to ensure "genericSubstitutions" is required (not null)
            if (genericSubstitutions == null)
            {
                throw new ArgumentNullException("genericSubstitutions is a required property for CoreApiBlueprintInfo and cannot be null");
            }
        ...
        public List<CoreApiGenericSubstitution> GenericSubstitutions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiBlueprintInfo {\n");
        ...
        {
            return this.Equals(input as CoreApiBlueprintInfo);
        }

        /// <summary>
        /// Returns true if CoreApiBlueprintInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiBlueprintInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiBlueprintInfo input)
        {
            if (input == null)
            {
                return false;
