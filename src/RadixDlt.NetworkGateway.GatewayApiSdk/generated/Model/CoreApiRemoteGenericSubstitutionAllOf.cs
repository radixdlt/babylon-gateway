...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiRemoteGenericSubstitution_allOf")]
    public partial class CoreApiRemoteGenericSubstitutionAllOf : IEquatable<CoreApiRemoteGenericSubstitutionAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiRemoteGenericSubstitutionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiRemoteGenericSubstitutionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiRemoteGenericSubstitutionAllOf" /> class.
        /// </summary>
        ...
        public CoreApiRemoteGenericSubstitutionAllOf(CoreApiBlueprintTypeIdentifier blueprintTypeIdentifier = default(CoreApiBlueprintTypeIdentifier), CoreApiFullyScopedTypeId resolvedFullTypeId = default(CoreApiFullyScopedTypeId))
        {
            // to ensure "blueprintTypeIdentifier" is required (not null)
            if (blueprintTypeIdentifier == null)
            {
                throw new ArgumentNullException("blueprintTypeIdentifier is a required property for CoreApiRemoteGenericSubstitutionAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiRemoteGenericSubstitutionAllOf {\n");
        ...
        {
            return this.Equals(input as CoreApiRemoteGenericSubstitutionAllOf);
        }

        /// <summary>
        /// Returns true if CoreApiRemoteGenericSubstitutionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiRemoteGenericSubstitutionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiRemoteGenericSubstitutionAllOf input)
        {
            if (input == null)
            {
                return false;
