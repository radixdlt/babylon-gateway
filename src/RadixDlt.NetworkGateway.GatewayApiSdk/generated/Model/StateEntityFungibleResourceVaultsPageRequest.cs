...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class StateEntityFungibleResourceVaultsPageRequest : IEquatable<StateEntityFungibleResourceVaultsPageRequest>
    {
        ...
        public StateEntityFungibleResourceVaultsPageRequest(long atLedgerStateVersion = default(long), string cursor = default(string), int? limitPerPage = default(int?), string address = default(string), string resourceAddress = default(string))
        {
