...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiScryptoInstant")]
    public partial class CoreApiScryptoInstant : IEquatable<CoreApiScryptoInstant>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiScryptoInstant" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiScryptoInstant() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiScryptoInstant" /> class.
        /// </summary>
        ...
        public CoreApiScryptoInstant(string unixTimestampSeconds = default(string), string dateTime = default(string))
        {
            // to ensure "unixTimestampSeconds" is required (not null)
            if (unixTimestampSeconds == null)
            {
                throw new ArgumentNullException("unixTimestampSeconds is a required property for CoreApiScryptoInstant and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiScryptoInstant {\n");
        ...
        {
            return this.Equals(input as CoreApiScryptoInstant);
        }

        /// <summary>
        /// Returns true if CoreApiScryptoInstant instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiScryptoInstant to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiScryptoInstant input)
        {
            if (input == null)
            {
                return false;
