...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NativeResourceEd25519SignatureResourceValue")]
    ...
    public partial class NativeResourceEd25519SignatureResourceValue : NativeResourceDetails, IEquatable<NativeResourceEd25519SignatureResourceValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceEd25519SignatureResourceValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NativeResourceEd25519SignatureResourceValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceEd25519SignatureResourceValue" /> class.
        /// </summary>
        /// <param name="kind">kind (required) (default to NativeResourceKind.Ed25519SignatureResource).</param>
        public NativeResourceEd25519SignatureResourceValue(NativeResourceKind kind = NativeResourceKind.Ed25519SignatureResource) : base(kind)
        {
        }
        ...
        {
            return this.Equals(input as NativeResourceEd25519SignatureResourceValue);
        }

        /// <summary>
        /// Returns true if NativeResourceEd25519SignatureResourceValue instances are equal
        /// </summary>
        /// <param name="input">Instance of NativeResourceEd25519SignatureResourceValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NativeResourceEd25519SignatureResourceValue input)
        {
            if (input == null)
            {
                return false;
