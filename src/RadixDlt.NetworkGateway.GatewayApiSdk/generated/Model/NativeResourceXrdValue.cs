...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NativeResourceXrdValue")]
    ...
    public partial class NativeResourceXrdValue : NativeResourceDetails, IEquatable<NativeResourceXrdValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceXrdValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NativeResourceXrdValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceXrdValue" /> class.
        /// </summary>
        /// <param name="kind">kind (required) (default to NativeResourceKind.Xrd).</param>
        public NativeResourceXrdValue(NativeResourceKind kind = NativeResourceKind.Xrd) : base(kind)
        {
        }
        ...
        {
            return this.Equals(input as NativeResourceXrdValue);
        }

        /// <summary>
        /// Returns true if NativeResourceXrdValue instances are equal
        /// </summary>
        /// <param name="input">Instance of NativeResourceXrdValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NativeResourceXrdValue input)
        {
            if (input == null)
            {
                return false;
