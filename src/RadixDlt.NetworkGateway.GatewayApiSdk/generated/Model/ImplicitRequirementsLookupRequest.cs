...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class ImplicitRequirementsLookupRequest
    {
        ...
        protected ImplicitRequirementsLookupRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ImplicitRequirementsLookupRequest" /> class.
        /// </summary>
        /// <param name="requirements">limited to max 100 items. (required).</param>
        public ImplicitRequirementsLookupRequest(List<NonFungibleGlobalId> requirements = default(List<NonFungibleGlobalId>))
        {
            // to ensure "requirements" is required (not null)
            if (requirements == null)
            {
                throw new ArgumentNullException("requirements is a required property for ImplicitRequirementsLookupRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImplicitRequirementsLookupRequest {\n");
        ...
        {
            return this.Equals(input as ImplicitRequirementsLookupRequest);
        }

        /// <summary>
        /// Returns true if ImplicitRequirementsLookupRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ImplicitRequirementsLookupRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImplicitRequirementsLookupRequest input)
        {
            if (input == null)
            {
                return false;
