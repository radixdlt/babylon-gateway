...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class DetailedEventPayload : IEquatable<DetailedEventPayload>
    {
        ...
        protected DetailedEventPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DetailedEventPayload" /> class.
        /// </summary>
        /// <param name="programmaticJson">programmaticJson (required).</param>
        public DetailedEventPayload(Object programmaticJson = default(Object))
        {
            // to ensure "programmaticJson" is required (not null)
            if (programmaticJson == null)
            {
                throw new ArgumentNullException("programmaticJson is a required property for DetailedEventPayload and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DetailedEventPayload {\n");
        ...
        {
            return this.Equals(input as DetailedEventPayload);
        }

        /// <summary>
        /// Returns true if DetailedEventPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of DetailedEventPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DetailedEventPayload input)
        {
            if (input == null)
            {
                return false;
