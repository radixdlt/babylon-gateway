...
{
    /// <summary>
    /// CaConsensusManagerFieldCurrentTimeSubstate
    /// </summary>
    [DataContract(Name = "CaConsensusManagerFieldCurrentTimeSubstate")]
    ...
    public partial class CaConsensusManagerFieldCurrentTimeSubstate : CaSubstate, IEquatable<CaConsensusManagerFieldCurrentTimeSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaConsensusManagerFieldCurrentTimeSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaConsensusManagerFieldCurrentTimeSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaConsensusManagerFieldCurrentTimeSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.ConsensusManagerFieldCurrentTime).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaConsensusManagerFieldCurrentTimeSubstate(CaConsensusManagerFieldCurrentTimeValue value = default(CaConsensusManagerFieldCurrentTimeValue), CaSubstateType substateType = CaSubstateType.ConsensusManagerFieldCurrentTime, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaConsensusManagerFieldCurrentTimeSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaConsensusManagerFieldCurrentTimeValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaConsensusManagerFieldCurrentTimeSubstate {\n");
        ...
        {
            return this.Equals(input as CaConsensusManagerFieldCurrentTimeSubstate);
        }

        /// <summary>
        /// Returns true if CaConsensusManagerFieldCurrentTimeSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaConsensusManagerFieldCurrentTimeSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaConsensusManagerFieldCurrentTimeSubstate input)
        {
            if (input == null)
            {
                return false;
