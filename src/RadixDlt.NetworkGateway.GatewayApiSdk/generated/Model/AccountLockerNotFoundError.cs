...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountLockerNotFoundError")]
    ...
    public partial class AccountLockerNotFoundError : GatewayError, IEquatable<AccountLockerNotFoundError>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountLockerNotFoundError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountLockerNotFoundError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountLockerNotFoundError" /> class.
        /// </summary>
        ...
        /// <param name="type">The type of error. Each subtype may have its own additional structured fields. (required) (default to &quot;AccountLockerNotFoundError&quot;).</param>
        public AccountLockerNotFoundError(string lockerAddress = default(string), string accountAddress = default(string), string type = "AccountLockerNotFoundError") : base(type)
        {
            // to ensure "lockerAddress" is required (not null)
            if (lockerAddress == null)
            {
                throw new ArgumentNullException("lockerAddress is a required property for AccountLockerNotFoundError and cannot be null");
            }
            this.LockerAddress = lockerAddress;
            // to ensure "accountAddress" is required (not null)
            if (accountAddress == null)
            {
                throw new ArgumentNullException("accountAddress is a required property for AccountLockerNotFoundError and cannot be null");
            }
        ...
        {
            return this.Equals(input as AccountLockerNotFoundError);
        }

        /// <summary>
        /// Returns true if AccountLockerNotFoundError instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountLockerNotFoundError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountLockerNotFoundError input)
        {
            if (input == null)
            {
                return false;
