...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class AccountLockerAddress : IEquatable<AccountLockerAddress>
    {
        ...
        protected AccountLockerAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountLockerAddress" /> class.
        /// </summary>
        ...
        public AccountLockerAddress(string lockerAddress = default(string), string accountAddress = default(string))
        {
            // to ensure "lockerAddress" is required (not null)
            if (lockerAddress == null)
            {
                throw new ArgumentNullException("lockerAddress is a required property for AccountLockerAddress and cannot be null");
            }
            this.LockerAddress = lockerAddress;
            // to ensure "accountAddress" is required (not null)
            if (accountAddress == null)
            {
                throw new ArgumentNullException("accountAddress is a required property for AccountLockerAddress and cannot be null");
            }
        ...
        {
            return this.Equals(input as AccountLockerAddress);
        }

        /// <summary>
        /// Returns true if AccountLockerAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountLockerAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountLockerAddress input)
        {
            if (input == null)
            {
                return false;
