...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MetadataOriginArrayValue")]
    ...
    public partial class MetadataOriginArrayValue : MetadataTypedValue, IEquatable<MetadataOriginArrayValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataOriginArrayValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataOriginArrayValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataOriginArrayValue" /> class.
        /// </summary>
        /// <param name="values">values (required).</param>
        /// <param name="type">type (required) (default to MetadataValueType.OriginArray).</param>
        public MetadataOriginArrayValue(List<string> values = default(List<string>), MetadataValueType type = MetadataValueType.OriginArray) : base(type)
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for MetadataOriginArrayValue and cannot be null");
            }
            this.Values = values;
        }
        ...
        {
            return this.Equals(input as MetadataOriginArrayValue);
        }

        /// <summary>
        /// Returns true if MetadataOriginArrayValue instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataOriginArrayValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataOriginArrayValue input)
        {
            if (input == null)
            {
                return false;
