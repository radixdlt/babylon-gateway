...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MetadataGlobalAddressArrayValue")]
    ...
    public partial class MetadataGlobalAddressArrayValue : MetadataTypedValue, IEquatable<MetadataGlobalAddressArrayValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataGlobalAddressArrayValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataGlobalAddressArrayValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataGlobalAddressArrayValue" /> class.
        /// </summary>
        /// <param name="values">values (required).</param>
        /// <param name="type">type (required) (default to MetadataValueType.GlobalAddressArray).</param>
        public MetadataGlobalAddressArrayValue(List<string> values = default(List<string>), MetadataValueType type = MetadataValueType.GlobalAddressArray) : base(type)
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for MetadataGlobalAddressArrayValue and cannot be null");
            }
            this.Values = values;
        }
        ...
        {
            return this.Equals(input as MetadataGlobalAddressArrayValue);
        }

        /// <summary>
        /// Returns true if MetadataGlobalAddressArrayValue instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataGlobalAddressArrayValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataGlobalAddressArrayValue input)
        {
            if (input == null)
            {
                return false;
