...
{
    /// <summary>
    /// CaRoyaltyModuleFieldStateSubstate
    /// </summary>
    [DataContract(Name = "CaRoyaltyModuleFieldStateSubstate")]
    ...
    public partial class CaRoyaltyModuleFieldStateSubstate : CaSubstate, IEquatable<CaRoyaltyModuleFieldStateSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaRoyaltyModuleFieldStateSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaRoyaltyModuleFieldStateSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaRoyaltyModuleFieldStateSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.RoyaltyModuleFieldState).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaRoyaltyModuleFieldStateSubstate(CaRoyaltyModuleFieldStateValue value = default(CaRoyaltyModuleFieldStateValue), CaSubstateType substateType = CaSubstateType.RoyaltyModuleFieldState, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaRoyaltyModuleFieldStateSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaRoyaltyModuleFieldStateValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaRoyaltyModuleFieldStateSubstate {\n");
        ...
        {
            return this.Equals(input as CaRoyaltyModuleFieldStateSubstate);
        }

        /// <summary>
        /// Returns true if CaRoyaltyModuleFieldStateSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaRoyaltyModuleFieldStateSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaRoyaltyModuleFieldStateSubstate input)
        {
            if (input == null)
            {
                return false;
