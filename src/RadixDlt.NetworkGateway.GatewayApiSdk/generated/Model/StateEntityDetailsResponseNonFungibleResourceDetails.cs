...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class StateEntityDetailsResponseNonFungibleResourceDetails : StateEntityDetailsResponseItemDetails, IEquatable<StateEntityDetailsResponseNonFungibleResourceDetails>
    {
        ...
        public StateEntityDetailsResponseNonFungibleResourceDetails(Object accessRulesChain = default(Object), Object vaultAccessRulesChain = default(Object), NonFungibleIdType nonFungibleIdType = default(NonFungibleIdType), string totalSupply = default(string), string totalMinted = default(string), string totalBurned = default(string), StateEntityDetailsResponseItemDetailsType type = StateEntityDetailsResponseItemDetailsType.NonFungibleResource) : base(type)
        {
