...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CaNetworkDefinition
    /// </summary>
    [DataContract(Name = "CaNetworkDefinition")]
    public partial class CaNetworkDefinition : IEquatable<CaNetworkDefinition>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaNetworkDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaNetworkDefinition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaNetworkDefinition" /> class.
        /// </summary>
        ...
        public CaNetworkDefinition(int id = default(int), string logicalName = default(string), string hrpSuffix = default(string))
        {
            this.Id = id;
            // to ensure "logicalName" is required (not null)
            if (logicalName == null)
            {
                throw new ArgumentNullException("logicalName is a required property for CaNetworkDefinition and cannot be null");
            }
            this.LogicalName = logicalName;
            // to ensure "hrpSuffix" is required (not null)
            if (hrpSuffix == null)
            {
                throw new ArgumentNullException("hrpSuffix is a required property for CaNetworkDefinition and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaNetworkDefinition {\n");
        ...
        {
            return this.Equals(input as CaNetworkDefinition);
        }

        /// <summary>
        /// Returns true if CaNetworkDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of CaNetworkDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaNetworkDefinition input)
        {
            if (input == null)
            {
                return false;
