...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StateEntityDetailsResponseFungibleResourceDetails")]
    ...
    public partial class StateEntityDetailsResponseFungibleResourceDetails : StateEntityDetailsResponseItemDetails, IEquatable<StateEntityDetailsResponseFungibleResourceDetails>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StateEntityDetailsResponseFungibleResourceDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StateEntityDetailsResponseFungibleResourceDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StateEntityDetailsResponseFungibleResourceDetails" /> class.
        /// </summary>
        ...
        public StateEntityDetailsResponseFungibleResourceDetails(ComponentEntityRoleAssignments roleAssignments = default(ComponentEntityRoleAssignments), int divisibility = default(int), string totalSupply = default(string), string totalMinted = default(string), string totalBurned = default(string), TwoWayLinkedDappsCollection twoWayLinkedDapps = default(TwoWayLinkedDappsCollection), NativeResourceDetails nativeResourceDetails = default(NativeResourceDetails), StateEntityDetailsResponseItemDetailsType type = StateEntityDetailsResponseItemDetailsType.FungibleResource) : base(type)
        {
        ...
        {
            return this.Equals(input as StateEntityDetailsResponseFungibleResourceDetails);
        }

        /// <summary>
        /// Returns true if StateEntityDetailsResponseFungibleResourceDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of StateEntityDetailsResponseFungibleResourceDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StateEntityDetailsResponseFungibleResourceDetails input)
        {
            if (input == null)
            {
                return false;
