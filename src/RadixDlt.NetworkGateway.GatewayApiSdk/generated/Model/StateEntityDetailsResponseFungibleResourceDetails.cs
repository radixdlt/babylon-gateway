...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class StateEntityDetailsResponseFungibleResourceDetails : StateEntityDetailsResponseItemDetails, IEquatable<StateEntityDetailsResponseFungibleResourceDetails>
    {
        ...
        public StateEntityDetailsResponseFungibleResourceDetails(Object accessRulesChain = default(Object), Object vaultAccessRulesChain = default(Object), int divisibility = default(int), string totalSupply = default(string), string totalMinted = default(string), string totalBurned = default(string), StateEntityDetailsResponseItemDetailsType type = StateEntityDetailsResponseItemDetailsType.FungibleResource) : base(type)
        {
            ...
            {
                throw new ArgumentNullException("accessRulesChain is a required property for StateEntityDetailsResponseFungibleResourceDetails and cannot be null");
            }
            this.AccessRulesChain = accessRulesChain;
            // to ensure "vaultAccessRulesChain" is required (not null)
            if (vaultAccessRulesChain == null)
            {
                throw new ArgumentNullException("vaultAccessRulesChain is a required property for StateEntityDetailsResponseFungibleResourceDetails and cannot be null");
            }
