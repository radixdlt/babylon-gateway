...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class InvalidRequestErrorAllOf : IEquatable<InvalidRequestErrorAllOf>
    {
        ...
        protected InvalidRequestErrorAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidRequestErrorAllOf" /> class.
        /// </summary>
        /// <param name="validationErrors">One or more validation errors which occurred when validating the request. (required).</param>
        public InvalidRequestErrorAllOf(List<ValidationErrorsAtPath> validationErrors = default(List<ValidationErrorsAtPath>))
        {
            // to ensure "validationErrors" is required (not null)
            if (validationErrors == null)
            {
                throw new ArgumentNullException("validationErrors is a required property for InvalidRequestErrorAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as InvalidRequestErrorAllOf);
        }

        /// <summary>
        /// Returns true if InvalidRequestErrorAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidRequestErrorAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidRequestErrorAllOf input)
        {
            if (input == null)
            {
                return false;
