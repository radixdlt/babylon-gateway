...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CaSortedSubstateKey
    /// </summary>
    [DataContract(Name = "CaSortedSubstateKey")]
    [JsonConverter(typeof(JsonSubtypes), "key_type")]
    [JsonSubtypes.KnownSubType(typeof(CaFieldSubstateKey), "Field")]
    [JsonSubtypes.KnownSubType(typeof(CaMapSubstateKey), "Map")]
    [JsonSubtypes.KnownSubType(typeof(CaSortedSubstateKey), "Sorted")]
    public partial class CaSortedSubstateKey : CaSubstateKey, IEquatable<CaSortedSubstateKey>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaSortedSubstateKey" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaSortedSubstateKey() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaSortedSubstateKey" /> class.
        /// </summary>
        ...
        /// <param name="keyType">keyType (required) (default to CaSubstateKeyType.Sorted).</param>
        ...
        public CaSortedSubstateKey(string sortPrefixHex = default(string), string keyHex = default(string), CaSubstateKeyType keyType = CaSubstateKeyType.Sorted, string dbSortKeyHex = default(string)) : base(keyType, dbSortKeyHex)
        {
            // to ensure "sortPrefixHex" is required (not null)
            if (sortPrefixHex == null)
            {
                throw new ArgumentNullException("sortPrefixHex is a required property for CaSortedSubstateKey and cannot be null");
            }
            this.SortPrefixHex = sortPrefixHex;
            // to ensure "keyHex" is required (not null)
            if (keyHex == null)
            {
                throw new ArgumentNullException("keyHex is a required property for CaSortedSubstateKey and cannot be null");
            }
            this.KeyHex = keyHex;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaSortedSubstateKey {\n");
        ...
        {
            return this.Equals(input as CaSortedSubstateKey);
        }

        /// <summary>
        /// Returns true if CaSortedSubstateKey instances are equal
        /// </summary>
        /// <param name="input">Instance of CaSortedSubstateKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaSortedSubstateKey input)
        {
            if (input == null)
            {
                return false;
