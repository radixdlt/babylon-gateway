...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MetadataGlobalAddressValue")]
    ...
    public partial class MetadataGlobalAddressValue : MetadataTypedValue, IEquatable<MetadataGlobalAddressValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataGlobalAddressValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataGlobalAddressValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataGlobalAddressValue" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="type">type (required) (default to MetadataValueType.GlobalAddress).</param>
        public MetadataGlobalAddressValue(string value = default(string), MetadataValueType type = MetadataValueType.GlobalAddress) : base(type)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for MetadataGlobalAddressValue and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as MetadataGlobalAddressValue);
        }

        /// <summary>
        /// Returns true if MetadataGlobalAddressValue instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataGlobalAddressValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataGlobalAddressValue input)
        {
            if (input == null)
            {
                return false;
