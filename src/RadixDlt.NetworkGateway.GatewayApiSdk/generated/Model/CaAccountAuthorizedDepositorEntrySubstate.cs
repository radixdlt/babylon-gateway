...
{
    /// <summary>
    /// CaAccountAuthorizedDepositorEntrySubstate
    /// </summary>
    [DataContract(Name = "CaAccountAuthorizedDepositorEntrySubstate")]
    ...
    public partial class CaAccountAuthorizedDepositorEntrySubstate : CaSubstate, IEquatable<CaAccountAuthorizedDepositorEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaAccountAuthorizedDepositorEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaAccountAuthorizedDepositorEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaAccountAuthorizedDepositorEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value.</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.AccountAuthorizedDepositorEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaAccountAuthorizedDepositorEntrySubstate(CaAuthorizedDepositorKey key = default(CaAuthorizedDepositorKey), CaAccountAuthorizedDepositorEntryValue value = default(CaAccountAuthorizedDepositorEntryValue), CaSubstateType substateType = CaSubstateType.AccountAuthorizedDepositorEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CaAccountAuthorizedDepositorEntrySubstate and cannot be null");
            }
            this.Key = key;
            this.Value = value;
        }
        ...
        public CaAuthorizedDepositorKey Key { get; set; }

        /// <summary>
        /// Gets or Sets Value
        /// </summary>
        [DataMember(Name = "value", EmitDefaultValue = true)]
        public CaAccountAuthorizedDepositorEntryValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaAccountAuthorizedDepositorEntrySubstate {\n");
        ...
        {
            return this.Equals(input as CaAccountAuthorizedDepositorEntrySubstate);
        }

        /// <summary>
        /// Returns true if CaAccountAuthorizedDepositorEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaAccountAuthorizedDepositorEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaAccountAuthorizedDepositorEntrySubstate input)
        {
            if (input == null)
            {
                return false;
