...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CaSystemParameters
    /// </summary>
    [DataContract(Name = "CaSystemParameters")]
    public partial class CaSystemParameters : IEquatable<CaSystemParameters>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaSystemParameters" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaSystemParameters() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaSystemParameters" /> class.
        /// </summary>
        ...
        public CaSystemParameters(CaNetworkDefinition networkDefinition = default(CaNetworkDefinition), CaCostingModuleConfig costingModuleConfig = default(CaCostingModuleConfig), CaSystemCostingParameters costingParameters = default(CaSystemCostingParameters), CaLimitParameters limitParameters = default(CaLimitParameters))
        {
            // to ensure "networkDefinition" is required (not null)
            if (networkDefinition == null)
            {
                throw new ArgumentNullException("networkDefinition is a required property for CaSystemParameters and cannot be null");
            }
            this.NetworkDefinition = networkDefinition;
            // to ensure "costingModuleConfig" is required (not null)
            if (costingModuleConfig == null)
            {
                throw new ArgumentNullException("costingModuleConfig is a required property for CaSystemParameters and cannot be null");
            }
            this.CostingModuleConfig = costingModuleConfig;
            // to ensure "costingParameters" is required (not null)
            if (costingParameters == null)
            {
                throw new ArgumentNullException("costingParameters is a required property for CaSystemParameters and cannot be null");
            }
            this.CostingParameters = costingParameters;
            // to ensure "limitParameters" is required (not null)
            if (limitParameters == null)
            {
                throw new ArgumentNullException("limitParameters is a required property for CaSystemParameters and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaSystemParameters {\n");
        ...
        {
            return this.Equals(input as CaSystemParameters);
        }

        /// <summary>
        /// Returns true if CaSystemParameters instances are equal
        /// </summary>
        /// <param name="input">Instance of CaSystemParameters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaSystemParameters input)
        {
            if (input == null)
            {
                return false;
