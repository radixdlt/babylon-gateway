...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class TransactionInfo : IEquatable<TransactionInfo>, IValidatableObject
    {
        ...
        public TransactionInfo(TransactionStatus transactionStatus = default(TransactionStatus), string payloadHashHex = default(string), string intentHashHex = default(string), string transactionAccumulatorHex = default(string), TokenAmount feePaid = default(TokenAmount), TransactionMetadata metadata = default(TransactionMetadata))
        {
