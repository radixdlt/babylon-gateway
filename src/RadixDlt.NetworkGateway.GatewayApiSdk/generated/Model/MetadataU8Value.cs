...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// MetadataU8Value
    /// </summary>
    [DataContract(Name = "MetadataU8Value")]
    ...
    public partial class MetadataU8Value : MetadataTypedValue, IEquatable<MetadataU8Value>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataU8Value" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataU8Value() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataU8Value" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="type">type (required) (default to MetadataValueType.U8).</param>
        public MetadataU8Value(string value = default(string), MetadataValueType type = MetadataValueType.U8) : base(type)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for MetadataU8Value and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as MetadataU8Value);
        }

        /// <summary>
        /// Returns true if MetadataU8Value instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataU8Value to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataU8Value input)
        {
            if (input == null)
            {
                return false;
