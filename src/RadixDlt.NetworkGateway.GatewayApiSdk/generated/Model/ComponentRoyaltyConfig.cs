...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class ComponentRoyaltyConfig : IEquatable<ComponentRoyaltyConfig>
    {
        ...
        protected ComponentRoyaltyConfig() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ComponentRoyaltyConfig" /> class.
        /// </summary>
        ...
        public ComponentRoyaltyConfig(bool isEnabled = default(bool), List<ComponentMethodRoyalty> methodRules = default(List<ComponentMethodRoyalty>))
        {
        ...
        public List<ComponentMethodRoyalty> MethodRules { get; set; }
        ...
        {
            return this.Equals(input as ComponentRoyaltyConfig);
        }

        /// <summary>
        /// Returns true if ComponentRoyaltyConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of ComponentRoyaltyConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComponentRoyaltyConfig input)
        {
            if (input == null)
            {
                return false;
