...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CaRemoteGenericSubstitution_allOf")]
    public partial class CaRemoteGenericSubstitutionAllOf : IEquatable<CaRemoteGenericSubstitutionAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaRemoteGenericSubstitutionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaRemoteGenericSubstitutionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaRemoteGenericSubstitutionAllOf" /> class.
        /// </summary>
        ...
        public CaRemoteGenericSubstitutionAllOf(CaBlueprintTypeIdentifier blueprintTypeIdentifier = default(CaBlueprintTypeIdentifier), CaFullyScopedTypeId resolvedFullTypeId = default(CaFullyScopedTypeId))
        {
            // to ensure "blueprintTypeIdentifier" is required (not null)
            if (blueprintTypeIdentifier == null)
            {
                throw new ArgumentNullException("blueprintTypeIdentifier is a required property for CaRemoteGenericSubstitutionAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaRemoteGenericSubstitutionAllOf {\n");
        ...
        {
            return this.Equals(input as CaRemoteGenericSubstitutionAllOf);
        }

        /// <summary>
        /// Returns true if CaRemoteGenericSubstitutionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CaRemoteGenericSubstitutionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaRemoteGenericSubstitutionAllOf input)
        {
            if (input == null)
            {
                return false;
