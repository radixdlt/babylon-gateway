...
{
    /// <summary>
    /// CaGenericScryptoComponentFieldStateSubstate
    /// </summary>
    [DataContract(Name = "CaGenericScryptoComponentFieldStateSubstate")]
    ...
    public partial class CaGenericScryptoComponentFieldStateSubstate : CaSubstate, IEquatable<CaGenericScryptoComponentFieldStateSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaGenericScryptoComponentFieldStateSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaGenericScryptoComponentFieldStateSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaGenericScryptoComponentFieldStateSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.GenericScryptoComponentFieldState).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaGenericScryptoComponentFieldStateSubstate(CaGenericScryptoComponentFieldStateValue value = default(CaGenericScryptoComponentFieldStateValue), CaSubstateType substateType = CaSubstateType.GenericScryptoComponentFieldState, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaGenericScryptoComponentFieldStateSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaGenericScryptoComponentFieldStateValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaGenericScryptoComponentFieldStateSubstate {\n");
        ...
        {
            return this.Equals(input as CaGenericScryptoComponentFieldStateSubstate);
        }

        /// <summary>
        /// Returns true if CaGenericScryptoComponentFieldStateSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaGenericScryptoComponentFieldStateSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaGenericScryptoComponentFieldStateSubstate input)
        {
            if (input == null)
            {
                return false;
