...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CoreApiDataStruct
    /// </summary>
    [DataContract(Name = "CoreApiDataStruct")]
    public partial class CoreApiDataStruct : IEquatable<CoreApiDataStruct>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiDataStruct" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiDataStruct() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiDataStruct" /> class.
        /// </summary>
        ...
        public CoreApiDataStruct(CoreApiSborData structData = default(CoreApiSborData), List<CoreApiEntityReference> ownedEntities = default(List<CoreApiEntityReference>), List<CoreApiEntityReference> referencedEntities = default(List<CoreApiEntityReference>))
        {
            // to ensure "structData" is required (not null)
            if (structData == null)
            {
                throw new ArgumentNullException("structData is a required property for CoreApiDataStruct and cannot be null");
            }
            this.StructData = structData;
            // to ensure "ownedEntities" is required (not null)
            if (ownedEntities == null)
            {
                throw new ArgumentNullException("ownedEntities is a required property for CoreApiDataStruct and cannot be null");
            }
            this.OwnedEntities = ownedEntities;
            // to ensure "referencedEntities" is required (not null)
            if (referencedEntities == null)
            {
                throw new ArgumentNullException("referencedEntities is a required property for CoreApiDataStruct and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiDataStruct {\n");
        ...
        {
            return this.Equals(input as CoreApiDataStruct);
        }

        /// <summary>
        /// Returns true if CoreApiDataStruct instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiDataStruct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiDataStruct input)
        {
            if (input == null)
            {
                return false;
