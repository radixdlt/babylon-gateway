...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MetadataU64ArrayValue")]
    ...
    public partial class MetadataU64ArrayValue : MetadataTypedValue, IEquatable<MetadataU64ArrayValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataU64ArrayValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataU64ArrayValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataU64ArrayValue" /> class.
        /// </summary>
        /// <param name="values">values (required).</param>
        /// <param name="type">type (required) (default to MetadataValueType.U64Array).</param>
        public MetadataU64ArrayValue(List<string> values = default(List<string>), MetadataValueType type = MetadataValueType.U64Array) : base(type)
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for MetadataU64ArrayValue and cannot be null");
            }
            this.Values = values;
        }
        ...
        {
            return this.Equals(input as MetadataU64ArrayValue);
        }

        /// <summary>
        /// Returns true if MetadataU64ArrayValue instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataU64ArrayValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataU64ArrayValue input)
        {
            if (input == null)
            {
                return false;
