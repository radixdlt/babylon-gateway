...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CaStateUpdates")]
    public partial class CaStateUpdates : IEquatable<CaStateUpdates>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaStateUpdates" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaStateUpdates() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaStateUpdates" /> class.
        /// </summary>
        ...
        public CaStateUpdates(List<CaPartitionId> deletedPartitions = default(List<CaPartitionId>), List<CaCreatedSubstate> createdSubstates = default(List<CaCreatedSubstate>), List<CaUpdatedSubstate> updatedSubstates = default(List<CaUpdatedSubstate>), List<CaDeletedSubstate> deletedSubstates = default(List<CaDeletedSubstate>), List<CaEntityReference> newGlobalEntities = default(List<CaEntityReference>))
        {
            // to ensure "deletedPartitions" is required (not null)
            if (deletedPartitions == null)
            {
                throw new ArgumentNullException("deletedPartitions is a required property for CaStateUpdates and cannot be null");
            }
            this.DeletedPartitions = deletedPartitions;
            // to ensure "createdSubstates" is required (not null)
            if (createdSubstates == null)
            {
                throw new ArgumentNullException("createdSubstates is a required property for CaStateUpdates and cannot be null");
            }
            this.CreatedSubstates = createdSubstates;
            // to ensure "updatedSubstates" is required (not null)
            if (updatedSubstates == null)
            {
                throw new ArgumentNullException("updatedSubstates is a required property for CaStateUpdates and cannot be null");
            }
            this.UpdatedSubstates = updatedSubstates;
            // to ensure "deletedSubstates" is required (not null)
            if (deletedSubstates == null)
            {
                throw new ArgumentNullException("deletedSubstates is a required property for CaStateUpdates and cannot be null");
            }
            this.DeletedSubstates = deletedSubstates;
            // to ensure "newGlobalEntities" is required (not null)
            if (newGlobalEntities == null)
            {
                throw new ArgumentNullException("newGlobalEntities is a required property for CaStateUpdates and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaStateUpdates {\n");
        ...
        {
            return this.Equals(input as CaStateUpdates);
        }

        /// <summary>
        /// Returns true if CaStateUpdates instances are equal
        /// </summary>
        /// <param name="input">Instance of CaStateUpdates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaStateUpdates input)
        {
            if (input == null)
            {
                return false;
