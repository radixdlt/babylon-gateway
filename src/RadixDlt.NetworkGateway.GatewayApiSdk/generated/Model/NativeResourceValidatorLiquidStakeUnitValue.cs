...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NativeResourceValidatorLiquidStakeUnitValue")]
    ...
    public partial class NativeResourceValidatorLiquidStakeUnitValue : NativeResourceDetails, IEquatable<NativeResourceValidatorLiquidStakeUnitValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceValidatorLiquidStakeUnitValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NativeResourceValidatorLiquidStakeUnitValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceValidatorLiquidStakeUnitValue" /> class.
        /// </summary>
        ...
        /// <param name="kind">kind (required) (default to NativeResourceKind.ValidatorLiquidStakeUnit).</param>
        public NativeResourceValidatorLiquidStakeUnitValue(string validatorAddress = default(string), int redemptionResourceCount = default(int), List<NativeResourceRedemptionValueItem> unitRedemptionValue = default(List<NativeResourceRedemptionValueItem>), NativeResourceKind kind = NativeResourceKind.ValidatorLiquidStakeUnit) : base(kind)
        {
            // to ensure "validatorAddress" is required (not null)
            if (validatorAddress == null)
            {
                throw new ArgumentNullException("validatorAddress is a required property for NativeResourceValidatorLiquidStakeUnitValue and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("unitRedemptionValue is a required property for NativeResourceValidatorLiquidStakeUnitValue and cannot be null");
            }
        ...
        {
            return this.Equals(input as NativeResourceValidatorLiquidStakeUnitValue);
        }

        /// <summary>
        /// Returns true if NativeResourceValidatorLiquidStakeUnitValue instances are equal
        /// </summary>
        /// <param name="input">Instance of NativeResourceValidatorLiquidStakeUnitValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NativeResourceValidatorLiquidStakeUnitValue input)
        {
            if (input == null)
            {
                return false;
