...
{
    /// <summary>
    /// CaPackageCodeInstrumentedCodeEntrySubstate
    /// </summary>
    [DataContract(Name = "CaPackageCodeInstrumentedCodeEntrySubstate")]
    ...
    public partial class CaPackageCodeInstrumentedCodeEntrySubstate : CaSubstate, IEquatable<CaPackageCodeInstrumentedCodeEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPackageCodeInstrumentedCodeEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaPackageCodeInstrumentedCodeEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPackageCodeInstrumentedCodeEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.PackageCodeInstrumentedCodeEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaPackageCodeInstrumentedCodeEntrySubstate(CaPackageCodeKey key = default(CaPackageCodeKey), CaPackageCodeInstrumentedCodeEntryValue value = default(CaPackageCodeInstrumentedCodeEntryValue), CaSubstateType substateType = CaSubstateType.PackageCodeInstrumentedCodeEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CaPackageCodeInstrumentedCodeEntrySubstate and cannot be null");
            }
            this.Key = key;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaPackageCodeInstrumentedCodeEntrySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaPackageCodeKey Key { get; set; }

        /// <summary>
        /// Gets or Sets Value
        /// </summary>
        [DataMember(Name = "value", IsRequired = true, EmitDefaultValue = true)]
        public CaPackageCodeInstrumentedCodeEntryValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaPackageCodeInstrumentedCodeEntrySubstate {\n");
        ...
        {
            return this.Equals(input as CaPackageCodeInstrumentedCodeEntrySubstate);
        }

        /// <summary>
        /// Returns true if CaPackageCodeInstrumentedCodeEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaPackageCodeInstrumentedCodeEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaPackageCodeInstrumentedCodeEntrySubstate input)
        {
            if (input == null)
            {
                return false;
