...
{
    /// <summary>
    /// CaCostingModuleConfig
    /// </summary>
    [DataContract(Name = "CaCostingModuleConfig")]
    public partial class CaCostingModuleConfig : IEquatable<CaCostingModuleConfig>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaCostingModuleConfig" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaCostingModuleConfig() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaCostingModuleConfig" /> class.
        /// </summary>
        ...
        public CaCostingModuleConfig(string xrdMaxPerFunctionRoyalty = default(string), bool applyExecutionCostForAllSystemCalls = default(bool), bool applyBootRefCheckCosting = default(bool))
        {
            // to ensure "xrdMaxPerFunctionRoyalty" is required (not null)
            if (xrdMaxPerFunctionRoyalty == null)
            {
                throw new ArgumentNullException("xrdMaxPerFunctionRoyalty is a required property for CaCostingModuleConfig and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaCostingModuleConfig {\n");
        ...
        {
            return this.Equals(input as CaCostingModuleConfig);
        }

        /// <summary>
        /// Returns true if CaCostingModuleConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of CaCostingModuleConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaCostingModuleConfig input)
        {
            if (input == null)
            {
                return false;
