...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CaActiveValidator
    /// </summary>
    [DataContract(Name = "CaActiveValidator")]
    public partial class CaActiveValidator : IEquatable<CaActiveValidator>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaActiveValidator" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaActiveValidator() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaActiveValidator" /> class.
        /// </summary>
        ...
        public CaActiveValidator(string address = default(string), CaEcdsaSecp256k1PublicKey key = default(CaEcdsaSecp256k1PublicKey), string stake = default(string))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for CaActiveValidator and cannot be null");
            }
            this.Address = address;
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CaActiveValidator and cannot be null");
            }
            this.Key = key;
            // to ensure "stake" is required (not null)
            if (stake == null)
            {
                throw new ArgumentNullException("stake is a required property for CaActiveValidator and cannot be null");
            }
            this.Stake = stake;
        }
        ...
        public CaEcdsaSecp256k1PublicKey Key { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaActiveValidator {\n");
        ...
        {
            return this.Equals(input as CaActiveValidator);
        }

        /// <summary>
        /// Returns true if CaActiveValidator instances are equal
        /// </summary>
        /// <param name="input">Instance of CaActiveValidator to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaActiveValidator input)
        {
            if (input == null)
            {
                return false;
