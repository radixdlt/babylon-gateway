...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NativeResourceAccountOwnerBadgeValue")]
    ...
    public partial class NativeResourceAccountOwnerBadgeValue : NativeResourceDetails, IEquatable<NativeResourceAccountOwnerBadgeValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceAccountOwnerBadgeValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NativeResourceAccountOwnerBadgeValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceAccountOwnerBadgeValue" /> class.
        /// </summary>
        /// <param name="kind">kind (required) (default to NativeResourceKind.AccountOwnerBadge).</param>
        public NativeResourceAccountOwnerBadgeValue(NativeResourceKind kind = NativeResourceKind.AccountOwnerBadge) : base(kind)
        {
        }
        ...
        {
            return this.Equals(input as NativeResourceAccountOwnerBadgeValue);
        }

        /// <summary>
        /// Returns true if NativeResourceAccountOwnerBadgeValue instances are equal
        /// </summary>
        /// <param name="input">Instance of NativeResourceAccountOwnerBadgeValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NativeResourceAccountOwnerBadgeValue input)
        {
            if (input == null)
            {
                return false;
