...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CaSubstateIdAllOf
    /// </summary>
    [DataContract(Name = "CaSubstateId_allOf")]
    public partial class CaSubstateIdAllOf : IEquatable<CaSubstateIdAllOf>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CaSubstateIdAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaSubstateIdAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaSubstateIdAllOf" /> class.
        /// </summary>
        /// <param name="substateType">substateType (required).</param>
        /// <param name="substateKey">substateKey (required).</param>
        public CaSubstateIdAllOf(CaSubstateType substateType = default(CaSubstateType), CaSubstateKey substateKey = default(CaSubstateKey))
        {
            this.SubstateType = substateType;
            // to ensure "substateKey" is required (not null)
            if (substateKey == null)
            {
                throw new ArgumentNullException("substateKey is a required property for CaSubstateIdAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaSubstateIdAllOf {\n");
        ...
        {
            return this.Equals(input as CaSubstateIdAllOf);
        }

        /// <summary>
        /// Returns true if CaSubstateIdAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CaSubstateIdAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaSubstateIdAllOf input)
        {
            if (input == null)
            {
                return false;
