...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiPaymentToRoyaltyRecipient")]
    public partial class CoreApiPaymentToRoyaltyRecipient : IEquatable<CoreApiPaymentToRoyaltyRecipient>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiPaymentToRoyaltyRecipient" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiPaymentToRoyaltyRecipient() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiPaymentToRoyaltyRecipient" /> class.
        /// </summary>
        ...
        public CoreApiPaymentToRoyaltyRecipient(CoreApiEntityReference royaltyRecipient = default(CoreApiEntityReference), string xrdAmount = default(string))
        {
            // to ensure "royaltyRecipient" is required (not null)
            if (royaltyRecipient == null)
            {
                throw new ArgumentNullException("royaltyRecipient is a required property for CoreApiPaymentToRoyaltyRecipient and cannot be null");
            }
            this.RoyaltyRecipient = royaltyRecipient;
            // to ensure "xrdAmount" is required (not null)
            if (xrdAmount == null)
            {
                throw new ArgumentNullException("xrdAmount is a required property for CoreApiPaymentToRoyaltyRecipient and cannot be null");
            }
        ...
        public CoreApiEntityReference RoyaltyRecipient { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiPaymentToRoyaltyRecipient {\n");
        ...
        {
            return this.Equals(input as CoreApiPaymentToRoyaltyRecipient);
        }

        /// <summary>
        /// Returns true if CoreApiPaymentToRoyaltyRecipient instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiPaymentToRoyaltyRecipient to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiPaymentToRoyaltyRecipient input)
        {
            if (input == null)
            {
                return false;
