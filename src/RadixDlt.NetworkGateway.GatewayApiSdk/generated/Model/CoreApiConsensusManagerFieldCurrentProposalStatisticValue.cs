...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiConsensusManagerFieldCurrentProposalStatisticValue")]
    public partial class CoreApiConsensusManagerFieldCurrentProposalStatisticValue : IEquatable<CoreApiConsensusManagerFieldCurrentProposalStatisticValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiConsensusManagerFieldCurrentProposalStatisticValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiConsensusManagerFieldCurrentProposalStatisticValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiConsensusManagerFieldCurrentProposalStatisticValue" /> class.
        /// </summary>
        ...
        public CoreApiConsensusManagerFieldCurrentProposalStatisticValue(List<long> completed = default(List<long>), List<long> missed = default(List<long>))
        {
            // to ensure "completed" is required (not null)
            if (completed == null)
            {
                throw new ArgumentNullException("completed is a required property for CoreApiConsensusManagerFieldCurrentProposalStatisticValue and cannot be null");
            }
            this.Completed = completed;
            // to ensure "missed" is required (not null)
            if (missed == null)
            {
                throw new ArgumentNullException("missed is a required property for CoreApiConsensusManagerFieldCurrentProposalStatisticValue and cannot be null");
            }
            this.Missed = missed;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiConsensusManagerFieldCurrentProposalStatisticValue {\n");
        ...
        {
            return this.Equals(input as CoreApiConsensusManagerFieldCurrentProposalStatisticValue);
        }

        /// <summary>
        /// Returns true if CoreApiConsensusManagerFieldCurrentProposalStatisticValue instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiConsensusManagerFieldCurrentProposalStatisticValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiConsensusManagerFieldCurrentProposalStatisticValue input)
        {
            if (input == null)
            {
                return false;
