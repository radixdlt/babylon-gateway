...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class EntitiesByRoleRequirementLookupCollection : IEquatable<EntitiesByRoleRequirementLookupCollection>
    {
        ...
        public EntitiesByRoleRequirementLookupCollection(EntitiesByRoleRequirementRequestRequirement requirement = default(EntitiesByRoleRequirementRequestRequirement), List<EntitiesByRoleRequirementItem> items = default(List<EntitiesByRoleRequirementItem>))
        {
