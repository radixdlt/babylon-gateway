...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StateAccountResourcePreferencesPageRequest")]
    public partial class StateAccountResourcePreferencesPageRequest : IEquatable<StateAccountResourcePreferencesPageRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StateAccountResourcePreferencesPageRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StateAccountResourcePreferencesPageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StateAccountResourcePreferencesPageRequest" /> class.
        /// </summary>
        ...
        public StateAccountResourcePreferencesPageRequest(LedgerStateSelector atLedgerState = default(LedgerStateSelector), string cursor = default(string), int? limitPerPage = default(int?), string accountAddress = default(string))
        {
            // to ensure "accountAddress" is required (not null)
            if (accountAddress == null)
            {
                throw new ArgumentNullException("accountAddress is a required property for StateAccountResourcePreferencesPageRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as StateAccountResourcePreferencesPageRequest);
        }

        /// <summary>
        /// Returns true if StateAccountResourcePreferencesPageRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of StateAccountResourcePreferencesPageRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StateAccountResourcePreferencesPageRequest input)
        {
            if (input == null)
            {
                return false;
