...
{
    /// <summary>
    /// CaBlueprintVersionKey
    /// </summary>
    [DataContract(Name = "CaBlueprintVersionKey")]
    public partial class CaBlueprintVersionKey : IEquatable<CaBlueprintVersionKey>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaBlueprintVersionKey" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaBlueprintVersionKey() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaBlueprintVersionKey" /> class.
        /// </summary>
        ...
        public CaBlueprintVersionKey(string blueprintName = default(string), string blueprintVersion = default(string))
        {
            // to ensure "blueprintName" is required (not null)
            if (blueprintName == null)
            {
                throw new ArgumentNullException("blueprintName is a required property for CaBlueprintVersionKey and cannot be null");
            }
            this.BlueprintName = blueprintName;
            // to ensure "blueprintVersion" is required (not null)
            if (blueprintVersion == null)
            {
                throw new ArgumentNullException("blueprintVersion is a required property for CaBlueprintVersionKey and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaBlueprintVersionKey {\n");
        ...
        {
            return this.Equals(input as CaBlueprintVersionKey);
        }

        /// <summary>
        /// Returns true if CaBlueprintVersionKey instances are equal
        /// </summary>
        /// <param name="input">Instance of CaBlueprintVersionKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaBlueprintVersionKey input)
        {
            if (input == null)
            {
                return false;
