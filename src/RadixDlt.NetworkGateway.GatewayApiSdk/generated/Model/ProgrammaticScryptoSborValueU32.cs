...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class ProgrammaticScryptoSborValueU32 : ProgrammaticScryptoSborValue, IEquatable<ProgrammaticScryptoSborValueU32>
    {
        ...
        /// <param name="kind">kind (required) (default to ProgrammaticScryptoSborValueKind.U32).</param>
        ...
        public ProgrammaticScryptoSborValueU32(string value = default(string), ProgrammaticScryptoSborValueKind kind = ProgrammaticScryptoSborValueKind.U32, string typeName = default(string), string fieldName = default(string)) : base(kind, typeName, fieldName)
        {
