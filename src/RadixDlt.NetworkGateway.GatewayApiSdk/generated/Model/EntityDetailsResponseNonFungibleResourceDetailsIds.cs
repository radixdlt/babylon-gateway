...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class EntityDetailsResponseNonFungibleResourceDetailsIds : IEquatable<EntityDetailsResponseNonFungibleResourceDetailsIds>
    {
        /// <summary>
        ...
        public EntityDetailsResponseNonFungibleResourceDetailsIds(long? totalCount = default(long?), string previousCursor = default(string), string nextCursor = default(string), List<EntityDetailsResponseNonFungibleResourceDetailsIdsItem> items = default(List<EntityDetailsResponseNonFungibleResourceDetailsIdsItem>))
        {
