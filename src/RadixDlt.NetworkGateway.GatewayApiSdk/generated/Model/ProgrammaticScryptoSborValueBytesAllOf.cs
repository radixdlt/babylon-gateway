...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class ProgrammaticScryptoSborValueBytesAllOf : IEquatable<ProgrammaticScryptoSborValueBytesAllOf>
    {
        ...
        public ProgrammaticScryptoSborValueBytesAllOf(ProgrammaticScryptoSborValueTypeKind elementValueKind = default(ProgrammaticScryptoSborValueTypeKind), string hex = default(string))
        {
