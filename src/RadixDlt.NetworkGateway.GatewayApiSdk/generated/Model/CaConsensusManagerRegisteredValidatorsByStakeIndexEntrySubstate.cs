...
{
    /// <summary>
    /// CaConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate
    /// </summary>
    [DataContract(Name = "CaConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate")]
    ...
    public partial class CaConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate : CaSubstate, IEquatable<CaConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.ConsensusManagerRegisteredValidatorsByStakeIndexEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate(CaActiveValidatorKey key = default(CaActiveValidatorKey), CaConsensusManagerRegisteredValidatorsByStakeIndexEntryValue value = default(CaConsensusManagerRegisteredValidatorsByStakeIndexEntryValue), CaSubstateType substateType = CaSubstateType.ConsensusManagerRegisteredValidatorsByStakeIndexEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CaConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate and cannot be null");
            }
            this.Key = key;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaActiveValidatorKey Key { get; set; }

        /// <summary>
        /// Gets or Sets Value
        /// </summary>
        [DataMember(Name = "value", IsRequired = true, EmitDefaultValue = true)]
        public CaConsensusManagerRegisteredValidatorsByStakeIndexEntryValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate {\n");
        ...
        {
            return this.Equals(input as CaConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate);
        }

        /// <summary>
        /// Returns true if CaConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate input)
        {
            if (input == null)
            {
                return false;
