...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiNonFungibleLocalId")]
    public partial class CoreApiNonFungibleLocalId : IEquatable<CoreApiNonFungibleLocalId>
    {
        ...
        public CoreApiNonFungibleIdType IdType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiNonFungibleLocalId" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiNonFungibleLocalId() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiNonFungibleLocalId" /> class.
        /// </summary>
        ...
        public CoreApiNonFungibleLocalId(string simpleRep = default(string), CoreApiNonFungibleIdType idType = default(CoreApiNonFungibleIdType), string sborHex = default(string))
        {
            // to ensure "simpleRep" is required (not null)
            if (simpleRep == null)
            {
                throw new ArgumentNullException("simpleRep is a required property for CoreApiNonFungibleLocalId and cannot be null");
            }
            ...
            if (sborHex == null)
            {
                throw new ArgumentNullException("sborHex is a required property for CoreApiNonFungibleLocalId and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiNonFungibleLocalId {\n");
        ...
        {
            return this.Equals(input as CoreApiNonFungibleLocalId);
        }

        /// <summary>
        /// Returns true if CoreApiNonFungibleLocalId instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiNonFungibleLocalId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiNonFungibleLocalId input)
        {
            if (input == null)
            {
                return false;
