...
{
    /// <summary>
    /// ReturnValueTypeRawHex
    /// </summary>
    [DataContract(Name = "ReturnValueTypeRawHex")]
    ...
    public partial class ReturnValueTypeRawHex : ReturnValue, IEquatable<ReturnValueTypeRawHex>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReturnValueTypeRawHex" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ReturnValueTypeRawHex() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReturnValueTypeRawHex" /> class.
        /// </summary>
        /// <param name="rawHex">rawHex (required).</param>
        /// <param name="returnValueType">returnValueType (required) (default to ReturnValueType.RawHex).</param>
        public ReturnValueTypeRawHex(string rawHex = default(string), ReturnValueType returnValueType = ReturnValueType.RawHex) : base(returnValueType)
        {
            // to ensure "rawHex" is required (not null)
            if (rawHex == null)
            {
                throw new ArgumentNullException("rawHex is a required property for ReturnValueTypeRawHex and cannot be null");
            }
            this.RawHex = rawHex;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReturnValueTypeRawHex {\n");
        ...
        {
            return this.Equals(input as ReturnValueTypeRawHex);
        }

        /// <summary>
        /// Returns true if ReturnValueTypeRawHex instances are equal
        /// </summary>
        /// <param name="input">Instance of ReturnValueTypeRawHex to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReturnValueTypeRawHex input)
        {
            if (input == null)
            {
                return false;
