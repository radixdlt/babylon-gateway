...
{
    /// <summary>
    /// CaConsensusManagerFieldValidatorRewardsSubstate
    /// </summary>
    [DataContract(Name = "CaConsensusManagerFieldValidatorRewardsSubstate")]
    ...
    public partial class CaConsensusManagerFieldValidatorRewardsSubstate : CaSubstate, IEquatable<CaConsensusManagerFieldValidatorRewardsSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaConsensusManagerFieldValidatorRewardsSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaConsensusManagerFieldValidatorRewardsSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaConsensusManagerFieldValidatorRewardsSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.ConsensusManagerFieldValidatorRewards).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaConsensusManagerFieldValidatorRewardsSubstate(CaConsensusManagerFieldValidatorRewardsValue value = default(CaConsensusManagerFieldValidatorRewardsValue), CaSubstateType substateType = CaSubstateType.ConsensusManagerFieldValidatorRewards, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaConsensusManagerFieldValidatorRewardsSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaConsensusManagerFieldValidatorRewardsValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaConsensusManagerFieldValidatorRewardsSubstate {\n");
        ...
        {
            return this.Equals(input as CaConsensusManagerFieldValidatorRewardsSubstate);
        }

        /// <summary>
        /// Returns true if CaConsensusManagerFieldValidatorRewardsSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaConsensusManagerFieldValidatorRewardsSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaConsensusManagerFieldValidatorRewardsSubstate input)
        {
            if (input == null)
            {
                return false;
