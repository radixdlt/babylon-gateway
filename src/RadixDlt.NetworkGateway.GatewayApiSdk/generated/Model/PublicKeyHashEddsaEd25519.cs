...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PublicKeyHashEddsaEd25519")]
    ...
    public partial class PublicKeyHashEddsaEd25519 : PublicKeyHash, IEquatable<PublicKeyHashEddsaEd25519>
    {
        ...
        protected PublicKeyHashEddsaEd25519() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicKeyHashEddsaEd25519" /> class.
        /// </summary>
        /// <param name="hashHex">Hex-encoded SHA-256 hash. (required).</param>
        /// <param name="keyHashType">keyHashType (required) (default to PublicKeyHashType.EddsaEd25519).</param>
        public PublicKeyHashEddsaEd25519(string hashHex = default(string), PublicKeyHashType keyHashType = PublicKeyHashType.EddsaEd25519) : base(keyHashType)
        {
            // to ensure "hashHex" is required (not null)
            if (hashHex == null)
            {
                throw new ArgumentNullException("hashHex is a required property for PublicKeyHashEddsaEd25519 and cannot be null");
            }
        ...
        {
            return this.Equals(input as PublicKeyHashEddsaEd25519);
        }

        /// <summary>
        /// Returns true if PublicKeyHashEddsaEd25519 instances are equal
        /// </summary>
        /// <param name="input">Instance of PublicKeyHashEddsaEd25519 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PublicKeyHashEddsaEd25519 input)
        {
            if (input == null)
            {
                return false;
