...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiSborData")]
    public partial class CoreApiSborData : IEquatable<CoreApiSborData>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiSborData" /> class.
        /// </summary>
        ...
        public CoreApiSborData(string hex = default(string), Object programmaticJson = default(Object))
        {
            this.Hex = hex;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiSborData {\n");
        ...
        {
            return this.Equals(input as CoreApiSborData);
        }

        /// <summary>
        /// Returns true if CoreApiSborData instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiSborData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiSborData input)
        {
            if (input == null)
            {
                return false;
