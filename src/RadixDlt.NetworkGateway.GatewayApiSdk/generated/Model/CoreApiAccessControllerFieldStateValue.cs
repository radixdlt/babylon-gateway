...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiAccessControllerFieldStateValue")]
    public partial class CoreApiAccessControllerFieldStateValue : IEquatable<CoreApiAccessControllerFieldStateValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiAccessControllerFieldStateValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiAccessControllerFieldStateValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiAccessControllerFieldStateValue" /> class.
        /// </summary>
        ...
        public CoreApiAccessControllerFieldStateValue(CoreApiEntityReference controlledVault = default(CoreApiEntityReference), CoreApiEntityReference xrdFeeVault = default(CoreApiEntityReference), long? timedRecoveryDelayMinutes = default(long?), string recoveryBadgeResourceAddress = default(string), bool isPrimaryRoleLocked = default(bool), CoreApiPrimaryRoleRecoveryAttempt primaryRoleRecoveryAttempt = default(CoreApiPrimaryRoleRecoveryAttempt), bool hasPrimaryRoleBadgeWithdrawAttempt = default(bool), CoreApiRecoveryRoleRecoveryAttempt recoveryRoleRecoveryAttempt = default(CoreApiRecoveryRoleRecoveryAttempt), bool hasRecoveryRoleBadgeWithdrawAttempt = default(bool))
        {
            // to ensure "controlledVault" is required (not null)
            if (controlledVault == null)
            {
                throw new ArgumentNullException("controlledVault is a required property for CoreApiAccessControllerFieldStateValue and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("recoveryBadgeResourceAddress is a required property for CoreApiAccessControllerFieldStateValue and cannot be null");
            }
        ...
        public CoreApiEntityReference ControlledVault { get; set; }

        /// <summary>
        /// Gets or Sets XrdFeeVault
        /// </summary>
        [DataMember(Name = "xrd_fee_vault", EmitDefaultValue = true)]
        public CoreApiEntityReference XrdFeeVault { get; set; }
        ...
        public CoreApiPrimaryRoleRecoveryAttempt PrimaryRoleRecoveryAttempt { get; set; }
        ...
        public CoreApiRecoveryRoleRecoveryAttempt RecoveryRoleRecoveryAttempt { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiAccessControllerFieldStateValue {\n");
        ...
        {
            return this.Equals(input as CoreApiAccessControllerFieldStateValue);
        }

        /// <summary>
        /// Returns true if CoreApiAccessControllerFieldStateValue instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiAccessControllerFieldStateValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiAccessControllerFieldStateValue input)
        {
            if (input == null)
            {
                return false;
