...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// MetadataI32Value
    /// </summary>
    [DataContract(Name = "MetadataI32Value")]
    ...
    public partial class MetadataI32Value : MetadataTypedValue, IEquatable<MetadataI32Value>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataI32Value" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataI32Value() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataI32Value" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="type">type (required) (default to MetadataValueType.I32).</param>
        public MetadataI32Value(string value = default(string), MetadataValueType type = MetadataValueType.I32) : base(type)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for MetadataI32Value and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as MetadataI32Value);
        }

        /// <summary>
        /// Returns true if MetadataI32Value instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataI32Value to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataI32Value input)
        {
            if (input == null)
            {
                return false;
