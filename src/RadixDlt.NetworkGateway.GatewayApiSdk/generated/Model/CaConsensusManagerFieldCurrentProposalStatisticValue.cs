...
{
    /// <summary>
    /// CaConsensusManagerFieldCurrentProposalStatisticValue
    /// </summary>
    [DataContract(Name = "CaConsensusManagerFieldCurrentProposalStatisticValue")]
    public partial class CaConsensusManagerFieldCurrentProposalStatisticValue : IEquatable<CaConsensusManagerFieldCurrentProposalStatisticValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaConsensusManagerFieldCurrentProposalStatisticValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaConsensusManagerFieldCurrentProposalStatisticValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaConsensusManagerFieldCurrentProposalStatisticValue" /> class.
        /// </summary>
        ...
        public CaConsensusManagerFieldCurrentProposalStatisticValue(List<long> completed = default(List<long>), List<long> missed = default(List<long>))
        {
            // to ensure "completed" is required (not null)
            if (completed == null)
            {
                throw new ArgumentNullException("completed is a required property for CaConsensusManagerFieldCurrentProposalStatisticValue and cannot be null");
            }
            this.Completed = completed;
            // to ensure "missed" is required (not null)
            if (missed == null)
            {
                throw new ArgumentNullException("missed is a required property for CaConsensusManagerFieldCurrentProposalStatisticValue and cannot be null");
            }
            this.Missed = missed;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaConsensusManagerFieldCurrentProposalStatisticValue {\n");
        ...
        {
            return this.Equals(input as CaConsensusManagerFieldCurrentProposalStatisticValue);
        }

        /// <summary>
        /// Returns true if CaConsensusManagerFieldCurrentProposalStatisticValue instances are equal
        /// </summary>
        /// <param name="input">Instance of CaConsensusManagerFieldCurrentProposalStatisticValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaConsensusManagerFieldCurrentProposalStatisticValue input)
        {
            if (input == null)
            {
                return false;
