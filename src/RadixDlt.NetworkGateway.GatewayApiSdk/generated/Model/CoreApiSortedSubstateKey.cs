...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiSortedSubstateKey")]
    [JsonConverter(typeof(JsonSubtypes), "key_type")]
    [JsonSubtypes.KnownSubType(typeof(CoreApiFieldSubstateKey), "Field")]
    [JsonSubtypes.KnownSubType(typeof(CoreApiMapSubstateKey), "Map")]
    [JsonSubtypes.KnownSubType(typeof(CoreApiSortedSubstateKey), "Sorted")]
    public partial class CoreApiSortedSubstateKey : CoreApiSubstateKey, IEquatable<CoreApiSortedSubstateKey>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiSortedSubstateKey" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiSortedSubstateKey() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiSortedSubstateKey" /> class.
        /// </summary>
        ...
        /// <param name="keyType">keyType (required) (default to CoreApiSubstateKeyType.Sorted).</param>
        ...
        public CoreApiSortedSubstateKey(string sortPrefixHex = default(string), string keyHex = default(string), CoreApiSubstateKeyType keyType = CoreApiSubstateKeyType.Sorted, string dbSortKeyHex = default(string)) : base(keyType, dbSortKeyHex)
        {
            // to ensure "sortPrefixHex" is required (not null)
            if (sortPrefixHex == null)
            {
                throw new ArgumentNullException("sortPrefixHex is a required property for CoreApiSortedSubstateKey and cannot be null");
            }
            this.SortPrefixHex = sortPrefixHex;
            // to ensure "keyHex" is required (not null)
            if (keyHex == null)
            {
                throw new ArgumentNullException("keyHex is a required property for CoreApiSortedSubstateKey and cannot be null");
            }
            this.KeyHex = keyHex;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiSortedSubstateKey {\n");
        ...
        {
            return this.Equals(input as CoreApiSortedSubstateKey);
        }

        /// <summary>
        /// Returns true if CoreApiSortedSubstateKey instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiSortedSubstateKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiSortedSubstateKey input)
        {
            if (input == null)
            {
                return false;
