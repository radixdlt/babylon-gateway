...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class ProgrammaticScryptoSborValueBool : ProgrammaticScryptoSborValue, IEquatable<ProgrammaticScryptoSborValueBool>
    {
        ...
        /// <param name="kind">kind (required) (default to ProgrammaticScryptoSborValueTypeKind.Bool).</param>
        ...
        public ProgrammaticScryptoSborValueBool(bool value = default(bool), ProgrammaticScryptoSborValueTypeKind kind = ProgrammaticScryptoSborValueTypeKind.Bool, string typeName = default(string), string fieldName = default(string)) : base(kind, typeName, fieldName)
        {
            this.Value = value;
        }
