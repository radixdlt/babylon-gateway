...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MetadataNonFungibleGlobalIdArrayValue")]
    ...
    public partial class MetadataNonFungibleGlobalIdArrayValue : MetadataTypedValue
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataNonFungibleGlobalIdArrayValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataNonFungibleGlobalIdArrayValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataNonFungibleGlobalIdArrayValue" /> class.
        /// </summary>
        ...
        public MetadataNonFungibleGlobalIdArrayValue(List<MetadataNonFungibleGlobalIdArrayValueAllOfValues> values = default(List<MetadataNonFungibleGlobalIdArrayValueAllOfValues>), MetadataValueType type = MetadataValueType.NonFungibleGlobalIdArray) : base(type)
        {
            ...
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for MetadataNonFungibleGlobalIdArrayValue and cannot be null");
            }
            this.Values = values;
        }
        ...
        {
            return this.Equals(input as MetadataNonFungibleGlobalIdArrayValue);
        }

        /// <summary>
        /// Returns true if MetadataNonFungibleGlobalIdArrayValue instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataNonFungibleGlobalIdArrayValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataNonFungibleGlobalIdArrayValue input)
        {
            if (input == null)
            {
                return false;
