...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiStateUpdates")]
    public partial class CoreApiStateUpdates : IEquatable<CoreApiStateUpdates>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiStateUpdates" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiStateUpdates() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiStateUpdates" /> class.
        /// </summary>
        ...
        public CoreApiStateUpdates(List<CoreApiPartitionId> deletedPartitions = default(List<CoreApiPartitionId>), List<CoreApiCreatedSubstate> createdSubstates = default(List<CoreApiCreatedSubstate>), List<CoreApiUpdatedSubstate> updatedSubstates = default(List<CoreApiUpdatedSubstate>), List<CoreApiDeletedSubstate> deletedSubstates = default(List<CoreApiDeletedSubstate>), List<CoreApiEntityReference> newGlobalEntities = default(List<CoreApiEntityReference>))
        {
            // to ensure "deletedPartitions" is required (not null)
            if (deletedPartitions == null)
            {
                throw new ArgumentNullException("deletedPartitions is a required property for CoreApiStateUpdates and cannot be null");
            }
            this.DeletedPartitions = deletedPartitions;
            // to ensure "createdSubstates" is required (not null)
            if (createdSubstates == null)
            {
                throw new ArgumentNullException("createdSubstates is a required property for CoreApiStateUpdates and cannot be null");
            }
            this.CreatedSubstates = createdSubstates;
            // to ensure "updatedSubstates" is required (not null)
            if (updatedSubstates == null)
            {
                throw new ArgumentNullException("updatedSubstates is a required property for CoreApiStateUpdates and cannot be null");
            }
            this.UpdatedSubstates = updatedSubstates;
            // to ensure "deletedSubstates" is required (not null)
            if (deletedSubstates == null)
            {
                throw new ArgumentNullException("deletedSubstates is a required property for CoreApiStateUpdates and cannot be null");
            }
            this.DeletedSubstates = deletedSubstates;
            // to ensure "newGlobalEntities" is required (not null)
            if (newGlobalEntities == null)
            {
                throw new ArgumentNullException("newGlobalEntities is a required property for CoreApiStateUpdates and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiStateUpdates {\n");
        ...
        {
            return this.Equals(input as CoreApiStateUpdates);
        }

        /// <summary>
        /// Returns true if CoreApiStateUpdates instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiStateUpdates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiStateUpdates input)
        {
            if (input == null)
            {
                return false;
