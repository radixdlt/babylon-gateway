...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class ResourceOwnersResponse : IEquatable<ResourceOwnersResponse>
    {
        ...
        public ResourceOwnersResponse(ResourceOwnersCollection owners = default(ResourceOwnersCollection))
        {
            // to ensure "owners" is required (not null)
            if (owners == null)
            {
                throw new ArgumentNullException("owners is a required property for ResourceOwnersResponse and cannot be null");
            }
            this.Owners = owners;
        }
