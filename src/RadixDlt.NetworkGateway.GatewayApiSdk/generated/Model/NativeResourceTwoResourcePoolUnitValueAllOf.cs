...
{
    /// <summary>
    /// NativeResourceTwoResourcePoolUnitValueAllOf
    /// </summary>
    [DataContract(Name = "NativeResourceTwoResourcePoolUnitValue_allOf")]
    public partial class NativeResourceTwoResourcePoolUnitValueAllOf : IEquatable<NativeResourceTwoResourcePoolUnitValueAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceTwoResourcePoolUnitValueAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NativeResourceTwoResourcePoolUnitValueAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceTwoResourcePoolUnitValueAllOf" /> class.
        /// </summary>
        ...
        public NativeResourceTwoResourcePoolUnitValueAllOf(string poolAddress = default(string), int redemptionResourceCount = default(int), List<NativeResourceRedemptionValueItem> unitRedemptionValue = default(List<NativeResourceRedemptionValueItem>))
        {
            // to ensure "poolAddress" is required (not null)
            if (poolAddress == null)
            {
                throw new ArgumentNullException("poolAddress is a required property for NativeResourceTwoResourcePoolUnitValueAllOf and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("unitRedemptionValue is a required property for NativeResourceTwoResourcePoolUnitValueAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NativeResourceTwoResourcePoolUnitValueAllOf {\n");
        ...
        {
            return this.Equals(input as NativeResourceTwoResourcePoolUnitValueAllOf);
        }

        /// <summary>
        /// Returns true if NativeResourceTwoResourcePoolUnitValueAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of NativeResourceTwoResourcePoolUnitValueAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NativeResourceTwoResourcePoolUnitValueAllOf input)
        {
            if (input == null)
            {
                return false;
