...
{
    /// <summary>
    /// CaPendingOwnerStakeWithdrawal
    /// </summary>
    [DataContract(Name = "CaPendingOwnerStakeWithdrawal")]
    public partial class CaPendingOwnerStakeWithdrawal : IEquatable<CaPendingOwnerStakeWithdrawal>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPendingOwnerStakeWithdrawal" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaPendingOwnerStakeWithdrawal() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPendingOwnerStakeWithdrawal" /> class.
        /// </summary>
        ...
        public CaPendingOwnerStakeWithdrawal(long epochUnlocked = default(long), string stakeUnitAmount = default(string))
        {
            this.EpochUnlocked = epochUnlocked;
            // to ensure "stakeUnitAmount" is required (not null)
            if (stakeUnitAmount == null)
            {
                throw new ArgumentNullException("stakeUnitAmount is a required property for CaPendingOwnerStakeWithdrawal and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaPendingOwnerStakeWithdrawal {\n");
        ...
        {
            return this.Equals(input as CaPendingOwnerStakeWithdrawal);
        }

        /// <summary>
        /// Returns true if CaPendingOwnerStakeWithdrawal instances are equal
        /// </summary>
        /// <param name="input">Instance of CaPendingOwnerStakeWithdrawal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaPendingOwnerStakeWithdrawal input)
        {
            if (input == null)
            {
                return false;
