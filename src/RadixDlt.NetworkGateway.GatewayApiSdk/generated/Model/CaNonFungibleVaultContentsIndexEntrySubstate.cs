...
{
    /// <summary>
    /// CaNonFungibleVaultContentsIndexEntrySubstate
    /// </summary>
    [DataContract(Name = "CaNonFungibleVaultContentsIndexEntrySubstate")]
    ...
    public partial class CaNonFungibleVaultContentsIndexEntrySubstate : CaSubstate, IEquatable<CaNonFungibleVaultContentsIndexEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaNonFungibleVaultContentsIndexEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaNonFungibleVaultContentsIndexEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaNonFungibleVaultContentsIndexEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.NonFungibleVaultContentsIndexEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaNonFungibleVaultContentsIndexEntrySubstate(CaLocalNonFungibleKey key = default(CaLocalNonFungibleKey), CaNonFungibleVaultContentsIndexEntryValue value = default(CaNonFungibleVaultContentsIndexEntryValue), CaSubstateType substateType = CaSubstateType.NonFungibleVaultContentsIndexEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CaNonFungibleVaultContentsIndexEntrySubstate and cannot be null");
            }
            this.Key = key;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaNonFungibleVaultContentsIndexEntrySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaLocalNonFungibleKey Key { get; set; }

        /// <summary>
        /// Gets or Sets Value
        /// </summary>
        [DataMember(Name = "value", IsRequired = true, EmitDefaultValue = true)]
        public CaNonFungibleVaultContentsIndexEntryValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaNonFungibleVaultContentsIndexEntrySubstate {\n");
        ...
        {
            return this.Equals(input as CaNonFungibleVaultContentsIndexEntrySubstate);
        }

        /// <summary>
        /// Returns true if CaNonFungibleVaultContentsIndexEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaNonFungibleVaultContentsIndexEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaNonFungibleVaultContentsIndexEntrySubstate input)
        {
            if (input == null)
            {
                return false;
