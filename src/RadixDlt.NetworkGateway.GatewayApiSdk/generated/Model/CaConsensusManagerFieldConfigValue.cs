...
{
    /// <summary>
    /// CaConsensusManagerFieldConfigValue
    /// </summary>
    [DataContract(Name = "CaConsensusManagerFieldConfigValue")]
    public partial class CaConsensusManagerFieldConfigValue : IEquatable<CaConsensusManagerFieldConfigValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaConsensusManagerFieldConfigValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaConsensusManagerFieldConfigValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaConsensusManagerFieldConfigValue" /> class.
        /// </summary>
        ...
        public CaConsensusManagerFieldConfigValue(long maxValidators = default(long), CaEpochChangeCondition epochChangeCondition = default(CaEpochChangeCondition), long numUnstakeEpochs = default(long), string totalEmissionXrdPerEpoch = default(string), string minValidatorReliability = default(string), long numOwnerStakeUnitsUnlockEpochs = default(long), long numFeeIncreaseDelayEpochs = default(long), string validatorCreationUsdEquivalentCost = default(string), string validatorCreationXrdCost = default(string))
        {
            this.MaxValidators = maxValidators;
            // to ensure "epochChangeCondition" is required (not null)
            if (epochChangeCondition == null)
            {
                throw new ArgumentNullException("epochChangeCondition is a required property for CaConsensusManagerFieldConfigValue and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("totalEmissionXrdPerEpoch is a required property for CaConsensusManagerFieldConfigValue and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("minValidatorReliability is a required property for CaConsensusManagerFieldConfigValue and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("validatorCreationUsdEquivalentCost is a required property for CaConsensusManagerFieldConfigValue and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("validatorCreationXrdCost is a required property for CaConsensusManagerFieldConfigValue and cannot be null");
            }
        ...
        public CaEpochChangeCondition EpochChangeCondition { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaConsensusManagerFieldConfigValue {\n");
        ...
        {
            return this.Equals(input as CaConsensusManagerFieldConfigValue);
        }

        /// <summary>
        /// Returns true if CaConsensusManagerFieldConfigValue instances are equal
        /// </summary>
        /// <param name="input">Instance of CaConsensusManagerFieldConfigValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaConsensusManagerFieldConfigValue input)
        {
            if (input == null)
            {
                return false;
