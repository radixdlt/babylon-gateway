...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CaPartitionId
    /// </summary>
    [DataContract(Name = "CaPartitionId")]
    public partial class CaPartitionId : IEquatable<CaPartitionId>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPartitionId" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaPartitionId() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPartitionId" /> class.
        /// </summary>
        ...
        public CaPartitionId(CaEntityType entityType = default(CaEntityType), string entityAddress = default(string), CaEntityModule entityModule = default(CaEntityModule), CaPartitionKind partitionKind = default(CaPartitionKind), int partitionNumber = default(int))
        {
            this.EntityType = entityType;
            // to ensure "entityAddress" is required (not null)
            if (entityAddress == null)
            {
                throw new ArgumentNullException("entityAddress is a required property for CaPartitionId and cannot be null");
            }
        ...
        {
            return this.Equals(input as CaPartitionId);
        }

        /// <summary>
        /// Returns true if CaPartitionId instances are equal
        /// </summary>
        /// <param name="input">Instance of CaPartitionId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaPartitionId input)
        {
            if (input == null)
            {
                return false;
