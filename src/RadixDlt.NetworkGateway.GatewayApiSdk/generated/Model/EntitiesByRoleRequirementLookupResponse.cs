...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class EntitiesByRoleRequirementLookupResponse : IEquatable<EntitiesByRoleRequirementLookupResponse>
    {
        ...
        public EntitiesByRoleRequirementLookupResponse(EntitiesByRoleRequirementRequestRequirement requirement = default(EntitiesByRoleRequirementRequestRequirement), List<EntitiesByRoleRequirementItem> items = default(List<EntitiesByRoleRequirementItem>))
        {
            // to ensure "requirement" is required (not null)
            if (requirement == null)
            {
                throw new ArgumentNullException("requirement is a required property for EntitiesByRoleRequirementLookupResponse and cannot be null");
            }
