...
{
    /// <summary>
    /// If specified instructs Network Gateway to limit request processing up to the ledger state version lower than or equal to one of the following constraints. 
    /// </summary>
