...
{
    /// <summary>
    /// CaAccessControllerFieldStateSubstate
    /// </summary>
    [DataContract(Name = "CaAccessControllerFieldStateSubstate")]
    ...
    public partial class CaAccessControllerFieldStateSubstate : CaSubstate, IEquatable<CaAccessControllerFieldStateSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaAccessControllerFieldStateSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaAccessControllerFieldStateSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaAccessControllerFieldStateSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.AccessControllerFieldState).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaAccessControllerFieldStateSubstate(CaAccessControllerFieldStateValue value = default(CaAccessControllerFieldStateValue), CaSubstateType substateType = CaSubstateType.AccessControllerFieldState, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaAccessControllerFieldStateSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaAccessControllerFieldStateValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaAccessControllerFieldStateSubstate {\n");
        ...
        {
            return this.Equals(input as CaAccessControllerFieldStateSubstate);
        }

        /// <summary>
        /// Returns true if CaAccessControllerFieldStateSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaAccessControllerFieldStateSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaAccessControllerFieldStateSubstate input)
        {
            if (input == null)
            {
                return false;
