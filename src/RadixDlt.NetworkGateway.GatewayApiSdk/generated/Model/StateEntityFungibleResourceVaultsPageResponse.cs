...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class StateEntityFungibleResourceVaultsPageResponse
    {
        /// <summary>
        ...
        public StateEntityFungibleResourceVaultsPageResponse(LedgerState ledgerState = default(LedgerState), long? totalCount = default(long?), string nextCursor = default(string), List<FungibleResourcesCollectionItemVaultAggregatedVaultItem> items = default(List<FungibleResourcesCollectionItemVaultAggregatedVaultItem>), string address = default(string), string resourceAddress = default(string))
        {
