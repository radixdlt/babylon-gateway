...
{
    /// <summary>
    /// CoreApiObjectTypeInfoDetailsAllOf
    /// </summary>
    [DataContract(Name = "CoreApiObjectTypeInfoDetails_allOf")]
    public partial class CoreApiObjectTypeInfoDetailsAllOf : IEquatable<CoreApiObjectTypeInfoDetailsAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiObjectTypeInfoDetailsAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiObjectTypeInfoDetailsAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiObjectTypeInfoDetailsAllOf" /> class.
        /// </summary>
        ...
        public CoreApiObjectTypeInfoDetailsAllOf(List<CoreApiModuleVersion> moduleVersions = default(List<CoreApiModuleVersion>), CoreApiBlueprintInfo blueprintInfo = default(CoreApiBlueprintInfo), bool global = default(bool))
        {
            // to ensure "moduleVersions" is required (not null)
            if (moduleVersions == null)
            {
                throw new ArgumentNullException("moduleVersions is a required property for CoreApiObjectTypeInfoDetailsAllOf and cannot be null");
            }
            this.ModuleVersions = moduleVersions;
            // to ensure "blueprintInfo" is required (not null)
            if (blueprintInfo == null)
            {
                throw new ArgumentNullException("blueprintInfo is a required property for CoreApiObjectTypeInfoDetailsAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiObjectTypeInfoDetailsAllOf {\n");
        ...
        {
            return this.Equals(input as CoreApiObjectTypeInfoDetailsAllOf);
        }

        /// <summary>
        /// Returns true if CoreApiObjectTypeInfoDetailsAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiObjectTypeInfoDetailsAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiObjectTypeInfoDetailsAllOf input)
        {
            if (input == null)
            {
                return false;
