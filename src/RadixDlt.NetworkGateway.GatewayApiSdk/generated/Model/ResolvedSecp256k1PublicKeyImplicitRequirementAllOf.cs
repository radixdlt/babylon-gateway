...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class ResolvedSecp256k1PublicKeyImplicitRequirementAllOf : IEquatable<ResolvedSecp256k1PublicKeyImplicitRequirementAllOf>
    {
        ...
        protected ResolvedSecp256k1PublicKeyImplicitRequirementAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResolvedSecp256k1PublicKeyImplicitRequirementAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ResolvedSecp256k1PublicKeyImplicitRequirementAllOf);
        }

        /// <summary>
        /// Returns true if ResolvedSecp256k1PublicKeyImplicitRequirementAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ResolvedSecp256k1PublicKeyImplicitRequirementAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResolvedSecp256k1PublicKeyImplicitRequirementAllOf input)
        {
            if (input == null)
            {
                return false;
