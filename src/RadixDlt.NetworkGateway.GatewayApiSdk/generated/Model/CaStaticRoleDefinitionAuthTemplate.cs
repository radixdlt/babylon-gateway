...
{
    /// <summary>
    /// CaStaticRoleDefinitionAuthTemplate
    /// </summary>
    [DataContract(Name = "CaStaticRoleDefinitionAuthTemplate")]
    public partial class CaStaticRoleDefinitionAuthTemplate : IEquatable<CaStaticRoleDefinitionAuthTemplate>
    {
        ...
        public CaRoleSpecification RoleSpecification { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaStaticRoleDefinitionAuthTemplate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaStaticRoleDefinitionAuthTemplate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaStaticRoleDefinitionAuthTemplate" /> class.
        /// </summary>
        ...
        public CaStaticRoleDefinitionAuthTemplate(CaRoleSpecification roleSpecification = default(CaRoleSpecification), Dictionary<string, CaRoleDetails> roles = default(Dictionary<string, CaRoleDetails>), Dictionary<string, CaMethodAccessibility> methodAccessibilityMap = default(Dictionary<string, CaMethodAccessibility>))
        {
            ...
            {
                throw new ArgumentNullException("methodAccessibilityMap is a required property for CaStaticRoleDefinitionAuthTemplate and cannot be null");
            }
        ...
        public Dictionary<string, CaRoleDetails> Roles { get; set; }
        ...
        public Dictionary<string, CaMethodAccessibility> MethodAccessibilityMap { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaStaticRoleDefinitionAuthTemplate {\n");
        ...
        {
            return this.Equals(input as CaStaticRoleDefinitionAuthTemplate);
        }

        /// <summary>
        /// Returns true if CaStaticRoleDefinitionAuthTemplate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaStaticRoleDefinitionAuthTemplate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaStaticRoleDefinitionAuthTemplate input)
        {
            if (input == null)
            {
                return false;
