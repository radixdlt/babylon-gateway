...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiPaymentFromVault")]
    public partial class CoreApiPaymentFromVault : IEquatable<CoreApiPaymentFromVault>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiPaymentFromVault" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiPaymentFromVault() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiPaymentFromVault" /> class.
        /// </summary>
        ...
        public CoreApiPaymentFromVault(CoreApiEntityReference vaultEntity = default(CoreApiEntityReference), string xrdAmount = default(string))
        {
            // to ensure "vaultEntity" is required (not null)
            if (vaultEntity == null)
            {
                throw new ArgumentNullException("vaultEntity is a required property for CoreApiPaymentFromVault and cannot be null");
            }
            this.VaultEntity = vaultEntity;
            // to ensure "xrdAmount" is required (not null)
            if (xrdAmount == null)
            {
                throw new ArgumentNullException("xrdAmount is a required property for CoreApiPaymentFromVault and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiPaymentFromVault {\n");
        ...
        {
            return this.Equals(input as CoreApiPaymentFromVault);
        }

        /// <summary>
        /// Returns true if CoreApiPaymentFromVault instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiPaymentFromVault to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiPaymentFromVault input)
        {
            if (input == null)
            {
                return false;
