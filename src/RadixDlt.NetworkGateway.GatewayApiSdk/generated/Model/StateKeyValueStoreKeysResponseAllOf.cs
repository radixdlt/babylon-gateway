...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class StateKeyValueStoreKeysResponseAllOf : IEquatable<StateKeyValueStoreKeysResponseAllOf>
    {
        ...
        protected StateKeyValueStoreKeysResponseAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StateKeyValueStoreKeysResponseAllOf" /> class.
        /// </summary>
        ...
        public StateKeyValueStoreKeysResponseAllOf(string keyValueStoreAddress = default(string), StateKeyValueStoreKeysCollection entries = default(StateKeyValueStoreKeysCollection))
        {
            // to ensure "keyValueStoreAddress" is required (not null)
            if (keyValueStoreAddress == null)
            {
                throw new ArgumentNullException("keyValueStoreAddress is a required property for StateKeyValueStoreKeysResponseAllOf and cannot be null");
            }
            this.KeyValueStoreAddress = keyValueStoreAddress;
            // to ensure "entries" is required (not null)
            if (entries == null)
            {
                throw new ArgumentNullException("entries is a required property for StateKeyValueStoreKeysResponseAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StateKeyValueStoreKeysResponseAllOf {\n");
        ...
        {
            return this.Equals(input as StateKeyValueStoreKeysResponseAllOf);
        }

        /// <summary>
        /// Returns true if StateKeyValueStoreKeysResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of StateKeyValueStoreKeysResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StateKeyValueStoreKeysResponseAllOf input)
        {
            if (input == null)
            {
                return false;
