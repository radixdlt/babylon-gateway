...
{
    /// <summary>
    /// CaNonFungibleResourceManagerDataEntrySubstate
    /// </summary>
    [DataContract(Name = "CaNonFungibleResourceManagerDataEntrySubstate")]
    ...
    public partial class CaNonFungibleResourceManagerDataEntrySubstate : CaSubstate, IEquatable<CaNonFungibleResourceManagerDataEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaNonFungibleResourceManagerDataEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaNonFungibleResourceManagerDataEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaNonFungibleResourceManagerDataEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value.</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.NonFungibleResourceManagerDataEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaNonFungibleResourceManagerDataEntrySubstate(CaLocalNonFungibleKey key = default(CaLocalNonFungibleKey), CaNonFungibleResourceManagerDataEntryValue value = default(CaNonFungibleResourceManagerDataEntryValue), CaSubstateType substateType = CaSubstateType.NonFungibleResourceManagerDataEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CaNonFungibleResourceManagerDataEntrySubstate and cannot be null");
            }
            this.Key = key;
            this.Value = value;
        }
        ...
        public CaNonFungibleResourceManagerDataEntryValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaNonFungibleResourceManagerDataEntrySubstate {\n");
        ...
        {
            return this.Equals(input as CaNonFungibleResourceManagerDataEntrySubstate);
        }

        /// <summary>
        /// Returns true if CaNonFungibleResourceManagerDataEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaNonFungibleResourceManagerDataEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaNonFungibleResourceManagerDataEntrySubstate input)
        {
            if (input == null)
            {
                return false;
