...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CaTransactionReceipt")]
    public partial class CaTransactionReceipt : IEquatable<CaTransactionReceipt>
    {
        ...
        public CaTransactionStatus Status { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaTransactionReceipt" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaTransactionReceipt() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaTransactionReceipt" /> class.
        /// </summary>
        ...
        public CaTransactionReceipt(CaTransactionStatus status = default(CaTransactionStatus), CaFeeSummary feeSummary = default(CaFeeSummary), CaCostingParameters costingParameters = default(CaCostingParameters), CaFeeSource feeSource = default(CaFeeSource), CaFeeDestination feeDestination = default(CaFeeDestination), CaStateUpdates stateUpdates = default(CaStateUpdates), List<CaEvent> events = default(List<CaEvent>), CaNextEpoch nextEpoch = default(CaNextEpoch), List<CaSborData> output = default(List<CaSborData>), string errorMessage = default(string))
        {
            this.Status = status;
            // to ensure "feeSummary" is required (not null)
            if (feeSummary == null)
            {
                throw new ArgumentNullException("feeSummary is a required property for CaTransactionReceipt and cannot be null");
            }
            this.FeeSummary = feeSummary;
            // to ensure "costingParameters" is required (not null)
            if (costingParameters == null)
            {
                throw new ArgumentNullException("costingParameters is a required property for CaTransactionReceipt and cannot be null");
            }
            this.CostingParameters = costingParameters;
            // to ensure "stateUpdates" is required (not null)
            if (stateUpdates == null)
            {
                throw new ArgumentNullException("stateUpdates is a required property for CaTransactionReceipt and cannot be null");
            }
        ...
        public List<CaEvent> Events { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaTransactionReceipt {\n");
        ...
        {
            return this.Equals(input as CaTransactionReceipt);
        }

        /// <summary>
        /// Returns true if CaTransactionReceipt instances are equal
        /// </summary>
        /// <param name="input">Instance of CaTransactionReceipt to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaTransactionReceipt input)
        {
            if (input == null)
            {
                return false;
