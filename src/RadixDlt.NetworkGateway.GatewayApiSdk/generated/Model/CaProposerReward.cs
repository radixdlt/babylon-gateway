...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CaProposerReward
    /// </summary>
    [DataContract(Name = "CaProposerReward")]
    public partial class CaProposerReward : IEquatable<CaProposerReward>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaProposerReward" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaProposerReward() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaProposerReward" /> class.
        /// </summary>
        ...
        public CaProposerReward(CaActiveValidatorIndex validatorIndex = default(CaActiveValidatorIndex), string xrdAmount = default(string))
        {
            // to ensure "validatorIndex" is required (not null)
            if (validatorIndex == null)
            {
                throw new ArgumentNullException("validatorIndex is a required property for CaProposerReward and cannot be null");
            }
            this.ValidatorIndex = validatorIndex;
            // to ensure "xrdAmount" is required (not null)
            if (xrdAmount == null)
            {
                throw new ArgumentNullException("xrdAmount is a required property for CaProposerReward and cannot be null");
            }
        ...
        public CaActiveValidatorIndex ValidatorIndex { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaProposerReward {\n");
        ...
        {
            return this.Equals(input as CaProposerReward);
        }

        /// <summary>
        /// Returns true if CaProposerReward instances are equal
        /// </summary>
        /// <param name="input">Instance of CaProposerReward to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaProposerReward input)
        {
            if (input == null)
            {
                return false;
