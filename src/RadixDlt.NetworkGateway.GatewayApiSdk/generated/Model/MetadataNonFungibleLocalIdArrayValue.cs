...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MetadataNonFungibleLocalIdArrayValue")]
    ...
    public partial class MetadataNonFungibleLocalIdArrayValue : MetadataTypedValue, IEquatable<MetadataNonFungibleLocalIdArrayValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataNonFungibleLocalIdArrayValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataNonFungibleLocalIdArrayValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataNonFungibleLocalIdArrayValue" /> class.
        /// </summary>
        /// <param name="values">values (required).</param>
        /// <param name="type">type (required) (default to MetadataValueType.NonFungibleLocalIdArray).</param>
        public MetadataNonFungibleLocalIdArrayValue(List<string> values = default(List<string>), MetadataValueType type = MetadataValueType.NonFungibleLocalIdArray) : base(type)
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for MetadataNonFungibleLocalIdArrayValue and cannot be null");
            }
            this.Values = values;
        }
        ...
        {
            return this.Equals(input as MetadataNonFungibleLocalIdArrayValue);
        }

        /// <summary>
        /// Returns true if MetadataNonFungibleLocalIdArrayValue instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataNonFungibleLocalIdArrayValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataNonFungibleLocalIdArrayValue input)
        {
            if (input == null)
            {
                return false;
