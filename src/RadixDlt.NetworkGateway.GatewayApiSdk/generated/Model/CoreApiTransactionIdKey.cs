...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiTransactionIdKey")]
    public partial class CoreApiTransactionIdKey : IEquatable<CoreApiTransactionIdKey>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiTransactionIdKey" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiTransactionIdKey() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiTransactionIdKey" /> class.
        /// </summary>
        ...
        public CoreApiTransactionIdKey(string intentHash = default(string), string intentHashBech32m = default(string))
        {
            // to ensure "intentHash" is required (not null)
            if (intentHash == null)
            {
                throw new ArgumentNullException("intentHash is a required property for CoreApiTransactionIdKey and cannot be null");
            }
            this.IntentHash = intentHash;
            // to ensure "intentHashBech32m" is required (not null)
            if (intentHashBech32m == null)
            {
                throw new ArgumentNullException("intentHashBech32m is a required property for CoreApiTransactionIdKey and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiTransactionIdKey {\n");
        ...
        {
            return this.Equals(input as CoreApiTransactionIdKey);
        }

        /// <summary>
        /// Returns true if CoreApiTransactionIdKey instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiTransactionIdKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiTransactionIdKey input)
        {
            if (input == null)
            {
                return false;
