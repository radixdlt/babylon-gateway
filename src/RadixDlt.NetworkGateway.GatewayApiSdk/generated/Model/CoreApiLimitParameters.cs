...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiLimitParameters")]
    public partial class CoreApiLimitParameters : IEquatable<CoreApiLimitParameters>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiLimitParameters" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiLimitParameters() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiLimitParameters" /> class.
        /// </summary>
        ...
        public CoreApiLimitParameters(string maxCallDepth = default(string), string maxHeapSubstateTotalBytes = default(string), string maxTrackSubstateTotalBytes = default(string), string maxSubstateKeySize = default(string), string maxSubstateValueSize = default(string), string maxInvokeInputSize = default(string), string maxEventSize = default(string), string maxLogSize = default(string), string maxPanicMessageSize = default(string), string maxNumberOfLogs = default(string), string maxNumberOfEvents = default(string))
        {
            ...
            {
                throw new ArgumentNullException("maxTrackSubstateTotalBytes is a required property for CoreApiLimitParameters and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("maxSubstateKeySize is a required property for CoreApiLimitParameters and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("maxSubstateValueSize is a required property for CoreApiLimitParameters and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("maxInvokeInputSize is a required property for CoreApiLimitParameters and cannot be null");
            }
            this.MaxInvokeInputSize = maxInvokeInputSize;
            // to ensure "maxEventSize" is required (not null)
            if (maxEventSize == null)
            {
                throw new ArgumentNullException("maxEventSize is a required property for CoreApiLimitParameters and cannot be null");
            }
            this.MaxEventSize = maxEventSize;
            // to ensure "maxLogSize" is required (not null)
            if (maxLogSize == null)
            {
                throw new ArgumentNullException("maxLogSize is a required property for CoreApiLimitParameters and cannot be null");
            }
            this.MaxLogSize = maxLogSize;
            // to ensure "maxPanicMessageSize" is required (not null)
            if (maxPanicMessageSize == null)
            {
                throw new ArgumentNullException("maxPanicMessageSize is a required property for CoreApiLimitParameters and cannot be null");
            }
            this.MaxPanicMessageSize = maxPanicMessageSize;
            // to ensure "maxNumberOfLogs" is required (not null)
            if (maxNumberOfLogs == null)
            {
                throw new ArgumentNullException("maxNumberOfLogs is a required property for CoreApiLimitParameters and cannot be null");
            }
            this.MaxNumberOfLogs = maxNumberOfLogs;
            // to ensure "maxNumberOfEvents" is required (not null)
            if (maxNumberOfEvents == null)
            {
                throw new ArgumentNullException("maxNumberOfEvents is a required property for CoreApiLimitParameters and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiLimitParameters {\n");
        ...
        {
            return this.Equals(input as CoreApiLimitParameters);
        }

        /// <summary>
        /// Returns true if CoreApiLimitParameters instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiLimitParameters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiLimitParameters input)
        {
            if (input == null)
            {
                return false;
