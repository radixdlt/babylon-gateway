...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class EventsItem : IEquatable<EventsItem>
    {
        ...
        /// <param name="emitter">This type is defined in Core API as &#x60;EventEmitterIdentifier&#x60;. See Core API documentation for more details.  (required).</param>
        ...
        public EventsItem(string name = default(string), Object emitter = default(Object), ProgrammaticScryptoSborValue data = default(ProgrammaticScryptoSborValue))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for EventsItem and cannot be null");
            }
            this.Name = name;
            // to ensure "emitter" is required (not null)
            if (emitter == null)
            {
                throw new ArgumentNullException("emitter is a required property for EventsItem and cannot be null");
            }
            this.Emitter = emitter;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for EventsItem and cannot be null");
            }
            this.Data = data;
        }
        ...
        /// </summary>
        /// <value>This type is defined in Core API as &#x60;EventEmitterIdentifier&#x60;. See Core API documentation for more details. </value>
        ...
        public ProgrammaticScryptoSborValue Data { get; set; }
        ...
        {
            return this.Equals(input as EventsItem);
        }

        /// <summary>
        /// Returns true if EventsItem instances are equal
        /// </summary>
        /// <param name="input">Instance of EventsItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventsItem input)
        {
            if (input == null)
            {
                return false;
