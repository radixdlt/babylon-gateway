...
{
    /// <summary>
    /// CaSortedSubstateKeyAllOf
    /// </summary>
    [DataContract(Name = "CaSortedSubstateKey_allOf")]
    public partial class CaSortedSubstateKeyAllOf : IEquatable<CaSortedSubstateKeyAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaSortedSubstateKeyAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaSortedSubstateKeyAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaSortedSubstateKeyAllOf" /> class.
        /// </summary>
        ...
        public CaSortedSubstateKeyAllOf(string sortPrefixHex = default(string), string keyHex = default(string))
        {
            // to ensure "sortPrefixHex" is required (not null)
            if (sortPrefixHex == null)
            {
                throw new ArgumentNullException("sortPrefixHex is a required property for CaSortedSubstateKeyAllOf and cannot be null");
            }
            this.SortPrefixHex = sortPrefixHex;
            // to ensure "keyHex" is required (not null)
            if (keyHex == null)
            {
                throw new ArgumentNullException("keyHex is a required property for CaSortedSubstateKeyAllOf and cannot be null");
            }
            this.KeyHex = keyHex;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaSortedSubstateKeyAllOf {\n");
        ...
        {
            return this.Equals(input as CaSortedSubstateKeyAllOf);
        }

        /// <summary>
        /// Returns true if CaSortedSubstateKeyAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CaSortedSubstateKeyAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaSortedSubstateKeyAllOf input)
        {
            if (input == null)
            {
                return false;
