...
{
    /// <summary>
    /// ResolvedPackageOfDirectCallerImplicitRequirementAllOf
    /// </summary>
    [DataContract(Name = "ResolvedPackageOfDirectCallerImplicitRequirement_allOf")]
    public partial class ResolvedPackageOfDirectCallerImplicitRequirementAllOf : IEquatable<ResolvedPackageOfDirectCallerImplicitRequirementAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResolvedPackageOfDirectCallerImplicitRequirementAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResolvedPackageOfDirectCallerImplicitRequirementAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResolvedPackageOfDirectCallerImplicitRequirementAllOf" /> class.
        /// </summary>
        ...
        public ResolvedPackageOfDirectCallerImplicitRequirementAllOf(long firstSeenStateVersion = default(long), string packageAddress = default(string))
        {
            ...
            {
                throw new ArgumentNullException("packageAddress is a required property for ResolvedPackageOfDirectCallerImplicitRequirementAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as ResolvedPackageOfDirectCallerImplicitRequirementAllOf);
        }

        /// <summary>
        /// Returns true if ResolvedPackageOfDirectCallerImplicitRequirementAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ResolvedPackageOfDirectCallerImplicitRequirementAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResolvedPackageOfDirectCallerImplicitRequirementAllOf input)
        {
            if (input == null)
            {
                return false;
