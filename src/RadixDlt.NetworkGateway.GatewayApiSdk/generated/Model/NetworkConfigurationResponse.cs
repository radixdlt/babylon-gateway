...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class NetworkConfigurationResponse
    {
        ...
        /// <param name="networkName">The logical name of the network (required).</param>
        /// <param name="wellKnownAddresses">wellKnownAddresses (required).</param>
        public NetworkConfigurationResponse(int networkId = default(int), string networkName = default(string), NetworkConfigurationResponseWellKnownAddresses wellKnownAddresses = default(NetworkConfigurationResponseWellKnownAddresses))
        {
            this.NetworkId = networkId;
            // to ensure "networkName" is required (not null)
            if (networkName == null)
            {
                throw new ArgumentNullException("networkName is a required property for NetworkConfigurationResponse and cannot be null");
            }
        ...
        [DataMember(Name = "network_name", IsRequired = true, EmitDefaultValue = true)]
