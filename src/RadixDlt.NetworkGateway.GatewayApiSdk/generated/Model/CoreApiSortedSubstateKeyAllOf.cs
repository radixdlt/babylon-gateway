...
{
    /// <summary>
    /// CoreApiSortedSubstateKeyAllOf
    /// </summary>
    [DataContract(Name = "CoreApiSortedSubstateKey_allOf")]
    public partial class CoreApiSortedSubstateKeyAllOf : IEquatable<CoreApiSortedSubstateKeyAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiSortedSubstateKeyAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiSortedSubstateKeyAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiSortedSubstateKeyAllOf" /> class.
        /// </summary>
        ...
        public CoreApiSortedSubstateKeyAllOf(string sortPrefixHex = default(string), string keyHex = default(string))
        {
            // to ensure "sortPrefixHex" is required (not null)
            if (sortPrefixHex == null)
            {
                throw new ArgumentNullException("sortPrefixHex is a required property for CoreApiSortedSubstateKeyAllOf and cannot be null");
            }
            this.SortPrefixHex = sortPrefixHex;
            // to ensure "keyHex" is required (not null)
            if (keyHex == null)
            {
                throw new ArgumentNullException("keyHex is a required property for CoreApiSortedSubstateKeyAllOf and cannot be null");
            }
            this.KeyHex = keyHex;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiSortedSubstateKeyAllOf {\n");
        ...
        {
            return this.Equals(input as CoreApiSortedSubstateKeyAllOf);
        }

        /// <summary>
        /// Returns true if CoreApiSortedSubstateKeyAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiSortedSubstateKeyAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiSortedSubstateKeyAllOf input)
        {
            if (input == null)
            {
                return false;
