...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CaSubstateValue
    /// </summary>
    [DataContract(Name = "CaSubstateValue")]
    public partial class CaSubstateValue : IEquatable<CaSubstateValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaSubstateValue" /> class.
        /// </summary>
        ...
        public CaSubstateValue(string substateHex = default(string), string substateDataHash = default(string), CaSubstate substateData = default(CaSubstate))
        {
        ...
        public CaSubstate SubstateData { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaSubstateValue {\n");
        ...
        {
            return this.Equals(input as CaSubstateValue);
        }

        /// <summary>
        /// Returns true if CaSubstateValue instances are equal
        /// </summary>
        /// <param name="input">Instance of CaSubstateValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaSubstateValue input)
        {
            if (input == null)
            {
                return false;
