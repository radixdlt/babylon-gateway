...
{
    /// <summary>
    /// CaSchemaEntrySubstate
    /// </summary>
    [DataContract(Name = "CaSchemaEntrySubstate")]
    ...
    public partial class CaSchemaEntrySubstate : CaSubstate, IEquatable<CaSchemaEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaSchemaEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaSchemaEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaSchemaEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.SchemaEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaSchemaEntrySubstate(CaSchemaKey key = default(CaSchemaKey), CaSchemaEntryValue value = default(CaSchemaEntryValue), CaSubstateType substateType = CaSubstateType.SchemaEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CaSchemaEntrySubstate and cannot be null");
            }
            this.Key = key;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaSchemaEntrySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaSchemaKey Key { get; set; }

        /// <summary>
        /// Gets or Sets Value
        /// </summary>
        [DataMember(Name = "value", IsRequired = true, EmitDefaultValue = true)]
        public CaSchemaEntryValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaSchemaEntrySubstate {\n");
        ...
        {
            return this.Equals(input as CaSchemaEntrySubstate);
        }

        /// <summary>
        /// Returns true if CaSchemaEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaSchemaEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaSchemaEntrySubstate input)
        {
            if (input == null)
            {
                return false;
