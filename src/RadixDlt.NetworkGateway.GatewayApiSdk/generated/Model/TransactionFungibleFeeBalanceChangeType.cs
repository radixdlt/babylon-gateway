...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public enum TransactionFungibleFeeBalanceChangeType
    {
        ...
        /// <summary>
        /// Enum FeeDistributed for value: FeeDistributed
        /// </summary>
        [EnumMember(Value = "FeeDistributed")]
        FeeDistributed = 2,

        /// <summary>
        /// Enum TipDistributed for value: TipDistributed
        /// </summary>
        [EnumMember(Value = "TipDistributed")]
        TipDistributed = 3,

        /// <summary>
        /// Enum RoyaltyDistributed for value: RoyaltyDistributed
        /// </summary>
        [EnumMember(Value = "RoyaltyDistributed")]
        RoyaltyDistributed = 4
