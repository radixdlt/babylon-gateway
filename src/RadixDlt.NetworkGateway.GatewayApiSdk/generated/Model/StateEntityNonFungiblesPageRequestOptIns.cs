...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StateEntityNonFungiblesPageRequestOptIns")]
    public partial class StateEntityNonFungiblesPageRequestOptIns : IEquatable<StateEntityNonFungiblesPageRequestOptIns>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>allows specifying explicitly metadata properties which should be returned in response, limited to max 20 items.</value>
        ...
        {
            return this.Equals(input as StateEntityNonFungiblesPageRequestOptIns);
        }

        /// <summary>
        /// Returns true if StateEntityNonFungiblesPageRequestOptIns instances are equal
        /// </summary>
        /// <param name="input">Instance of StateEntityNonFungiblesPageRequestOptIns to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StateEntityNonFungiblesPageRequestOptIns input)
        {
            if (input == null)
            {
                return false;
