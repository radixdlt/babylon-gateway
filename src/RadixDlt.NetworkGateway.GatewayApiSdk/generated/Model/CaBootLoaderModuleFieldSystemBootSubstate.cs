...
{
    /// <summary>
    /// CaBootLoaderModuleFieldSystemBootSubstate
    /// </summary>
    [DataContract(Name = "CaBootLoaderModuleFieldSystemBootSubstate")]
    ...
    public partial class CaBootLoaderModuleFieldSystemBootSubstate : CaSubstate, IEquatable<CaBootLoaderModuleFieldSystemBootSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaBootLoaderModuleFieldSystemBootSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaBootLoaderModuleFieldSystemBootSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaBootLoaderModuleFieldSystemBootSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.BootLoaderModuleFieldSystemBoot).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaBootLoaderModuleFieldSystemBootSubstate(CaBootLoaderModuleFieldSystemBootValue value = default(CaBootLoaderModuleFieldSystemBootValue), CaSubstateType substateType = CaSubstateType.BootLoaderModuleFieldSystemBoot, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaBootLoaderModuleFieldSystemBootSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaBootLoaderModuleFieldSystemBootValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaBootLoaderModuleFieldSystemBootSubstate {\n");
        ...
        {
            return this.Equals(input as CaBootLoaderModuleFieldSystemBootSubstate);
        }

        /// <summary>
        /// Returns true if CaBootLoaderModuleFieldSystemBootSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaBootLoaderModuleFieldSystemBootSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaBootLoaderModuleFieldSystemBootSubstate input)
        {
            if (input == null)
            {
                return false;
