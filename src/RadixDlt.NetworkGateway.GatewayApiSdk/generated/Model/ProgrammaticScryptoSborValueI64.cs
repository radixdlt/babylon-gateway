...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class ProgrammaticScryptoSborValueI64 : ProgrammaticScryptoSborValue, IEquatable<ProgrammaticScryptoSborValueI64>
    {
        ...
        /// <param name="kind">kind (required) (default to ProgrammaticScryptoSborValueKind.I64).</param>
        ...
        public ProgrammaticScryptoSborValueI64(string value = default(string), ProgrammaticScryptoSborValueKind kind = ProgrammaticScryptoSborValueKind.I64, string typeName = default(string), string fieldName = default(string)) : base(kind, typeName, fieldName)
        {
