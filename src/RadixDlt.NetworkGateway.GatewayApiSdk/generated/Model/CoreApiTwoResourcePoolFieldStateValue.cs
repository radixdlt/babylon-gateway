...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiTwoResourcePoolFieldStateValue")]
    public partial class CoreApiTwoResourcePoolFieldStateValue : IEquatable<CoreApiTwoResourcePoolFieldStateValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiTwoResourcePoolFieldStateValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiTwoResourcePoolFieldStateValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiTwoResourcePoolFieldStateValue" /> class.
        /// </summary>
        ...
        public CoreApiTwoResourcePoolFieldStateValue(List<CoreApiPoolVault> vaults = default(List<CoreApiPoolVault>), string poolUnitResourceAddress = default(string))
        {
            // to ensure "vaults" is required (not null)
            if (vaults == null)
            {
                throw new ArgumentNullException("vaults is a required property for CoreApiTwoResourcePoolFieldStateValue and cannot be null");
            }
            this.Vaults = vaults;
            // to ensure "poolUnitResourceAddress" is required (not null)
            if (poolUnitResourceAddress == null)
            {
                throw new ArgumentNullException("poolUnitResourceAddress is a required property for CoreApiTwoResourcePoolFieldStateValue and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiTwoResourcePoolFieldStateValue {\n");
        ...
        {
            return this.Equals(input as CoreApiTwoResourcePoolFieldStateValue);
        }

        /// <summary>
        /// Returns true if CoreApiTwoResourcePoolFieldStateValue instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiTwoResourcePoolFieldStateValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiTwoResourcePoolFieldStateValue input)
        {
            if (input == null)
            {
                return false;
