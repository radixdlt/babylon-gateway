...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NativeResourceTwoResourcePoolUnitValue")]
    ...
    public partial class NativeResourceTwoResourcePoolUnitValue : NativeResourceDetails, IEquatable<NativeResourceTwoResourcePoolUnitValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceTwoResourcePoolUnitValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NativeResourceTwoResourcePoolUnitValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceTwoResourcePoolUnitValue" /> class.
        /// </summary>
        ...
        /// <param name="kind">kind (required) (default to NativeResourceKind.TwoResourcePoolUnit).</param>
        public NativeResourceTwoResourcePoolUnitValue(string poolAddress = default(string), int redemptionResourceCount = default(int), List<NativeResourceRedemptionValueItem> unitRedemptionValue = default(List<NativeResourceRedemptionValueItem>), NativeResourceKind kind = NativeResourceKind.TwoResourcePoolUnit) : base(kind)
        {
            // to ensure "poolAddress" is required (not null)
            if (poolAddress == null)
            {
                throw new ArgumentNullException("poolAddress is a required property for NativeResourceTwoResourcePoolUnitValue and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("unitRedemptionValue is a required property for NativeResourceTwoResourcePoolUnitValue and cannot be null");
            }
        ...
        {
            return this.Equals(input as NativeResourceTwoResourcePoolUnitValue);
        }

        /// <summary>
        /// Returns true if NativeResourceTwoResourcePoolUnitValue instances are equal
        /// </summary>
        /// <param name="input">Instance of NativeResourceTwoResourcePoolUnitValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NativeResourceTwoResourcePoolUnitValue input)
        {
            if (input == null)
            {
                return false;
