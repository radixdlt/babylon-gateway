...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProgrammaticScryptoSborValueTuple")]
    ...
    public partial class ProgrammaticScryptoSborValueTuple : ProgrammaticScryptoSborValue, IEquatable<ProgrammaticScryptoSborValueTuple>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgrammaticScryptoSborValueTuple" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProgrammaticScryptoSborValueTuple() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgrammaticScryptoSborValueTuple" /> class.
        /// </summary>
        /// <param name="fields">fields (required).</param>
        /// <param name="kind">kind (required) (default to ProgrammaticScryptoSborValueTypeKind.Tuple).</param>
        /// <param name="typeName">TBD.</param>
        /// <param name="fieldName">TBD.</param>
        public ProgrammaticScryptoSborValueTuple(List<ProgrammaticScryptoSborValue> fields = default(List<ProgrammaticScryptoSborValue>), ProgrammaticScryptoSborValueTypeKind kind = ProgrammaticScryptoSborValueTypeKind.Tuple, string typeName = default(string), string fieldName = default(string)) : base(kind, typeName, fieldName)
        {
            // to ensure "fields" is required (not null)
            if (fields == null)
            {
                throw new ArgumentNullException("fields is a required property for ProgrammaticScryptoSborValueTuple and cannot be null");
            }
            this.Fields = fields;
        }
        ...
        {
            return this.Equals(input as ProgrammaticScryptoSborValueTuple);
        }

        /// <summary>
        /// Returns true if ProgrammaticScryptoSborValueTuple instances are equal
        /// </summary>
        /// <param name="input">Instance of ProgrammaticScryptoSborValueTuple to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProgrammaticScryptoSborValueTuple input)
        {
            if (input == null)
            {
                return false;
