...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiTransactionTrackerFieldStateValue")]
    public partial class CoreApiTransactionTrackerFieldStateValue : IEquatable<CoreApiTransactionTrackerFieldStateValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiTransactionTrackerFieldStateValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiTransactionTrackerFieldStateValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiTransactionTrackerFieldStateValue" /> class.
        /// </summary>
        ...
        public CoreApiTransactionTrackerFieldStateValue(long startEpoch = default(long), int startPartition = default(int), int partitionRangeStartInclusive = default(int), int partitionRangeEndInclusive = default(int), long epochsPerPartition = default(long))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiTransactionTrackerFieldStateValue {\n");
        ...
        {
            return this.Equals(input as CoreApiTransactionTrackerFieldStateValue);
        }

        /// <summary>
        /// Returns true if CoreApiTransactionTrackerFieldStateValue instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiTransactionTrackerFieldStateValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiTransactionTrackerFieldStateValue input)
        {
            if (input == null)
            {
                return false;
