...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CaPaymentFromVault
    /// </summary>
    [DataContract(Name = "CaPaymentFromVault")]
    public partial class CaPaymentFromVault : IEquatable<CaPaymentFromVault>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPaymentFromVault" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaPaymentFromVault() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPaymentFromVault" /> class.
        /// </summary>
        ...
        public CaPaymentFromVault(CaEntityReference vaultEntity = default(CaEntityReference), string xrdAmount = default(string))
        {
            // to ensure "vaultEntity" is required (not null)
            if (vaultEntity == null)
            {
                throw new ArgumentNullException("vaultEntity is a required property for CaPaymentFromVault and cannot be null");
            }
            this.VaultEntity = vaultEntity;
            // to ensure "xrdAmount" is required (not null)
            if (xrdAmount == null)
            {
                throw new ArgumentNullException("xrdAmount is a required property for CaPaymentFromVault and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaPaymentFromVault {\n");
        ...
        {
            return this.Equals(input as CaPaymentFromVault);
        }

        /// <summary>
        /// Returns true if CaPaymentFromVault instances are equal
        /// </summary>
        /// <param name="input">Instance of CaPaymentFromVault to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaPaymentFromVault input)
        {
            if (input == null)
            {
                return false;
