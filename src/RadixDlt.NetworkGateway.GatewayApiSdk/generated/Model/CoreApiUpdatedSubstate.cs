...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiUpdatedSubstate")]
    public partial class CoreApiUpdatedSubstate : IEquatable<CoreApiUpdatedSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiUpdatedSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiUpdatedSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiUpdatedSubstate" /> class.
        /// </summary>
        ...
        public CoreApiUpdatedSubstate(CoreApiSubstateId substateId = default(CoreApiSubstateId), CoreApiSubstateValue newValue = default(CoreApiSubstateValue), CoreApiSubstateValue previousValue = default(CoreApiSubstateValue), CoreApiSubstateSystemStructure systemStructure = default(CoreApiSubstateSystemStructure))
        {
            // to ensure "substateId" is required (not null)
            if (substateId == null)
            {
                throw new ArgumentNullException("substateId is a required property for CoreApiUpdatedSubstate and cannot be null");
            }
            this.SubstateId = substateId;
            // to ensure "newValue" is required (not null)
            if (newValue == null)
            {
                throw new ArgumentNullException("newValue is a required property for CoreApiUpdatedSubstate and cannot be null");
            }
            this.NewValue = newValue;
            // to ensure "systemStructure" is required (not null)
            if (systemStructure == null)
            {
                throw new ArgumentNullException("systemStructure is a required property for CoreApiUpdatedSubstate and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiUpdatedSubstate {\n");
        ...
        {
            return this.Equals(input as CoreApiUpdatedSubstate);
        }

        /// <summary>
        /// Returns true if CoreApiUpdatedSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiUpdatedSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiUpdatedSubstate input)
        {
            if (input == null)
            {
                return false;
