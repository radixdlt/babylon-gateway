...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class StateEntityDetailsResponseNonFungibleVaultDetails : StateEntityDetailsResponseItemDetails
    {
        /// <summary>
        ...
        public StateEntityDetailsResponseNonFungibleVaultDetails(string resourceAddress = default(string), NonFungibleResourcesCollectionItemVaultAggregatedVaultItem balance = default(NonFungibleResourcesCollectionItemVaultAggregatedVaultItem), StateEntityDetailsResponseItemDetailsType type = StateEntityDetailsResponseItemDetailsType.NonFungibleVault) : base(type)
        {
            // to ensure "resourceAddress" is required (not null)
            if (resourceAddress == null)
            {
                throw new ArgumentNullException("resourceAddress is a required property for StateEntityDetailsResponseNonFungibleVaultDetails and cannot be null");
            }
