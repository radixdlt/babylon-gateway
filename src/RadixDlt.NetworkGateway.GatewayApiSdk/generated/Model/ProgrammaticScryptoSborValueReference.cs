...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class ProgrammaticScryptoSborValueReference : ProgrammaticScryptoSborValue, IEquatable<ProgrammaticScryptoSborValueReference>
    {
        ...
        /// <param name="kind">kind (required) (default to ProgrammaticScryptoSborValueTypeKind.Reference).</param>
        /// <param name="typeName">TBD.</param>
        /// <param name="fieldName">TBD.</param>
        public ProgrammaticScryptoSborValueReference(string value = default(string), ProgrammaticScryptoSborValueTypeKind kind = ProgrammaticScryptoSborValueTypeKind.Reference, string typeName = default(string), string fieldName = default(string)) : base(kind, typeName, fieldName)
        {
