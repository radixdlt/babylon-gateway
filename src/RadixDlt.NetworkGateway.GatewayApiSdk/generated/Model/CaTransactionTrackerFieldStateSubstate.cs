...
{
    /// <summary>
    /// CaTransactionTrackerFieldStateSubstate
    /// </summary>
    [DataContract(Name = "CaTransactionTrackerFieldStateSubstate")]
    ...
    public partial class CaTransactionTrackerFieldStateSubstate : CaSubstate, IEquatable<CaTransactionTrackerFieldStateSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaTransactionTrackerFieldStateSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaTransactionTrackerFieldStateSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaTransactionTrackerFieldStateSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.TransactionTrackerFieldState).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaTransactionTrackerFieldStateSubstate(CaTransactionTrackerFieldStateValue value = default(CaTransactionTrackerFieldStateValue), CaSubstateType substateType = CaSubstateType.TransactionTrackerFieldState, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaTransactionTrackerFieldStateSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaTransactionTrackerFieldStateValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaTransactionTrackerFieldStateSubstate {\n");
        ...
        {
            return this.Equals(input as CaTransactionTrackerFieldStateSubstate);
        }

        /// <summary>
        /// Returns true if CaTransactionTrackerFieldStateSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaTransactionTrackerFieldStateSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaTransactionTrackerFieldStateSubstate input)
        {
            if (input == null)
            {
                return false;
