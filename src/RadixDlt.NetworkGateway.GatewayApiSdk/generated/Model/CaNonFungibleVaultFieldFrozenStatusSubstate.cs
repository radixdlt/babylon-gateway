...
{
    /// <summary>
    /// CaNonFungibleVaultFieldFrozenStatusSubstate
    /// </summary>
    [DataContract(Name = "CaNonFungibleVaultFieldFrozenStatusSubstate")]
    ...
    public partial class CaNonFungibleVaultFieldFrozenStatusSubstate : CaSubstate, IEquatable<CaNonFungibleVaultFieldFrozenStatusSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaNonFungibleVaultFieldFrozenStatusSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaNonFungibleVaultFieldFrozenStatusSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaNonFungibleVaultFieldFrozenStatusSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.NonFungibleVaultFieldFrozenStatus).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaNonFungibleVaultFieldFrozenStatusSubstate(CaNonFungibleVaultFieldFrozenStatusValue value = default(CaNonFungibleVaultFieldFrozenStatusValue), CaSubstateType substateType = CaSubstateType.NonFungibleVaultFieldFrozenStatus, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaNonFungibleVaultFieldFrozenStatusSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaNonFungibleVaultFieldFrozenStatusValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaNonFungibleVaultFieldFrozenStatusSubstate {\n");
        ...
        {
            return this.Equals(input as CaNonFungibleVaultFieldFrozenStatusSubstate);
        }

        /// <summary>
        /// Returns true if CaNonFungibleVaultFieldFrozenStatusSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaNonFungibleVaultFieldFrozenStatusSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaNonFungibleVaultFieldFrozenStatusSubstate input)
        {
            if (input == null)
            {
                return false;
