...
{
    /// <summary>
    /// CaTransactionTrackerCollectionEntrySubstate
    /// </summary>
    [DataContract(Name = "CaTransactionTrackerCollectionEntrySubstate")]
    ...
    public partial class CaTransactionTrackerCollectionEntrySubstate : CaSubstate, IEquatable<CaTransactionTrackerCollectionEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaTransactionTrackerCollectionEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaTransactionTrackerCollectionEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaTransactionTrackerCollectionEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.TransactionTrackerCollectionEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaTransactionTrackerCollectionEntrySubstate(CaTransactionIdKey key = default(CaTransactionIdKey), CaTransactionTrackerCollectionEntryValue value = default(CaTransactionTrackerCollectionEntryValue), CaSubstateType substateType = CaSubstateType.TransactionTrackerCollectionEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CaTransactionTrackerCollectionEntrySubstate and cannot be null");
            }
            this.Key = key;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaTransactionTrackerCollectionEntrySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaTransactionIdKey Key { get; set; }

        /// <summary>
        /// Gets or Sets Value
        /// </summary>
        [DataMember(Name = "value", IsRequired = true, EmitDefaultValue = true)]
        public CaTransactionTrackerCollectionEntryValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaTransactionTrackerCollectionEntrySubstate {\n");
        ...
        {
            return this.Equals(input as CaTransactionTrackerCollectionEntrySubstate);
        }

        /// <summary>
        /// Returns true if CaTransactionTrackerCollectionEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaTransactionTrackerCollectionEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaTransactionTrackerCollectionEntrySubstate input)
        {
            if (input == null)
            {
                return false;
