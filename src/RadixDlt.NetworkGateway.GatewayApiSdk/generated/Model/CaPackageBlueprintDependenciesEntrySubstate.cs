...
{
    /// <summary>
    /// CaPackageBlueprintDependenciesEntrySubstate
    /// </summary>
    [DataContract(Name = "CaPackageBlueprintDependenciesEntrySubstate")]
    ...
    public partial class CaPackageBlueprintDependenciesEntrySubstate : CaSubstate, IEquatable<CaPackageBlueprintDependenciesEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPackageBlueprintDependenciesEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaPackageBlueprintDependenciesEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPackageBlueprintDependenciesEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.PackageBlueprintDependenciesEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaPackageBlueprintDependenciesEntrySubstate(CaBlueprintVersionKey key = default(CaBlueprintVersionKey), CaPackageBlueprintDependenciesEntryValue value = default(CaPackageBlueprintDependenciesEntryValue), CaSubstateType substateType = CaSubstateType.PackageBlueprintDependenciesEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CaPackageBlueprintDependenciesEntrySubstate and cannot be null");
            }
            this.Key = key;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaPackageBlueprintDependenciesEntrySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaPackageBlueprintDependenciesEntryValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaPackageBlueprintDependenciesEntrySubstate {\n");
        ...
        {
            return this.Equals(input as CaPackageBlueprintDependenciesEntrySubstate);
        }

        /// <summary>
        /// Returns true if CaPackageBlueprintDependenciesEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaPackageBlueprintDependenciesEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaPackageBlueprintDependenciesEntrySubstate input)
        {
            if (input == null)
            {
                return false;
