...
{
    /// <summary>
    /// CaEncryptedMessageDecryptor
    /// </summary>
    [DataContract(Name = "CaEncryptedMessageDecryptor")]
    public partial class CaEncryptedMessageDecryptor : IEquatable<CaEncryptedMessageDecryptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaEncryptedMessageDecryptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaEncryptedMessageDecryptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaEncryptedMessageDecryptor" /> class.
        /// </summary>
        ...
        public CaEncryptedMessageDecryptor(string publicKeyFingerprintHex = default(string), string aesWrappedKeyHex = default(string))
        {
            // to ensure "publicKeyFingerprintHex" is required (not null)
            if (publicKeyFingerprintHex == null)
            {
                throw new ArgumentNullException("publicKeyFingerprintHex is a required property for CaEncryptedMessageDecryptor and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("aesWrappedKeyHex is a required property for CaEncryptedMessageDecryptor and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaEncryptedMessageDecryptor {\n");
        ...
        {
            return this.Equals(input as CaEncryptedMessageDecryptor);
        }

        /// <summary>
        /// Returns true if CaEncryptedMessageDecryptor instances are equal
        /// </summary>
        /// <param name="input">Instance of CaEncryptedMessageDecryptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaEncryptedMessageDecryptor input)
        {
            if (input == null)
            {
                return false;
