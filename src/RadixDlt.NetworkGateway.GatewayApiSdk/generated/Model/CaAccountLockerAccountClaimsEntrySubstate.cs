...
{
    /// <summary>
    /// CaAccountLockerAccountClaimsEntrySubstate
    /// </summary>
    [DataContract(Name = "CaAccountLockerAccountClaimsEntrySubstate")]
    ...
    public partial class CaAccountLockerAccountClaimsEntrySubstate : CaSubstate, IEquatable<CaAccountLockerAccountClaimsEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaAccountLockerAccountClaimsEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaAccountLockerAccountClaimsEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaAccountLockerAccountClaimsEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.AccountLockerAccountClaimsEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaAccountLockerAccountClaimsEntrySubstate(CaAccountAddressKey key = default(CaAccountAddressKey), CaAccountLockerAccountClaimsEntryValue value = default(CaAccountLockerAccountClaimsEntryValue), CaSubstateType substateType = CaSubstateType.AccountLockerAccountClaimsEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CaAccountLockerAccountClaimsEntrySubstate and cannot be null");
            }
            this.Key = key;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaAccountLockerAccountClaimsEntrySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaAccountAddressKey Key { get; set; }

        /// <summary>
        /// Gets or Sets Value
        /// </summary>
        [DataMember(Name = "value", IsRequired = true, EmitDefaultValue = true)]
        public CaAccountLockerAccountClaimsEntryValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaAccountLockerAccountClaimsEntrySubstate {\n");
        ...
        {
            return this.Equals(input as CaAccountLockerAccountClaimsEntrySubstate);
        }

        /// <summary>
        /// Returns true if CaAccountLockerAccountClaimsEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaAccountLockerAccountClaimsEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaAccountLockerAccountClaimsEntrySubstate input)
        {
            if (input == null)
            {
                return false;
