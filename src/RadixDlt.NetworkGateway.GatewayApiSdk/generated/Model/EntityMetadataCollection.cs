...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class EntityMetadataCollection : IEquatable<EntityMetadataCollection>
    {
        /// <summary>
        ...
        public EntityMetadataCollection(long? totalCount = default(long?), string nextCursor = default(string), List<EntityMetadataItem> items = default(List<EntityMetadataItem>))
        {
