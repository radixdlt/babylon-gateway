...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CaResourceChange
    /// </summary>
    [DataContract(Name = "CaResourceChange")]
    public partial class CaResourceChange : IEquatable<CaResourceChange>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaResourceChange" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaResourceChange() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaResourceChange" /> class.
        /// </summary>
        ...
        public CaResourceChange(string resourceAddress = default(string), CaEntityReference componentEntity = default(CaEntityReference), CaEntityReference vaultEntity = default(CaEntityReference), string amount = default(string))
        {
            // to ensure "resourceAddress" is required (not null)
            if (resourceAddress == null)
            {
                throw new ArgumentNullException("resourceAddress is a required property for CaResourceChange and cannot be null");
            }
            this.ResourceAddress = resourceAddress;
            // to ensure "componentEntity" is required (not null)
            if (componentEntity == null)
            {
                throw new ArgumentNullException("componentEntity is a required property for CaResourceChange and cannot be null");
            }
            this.ComponentEntity = componentEntity;
            // to ensure "vaultEntity" is required (not null)
            if (vaultEntity == null)
            {
                throw new ArgumentNullException("vaultEntity is a required property for CaResourceChange and cannot be null");
            }
            this.VaultEntity = vaultEntity;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for CaResourceChange and cannot be null");
            }
            this.Amount = amount;
        }
        ...
        public CaEntityReference ComponentEntity { get; set; }

        /// <summary>
        /// Gets or Sets VaultEntity
        /// </summary>
        [DataMember(Name = "vault_entity", IsRequired = true, EmitDefaultValue = true)]
        public CaEntityReference VaultEntity { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaResourceChange {\n");
        ...
        {
            return this.Equals(input as CaResourceChange);
        }

        /// <summary>
        /// Returns true if CaResourceChange instances are equal
        /// </summary>
        /// <param name="input">Instance of CaResourceChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaResourceChange input)
        {
            if (input == null)
            {
                return false;
