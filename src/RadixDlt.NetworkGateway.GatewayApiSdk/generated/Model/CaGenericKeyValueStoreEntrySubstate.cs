...
{
    /// <summary>
    /// CaGenericKeyValueStoreEntrySubstate
    /// </summary>
    [DataContract(Name = "CaGenericKeyValueStoreEntrySubstate")]
    ...
    public partial class CaGenericKeyValueStoreEntrySubstate : CaSubstate, IEquatable<CaGenericKeyValueStoreEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaGenericKeyValueStoreEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaGenericKeyValueStoreEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaGenericKeyValueStoreEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value.</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.GenericKeyValueStoreEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaGenericKeyValueStoreEntrySubstate(CaGenericKey key = default(CaGenericKey), CaGenericKeyValueStoreEntryValue value = default(CaGenericKeyValueStoreEntryValue), CaSubstateType substateType = CaSubstateType.GenericKeyValueStoreEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CaGenericKeyValueStoreEntrySubstate and cannot be null");
            }
            this.Key = key;
            this.Value = value;
        }
        ...
        public CaGenericKey Key { get; set; }

        /// <summary>
        /// Gets or Sets Value
        /// </summary>
        [DataMember(Name = "value", EmitDefaultValue = true)]
        public CaGenericKeyValueStoreEntryValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaGenericKeyValueStoreEntrySubstate {\n");
        ...
        {
            return this.Equals(input as CaGenericKeyValueStoreEntrySubstate);
        }

        /// <summary>
        /// Returns true if CaGenericKeyValueStoreEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaGenericKeyValueStoreEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaGenericKeyValueStoreEntrySubstate input)
        {
            if (input == null)
            {
                return false;
