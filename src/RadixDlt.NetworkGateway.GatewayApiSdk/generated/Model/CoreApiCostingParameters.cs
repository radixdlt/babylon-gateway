...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiCostingParameters")]
    public partial class CoreApiCostingParameters : IEquatable<CoreApiCostingParameters>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiCostingParameters" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiCostingParameters() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiCostingParameters" /> class.
        /// </summary>
        ...
        public CoreApiCostingParameters(string executionCostUnitPrice = default(string), long executionCostUnitLimit = default(long), long executionCostUnitLoan = default(long), string finalizationCostUnitPrice = default(string), long finalizationCostUnitLimit = default(long), string xrdUsdPrice = default(string), string xrdStoragePrice = default(string), string xrdArchiveStoragePrice = default(string), int tipPercentage = default(int))
        {
            // to ensure "executionCostUnitPrice" is required (not null)
            if (executionCostUnitPrice == null)
            {
                throw new ArgumentNullException("executionCostUnitPrice is a required property for CoreApiCostingParameters and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("finalizationCostUnitPrice is a required property for CoreApiCostingParameters and cannot be null");
            }
            ...
            if (xrdUsdPrice == null)
            {
                throw new ArgumentNullException("xrdUsdPrice is a required property for CoreApiCostingParameters and cannot be null");
            }
            this.XrdUsdPrice = xrdUsdPrice;
            // to ensure "xrdStoragePrice" is required (not null)
            if (xrdStoragePrice == null)
            {
                throw new ArgumentNullException("xrdStoragePrice is a required property for CoreApiCostingParameters and cannot be null");
            }
            this.XrdStoragePrice = xrdStoragePrice;
            // to ensure "xrdArchiveStoragePrice" is required (not null)
            if (xrdArchiveStoragePrice == null)
            {
                throw new ArgumentNullException("xrdArchiveStoragePrice is a required property for CoreApiCostingParameters and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiCostingParameters {\n");
        ...
        {
            return this.Equals(input as CoreApiCostingParameters);
        }

        /// <summary>
        /// Returns true if CoreApiCostingParameters instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiCostingParameters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiCostingParameters input)
        {
            if (input == null)
            {
                return false;
