...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// ValidatorCollection
    /// </summary>
    [DataContract(Name = "ValidatorCollection")]
    public partial class ValidatorCollection : IEquatable<ValidatorCollection>
    {
        /// <summary>
        ...
        public ValidatorCollection(long? totalCount = default(long?), string previousCursor = default(string), string nextCursor = default(string), List<ValidatorCollectionItem> items = default(List<ValidatorCollectionItem>))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for ValidatorCollection and cannot be null");
            }
            this.Items = items;
        ...
        {
            return this.Equals(input as ValidatorCollection);
        }

        /// <summary>
        /// Returns true if ValidatorCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of ValidatorCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValidatorCollection input)
        {
            if (input == null)
            {
                return false;
