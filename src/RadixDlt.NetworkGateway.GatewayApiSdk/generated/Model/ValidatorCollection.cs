...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class ValidatorCollection : IEquatable<ValidatorCollection>
    {
        ...
        public ValidatorCollection(long? totalCount = default(long?), string nextCursor = default(string), List<ValidatorCollectionItem> items = default(List<ValidatorCollectionItem>))
        {
