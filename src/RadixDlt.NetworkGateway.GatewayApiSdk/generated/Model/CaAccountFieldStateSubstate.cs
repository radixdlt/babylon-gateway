...
{
    /// <summary>
    /// CaAccountFieldStateSubstate
    /// </summary>
    [DataContract(Name = "CaAccountFieldStateSubstate")]
    ...
    public partial class CaAccountFieldStateSubstate : CaSubstate, IEquatable<CaAccountFieldStateSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaAccountFieldStateSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaAccountFieldStateSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaAccountFieldStateSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.AccountFieldState).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaAccountFieldStateSubstate(CaAccountFieldStateValue value = default(CaAccountFieldStateValue), CaSubstateType substateType = CaSubstateType.AccountFieldState, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaAccountFieldStateSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaAccountFieldStateValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaAccountFieldStateSubstate {\n");
        ...
        {
            return this.Equals(input as CaAccountFieldStateSubstate);
        }

        /// <summary>
        /// Returns true if CaAccountFieldStateSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaAccountFieldStateSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaAccountFieldStateSubstate input)
        {
            if (input == null)
            {
                return false;
