...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CaNonFungibleVaultContentsIndexEntryValue")]
    public partial class CaNonFungibleVaultContentsIndexEntryValue : IEquatable<CaNonFungibleVaultContentsIndexEntryValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaNonFungibleVaultContentsIndexEntryValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaNonFungibleVaultContentsIndexEntryValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaNonFungibleVaultContentsIndexEntryValue" /> class.
        /// </summary>
        ...
        public CaNonFungibleVaultContentsIndexEntryValue(bool isPresent = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaNonFungibleVaultContentsIndexEntryValue {\n");
        ...
        {
            return this.Equals(input as CaNonFungibleVaultContentsIndexEntryValue);
        }

        /// <summary>
        /// Returns true if CaNonFungibleVaultContentsIndexEntryValue instances are equal
        /// </summary>
        /// <param name="input">Instance of CaNonFungibleVaultContentsIndexEntryValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaNonFungibleVaultContentsIndexEntryValue input)
        {
            if (input == null)
            {
                return false;
