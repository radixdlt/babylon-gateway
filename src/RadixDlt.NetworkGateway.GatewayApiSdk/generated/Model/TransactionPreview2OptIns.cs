...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionPreview2OptIns")]
    public partial class TransactionPreview2OptIns : IEquatable<TransactionPreview2OptIns>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionPreview2OptIns" /> class.
        /// </summary>
        ...
        public TransactionPreview2OptIns(bool coreApiReceipt = default(bool), bool radixEngineToolkitReceipt = default(bool), bool logs = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionPreview2OptIns {\n");
        ...
        {
            return this.Equals(input as TransactionPreview2OptIns);
        }

        /// <summary>
        /// Returns true if TransactionPreview2OptIns instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionPreview2OptIns to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionPreview2OptIns input)
        {
            if (input == null)
            {
                return false;
