...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class ProgrammaticScryptoSborValueString : ProgrammaticScryptoSborValue, IEquatable<ProgrammaticScryptoSborValueString>
    {
        ...
        /// <param name="kind">kind (required) (default to ProgrammaticScryptoSborValueTypeKind.String).</param>
        /// <param name="typeName">TBD.</param>
        /// <param name="fieldName">TBD.</param>
        public ProgrammaticScryptoSborValueString(string value = default(string), ProgrammaticScryptoSborValueTypeKind kind = ProgrammaticScryptoSborValueTypeKind.String, string typeName = default(string), string fieldName = default(string)) : base(kind, typeName, fieldName)
        {
