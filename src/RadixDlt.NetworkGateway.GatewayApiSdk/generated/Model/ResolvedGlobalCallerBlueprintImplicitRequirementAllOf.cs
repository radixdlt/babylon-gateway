...
{
    /// <summary>
    /// ResolvedGlobalCallerBlueprintImplicitRequirementAllOf
    /// </summary>
    [DataContract(Name = "ResolvedGlobalCallerBlueprintImplicitRequirement_allOf")]
    public partial class ResolvedGlobalCallerBlueprintImplicitRequirementAllOf : IEquatable<ResolvedGlobalCallerBlueprintImplicitRequirementAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResolvedGlobalCallerBlueprintImplicitRequirementAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResolvedGlobalCallerBlueprintImplicitRequirementAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResolvedGlobalCallerBlueprintImplicitRequirementAllOf" /> class.
        /// </summary>
        ...
        public ResolvedGlobalCallerBlueprintImplicitRequirementAllOf(long firstSeenStateVersion = default(long), string packageAddress = default(string), string blueprintName = default(string))
        {
            ...
            {
                throw new ArgumentNullException("packageAddress is a required property for ResolvedGlobalCallerBlueprintImplicitRequirementAllOf and cannot be null");
            }
            this.PackageAddress = packageAddress;
            // to ensure "blueprintName" is required (not null)
            if (blueprintName == null)
            {
                throw new ArgumentNullException("blueprintName is a required property for ResolvedGlobalCallerBlueprintImplicitRequirementAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as ResolvedGlobalCallerBlueprintImplicitRequirementAllOf);
        }

        /// <summary>
        /// Returns true if ResolvedGlobalCallerBlueprintImplicitRequirementAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ResolvedGlobalCallerBlueprintImplicitRequirementAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResolvedGlobalCallerBlueprintImplicitRequirementAllOf input)
        {
            if (input == null)
            {
                return false;
