...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CaEntityReference
    /// </summary>
    [DataContract(Name = "CaEntityReference")]
    public partial class CaEntityReference : IEquatable<CaEntityReference>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CaEntityReference" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaEntityReference() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaEntityReference" /> class.
        /// </summary>
        ...
        public CaEntityReference(CaEntityType entityType = default(CaEntityType), bool isGlobal = default(bool), string entityAddress = default(string))
        {
            ...
            {
                throw new ArgumentNullException("entityAddress is a required property for CaEntityReference and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaEntityReference {\n");
        ...
        {
            return this.Equals(input as CaEntityReference);
        }

        /// <summary>
        /// Returns true if CaEntityReference instances are equal
        /// </summary>
        /// <param name="input">Instance of CaEntityReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaEntityReference input)
        {
            if (input == null)
            {
                return false;
