...
{
    /// <summary>
    /// CaConsensusManagerFieldCurrentValidatorSetSubstate
    /// </summary>
    [DataContract(Name = "CaConsensusManagerFieldCurrentValidatorSetSubstate")]
    ...
    public partial class CaConsensusManagerFieldCurrentValidatorSetSubstate : CaSubstate, IEquatable<CaConsensusManagerFieldCurrentValidatorSetSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaConsensusManagerFieldCurrentValidatorSetSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaConsensusManagerFieldCurrentValidatorSetSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaConsensusManagerFieldCurrentValidatorSetSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.ConsensusManagerFieldCurrentValidatorSet).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaConsensusManagerFieldCurrentValidatorSetSubstate(CaConsensusManagerFieldCurrentValidatorSetValue value = default(CaConsensusManagerFieldCurrentValidatorSetValue), CaSubstateType substateType = CaSubstateType.ConsensusManagerFieldCurrentValidatorSet, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaConsensusManagerFieldCurrentValidatorSetSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaConsensusManagerFieldCurrentValidatorSetValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaConsensusManagerFieldCurrentValidatorSetSubstate {\n");
        ...
        {
            return this.Equals(input as CaConsensusManagerFieldCurrentValidatorSetSubstate);
        }

        /// <summary>
        /// Returns true if CaConsensusManagerFieldCurrentValidatorSetSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaConsensusManagerFieldCurrentValidatorSetSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaConsensusManagerFieldCurrentValidatorSetSubstate input)
        {
            if (input == null)
            {
                return false;
