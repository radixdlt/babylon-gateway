...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StateAccountAuthorizedDepositorsPageResponse")]
    public partial class StateAccountAuthorizedDepositorsPageResponse : IEquatable<StateAccountAuthorizedDepositorsPageResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StateAccountAuthorizedDepositorsPageResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StateAccountAuthorizedDepositorsPageResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StateAccountAuthorizedDepositorsPageResponse" /> class.
        /// </summary>
        ...
        public StateAccountAuthorizedDepositorsPageResponse(LedgerState ledgerState = default(LedgerState), long? totalCount = default(long?), string nextCursor = default(string), List<AccountAuthorizedDepositorsResponseItem> items = default(List<AccountAuthorizedDepositorsResponseItem>), string accountAddress = default(string))
        {
            // to ensure "ledgerState" is required (not null)
            if (ledgerState == null)
            {
                throw new ArgumentNullException("ledgerState is a required property for StateAccountAuthorizedDepositorsPageResponse and cannot be null");
            }
            this.LedgerState = ledgerState;
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for StateAccountAuthorizedDepositorsPageResponse and cannot be null");
            }
            this.Items = items;
            // to ensure "accountAddress" is required (not null)
            if (accountAddress == null)
            {
                throw new ArgumentNullException("accountAddress is a required property for StateAccountAuthorizedDepositorsPageResponse and cannot be null");
            }
        ...
        public List<AccountAuthorizedDepositorsResponseItem> Items { get; set; }
        ...
        {
            return this.Equals(input as StateAccountAuthorizedDepositorsPageResponse);
        }

        /// <summary>
        /// Returns true if StateAccountAuthorizedDepositorsPageResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of StateAccountAuthorizedDepositorsPageResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StateAccountAuthorizedDepositorsPageResponse input)
        {
            if (input == null)
            {
                return false;
