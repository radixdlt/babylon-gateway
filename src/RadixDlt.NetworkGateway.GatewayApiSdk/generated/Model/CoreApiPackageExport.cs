...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiPackageExport")]
    public partial class CoreApiPackageExport : IEquatable<CoreApiPackageExport>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiPackageExport" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiPackageExport() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiPackageExport" /> class.
        /// </summary>
        ...
        public CoreApiPackageExport(string codeHash = default(string), string exportName = default(string))
        {
            // to ensure "codeHash" is required (not null)
            if (codeHash == null)
            {
                throw new ArgumentNullException("codeHash is a required property for CoreApiPackageExport and cannot be null");
            }
            this.CodeHash = codeHash;
            // to ensure "exportName" is required (not null)
            if (exportName == null)
            {
                throw new ArgumentNullException("exportName is a required property for CoreApiPackageExport and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiPackageExport {\n");
        ...
        {
            return this.Equals(input as CoreApiPackageExport);
        }

        /// <summary>
        /// Returns true if CoreApiPackageExport instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiPackageExport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiPackageExport input)
        {
            if (input == null)
            {
                return false;
