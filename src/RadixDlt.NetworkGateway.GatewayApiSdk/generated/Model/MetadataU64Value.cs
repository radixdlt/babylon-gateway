...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// MetadataU64Value
    /// </summary>
    [DataContract(Name = "MetadataU64Value")]
    ...
    public partial class MetadataU64Value : MetadataTypedValue, IEquatable<MetadataU64Value>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataU64Value" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataU64Value() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataU64Value" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="type">type (required) (default to MetadataValueType.U64).</param>
        public MetadataU64Value(string value = default(string), MetadataValueType type = MetadataValueType.U64) : base(type)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for MetadataU64Value and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as MetadataU64Value);
        }

        /// <summary>
        /// Returns true if MetadataU64Value instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataU64Value to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataU64Value input)
        {
            if (input == null)
            {
                return false;
