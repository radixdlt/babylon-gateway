...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class ProgrammaticScryptoSborValueU8 : ProgrammaticScryptoSborValue, IEquatable<ProgrammaticScryptoSborValueU8>
    {
        ...
        /// <param name="kind">kind (required) (default to ProgrammaticScryptoSborValueKind.U8).</param>
        ...
        public ProgrammaticScryptoSborValueU8(string value = default(string), ProgrammaticScryptoSborValueKind kind = ProgrammaticScryptoSborValueKind.U8, string typeName = default(string), string fieldName = default(string)) : base(kind, typeName, fieldName)
        {
