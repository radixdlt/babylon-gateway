...
{
    /// <summary>
    /// CaPackageBlueprintRoyaltyEntrySubstate
    /// </summary>
    [DataContract(Name = "CaPackageBlueprintRoyaltyEntrySubstate")]
    ...
    public partial class CaPackageBlueprintRoyaltyEntrySubstate : CaSubstate, IEquatable<CaPackageBlueprintRoyaltyEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPackageBlueprintRoyaltyEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaPackageBlueprintRoyaltyEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPackageBlueprintRoyaltyEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.PackageBlueprintRoyaltyEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaPackageBlueprintRoyaltyEntrySubstate(CaBlueprintVersionKey key = default(CaBlueprintVersionKey), CaPackageBlueprintRoyaltyEntryValue value = default(CaPackageBlueprintRoyaltyEntryValue), CaSubstateType substateType = CaSubstateType.PackageBlueprintRoyaltyEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CaPackageBlueprintRoyaltyEntrySubstate and cannot be null");
            }
            this.Key = key;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaPackageBlueprintRoyaltyEntrySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaPackageBlueprintRoyaltyEntryValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaPackageBlueprintRoyaltyEntrySubstate {\n");
        ...
        {
            return this.Equals(input as CaPackageBlueprintRoyaltyEntrySubstate);
        }

        /// <summary>
        /// Returns true if CaPackageBlueprintRoyaltyEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaPackageBlueprintRoyaltyEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaPackageBlueprintRoyaltyEntrySubstate input)
        {
            if (input == null)
            {
                return false;
