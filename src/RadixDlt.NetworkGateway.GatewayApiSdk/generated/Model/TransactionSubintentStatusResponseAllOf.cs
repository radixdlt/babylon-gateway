...
{
    /// <summary>
    /// TransactionSubintentStatusResponseAllOf
    /// </summary>
    [DataContract(Name = "TransactionSubintentStatusResponse_allOf")]
    public partial class TransactionSubintentStatusResponseAllOf : IEquatable<TransactionSubintentStatusResponseAllOf>
    {
        ...
        protected TransactionSubintentStatusResponseAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionSubintentStatusResponseAllOf" /> class.
        /// </summary>
        ...
        public TransactionSubintentStatusResponseAllOf(SubintentStatus subintentStatus = default(SubintentStatus), string subintentStatusDescription = default(string), long? finalizedAtStateVersion = default(long?), string finalizedAtTransactionIntentHash = default(string))
        {
            ...
            {
                throw new ArgumentNullException("subintentStatusDescription is a required property for TransactionSubintentStatusResponseAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionSubintentStatusResponseAllOf {\n");
        ...
        {
            return this.Equals(input as TransactionSubintentStatusResponseAllOf);
        }

        /// <summary>
        /// Returns true if TransactionSubintentStatusResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionSubintentStatusResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionSubintentStatusResponseAllOf input)
        {
            if (input == null)
            {
                return false;
