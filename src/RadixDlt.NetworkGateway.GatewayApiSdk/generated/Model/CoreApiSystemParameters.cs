...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiSystemParameters")]
    public partial class CoreApiSystemParameters : IEquatable<CoreApiSystemParameters>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiSystemParameters" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiSystemParameters() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiSystemParameters" /> class.
        /// </summary>
        ...
        public CoreApiSystemParameters(CoreApiNetworkDefinition networkDefinition = default(CoreApiNetworkDefinition), CoreApiCostingModuleConfig costingModuleConfig = default(CoreApiCostingModuleConfig), CoreApiSystemCostingParameters costingParameters = default(CoreApiSystemCostingParameters), CoreApiLimitParameters limitParameters = default(CoreApiLimitParameters))
        {
            // to ensure "networkDefinition" is required (not null)
            if (networkDefinition == null)
            {
                throw new ArgumentNullException("networkDefinition is a required property for CoreApiSystemParameters and cannot be null");
            }
            this.NetworkDefinition = networkDefinition;
            // to ensure "costingModuleConfig" is required (not null)
            if (costingModuleConfig == null)
            {
                throw new ArgumentNullException("costingModuleConfig is a required property for CoreApiSystemParameters and cannot be null");
            }
            this.CostingModuleConfig = costingModuleConfig;
            // to ensure "costingParameters" is required (not null)
            if (costingParameters == null)
            {
                throw new ArgumentNullException("costingParameters is a required property for CoreApiSystemParameters and cannot be null");
            }
            this.CostingParameters = costingParameters;
            // to ensure "limitParameters" is required (not null)
            if (limitParameters == null)
            {
                throw new ArgumentNullException("limitParameters is a required property for CoreApiSystemParameters and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiSystemParameters {\n");
        ...
        {
            return this.Equals(input as CoreApiSystemParameters);
        }

        /// <summary>
        /// Returns true if CoreApiSystemParameters instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiSystemParameters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiSystemParameters input)
        {
            if (input == null)
            {
                return false;
