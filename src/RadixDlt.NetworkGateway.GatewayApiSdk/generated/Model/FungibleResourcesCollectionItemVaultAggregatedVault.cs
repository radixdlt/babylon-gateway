...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class FungibleResourcesCollectionItemVaultAggregatedVault : IEquatable<FungibleResourcesCollectionItemVaultAggregatedVault>
    {
        ...
        protected FungibleResourcesCollectionItemVaultAggregatedVault() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FungibleResourcesCollectionItemVaultAggregatedVault" /> class.
        /// </summary>
        ...
        public FungibleResourcesCollectionItemVaultAggregatedVault(long? totalCount = default(long?), string previousCursor = default(string), string nextCursor = default(string), List<FungibleResourcesCollectionItemVaultAggregatedVaultItem> items = default(List<FungibleResourcesCollectionItemVaultAggregatedVaultItem>))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for FungibleResourcesCollectionItemVaultAggregatedVault and cannot be null");
            }
            this.Items = items;
        ...
        {
            return this.Equals(input as FungibleResourcesCollectionItemVaultAggregatedVault);
        }

        /// <summary>
        /// Returns true if FungibleResourcesCollectionItemVaultAggregatedVault instances are equal
        /// </summary>
        /// <param name="input">Instance of FungibleResourcesCollectionItemVaultAggregatedVault to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FungibleResourcesCollectionItemVaultAggregatedVault input)
        {
            if (input == null)
            {
                return false;
