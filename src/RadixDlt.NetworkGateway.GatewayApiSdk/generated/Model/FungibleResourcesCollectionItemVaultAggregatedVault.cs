...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class FungibleResourcesCollectionItemVaultAggregatedVault : IEquatable<FungibleResourcesCollectionItemVaultAggregatedVault>
    {
        ...
        public FungibleResourcesCollectionItemVaultAggregatedVault(long? totalCount = default(long?), string nextCursor = default(string), List<FungibleResourcesCollectionItemVaultAggregatedVaultItem> items = default(List<FungibleResourcesCollectionItemVaultAggregatedVaultItem>))
        {
