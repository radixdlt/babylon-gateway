...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// MetadataI64Value
    /// </summary>
    [DataContract(Name = "MetadataI64Value")]
    ...
    public partial class MetadataI64Value : MetadataTypedValue, IEquatable<MetadataI64Value>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataI64Value" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataI64Value() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataI64Value" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="type">type (required) (default to MetadataValueType.I64).</param>
        public MetadataI64Value(string value = default(string), MetadataValueType type = MetadataValueType.I64) : base(type)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for MetadataI64Value and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as MetadataI64Value);
        }

        /// <summary>
        /// Returns true if MetadataI64Value instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataI64Value to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataI64Value input)
        {
            if (input == null)
            {
                return false;
