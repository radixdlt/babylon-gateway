...
{
    /// <summary>
    /// CaOneResourcePoolFieldStateSubstate
    /// </summary>
    [DataContract(Name = "CaOneResourcePoolFieldStateSubstate")]
    ...
    public partial class CaOneResourcePoolFieldStateSubstate : CaSubstate, IEquatable<CaOneResourcePoolFieldStateSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaOneResourcePoolFieldStateSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaOneResourcePoolFieldStateSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaOneResourcePoolFieldStateSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.OneResourcePoolFieldState).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaOneResourcePoolFieldStateSubstate(CaOneResourcePoolFieldStateValue value = default(CaOneResourcePoolFieldStateValue), CaSubstateType substateType = CaSubstateType.OneResourcePoolFieldState, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaOneResourcePoolFieldStateSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaOneResourcePoolFieldStateValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaOneResourcePoolFieldStateSubstate {\n");
        ...
        {
            return this.Equals(input as CaOneResourcePoolFieldStateSubstate);
        }

        /// <summary>
        /// Returns true if CaOneResourcePoolFieldStateSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaOneResourcePoolFieldStateSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaOneResourcePoolFieldStateSubstate input)
        {
            if (input == null)
            {
                return false;
