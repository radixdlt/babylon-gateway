...
{
    /// <summary>
    /// CaBootLoaderModuleFieldKernelBootSubstate
    /// </summary>
    [DataContract(Name = "CaBootLoaderModuleFieldKernelBootSubstate")]
    ...
    public partial class CaBootLoaderModuleFieldKernelBootSubstate : CaSubstate, IEquatable<CaBootLoaderModuleFieldKernelBootSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaBootLoaderModuleFieldKernelBootSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaBootLoaderModuleFieldKernelBootSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaBootLoaderModuleFieldKernelBootSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.BootLoaderModuleFieldKernelBoot).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaBootLoaderModuleFieldKernelBootSubstate(Object value = default(Object), CaSubstateType substateType = CaSubstateType.BootLoaderModuleFieldKernelBoot, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaBootLoaderModuleFieldKernelBootSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaBootLoaderModuleFieldKernelBootSubstate {\n");
        ...
        {
            return this.Equals(input as CaBootLoaderModuleFieldKernelBootSubstate);
        }

        /// <summary>
        /// Returns true if CaBootLoaderModuleFieldKernelBootSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaBootLoaderModuleFieldKernelBootSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaBootLoaderModuleFieldKernelBootSubstate input)
        {
            if (input == null)
            {
                return false;
