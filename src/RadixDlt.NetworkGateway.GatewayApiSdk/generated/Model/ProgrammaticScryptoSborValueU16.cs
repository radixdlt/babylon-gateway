...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class ProgrammaticScryptoSborValueU16 : ProgrammaticScryptoSborValue, IEquatable<ProgrammaticScryptoSborValueU16>
    {
        ...
        /// <param name="kind">kind (required) (default to ProgrammaticScryptoSborValueKind.U16).</param>
        ...
        public ProgrammaticScryptoSborValueU16(string value = default(string), ProgrammaticScryptoSborValueKind kind = ProgrammaticScryptoSborValueKind.U16, string typeName = default(string), string fieldName = default(string)) : base(kind, typeName, fieldName)
        {
