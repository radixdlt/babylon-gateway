...
{
    /// <summary>
    /// CaFungibleResourceManagerFieldDivisibilitySubstate
    /// </summary>
    [DataContract(Name = "CaFungibleResourceManagerFieldDivisibilitySubstate")]
    ...
    public partial class CaFungibleResourceManagerFieldDivisibilitySubstate : CaSubstate, IEquatable<CaFungibleResourceManagerFieldDivisibilitySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaFungibleResourceManagerFieldDivisibilitySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaFungibleResourceManagerFieldDivisibilitySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaFungibleResourceManagerFieldDivisibilitySubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.FungibleResourceManagerFieldDivisibility).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaFungibleResourceManagerFieldDivisibilitySubstate(CaFungibleResourceManagerFieldDivisibilityValue value = default(CaFungibleResourceManagerFieldDivisibilityValue), CaSubstateType substateType = CaSubstateType.FungibleResourceManagerFieldDivisibility, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaFungibleResourceManagerFieldDivisibilitySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaFungibleResourceManagerFieldDivisibilityValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaFungibleResourceManagerFieldDivisibilitySubstate {\n");
        ...
        {
            return this.Equals(input as CaFungibleResourceManagerFieldDivisibilitySubstate);
        }

        /// <summary>
        /// Returns true if CaFungibleResourceManagerFieldDivisibilitySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaFungibleResourceManagerFieldDivisibilitySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaFungibleResourceManagerFieldDivisibilitySubstate input)
        {
            if (input == null)
            {
                return false;
