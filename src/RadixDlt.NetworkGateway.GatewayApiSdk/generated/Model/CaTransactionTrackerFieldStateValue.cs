...
{
    /// <summary>
    /// CaTransactionTrackerFieldStateValue
    /// </summary>
    [DataContract(Name = "CaTransactionTrackerFieldStateValue")]
    public partial class CaTransactionTrackerFieldStateValue : IEquatable<CaTransactionTrackerFieldStateValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaTransactionTrackerFieldStateValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaTransactionTrackerFieldStateValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaTransactionTrackerFieldStateValue" /> class.
        /// </summary>
        ...
        public CaTransactionTrackerFieldStateValue(long startEpoch = default(long), int startPartition = default(int), int partitionRangeStartInclusive = default(int), int partitionRangeEndInclusive = default(int), long epochsPerPartition = default(long))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaTransactionTrackerFieldStateValue {\n");
        ...
        {
            return this.Equals(input as CaTransactionTrackerFieldStateValue);
        }

        /// <summary>
        /// Returns true if CaTransactionTrackerFieldStateValue instances are equal
        /// </summary>
        /// <param name="input">Instance of CaTransactionTrackerFieldStateValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaTransactionTrackerFieldStateValue input)
        {
            if (input == null)
            {
                return false;
