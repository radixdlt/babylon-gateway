...
{
    /// <summary>
    /// CaSignificantProtocolUpdateReadinessEntry
    /// </summary>
    [DataContract(Name = "CaSignificantProtocolUpdateReadinessEntry")]
    public partial class CaSignificantProtocolUpdateReadinessEntry : IEquatable<CaSignificantProtocolUpdateReadinessEntry>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaSignificantProtocolUpdateReadinessEntry" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaSignificantProtocolUpdateReadinessEntry() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaSignificantProtocolUpdateReadinessEntry" /> class.
        /// </summary>
        /// <param name="readinessSignalName">readinessSignalName (required).</param>
        /// <param name="signalledStake">signalledStake (required).</param>
        public CaSignificantProtocolUpdateReadinessEntry(string readinessSignalName = default(string), string signalledStake = default(string))
        {
            // to ensure "readinessSignalName" is required (not null)
            if (readinessSignalName == null)
            {
                throw new ArgumentNullException("readinessSignalName is a required property for CaSignificantProtocolUpdateReadinessEntry and cannot be null");
            }
            this.ReadinessSignalName = readinessSignalName;
            // to ensure "signalledStake" is required (not null)
            if (signalledStake == null)
            {
                throw new ArgumentNullException("signalledStake is a required property for CaSignificantProtocolUpdateReadinessEntry and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaSignificantProtocolUpdateReadinessEntry {\n");
        ...
        {
            return this.Equals(input as CaSignificantProtocolUpdateReadinessEntry);
        }

        /// <summary>
        /// Returns true if CaSignificantProtocolUpdateReadinessEntry instances are equal
        /// </summary>
        /// <param name="input">Instance of CaSignificantProtocolUpdateReadinessEntry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaSignificantProtocolUpdateReadinessEntry input)
        {
            if (input == null)
            {
                return false;
