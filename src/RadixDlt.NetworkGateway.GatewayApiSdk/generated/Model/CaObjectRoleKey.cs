...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CaObjectRoleKey
    /// </summary>
    [DataContract(Name = "CaObjectRoleKey")]
    public partial class CaObjectRoleKey : IEquatable<CaObjectRoleKey>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CaObjectRoleKey" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaObjectRoleKey() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaObjectRoleKey" /> class.
        /// </summary>
        /// <param name="objectModuleId">objectModuleId (required).</param>
        /// <param name="roleKey">roleKey (required).</param>
        public CaObjectRoleKey(CaModuleId objectModuleId = default(CaModuleId), string roleKey = default(string))
        {
            this.ObjectModuleId = objectModuleId;
            // to ensure "roleKey" is required (not null)
            if (roleKey == null)
            {
                throw new ArgumentNullException("roleKey is a required property for CaObjectRoleKey and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaObjectRoleKey {\n");
        ...
        {
            return this.Equals(input as CaObjectRoleKey);
        }

        /// <summary>
        /// Returns true if CaObjectRoleKey instances are equal
        /// </summary>
        /// <param name="input">Instance of CaObjectRoleKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaObjectRoleKey input)
        {
            if (input == null)
            {
                return false;
