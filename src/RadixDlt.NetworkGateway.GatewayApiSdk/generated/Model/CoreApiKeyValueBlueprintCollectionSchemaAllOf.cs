...
{
    /// <summary>
    /// CoreApiKeyValueBlueprintCollectionSchemaAllOf
    /// </summary>
    [DataContract(Name = "CoreApiKeyValueBlueprintCollectionSchema_allOf")]
    public partial class CoreApiKeyValueBlueprintCollectionSchemaAllOf : IEquatable<CoreApiKeyValueBlueprintCollectionSchemaAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiKeyValueBlueprintCollectionSchemaAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiKeyValueBlueprintCollectionSchemaAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiKeyValueBlueprintCollectionSchemaAllOf" /> class.
        /// </summary>
        ...
        public CoreApiKeyValueBlueprintCollectionSchemaAllOf(CoreApiBlueprintPayloadDef keyTypeRef = default(CoreApiBlueprintPayloadDef), CoreApiBlueprintPayloadDef valueTypeRef = default(CoreApiBlueprintPayloadDef), bool allowOwnership = default(bool))
        {
            // to ensure "keyTypeRef" is required (not null)
            if (keyTypeRef == null)
            {
                throw new ArgumentNullException("keyTypeRef is a required property for CoreApiKeyValueBlueprintCollectionSchemaAllOf and cannot be null");
            }
            this.KeyTypeRef = keyTypeRef;
            // to ensure "valueTypeRef" is required (not null)
            if (valueTypeRef == null)
            {
                throw new ArgumentNullException("valueTypeRef is a required property for CoreApiKeyValueBlueprintCollectionSchemaAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiKeyValueBlueprintCollectionSchemaAllOf {\n");
        ...
        {
            return this.Equals(input as CoreApiKeyValueBlueprintCollectionSchemaAllOf);
        }

        /// <summary>
        /// Returns true if CoreApiKeyValueBlueprintCollectionSchemaAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiKeyValueBlueprintCollectionSchemaAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiKeyValueBlueprintCollectionSchemaAllOf input)
        {
            if (input == null)
            {
                return false;
