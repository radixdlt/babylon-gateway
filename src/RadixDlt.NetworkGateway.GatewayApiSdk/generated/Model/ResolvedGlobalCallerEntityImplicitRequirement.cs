...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResolvedGlobalCallerEntityImplicitRequirement")]
    ...
    public partial class ResolvedGlobalCallerEntityImplicitRequirement : ResolvedImplicitRequirement
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResolvedGlobalCallerEntityImplicitRequirement" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResolvedGlobalCallerEntityImplicitRequirement() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResolvedGlobalCallerEntityImplicitRequirement" /> class.
        /// </summary>
        ...
        public ResolvedGlobalCallerEntityImplicitRequirement(long firstSeenStateVersion = default(long), string entityAddress = default(string), ResolvedImplicitRequirementType type = ResolvedImplicitRequirementType.GlobalCallerEntity) : base(type)
        {
            ...
            {
                throw new ArgumentNullException("entityAddress is a required property for ResolvedGlobalCallerEntityImplicitRequirement and cannot be null");
            }
        ...
        {
            return this.Equals(input as ResolvedGlobalCallerEntityImplicitRequirement);
        }

        /// <summary>
        /// Returns true if ResolvedGlobalCallerEntityImplicitRequirement instances are equal
        /// </summary>
        /// <param name="input">Instance of ResolvedGlobalCallerEntityImplicitRequirement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResolvedGlobalCallerEntityImplicitRequirement input)
        {
            if (input == null)
            {
                return false;
