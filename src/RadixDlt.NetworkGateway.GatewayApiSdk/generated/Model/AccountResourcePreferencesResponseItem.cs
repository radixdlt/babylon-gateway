...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class AccountResourcePreferencesResponseItem : IEquatable<AccountResourcePreferencesResponseItem>
    {
        ...
        protected AccountResourcePreferencesResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountResourcePreferencesResponseItem" /> class.
        /// </summary>
        ...
        public AccountResourcePreferencesResponseItem(string resourceAddress = default(string), AccountResourcePreferenceRule resourcePreferenceRule = default(AccountResourcePreferenceRule), long lastUpdatedAtStateVersion = default(long))
        {
            ...
            {
                throw new ArgumentNullException("resourceAddress is a required property for AccountResourcePreferencesResponseItem and cannot be null");
            }
        ...
        {
            return this.Equals(input as AccountResourcePreferencesResponseItem);
        }

        /// <summary>
        /// Returns true if AccountResourcePreferencesResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountResourcePreferencesResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountResourcePreferencesResponseItem input)
        {
            if (input == null)
            {
                return false;
