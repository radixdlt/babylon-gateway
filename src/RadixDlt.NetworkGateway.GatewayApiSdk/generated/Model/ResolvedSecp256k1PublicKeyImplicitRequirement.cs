...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class ResolvedSecp256k1PublicKeyImplicitRequirement : ResolvedImplicitRequirement, IEquatable<ResolvedSecp256k1PublicKeyImplicitRequirement>
    {
        ...
        public ResolvedSecp256k1PublicKeyImplicitRequirement(long firstSeenStateVersion = default(long), string publicKeyBytesHex = default(string), ResolvedImplicitRequirementType type = ResolvedImplicitRequirementType.Secp256k1PublicKey) : base(type)
        {
            ...
            {
                throw new ArgumentNullException("publicKeyBytesHex is a required property for ResolvedSecp256k1PublicKeyImplicitRequirement and cannot be null");
            }
