...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class NonFungibleResourcesCollectionItemVaultAggregatedVault
    {
        /// <summary>
        ...
        public NonFungibleResourcesCollectionItemVaultAggregatedVault(long? totalCount = default(long?), string nextCursor = default(string), List<NonFungibleResourcesCollectionItemVaultAggregatedVaultItem> items = default(List<NonFungibleResourcesCollectionItemVaultAggregatedVaultItem>))
        {
