...
{
    /// <summary>
    /// CaMetadataModuleEntrySubstate
    /// </summary>
    [DataContract(Name = "CaMetadataModuleEntrySubstate")]
    ...
    public partial class CaMetadataModuleEntrySubstate : CaSubstate, IEquatable<CaMetadataModuleEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaMetadataModuleEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaMetadataModuleEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaMetadataModuleEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value.</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.MetadataModuleEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaMetadataModuleEntrySubstate(CaMetadataKey key = default(CaMetadataKey), CaMetadataModuleEntryValue value = default(CaMetadataModuleEntryValue), CaSubstateType substateType = CaSubstateType.MetadataModuleEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CaMetadataModuleEntrySubstate and cannot be null");
            }
            this.Key = key;
            this.Value = value;
        }
        ...
        public CaMetadataKey Key { get; set; }

        /// <summary>
        /// Gets or Sets Value
        /// </summary>
        [DataMember(Name = "value", EmitDefaultValue = true)]
        public CaMetadataModuleEntryValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaMetadataModuleEntrySubstate {\n");
        ...
        {
            return this.Equals(input as CaMetadataModuleEntrySubstate);
        }

        /// <summary>
        /// Returns true if CaMetadataModuleEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaMetadataModuleEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaMetadataModuleEntrySubstate input)
        {
            if (input == null)
            {
                return false;
