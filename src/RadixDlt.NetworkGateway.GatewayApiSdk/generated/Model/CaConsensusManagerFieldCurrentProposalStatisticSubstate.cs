...
{
    /// <summary>
    /// CaConsensusManagerFieldCurrentProposalStatisticSubstate
    /// </summary>
    [DataContract(Name = "CaConsensusManagerFieldCurrentProposalStatisticSubstate")]
    ...
    public partial class CaConsensusManagerFieldCurrentProposalStatisticSubstate : CaSubstate, IEquatable<CaConsensusManagerFieldCurrentProposalStatisticSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaConsensusManagerFieldCurrentProposalStatisticSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaConsensusManagerFieldCurrentProposalStatisticSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaConsensusManagerFieldCurrentProposalStatisticSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.ConsensusManagerFieldCurrentProposalStatistic).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaConsensusManagerFieldCurrentProposalStatisticSubstate(CaConsensusManagerFieldCurrentProposalStatisticValue value = default(CaConsensusManagerFieldCurrentProposalStatisticValue), CaSubstateType substateType = CaSubstateType.ConsensusManagerFieldCurrentProposalStatistic, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaConsensusManagerFieldCurrentProposalStatisticSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaConsensusManagerFieldCurrentProposalStatisticValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaConsensusManagerFieldCurrentProposalStatisticSubstate {\n");
        ...
        {
            return this.Equals(input as CaConsensusManagerFieldCurrentProposalStatisticSubstate);
        }

        /// <summary>
        /// Returns true if CaConsensusManagerFieldCurrentProposalStatisticSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaConsensusManagerFieldCurrentProposalStatisticSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaConsensusManagerFieldCurrentProposalStatisticSubstate input)
        {
            if (input == null)
            {
                return false;
