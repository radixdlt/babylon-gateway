...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProgrammaticScryptoSborValueOwn")]
    ...
    public partial class ProgrammaticScryptoSborValueOwn : ProgrammaticScryptoSborValue
    {
        ...
        protected ProgrammaticScryptoSborValueOwn() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgrammaticScryptoSborValueOwn" /> class.
        /// </summary>
        ...
        public ProgrammaticScryptoSborValueOwn(string value = default(string), ProgrammaticScryptoSborValueKind kind = ProgrammaticScryptoSborValueKind.Own, string typeName = default(string), string fieldName = default(string)) : base(kind, typeName, fieldName)
        {
            ...
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for ProgrammaticScryptoSborValueOwn and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as ProgrammaticScryptoSborValueOwn);
        }

        /// <summary>
        /// Returns true if ProgrammaticScryptoSborValueOwn instances are equal
        /// </summary>
        /// <param name="input">Instance of ProgrammaticScryptoSborValueOwn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProgrammaticScryptoSborValueOwn input)
        {
            if (input == null)
            {
                return false;
