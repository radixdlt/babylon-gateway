...
{
    /// <summary>
    /// CaMultiResourcePoolFieldStateSubstate
    /// </summary>
    [DataContract(Name = "CaMultiResourcePoolFieldStateSubstate")]
    ...
    public partial class CaMultiResourcePoolFieldStateSubstate : CaSubstate, IEquatable<CaMultiResourcePoolFieldStateSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaMultiResourcePoolFieldStateSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaMultiResourcePoolFieldStateSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaMultiResourcePoolFieldStateSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.MultiResourcePoolFieldState).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaMultiResourcePoolFieldStateSubstate(CaMultiResourcePoolFieldStateValue value = default(CaMultiResourcePoolFieldStateValue), CaSubstateType substateType = CaSubstateType.MultiResourcePoolFieldState, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaMultiResourcePoolFieldStateSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaMultiResourcePoolFieldStateValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaMultiResourcePoolFieldStateSubstate {\n");
        ...
        {
            return this.Equals(input as CaMultiResourcePoolFieldStateSubstate);
        }

        /// <summary>
        /// Returns true if CaMultiResourcePoolFieldStateSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaMultiResourcePoolFieldStateSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaMultiResourcePoolFieldStateSubstate input)
        {
            if (input == null)
            {
                return false;
