...
{
    /// <summary>
    /// SborScryptoEncodeResponse
    /// </summary>
    [DataContract(Name = "SborScryptoEncodeResponse")]
    public partial class SborScryptoEncodeResponse : IEquatable<SborScryptoEncodeResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SborScryptoEncodeResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SborScryptoEncodeResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SborScryptoEncodeResponse" /> class.
        /// </summary>
        /// <param name="valueHex">Hex-encoded binary blob. (required).</param>
        public SborScryptoEncodeResponse(string valueHex = default(string))
        {
            // to ensure "valueHex" is required (not null)
            if (valueHex == null)
            {
                throw new ArgumentNullException("valueHex is a required property for SborScryptoEncodeResponse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SborScryptoEncodeResponse {\n");
        ...
        {
            return this.Equals(input as SborScryptoEncodeResponse);
        }

        /// <summary>
        /// Returns true if SborScryptoEncodeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SborScryptoEncodeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SborScryptoEncodeResponse input)
        {
            if (input == null)
            {
                return false;
