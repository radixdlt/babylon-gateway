...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class AccountAuthorizedDepositorsCollection : IEquatable<AccountAuthorizedDepositorsCollection>
    {
        ...
        protected AccountAuthorizedDepositorsCollection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountAuthorizedDepositorsCollection" /> class.
        /// </summary>
        ...
        public AccountAuthorizedDepositorsCollection(long? totalCount = default(long?), string nextCursor = default(string), List<AccountAuthorizedDepositorsResponseItem> items = default(List<AccountAuthorizedDepositorsResponseItem>))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for AccountAuthorizedDepositorsCollection and cannot be null");
            }
            this.Items = items;
        ...
        {
            return this.Equals(input as AccountAuthorizedDepositorsCollection);
        }

        /// <summary>
        /// Returns true if AccountAuthorizedDepositorsCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountAuthorizedDepositorsCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountAuthorizedDepositorsCollection input)
        {
            if (input == null)
            {
                return false;
