...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StateAccountAuthorizedDepositorsPageRequest")]
    public partial class StateAccountAuthorizedDepositorsPageRequest : IEquatable<StateAccountAuthorizedDepositorsPageRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StateAccountAuthorizedDepositorsPageRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StateAccountAuthorizedDepositorsPageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StateAccountAuthorizedDepositorsPageRequest" /> class.
        /// </summary>
        ...
        public StateAccountAuthorizedDepositorsPageRequest(LedgerStateSelector atLedgerState = default(LedgerStateSelector), string cursor = default(string), int? limitPerPage = default(int?), string accountAddress = default(string))
        {
            // to ensure "accountAddress" is required (not null)
            if (accountAddress == null)
            {
                throw new ArgumentNullException("accountAddress is a required property for StateAccountAuthorizedDepositorsPageRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as StateAccountAuthorizedDepositorsPageRequest);
        }

        /// <summary>
        /// Returns true if StateAccountAuthorizedDepositorsPageRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of StateAccountAuthorizedDepositorsPageRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StateAccountAuthorizedDepositorsPageRequest input)
        {
            if (input == null)
            {
                return false;
