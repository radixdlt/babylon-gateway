...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class StateEntityMetadataPageResponse
    {
        /// <summary>
        ...
        public StateEntityMetadataPageResponse(LedgerState ledgerState = default(LedgerState), long? totalCount = default(long?), string nextCursor = default(string), List<EntityMetadataItem> items = default(List<EntityMetadataItem>), string address = default(string))
        {
