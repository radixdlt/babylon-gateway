...
{
    /// <summary>
    /// CaTwoResourcePoolFieldStateSubstate
    /// </summary>
    [DataContract(Name = "CaTwoResourcePoolFieldStateSubstate")]
    ...
    public partial class CaTwoResourcePoolFieldStateSubstate : CaSubstate, IEquatable<CaTwoResourcePoolFieldStateSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaTwoResourcePoolFieldStateSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaTwoResourcePoolFieldStateSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaTwoResourcePoolFieldStateSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.TwoResourcePoolFieldState).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaTwoResourcePoolFieldStateSubstate(CaTwoResourcePoolFieldStateValue value = default(CaTwoResourcePoolFieldStateValue), CaSubstateType substateType = CaSubstateType.TwoResourcePoolFieldState, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaTwoResourcePoolFieldStateSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaTwoResourcePoolFieldStateValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaTwoResourcePoolFieldStateSubstate {\n");
        ...
        {
            return this.Equals(input as CaTwoResourcePoolFieldStateSubstate);
        }

        /// <summary>
        /// Returns true if CaTwoResourcePoolFieldStateSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaTwoResourcePoolFieldStateSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaTwoResourcePoolFieldStateSubstate input)
        {
            if (input == null)
            {
                return false;
