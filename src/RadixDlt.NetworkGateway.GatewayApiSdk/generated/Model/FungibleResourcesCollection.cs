...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class FungibleResourcesCollection : IEquatable<FungibleResourcesCollection>
    {
        ...
        public FungibleResourcesCollection(long? totalCount = default(long?), string nextCursor = default(string), List<FungibleResourcesCollectionItem> items = default(List<FungibleResourcesCollectionItem>))
        {
