...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class StateValidatorsListRequestAllOf : IEquatable<StateValidatorsListRequestAllOf>
    {
        ...
        public StateValidatorsListRequestAllOf(string cursor = default(string), UptimeRangeEnum? uptimeRange = default(UptimeRangeEnum?))
        {
            this.Cursor = cursor;
        ...
        {
            return this.Equals(input as StateValidatorsListRequestAllOf);
        }

        /// <summary>
        /// Returns true if StateValidatorsListRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of StateValidatorsListRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StateValidatorsListRequestAllOf input)
        {
            if (input == null)
            {
                return false;
