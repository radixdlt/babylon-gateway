...
{
    /// <summary>
    /// CaValidatorFieldProtocolUpdateReadinessSignalSubstate
    /// </summary>
    [DataContract(Name = "CaValidatorFieldProtocolUpdateReadinessSignalSubstate")]
    ...
    public partial class CaValidatorFieldProtocolUpdateReadinessSignalSubstate : CaSubstate, IEquatable<CaValidatorFieldProtocolUpdateReadinessSignalSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaValidatorFieldProtocolUpdateReadinessSignalSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaValidatorFieldProtocolUpdateReadinessSignalSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaValidatorFieldProtocolUpdateReadinessSignalSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.ValidatorFieldProtocolUpdateReadinessSignal).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaValidatorFieldProtocolUpdateReadinessSignalSubstate(CaValidatorFieldProtocolUpdateReadinessSignalValue value = default(CaValidatorFieldProtocolUpdateReadinessSignalValue), CaSubstateType substateType = CaSubstateType.ValidatorFieldProtocolUpdateReadinessSignal, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaValidatorFieldProtocolUpdateReadinessSignalSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaValidatorFieldProtocolUpdateReadinessSignalValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaValidatorFieldProtocolUpdateReadinessSignalSubstate {\n");
        ...
        {
            return this.Equals(input as CaValidatorFieldProtocolUpdateReadinessSignalSubstate);
        }

        /// <summary>
        /// Returns true if CaValidatorFieldProtocolUpdateReadinessSignalSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaValidatorFieldProtocolUpdateReadinessSignalSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaValidatorFieldProtocolUpdateReadinessSignalSubstate input)
        {
            if (input == null)
            {
                return false;
