...
{
    /// <summary>
    /// CaFungibleVaultFieldFrozenStatusSubstate
    /// </summary>
    [DataContract(Name = "CaFungibleVaultFieldFrozenStatusSubstate")]
    ...
    public partial class CaFungibleVaultFieldFrozenStatusSubstate : CaSubstate, IEquatable<CaFungibleVaultFieldFrozenStatusSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaFungibleVaultFieldFrozenStatusSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaFungibleVaultFieldFrozenStatusSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaFungibleVaultFieldFrozenStatusSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.FungibleVaultFieldFrozenStatus).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaFungibleVaultFieldFrozenStatusSubstate(CaFungibleVaultFieldFrozenStatusValue value = default(CaFungibleVaultFieldFrozenStatusValue), CaSubstateType substateType = CaSubstateType.FungibleVaultFieldFrozenStatus, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaFungibleVaultFieldFrozenStatusSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaFungibleVaultFieldFrozenStatusValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaFungibleVaultFieldFrozenStatusSubstate {\n");
        ...
        {
            return this.Equals(input as CaFungibleVaultFieldFrozenStatusSubstate);
        }

        /// <summary>
        /// Returns true if CaFungibleVaultFieldFrozenStatusSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaFungibleVaultFieldFrozenStatusSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaFungibleVaultFieldFrozenStatusSubstate input)
        {
            if (input == null)
            {
                return false;
