...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CaDeletedSubstate
    /// </summary>
    [DataContract(Name = "CaDeletedSubstate")]
    public partial class CaDeletedSubstate : IEquatable<CaDeletedSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaDeletedSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaDeletedSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaDeletedSubstate" /> class.
        /// </summary>
        ...
        public CaDeletedSubstate(CaSubstateId substateId = default(CaSubstateId), CaSubstateValue previousValue = default(CaSubstateValue), CaSubstateSystemStructure systemStructure = default(CaSubstateSystemStructure))
        {
            // to ensure "substateId" is required (not null)
            if (substateId == null)
            {
                throw new ArgumentNullException("substateId is a required property for CaDeletedSubstate and cannot be null");
            }
            this.SubstateId = substateId;
            // to ensure "systemStructure" is required (not null)
            if (systemStructure == null)
            {
                throw new ArgumentNullException("systemStructure is a required property for CaDeletedSubstate and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaDeletedSubstate {\n");
        ...
        {
            return this.Equals(input as CaDeletedSubstate);
        }

        /// <summary>
        /// Returns true if CaDeletedSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaDeletedSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaDeletedSubstate input)
        {
            if (input == null)
            {
                return false;
