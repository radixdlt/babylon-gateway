...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResolvedEd25519PublicKeyImplicitRequirement")]
    ...
    public partial class ResolvedEd25519PublicKeyImplicitRequirement : ResolvedImplicitRequirement, IEquatable<ResolvedEd25519PublicKeyImplicitRequirement>
    {
        ...
        protected ResolvedEd25519PublicKeyImplicitRequirement() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResolvedEd25519PublicKeyImplicitRequirement" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ResolvedEd25519PublicKeyImplicitRequirement);
        }

        /// <summary>
        /// Returns true if ResolvedEd25519PublicKeyImplicitRequirement instances are equal
        /// </summary>
        /// <param name="input">Instance of ResolvedEd25519PublicKeyImplicitRequirement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResolvedEd25519PublicKeyImplicitRequirement input)
        {
            if (input == null)
            {
                return false;
