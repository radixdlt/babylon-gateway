...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CaKeyValueStoreInfo
    /// </summary>
    [DataContract(Name = "CaKeyValueStoreInfo")]
    public partial class CaKeyValueStoreInfo : IEquatable<CaKeyValueStoreInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaKeyValueStoreInfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaKeyValueStoreInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaKeyValueStoreInfo" /> class.
        /// </summary>
        ...
        public CaKeyValueStoreInfo(CaGenericSubstitution keyGenericSubstitution = default(CaGenericSubstitution), CaGenericSubstitution valueGenericSubstitution = default(CaGenericSubstitution), bool allowOwnership = default(bool))
        {
            // to ensure "keyGenericSubstitution" is required (not null)
            if (keyGenericSubstitution == null)
            {
                throw new ArgumentNullException("keyGenericSubstitution is a required property for CaKeyValueStoreInfo and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("valueGenericSubstitution is a required property for CaKeyValueStoreInfo and cannot be null");
            }
        ...
        public CaGenericSubstitution KeyGenericSubstitution { get; set; }

        /// <summary>
        /// Gets or Sets ValueGenericSubstitution
        /// </summary>
        [DataMember(Name = "value_generic_substitution", IsRequired = true, EmitDefaultValue = true)]
        public CaGenericSubstitution ValueGenericSubstitution { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaKeyValueStoreInfo {\n");
        ...
        {
            return this.Equals(input as CaKeyValueStoreInfo);
        }

        /// <summary>
        /// Returns true if CaKeyValueStoreInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of CaKeyValueStoreInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaKeyValueStoreInfo input)
        {
            if (input == null)
            {
                return false;
