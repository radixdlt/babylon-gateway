...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CoreApiFieldSchema
    /// </summary>
    [DataContract(Name = "CoreApiFieldSchema")]
    public partial class CoreApiFieldSchema : IEquatable<CoreApiFieldSchema>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiFieldSchema" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiFieldSchema() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiFieldSchema" /> class.
        /// </summary>
        ...
        public CoreApiFieldSchema(CoreApiBlueprintPayloadDef fieldTypeRef = default(CoreApiBlueprintPayloadDef), CoreApiFieldSchemaFeatureCondition condition = default(CoreApiFieldSchemaFeatureCondition), string transientDefaultValueHex = default(string))
        {
            // to ensure "fieldTypeRef" is required (not null)
            if (fieldTypeRef == null)
            {
                throw new ArgumentNullException("fieldTypeRef is a required property for CoreApiFieldSchema and cannot be null");
            }
        ...
        public CoreApiBlueprintPayloadDef FieldTypeRef { get; set; }

        /// <summary>
        /// Gets or Sets Condition
        /// </summary>
        [DataMember(Name = "condition", EmitDefaultValue = true)]
        public CoreApiFieldSchemaFeatureCondition Condition { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiFieldSchema {\n");
        ...
        {
            return this.Equals(input as CoreApiFieldSchema);
        }

        /// <summary>
        /// Returns true if CoreApiFieldSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiFieldSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiFieldSchema input)
        {
            if (input == null)
            {
                return false;
