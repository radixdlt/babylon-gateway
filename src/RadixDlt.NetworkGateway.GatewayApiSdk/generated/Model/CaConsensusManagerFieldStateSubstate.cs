...
{
    /// <summary>
    /// CaConsensusManagerFieldStateSubstate
    /// </summary>
    [DataContract(Name = "CaConsensusManagerFieldStateSubstate")]
    ...
    public partial class CaConsensusManagerFieldStateSubstate : CaSubstate, IEquatable<CaConsensusManagerFieldStateSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaConsensusManagerFieldStateSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaConsensusManagerFieldStateSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaConsensusManagerFieldStateSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.ConsensusManagerFieldState).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaConsensusManagerFieldStateSubstate(CaConsensusManagerFieldStateValue value = default(CaConsensusManagerFieldStateValue), CaSubstateType substateType = CaSubstateType.ConsensusManagerFieldState, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaConsensusManagerFieldStateSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaConsensusManagerFieldStateValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaConsensusManagerFieldStateSubstate {\n");
        ...
        {
            return this.Equals(input as CaConsensusManagerFieldStateSubstate);
        }

        /// <summary>
        /// Returns true if CaConsensusManagerFieldStateSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaConsensusManagerFieldStateSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaConsensusManagerFieldStateSubstate input)
        {
            if (input == null)
            {
                return false;
