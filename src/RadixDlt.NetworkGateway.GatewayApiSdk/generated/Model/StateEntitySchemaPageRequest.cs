...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StateEntitySchemaPageRequest")]
    public partial class StateEntitySchemaPageRequest : IEquatable<StateEntitySchemaPageRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StateEntitySchemaPageRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StateEntitySchemaPageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StateEntitySchemaPageRequest" /> class.
        /// </summary>
        ...
        public StateEntitySchemaPageRequest(LedgerStateSelector atLedgerState = default(LedgerStateSelector), string cursor = default(string), int? limitPerPage = default(int?), string address = default(string))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for StateEntitySchemaPageRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as StateEntitySchemaPageRequest);
        }

        /// <summary>
        /// Returns true if StateEntitySchemaPageRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of StateEntitySchemaPageRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StateEntitySchemaPageRequest input)
        {
            if (input == null)
            {
                return false;
