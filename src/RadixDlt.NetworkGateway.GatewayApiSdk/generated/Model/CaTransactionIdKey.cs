...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CaTransactionIdKey
    /// </summary>
    [DataContract(Name = "CaTransactionIdKey")]
    public partial class CaTransactionIdKey : IEquatable<CaTransactionIdKey>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaTransactionIdKey" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaTransactionIdKey() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaTransactionIdKey" /> class.
        /// </summary>
        ...
        public CaTransactionIdKey(string intentHash = default(string), string intentHashBech32m = default(string))
        {
            // to ensure "intentHash" is required (not null)
            if (intentHash == null)
            {
                throw new ArgumentNullException("intentHash is a required property for CaTransactionIdKey and cannot be null");
            }
            this.IntentHash = intentHash;
            // to ensure "intentHashBech32m" is required (not null)
            if (intentHashBech32m == null)
            {
                throw new ArgumentNullException("intentHashBech32m is a required property for CaTransactionIdKey and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaTransactionIdKey {\n");
        ...
        {
            return this.Equals(input as CaTransactionIdKey);
        }

        /// <summary>
        /// Returns true if CaTransactionIdKey instances are equal
        /// </summary>
        /// <param name="input">Instance of CaTransactionIdKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaTransactionIdKey input)
        {
            if (input == null)
            {
                return false;
