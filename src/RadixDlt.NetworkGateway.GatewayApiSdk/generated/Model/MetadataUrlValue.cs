...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// MetadataUrlValue
    /// </summary>
    [DataContract(Name = "MetadataUrlValue")]
    ...
    public partial class MetadataUrlValue : MetadataTypedValue, IEquatable<MetadataUrlValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataUrlValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataUrlValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataUrlValue" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="type">type (required) (default to MetadataValueType.Url).</param>
        public MetadataUrlValue(string value = default(string), MetadataValueType type = MetadataValueType.Url) : base(type)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for MetadataUrlValue and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as MetadataUrlValue);
        }

        /// <summary>
        /// Returns true if MetadataUrlValue instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataUrlValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataUrlValue input)
        {
            if (input == null)
            {
                return false;
