...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiSubstateValue")]
    public partial class CoreApiSubstateValue : IEquatable<CoreApiSubstateValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiSubstateValue" /> class.
        /// </summary>
        ...
        public CoreApiSubstateValue(string substateHex = default(string), string substateDataHash = default(string), CoreApiSubstate substateData = default(CoreApiSubstate))
        {
        ...
        public CoreApiSubstate SubstateData { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiSubstateValue {\n");
        ...
        {
            return this.Equals(input as CoreApiSubstateValue);
        }

        /// <summary>
        /// Returns true if CoreApiSubstateValue instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiSubstateValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiSubstateValue input)
        {
            if (input == null)
            {
                return false;
