...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NativeResourcePackageOfDirectCallerResourceValue")]
    ...
    public partial class NativeResourcePackageOfDirectCallerResourceValue : NativeResourceDetails, IEquatable<NativeResourcePackageOfDirectCallerResourceValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourcePackageOfDirectCallerResourceValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NativeResourcePackageOfDirectCallerResourceValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourcePackageOfDirectCallerResourceValue" /> class.
        /// </summary>
        /// <param name="kind">kind (required) (default to NativeResourceKind.PackageOfDirectCallerResource).</param>
        public NativeResourcePackageOfDirectCallerResourceValue(NativeResourceKind kind = NativeResourceKind.PackageOfDirectCallerResource) : base(kind)
        {
        }
        ...
        {
            return this.Equals(input as NativeResourcePackageOfDirectCallerResourceValue);
        }

        /// <summary>
        /// Returns true if NativeResourcePackageOfDirectCallerResourceValue instances are equal
        /// </summary>
        /// <param name="input">Instance of NativeResourcePackageOfDirectCallerResourceValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NativeResourcePackageOfDirectCallerResourceValue input)
        {
            if (input == null)
            {
                return false;
