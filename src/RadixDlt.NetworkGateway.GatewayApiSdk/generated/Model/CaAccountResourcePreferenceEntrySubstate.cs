...
{
    /// <summary>
    /// CaAccountResourcePreferenceEntrySubstate
    /// </summary>
    [DataContract(Name = "CaAccountResourcePreferenceEntrySubstate")]
    ...
    public partial class CaAccountResourcePreferenceEntrySubstate : CaSubstate, IEquatable<CaAccountResourcePreferenceEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaAccountResourcePreferenceEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaAccountResourcePreferenceEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaAccountResourcePreferenceEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value.</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.AccountResourcePreferenceEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaAccountResourcePreferenceEntrySubstate(CaResourceKey key = default(CaResourceKey), CaAccountResourcePreferenceEntryValue value = default(CaAccountResourcePreferenceEntryValue), CaSubstateType substateType = CaSubstateType.AccountResourcePreferenceEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CaAccountResourcePreferenceEntrySubstate and cannot be null");
            }
            this.Key = key;
            this.Value = value;
        }
        ...
        public CaResourceKey Key { get; set; }

        /// <summary>
        /// Gets or Sets Value
        /// </summary>
        [DataMember(Name = "value", EmitDefaultValue = true)]
        public CaAccountResourcePreferenceEntryValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaAccountResourcePreferenceEntrySubstate {\n");
        ...
        {
            return this.Equals(input as CaAccountResourcePreferenceEntrySubstate);
        }

        /// <summary>
        /// Returns true if CaAccountResourcePreferenceEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaAccountResourcePreferenceEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaAccountResourcePreferenceEntrySubstate input)
        {
            if (input == null)
            {
                return false;
