...
{
    /// <summary>
    /// CaFungibleVaultFieldBalanceSubstate
    /// </summary>
    [DataContract(Name = "CaFungibleVaultFieldBalanceSubstate")]
    ...
    public partial class CaFungibleVaultFieldBalanceSubstate : CaSubstate, IEquatable<CaFungibleVaultFieldBalanceSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaFungibleVaultFieldBalanceSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaFungibleVaultFieldBalanceSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaFungibleVaultFieldBalanceSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.FungibleVaultFieldBalance).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaFungibleVaultFieldBalanceSubstate(CaFungibleVaultFieldBalanceValue value = default(CaFungibleVaultFieldBalanceValue), CaSubstateType substateType = CaSubstateType.FungibleVaultFieldBalance, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaFungibleVaultFieldBalanceSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaFungibleVaultFieldBalanceValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaFungibleVaultFieldBalanceSubstate {\n");
        ...
        {
            return this.Equals(input as CaFungibleVaultFieldBalanceSubstate);
        }

        /// <summary>
        /// Returns true if CaFungibleVaultFieldBalanceSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaFungibleVaultFieldBalanceSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaFungibleVaultFieldBalanceSubstate input)
        {
            if (input == null)
            {
                return false;
