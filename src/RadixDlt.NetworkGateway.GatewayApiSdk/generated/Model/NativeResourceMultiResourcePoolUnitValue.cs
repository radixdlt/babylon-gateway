...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NativeResourceMultiResourcePoolUnitValue")]
    ...
    public partial class NativeResourceMultiResourcePoolUnitValue : NativeResourceDetails, IEquatable<NativeResourceMultiResourcePoolUnitValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceMultiResourcePoolUnitValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NativeResourceMultiResourcePoolUnitValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceMultiResourcePoolUnitValue" /> class.
        /// </summary>
        ...
        /// <param name="kind">kind (required) (default to NativeResourceKind.MultiResourcePoolUnit).</param>
        public NativeResourceMultiResourcePoolUnitValue(string poolAddress = default(string), int redemptionResourceCount = default(int), List<NativeResourceRedemptionValueItem> unitRedemptionValue = default(List<NativeResourceRedemptionValueItem>), NativeResourceKind kind = NativeResourceKind.MultiResourcePoolUnit) : base(kind)
        {
            // to ensure "poolAddress" is required (not null)
            if (poolAddress == null)
            {
                throw new ArgumentNullException("poolAddress is a required property for NativeResourceMultiResourcePoolUnitValue and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("unitRedemptionValue is a required property for NativeResourceMultiResourcePoolUnitValue and cannot be null");
            }
        ...
        {
            return this.Equals(input as NativeResourceMultiResourcePoolUnitValue);
        }

        /// <summary>
        /// Returns true if NativeResourceMultiResourcePoolUnitValue instances are equal
        /// </summary>
        /// <param name="input">Instance of NativeResourceMultiResourcePoolUnitValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NativeResourceMultiResourcePoolUnitValue input)
        {
            if (input == null)
            {
                return false;
