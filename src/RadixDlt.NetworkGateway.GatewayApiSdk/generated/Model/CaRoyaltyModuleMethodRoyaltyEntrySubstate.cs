...
{
    /// <summary>
    /// CaRoyaltyModuleMethodRoyaltyEntrySubstate
    /// </summary>
    [DataContract(Name = "CaRoyaltyModuleMethodRoyaltyEntrySubstate")]
    ...
    public partial class CaRoyaltyModuleMethodRoyaltyEntrySubstate : CaSubstate, IEquatable<CaRoyaltyModuleMethodRoyaltyEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaRoyaltyModuleMethodRoyaltyEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaRoyaltyModuleMethodRoyaltyEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaRoyaltyModuleMethodRoyaltyEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value.</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.RoyaltyModuleMethodRoyaltyEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaRoyaltyModuleMethodRoyaltyEntrySubstate(CaMainMethodKey key = default(CaMainMethodKey), CaRoyaltyModuleMethodRoyaltyEntryValue value = default(CaRoyaltyModuleMethodRoyaltyEntryValue), CaSubstateType substateType = CaSubstateType.RoyaltyModuleMethodRoyaltyEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CaRoyaltyModuleMethodRoyaltyEntrySubstate and cannot be null");
            }
            this.Key = key;
            this.Value = value;
        }
        ...
        public CaMainMethodKey Key { get; set; }

        /// <summary>
        /// Gets or Sets Value
        /// </summary>
        [DataMember(Name = "value", EmitDefaultValue = true)]
        public CaRoyaltyModuleMethodRoyaltyEntryValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaRoyaltyModuleMethodRoyaltyEntrySubstate {\n");
        ...
        {
            return this.Equals(input as CaRoyaltyModuleMethodRoyaltyEntrySubstate);
        }

        /// <summary>
        /// Returns true if CaRoyaltyModuleMethodRoyaltyEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaRoyaltyModuleMethodRoyaltyEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaRoyaltyModuleMethodRoyaltyEntrySubstate input)
        {
            if (input == null)
            {
                return false;
