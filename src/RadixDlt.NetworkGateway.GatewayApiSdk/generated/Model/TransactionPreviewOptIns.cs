...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class TransactionPreviewOptIns : IEquatable<TransactionPreviewOptIns>
    {
        ...
        public TransactionPreviewOptIns(bool radixEngineToolkitReceipt = false)
        {
        ...
        {
            return this.Equals(input as TransactionPreviewOptIns);
        }

        /// <summary>
        /// Returns true if TransactionPreviewOptIns instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionPreviewOptIns to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionPreviewOptIns input)
        {
            if (input == null)
            {
                return false;
