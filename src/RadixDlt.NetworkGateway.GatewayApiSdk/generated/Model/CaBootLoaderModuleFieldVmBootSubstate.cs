...
{
    /// <summary>
    /// CaBootLoaderModuleFieldVmBootSubstate
    /// </summary>
    [DataContract(Name = "CaBootLoaderModuleFieldVmBootSubstate")]
    ...
    public partial class CaBootLoaderModuleFieldVmBootSubstate : CaSubstate, IEquatable<CaBootLoaderModuleFieldVmBootSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaBootLoaderModuleFieldVmBootSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaBootLoaderModuleFieldVmBootSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaBootLoaderModuleFieldVmBootSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.BootLoaderModuleFieldVmBoot).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaBootLoaderModuleFieldVmBootSubstate(CaBootLoaderModuleFieldVmBootValue value = default(CaBootLoaderModuleFieldVmBootValue), CaSubstateType substateType = CaSubstateType.BootLoaderModuleFieldVmBoot, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaBootLoaderModuleFieldVmBootSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaBootLoaderModuleFieldVmBootValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaBootLoaderModuleFieldVmBootSubstate {\n");
        ...
        {
            return this.Equals(input as CaBootLoaderModuleFieldVmBootSubstate);
        }

        /// <summary>
        /// Returns true if CaBootLoaderModuleFieldVmBootSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaBootLoaderModuleFieldVmBootSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaBootLoaderModuleFieldVmBootSubstate input)
        {
            if (input == null)
            {
                return false;
