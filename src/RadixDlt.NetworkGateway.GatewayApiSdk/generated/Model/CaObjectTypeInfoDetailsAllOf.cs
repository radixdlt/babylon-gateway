...
{
    /// <summary>
    /// CaObjectTypeInfoDetailsAllOf
    /// </summary>
    [DataContract(Name = "CaObjectTypeInfoDetails_allOf")]
    public partial class CaObjectTypeInfoDetailsAllOf : IEquatable<CaObjectTypeInfoDetailsAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaObjectTypeInfoDetailsAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaObjectTypeInfoDetailsAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaObjectTypeInfoDetailsAllOf" /> class.
        /// </summary>
        ...
        public CaObjectTypeInfoDetailsAllOf(List<CaModuleVersion> moduleVersions = default(List<CaModuleVersion>), CaBlueprintInfo blueprintInfo = default(CaBlueprintInfo), bool global = default(bool))
        {
            // to ensure "moduleVersions" is required (not null)
            if (moduleVersions == null)
            {
                throw new ArgumentNullException("moduleVersions is a required property for CaObjectTypeInfoDetailsAllOf and cannot be null");
            }
            this.ModuleVersions = moduleVersions;
            // to ensure "blueprintInfo" is required (not null)
            if (blueprintInfo == null)
            {
                throw new ArgumentNullException("blueprintInfo is a required property for CaObjectTypeInfoDetailsAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaObjectTypeInfoDetailsAllOf {\n");
        ...
        {
            return this.Equals(input as CaObjectTypeInfoDetailsAllOf);
        }

        /// <summary>
        /// Returns true if CaObjectTypeInfoDetailsAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CaObjectTypeInfoDetailsAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaObjectTypeInfoDetailsAllOf input)
        {
            if (input == null)
            {
                return false;
