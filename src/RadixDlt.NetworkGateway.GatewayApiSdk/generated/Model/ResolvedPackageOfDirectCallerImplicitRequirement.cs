...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResolvedPackageOfDirectCallerImplicitRequirement")]
    ...
    public partial class ResolvedPackageOfDirectCallerImplicitRequirement : ResolvedImplicitRequirement
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResolvedPackageOfDirectCallerImplicitRequirement" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResolvedPackageOfDirectCallerImplicitRequirement() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResolvedPackageOfDirectCallerImplicitRequirement" /> class.
        /// </summary>
        ...
        public ResolvedPackageOfDirectCallerImplicitRequirement(long firstSeenStateVersion = default(long), string packageAddress = default(string), ResolvedImplicitRequirementType type = ResolvedImplicitRequirementType.PackageOfDirectCaller) : base(type)
        {
            ...
            {
                throw new ArgumentNullException("packageAddress is a required property for ResolvedPackageOfDirectCallerImplicitRequirement and cannot be null");
            }
        ...
        {
            return this.Equals(input as ResolvedPackageOfDirectCallerImplicitRequirement);
        }

        /// <summary>
        /// Returns true if ResolvedPackageOfDirectCallerImplicitRequirement instances are equal
        /// </summary>
        /// <param name="input">Instance of ResolvedPackageOfDirectCallerImplicitRequirement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResolvedPackageOfDirectCallerImplicitRequirement input)
        {
            if (input == null)
            {
                return false;
