...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class StatePackageBlueprintPageResponseAllOf
    {
        ...
        protected StatePackageBlueprintPageResponseAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StatePackageBlueprintPageResponseAllOf" /> class.
        /// </summary>
        /// <param name="packageAddress">Bech32m-encoded human readable version of the address. (required).</param>
        public StatePackageBlueprintPageResponseAllOf(string packageAddress = default(string))
        {
            // to ensure "packageAddress" is required (not null)
            if (packageAddress == null)
            {
                throw new ArgumentNullException("packageAddress is a required property for StatePackageBlueprintPageResponseAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StatePackageBlueprintPageResponseAllOf {\n");
        ...
        {
            return this.Equals(input as StatePackageBlueprintPageResponseAllOf);
        }

        /// <summary>
        /// Returns true if StatePackageBlueprintPageResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of StatePackageBlueprintPageResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StatePackageBlueprintPageResponseAllOf input)
        {
            if (input == null)
            {
                return false;
