...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MetadataStringArrayValue")]
    ...
    public partial class MetadataStringArrayValue : MetadataTypedValue, IEquatable<MetadataStringArrayValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataStringArrayValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataStringArrayValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataStringArrayValue" /> class.
        /// </summary>
        /// <param name="values">values (required).</param>
        /// <param name="type">type (required) (default to MetadataValueType.StringArray).</param>
        public MetadataStringArrayValue(List<string> values = default(List<string>), MetadataValueType type = MetadataValueType.StringArray) : base(type)
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for MetadataStringArrayValue and cannot be null");
            }
            this.Values = values;
        }
        ...
        {
            return this.Equals(input as MetadataStringArrayValue);
        }

        /// <summary>
        /// Returns true if MetadataStringArrayValue instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataStringArrayValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataStringArrayValue input)
        {
            if (input == null)
            {
                return false;
