...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MetadataU32ArrayValue")]
    ...
    public partial class MetadataU32ArrayValue : MetadataTypedValue
    {
        ...
        protected MetadataU32ArrayValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataU32ArrayValue" /> class.
        /// </summary>
        /// <param name="values">values (required).</param>
        /// <param name="type">type (required) (default to MetadataValueType.U32Array).</param>
        public MetadataU32ArrayValue(List<string> values = default(List<string>), MetadataValueType type = MetadataValueType.U32Array) : base(type)
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for MetadataU32ArrayValue and cannot be null");
            }
            this.Values = values;
        }
        ...
        {
            return this.Equals(input as MetadataU32ArrayValue);
        }

        /// <summary>
        /// Returns true if MetadataU32ArrayValue instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataU32ArrayValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataU32ArrayValue input)
        {
            if (input == null)
            {
                return false;
