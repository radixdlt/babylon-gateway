...
{
    /// <summary>
    /// CaPackageBlueprintAuthTemplateEntrySubstate
    /// </summary>
    [DataContract(Name = "CaPackageBlueprintAuthTemplateEntrySubstate")]
    ...
    public partial class CaPackageBlueprintAuthTemplateEntrySubstate : CaSubstate, IEquatable<CaPackageBlueprintAuthTemplateEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPackageBlueprintAuthTemplateEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaPackageBlueprintAuthTemplateEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPackageBlueprintAuthTemplateEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.PackageBlueprintAuthTemplateEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaPackageBlueprintAuthTemplateEntrySubstate(CaBlueprintVersionKey key = default(CaBlueprintVersionKey), CaPackageBlueprintAuthTemplateEntryValue value = default(CaPackageBlueprintAuthTemplateEntryValue), CaSubstateType substateType = CaSubstateType.PackageBlueprintAuthTemplateEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CaPackageBlueprintAuthTemplateEntrySubstate and cannot be null");
            }
            this.Key = key;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaPackageBlueprintAuthTemplateEntrySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaPackageBlueprintAuthTemplateEntryValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaPackageBlueprintAuthTemplateEntrySubstate {\n");
        ...
        {
            return this.Equals(input as CaPackageBlueprintAuthTemplateEntrySubstate);
        }

        /// <summary>
        /// Returns true if CaPackageBlueprintAuthTemplateEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaPackageBlueprintAuthTemplateEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaPackageBlueprintAuthTemplateEntrySubstate input)
        {
            if (input == null)
            {
                return false;
