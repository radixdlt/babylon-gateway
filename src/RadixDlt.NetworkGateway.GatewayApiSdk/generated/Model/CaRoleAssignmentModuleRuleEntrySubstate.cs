...
{
    /// <summary>
    /// CaRoleAssignmentModuleRuleEntrySubstate
    /// </summary>
    [DataContract(Name = "CaRoleAssignmentModuleRuleEntrySubstate")]
    ...
    public partial class CaRoleAssignmentModuleRuleEntrySubstate : CaSubstate, IEquatable<CaRoleAssignmentModuleRuleEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaRoleAssignmentModuleRuleEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaRoleAssignmentModuleRuleEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaRoleAssignmentModuleRuleEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value.</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.RoleAssignmentModuleRuleEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaRoleAssignmentModuleRuleEntrySubstate(CaObjectRoleKey key = default(CaObjectRoleKey), CaRoleAssignmentModuleRuleEntryValue value = default(CaRoleAssignmentModuleRuleEntryValue), CaSubstateType substateType = CaSubstateType.RoleAssignmentModuleRuleEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CaRoleAssignmentModuleRuleEntrySubstate and cannot be null");
            }
            this.Key = key;
            this.Value = value;
        }
        ...
        public CaObjectRoleKey Key { get; set; }

        /// <summary>
        /// Gets or Sets Value
        /// </summary>
        [DataMember(Name = "value", EmitDefaultValue = true)]
        public CaRoleAssignmentModuleRuleEntryValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaRoleAssignmentModuleRuleEntrySubstate {\n");
        ...
        {
            return this.Equals(input as CaRoleAssignmentModuleRuleEntrySubstate);
        }

        /// <summary>
        /// Returns true if CaRoleAssignmentModuleRuleEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaRoleAssignmentModuleRuleEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaRoleAssignmentModuleRuleEntrySubstate input)
        {
            if (input == null)
            {
                return false;
