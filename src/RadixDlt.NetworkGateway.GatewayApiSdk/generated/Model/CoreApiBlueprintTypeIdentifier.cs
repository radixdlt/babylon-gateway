...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiBlueprintTypeIdentifier")]
    public partial class CoreApiBlueprintTypeIdentifier : IEquatable<CoreApiBlueprintTypeIdentifier>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiBlueprintTypeIdentifier" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiBlueprintTypeIdentifier() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiBlueprintTypeIdentifier" /> class.
        /// </summary>
        ...
        public CoreApiBlueprintTypeIdentifier(string packageAddress = default(string), string blueprintName = default(string), string typeName = default(string))
        {
            // to ensure "packageAddress" is required (not null)
            if (packageAddress == null)
            {
                throw new ArgumentNullException("packageAddress is a required property for CoreApiBlueprintTypeIdentifier and cannot be null");
            }
            this.PackageAddress = packageAddress;
            // to ensure "blueprintName" is required (not null)
            if (blueprintName == null)
            {
                throw new ArgumentNullException("blueprintName is a required property for CoreApiBlueprintTypeIdentifier and cannot be null");
            }
            this.BlueprintName = blueprintName;
            // to ensure "typeName" is required (not null)
            if (typeName == null)
            {
                throw new ArgumentNullException("typeName is a required property for CoreApiBlueprintTypeIdentifier and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "type_name", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiBlueprintTypeIdentifier {\n");
        ...
        {
            return this.Equals(input as CoreApiBlueprintTypeIdentifier);
        }

        /// <summary>
        /// Returns true if CoreApiBlueprintTypeIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiBlueprintTypeIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiBlueprintTypeIdentifier input)
        {
            if (input == null)
            {
                return false;
