...
{
    /// <summary>
    /// CaSystemCostingParameters
    /// </summary>
    [DataContract(Name = "CaSystemCostingParameters")]
    public partial class CaSystemCostingParameters : IEquatable<CaSystemCostingParameters>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaSystemCostingParameters" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaSystemCostingParameters() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaSystemCostingParameters" /> class.
        /// </summary>
        ...
        public CaSystemCostingParameters(string executionCostUnitPrice = default(string), long executionCostUnitLimit = default(long), long executionCostUnitLoan = default(long), string finalizationCostUnitPrice = default(string), long finalizationCostUnitLimit = default(long), string xrdUsdPrice = default(string), string xrdStoragePrice = default(string), string xrdArchiveStoragePrice = default(string))
        {
            // to ensure "executionCostUnitPrice" is required (not null)
            if (executionCostUnitPrice == null)
            {
                throw new ArgumentNullException("executionCostUnitPrice is a required property for CaSystemCostingParameters and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("finalizationCostUnitPrice is a required property for CaSystemCostingParameters and cannot be null");
            }
            ...
            if (xrdUsdPrice == null)
            {
                throw new ArgumentNullException("xrdUsdPrice is a required property for CaSystemCostingParameters and cannot be null");
            }
            this.XrdUsdPrice = xrdUsdPrice;
            // to ensure "xrdStoragePrice" is required (not null)
            if (xrdStoragePrice == null)
            {
                throw new ArgumentNullException("xrdStoragePrice is a required property for CaSystemCostingParameters and cannot be null");
            }
            this.XrdStoragePrice = xrdStoragePrice;
            // to ensure "xrdArchiveStoragePrice" is required (not null)
            if (xrdArchiveStoragePrice == null)
            {
                throw new ArgumentNullException("xrdArchiveStoragePrice is a required property for CaSystemCostingParameters and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaSystemCostingParameters {\n");
        ...
        {
            return this.Equals(input as CaSystemCostingParameters);
        }

        /// <summary>
        /// Returns true if CaSystemCostingParameters instances are equal
        /// </summary>
        /// <param name="input">Instance of CaSystemCostingParameters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaSystemCostingParameters input)
        {
            if (input == null)
            {
                return false;
