...
{
    /// <summary>
    /// CaConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate
    /// </summary>
    [DataContract(Name = "CaConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate")]
    ...
    public partial class CaConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate : CaSubstate, IEquatable<CaConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.ConsensusManagerFieldCurrentTimeRoundedToMinutes).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate(CaConsensusManagerFieldCurrentTimeRoundedToMinutesValue value = default(CaConsensusManagerFieldCurrentTimeRoundedToMinutesValue), CaSubstateType substateType = CaSubstateType.ConsensusManagerFieldCurrentTimeRoundedToMinutes, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaConsensusManagerFieldCurrentTimeRoundedToMinutesValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate {\n");
        ...
        {
            return this.Equals(input as CaConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate);
        }

        /// <summary>
        /// Returns true if CaConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate input)
        {
            if (input == null)
            {
                return false;
