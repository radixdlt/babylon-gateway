...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiSignificantProtocolUpdateReadinessEntry")]
    public partial class CoreApiSignificantProtocolUpdateReadinessEntry : IEquatable<CoreApiSignificantProtocolUpdateReadinessEntry>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiSignificantProtocolUpdateReadinessEntry" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiSignificantProtocolUpdateReadinessEntry() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiSignificantProtocolUpdateReadinessEntry" /> class.
        /// </summary>
        /// <param name="readinessSignalName">readinessSignalName (required).</param>
        /// <param name="signalledStake">signalledStake (required).</param>
        public CoreApiSignificantProtocolUpdateReadinessEntry(string readinessSignalName = default(string), string signalledStake = default(string))
        {
            // to ensure "readinessSignalName" is required (not null)
            if (readinessSignalName == null)
            {
                throw new ArgumentNullException("readinessSignalName is a required property for CoreApiSignificantProtocolUpdateReadinessEntry and cannot be null");
            }
            this.ReadinessSignalName = readinessSignalName;
            // to ensure "signalledStake" is required (not null)
            if (signalledStake == null)
            {
                throw new ArgumentNullException("signalledStake is a required property for CoreApiSignificantProtocolUpdateReadinessEntry and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiSignificantProtocolUpdateReadinessEntry {\n");
        ...
        {
            return this.Equals(input as CoreApiSignificantProtocolUpdateReadinessEntry);
        }

        /// <summary>
        /// Returns true if CoreApiSignificantProtocolUpdateReadinessEntry instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiSignificantProtocolUpdateReadinessEntry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiSignificantProtocolUpdateReadinessEntry input)
        {
            if (input == null)
            {
                return false;
