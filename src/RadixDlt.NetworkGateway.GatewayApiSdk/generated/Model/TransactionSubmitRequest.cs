...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class TransactionSubmitRequest : IEquatable<TransactionSubmitRequest>
    {
        ...
        /// Initializes a new instance of the <see cref="TransactionSubmitRequest" /> class.
        /// </summary>
        /// <param name="notarizedTransactionHex">Hex-encoded notarized transaction payload which can be submitted. (required).</param>
        ...
        /// </summary>
        /// <value>Hex-encoded notarized transaction payload which can be submitted.</value>
