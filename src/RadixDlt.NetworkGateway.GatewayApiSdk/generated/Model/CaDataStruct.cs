...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CaDataStruct
    /// </summary>
    [DataContract(Name = "CaDataStruct")]
    public partial class CaDataStruct : IEquatable<CaDataStruct>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaDataStruct" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaDataStruct() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaDataStruct" /> class.
        /// </summary>
        ...
        public CaDataStruct(CaSborData structData = default(CaSborData), List<CaEntityReference> ownedEntities = default(List<CaEntityReference>), List<CaEntityReference> referencedEntities = default(List<CaEntityReference>))
        {
            // to ensure "structData" is required (not null)
            if (structData == null)
            {
                throw new ArgumentNullException("structData is a required property for CaDataStruct and cannot be null");
            }
            this.StructData = structData;
            // to ensure "ownedEntities" is required (not null)
            if (ownedEntities == null)
            {
                throw new ArgumentNullException("ownedEntities is a required property for CaDataStruct and cannot be null");
            }
            this.OwnedEntities = ownedEntities;
            // to ensure "referencedEntities" is required (not null)
            if (referencedEntities == null)
            {
                throw new ArgumentNullException("referencedEntities is a required property for CaDataStruct and cannot be null");
            }
        ...
        {
            return this.Equals(input as CaDataStruct);
        }

        /// <summary>
        /// Returns true if CaDataStruct instances are equal
        /// </summary>
        /// <param name="input">Instance of CaDataStruct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaDataStruct input)
        {
            if (input == null)
            {
                return false;
