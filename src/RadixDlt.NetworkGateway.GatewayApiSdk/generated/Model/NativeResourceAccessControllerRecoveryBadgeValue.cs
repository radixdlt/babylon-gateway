...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NativeResourceAccessControllerRecoveryBadgeValue")]
    ...
    public partial class NativeResourceAccessControllerRecoveryBadgeValue : NativeResourceDetails, IEquatable<NativeResourceAccessControllerRecoveryBadgeValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceAccessControllerRecoveryBadgeValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NativeResourceAccessControllerRecoveryBadgeValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceAccessControllerRecoveryBadgeValue" /> class.
        /// </summary>
        /// <param name="accessControllerAddress">Bech32m-encoded human readable version of the address. (required).</param>
        /// <param name="kind">kind (required) (default to NativeResourceKind.AccessControllerRecoveryBadge).</param>
        public NativeResourceAccessControllerRecoveryBadgeValue(string accessControllerAddress = default(string), NativeResourceKind kind = NativeResourceKind.AccessControllerRecoveryBadge) : base(kind)
        {
            // to ensure "accessControllerAddress" is required (not null)
            if (accessControllerAddress == null)
            {
                throw new ArgumentNullException("accessControllerAddress is a required property for NativeResourceAccessControllerRecoveryBadgeValue and cannot be null");
            }
        ...
        {
            return this.Equals(input as NativeResourceAccessControllerRecoveryBadgeValue);
        }

        /// <summary>
        /// Returns true if NativeResourceAccessControllerRecoveryBadgeValue instances are equal
        /// </summary>
        /// <param name="input">Instance of NativeResourceAccessControllerRecoveryBadgeValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NativeResourceAccessControllerRecoveryBadgeValue input)
        {
            if (input == null)
            {
                return false;
