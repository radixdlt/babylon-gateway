...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class EntityMetadataRequest : IEquatable<EntityMetadataRequest>
    {
        ...
        public EntityMetadataRequest(LedgerStateSelector atLedgerState = default(LedgerStateSelector), string cursor = default(string), int? limit = default(int?), string address = default(string))
        {
