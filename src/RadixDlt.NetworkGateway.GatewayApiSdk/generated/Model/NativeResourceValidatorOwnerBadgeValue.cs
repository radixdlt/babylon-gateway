...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NativeResourceValidatorOwnerBadgeValue")]
    ...
    public partial class NativeResourceValidatorOwnerBadgeValue : NativeResourceDetails, IEquatable<NativeResourceValidatorOwnerBadgeValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceValidatorOwnerBadgeValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NativeResourceValidatorOwnerBadgeValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceValidatorOwnerBadgeValue" /> class.
        /// </summary>
        /// <param name="kind">kind (required) (default to NativeResourceKind.ValidatorOwnerBadge).</param>
        public NativeResourceValidatorOwnerBadgeValue(NativeResourceKind kind = NativeResourceKind.ValidatorOwnerBadge) : base(kind)
        {
        }
        ...
        {
            return this.Equals(input as NativeResourceValidatorOwnerBadgeValue);
        }

        /// <summary>
        /// Returns true if NativeResourceValidatorOwnerBadgeValue instances are equal
        /// </summary>
        /// <param name="input">Instance of NativeResourceValidatorOwnerBadgeValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NativeResourceValidatorOwnerBadgeValue input)
        {
            if (input == null)
            {
                return false;
