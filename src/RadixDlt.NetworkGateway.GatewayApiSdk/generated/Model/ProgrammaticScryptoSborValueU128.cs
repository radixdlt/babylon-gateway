...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProgrammaticScryptoSborValueU128")]
    ...
    public partial class ProgrammaticScryptoSborValueU128 : ProgrammaticScryptoSborValue, IEquatable<ProgrammaticScryptoSborValueU128>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgrammaticScryptoSborValueU128" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProgrammaticScryptoSborValueU128() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgrammaticScryptoSborValueU128" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="kind">kind (required) (default to ProgrammaticScryptoSborValueTypeKind.U128).</param>
        /// <param name="typeName">TBD.</param>
        /// <param name="fieldName">TBD.</param>
        public ProgrammaticScryptoSborValueU128(string value = default(string), ProgrammaticScryptoSborValueTypeKind kind = ProgrammaticScryptoSborValueTypeKind.U128, string typeName = default(string), string fieldName = default(string)) : base(kind, typeName, fieldName)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for ProgrammaticScryptoSborValueU128 and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as ProgrammaticScryptoSborValueU128);
        }

        /// <summary>
        /// Returns true if ProgrammaticScryptoSborValueU128 instances are equal
        /// </summary>
        /// <param name="input">Instance of ProgrammaticScryptoSborValueU128 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProgrammaticScryptoSborValueU128 input)
        {
            if (input == null)
            {
                return false;
