...
{
    /// <summary>
    /// CaPackageBlueprintDefinitionEntrySubstate
    /// </summary>
    [DataContract(Name = "CaPackageBlueprintDefinitionEntrySubstate")]
    ...
    public partial class CaPackageBlueprintDefinitionEntrySubstate : CaSubstate, IEquatable<CaPackageBlueprintDefinitionEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPackageBlueprintDefinitionEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaPackageBlueprintDefinitionEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPackageBlueprintDefinitionEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.PackageBlueprintDefinitionEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaPackageBlueprintDefinitionEntrySubstate(CaBlueprintVersionKey key = default(CaBlueprintVersionKey), CaPackageBlueprintDefinitionEntryValue value = default(CaPackageBlueprintDefinitionEntryValue), CaSubstateType substateType = CaSubstateType.PackageBlueprintDefinitionEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CaPackageBlueprintDefinitionEntrySubstate and cannot be null");
            }
            this.Key = key;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaPackageBlueprintDefinitionEntrySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaBlueprintVersionKey Key { get; set; }

        /// <summary>
        /// Gets or Sets Value
        /// </summary>
        [DataMember(Name = "value", IsRequired = true, EmitDefaultValue = true)]
        public CaPackageBlueprintDefinitionEntryValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaPackageBlueprintDefinitionEntrySubstate {\n");
        ...
        {
            return this.Equals(input as CaPackageBlueprintDefinitionEntrySubstate);
        }

        /// <summary>
        /// Returns true if CaPackageBlueprintDefinitionEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaPackageBlueprintDefinitionEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaPackageBlueprintDefinitionEntrySubstate input)
        {
            if (input == null)
            {
                return false;
