...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class NativeResourceValidatorLiquidStakeUnitValueAllOf : IEquatable<NativeResourceValidatorLiquidStakeUnitValueAllOf>
    {
        ...
        protected NativeResourceValidatorLiquidStakeUnitValueAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceValidatorLiquidStakeUnitValueAllOf" /> class.
        /// </summary>
        ...
        public NativeResourceValidatorLiquidStakeUnitValueAllOf(string validatorAddress = default(string), int redemptionResourceCount = default(int), List<NativeResourceRedemptionValueItem> unitRedemptionValue = default(List<NativeResourceRedemptionValueItem>))
        {
            // to ensure "validatorAddress" is required (not null)
            if (validatorAddress == null)
            {
                throw new ArgumentNullException("validatorAddress is a required property for NativeResourceValidatorLiquidStakeUnitValueAllOf and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("unitRedemptionValue is a required property for NativeResourceValidatorLiquidStakeUnitValueAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NativeResourceValidatorLiquidStakeUnitValueAllOf {\n");
        ...
        {
            return this.Equals(input as NativeResourceValidatorLiquidStakeUnitValueAllOf);
        }

        /// <summary>
        /// Returns true if NativeResourceValidatorLiquidStakeUnitValueAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of NativeResourceValidatorLiquidStakeUnitValueAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NativeResourceValidatorLiquidStakeUnitValueAllOf input)
        {
            if (input == null)
            {
                return false;
