...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class ResolvedGlobalCallerBlueprintImplicitRequirement : ResolvedImplicitRequirement, IEquatable<ResolvedGlobalCallerBlueprintImplicitRequirement>
    {
        ...
        public ResolvedGlobalCallerBlueprintImplicitRequirement(long firstSeenStateVersion = default(long), string packageAddress = default(string), string blueprintName = default(string), ResolvedImplicitRequirementType type = ResolvedImplicitRequirementType.GlobalCallerBlueprint) : base(type)
        {
