...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// CoreApiNextEpoch
    /// </summary>
    [DataContract(Name = "CoreApiNextEpoch")]
    public partial class CoreApiNextEpoch : IEquatable<CoreApiNextEpoch>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiNextEpoch" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiNextEpoch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiNextEpoch" /> class.
        /// </summary>
        ...
        public CoreApiNextEpoch(long epoch = default(long), List<CoreApiActiveValidator> validators = default(List<CoreApiActiveValidator>), List<CoreApiSignificantProtocolUpdateReadinessEntry> significantProtocolUpdateReadiness = default(List<CoreApiSignificantProtocolUpdateReadinessEntry>))
        {
            this.Epoch = epoch;
            // to ensure "validators" is required (not null)
            if (validators == null)
            {
                throw new ArgumentNullException("validators is a required property for CoreApiNextEpoch and cannot be null");
            }
        ...
        public List<CoreApiActiveValidator> Validators { get; set; }
        ...
        public List<CoreApiSignificantProtocolUpdateReadinessEntry> SignificantProtocolUpdateReadiness { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiNextEpoch {\n");
        ...
        {
            return this.Equals(input as CoreApiNextEpoch);
        }

        /// <summary>
        /// Returns true if CoreApiNextEpoch instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiNextEpoch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiNextEpoch input)
        {
            if (input == null)
            {
                return false;
