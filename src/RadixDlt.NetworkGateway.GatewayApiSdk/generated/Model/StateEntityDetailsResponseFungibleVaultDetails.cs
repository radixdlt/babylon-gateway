...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class StateEntityDetailsResponseFungibleVaultDetails : StateEntityDetailsResponseItemDetails
    {
        /// <summary>
        ...
        public StateEntityDetailsResponseFungibleVaultDetails(string resourceAddress = default(string), FungibleResourcesCollectionItemVaultAggregatedVaultItem balance = default(FungibleResourcesCollectionItemVaultAggregatedVaultItem), StateEntityDetailsResponseItemDetailsType type = StateEntityDetailsResponseItemDetailsType.FungibleVault) : base(type)
        {
            // to ensure "resourceAddress" is required (not null)
            if (resourceAddress == null)
            {
                throw new ArgumentNullException("resourceAddress is a required property for StateEntityDetailsResponseFungibleVaultDetails and cannot be null");
            }
