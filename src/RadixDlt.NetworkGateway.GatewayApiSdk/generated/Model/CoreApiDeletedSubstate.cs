...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoreApiDeletedSubstate")]
    public partial class CoreApiDeletedSubstate : IEquatable<CoreApiDeletedSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiDeletedSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreApiDeletedSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreApiDeletedSubstate" /> class.
        /// </summary>
        ...
        public CoreApiDeletedSubstate(CoreApiSubstateId substateId = default(CoreApiSubstateId), CoreApiSubstateValue previousValue = default(CoreApiSubstateValue), CoreApiSubstateSystemStructure systemStructure = default(CoreApiSubstateSystemStructure))
        {
            // to ensure "substateId" is required (not null)
            if (substateId == null)
            {
                throw new ArgumentNullException("substateId is a required property for CoreApiDeletedSubstate and cannot be null");
            }
            this.SubstateId = substateId;
            // to ensure "systemStructure" is required (not null)
            if (systemStructure == null)
            {
                throw new ArgumentNullException("systemStructure is a required property for CoreApiDeletedSubstate and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CoreApiDeletedSubstate {\n");
        ...
        {
            return this.Equals(input as CoreApiDeletedSubstate);
        }

        /// <summary>
        /// Returns true if CoreApiDeletedSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CoreApiDeletedSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoreApiDeletedSubstate input)
        {
            if (input == null)
            {
                return false;
