...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EntitiesByNonFungibleRoleRequirementItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EntitiesByNonFungibleRoleRequirementItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EntitiesByNonFungibleRoleRequirementItem" /> class.
        /// </summary>
        ...
        public EntitiesByNonFungibleRoleRequirementItem(string resourceAddress = default(string), string nonFungibleId = default(string), EntitiesByRoleRequirementRequirementType requirementType = default(EntitiesByRoleRequirementRequirementType), long firstSeenStateVersion = default(long)) : base(requirementType, firstSeenStateVersion)
        {
            ...
            {
                throw new ArgumentNullException("resourceAddress is a required property for EntitiesByNonFungibleRoleRequirementItem and cannot be null");
            }
            this.ResourceAddress = resourceAddress;
            // to ensure "nonFungibleId" is required (not null)
            if (nonFungibleId == null)
            {
                throw new ArgumentNullException("nonFungibleId is a required property for EntitiesByNonFungibleRoleRequirementItem and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EntitiesByNonFungibleRoleRequirementItem {\n");
        ...
        {
            return this.Equals(input as EntitiesByNonFungibleRoleRequirementItem);
        }

        /// <summary>
        /// Returns true if EntitiesByNonFungibleRoleRequirementItem instances are equal
        /// </summary>
        /// <param name="input">Instance of EntitiesByNonFungibleRoleRequirementItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntitiesByNonFungibleRoleRequirementItem input)
        {
            if (input == null)
            {
                return false;
