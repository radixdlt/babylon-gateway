...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class TransactionStatusRequest : IEquatable<TransactionStatusRequest>
    {
        ...
        public TransactionStatusRequest(string intentHashHex = default(string))
        {
            // to ensure "intentHashHex" is required (not null)
            if (intentHashHex == null)
            {
                throw new ArgumentNullException("intentHashHex is a required property for TransactionStatusRequest and cannot be null");
            }
