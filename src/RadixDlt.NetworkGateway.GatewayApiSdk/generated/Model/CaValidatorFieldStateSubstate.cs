...
{
    /// <summary>
    /// CaValidatorFieldStateSubstate
    /// </summary>
    [DataContract(Name = "CaValidatorFieldStateSubstate")]
    ...
    public partial class CaValidatorFieldStateSubstate : CaSubstate, IEquatable<CaValidatorFieldStateSubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaValidatorFieldStateSubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaValidatorFieldStateSubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaValidatorFieldStateSubstate" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.ValidatorFieldState).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaValidatorFieldStateSubstate(CaValidatorFieldStateValue value = default(CaValidatorFieldStateValue), CaSubstateType substateType = CaSubstateType.ValidatorFieldState, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaValidatorFieldStateSubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaValidatorFieldStateValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaValidatorFieldStateSubstate {\n");
        ...
        {
            return this.Equals(input as CaValidatorFieldStateSubstate);
        }

        /// <summary>
        /// Returns true if CaValidatorFieldStateSubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaValidatorFieldStateSubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaValidatorFieldStateSubstate input)
        {
            if (input == null)
            {
                return false;
