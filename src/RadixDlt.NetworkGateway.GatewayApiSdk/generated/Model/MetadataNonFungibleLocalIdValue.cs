...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MetadataNonFungibleLocalIdValue")]
    ...
    public partial class MetadataNonFungibleLocalIdValue : MetadataTypedValue, IEquatable<MetadataNonFungibleLocalIdValue>
    {
        ...
        protected MetadataNonFungibleLocalIdValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataNonFungibleLocalIdValue" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="type">type (required) (default to MetadataValueType.NonFungibleLocalId).</param>
        public MetadataNonFungibleLocalIdValue(string value = default(string), MetadataValueType type = MetadataValueType.NonFungibleLocalId) : base(type)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for MetadataNonFungibleLocalIdValue and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as MetadataNonFungibleLocalIdValue);
        }

        /// <summary>
        /// Returns true if MetadataNonFungibleLocalIdValue instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataNonFungibleLocalIdValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataNonFungibleLocalIdValue input)
        {
            if (input == null)
            {
                return false;
