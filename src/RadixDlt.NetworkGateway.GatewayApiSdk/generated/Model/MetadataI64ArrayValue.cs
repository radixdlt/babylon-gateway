...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MetadataI64ArrayValue")]
    ...
    public partial class MetadataI64ArrayValue : MetadataTypedValue, IEquatable<MetadataI64ArrayValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataI64ArrayValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetadataI64ArrayValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataI64ArrayValue" /> class.
        /// </summary>
        /// <param name="values">values (required).</param>
        /// <param name="type">type (required) (default to MetadataValueType.I64Array).</param>
        public MetadataI64ArrayValue(List<string> values = default(List<string>), MetadataValueType type = MetadataValueType.I64Array) : base(type)
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for MetadataI64ArrayValue and cannot be null");
            }
            this.Values = values;
        }
        ...
        {
            return this.Equals(input as MetadataI64ArrayValue);
        }

        /// <summary>
        /// Returns true if MetadataI64ArrayValue instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataI64ArrayValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataI64ArrayValue input)
        {
            if (input == null)
            {
                return false;
