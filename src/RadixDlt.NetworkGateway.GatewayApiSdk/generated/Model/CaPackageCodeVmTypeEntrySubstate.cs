...
{
    /// <summary>
    /// CaPackageCodeVmTypeEntrySubstate
    /// </summary>
    [DataContract(Name = "CaPackageCodeVmTypeEntrySubstate")]
    ...
    public partial class CaPackageCodeVmTypeEntrySubstate : CaSubstate, IEquatable<CaPackageCodeVmTypeEntrySubstate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPackageCodeVmTypeEntrySubstate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaPackageCodeVmTypeEntrySubstate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaPackageCodeVmTypeEntrySubstate" /> class.
        /// </summary>
        /// <param name="key">key (required).</param>
        /// <param name="value">value (required).</param>
        /// <param name="substateType">substateType (required) (default to CaSubstateType.PackageCodeVmTypeEntry).</param>
        /// <param name="isLocked">isLocked (required).</param>
        public CaPackageCodeVmTypeEntrySubstate(CaPackageCodeKey key = default(CaPackageCodeKey), CaPackageCodeVmTypeEntryValue value = default(CaPackageCodeVmTypeEntryValue), CaSubstateType substateType = CaSubstateType.PackageCodeVmTypeEntry, bool isLocked = default(bool)) : base(substateType, isLocked)
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for CaPackageCodeVmTypeEntrySubstate and cannot be null");
            }
            this.Key = key;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for CaPackageCodeVmTypeEntrySubstate and cannot be null");
            }
            this.Value = value;
        }
        ...
        public CaPackageCodeVmTypeEntryValue Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaPackageCodeVmTypeEntrySubstate {\n");
        ...
        {
            return this.Equals(input as CaPackageCodeVmTypeEntrySubstate);
        }

        /// <summary>
        /// Returns true if CaPackageCodeVmTypeEntrySubstate instances are equal
        /// </summary>
        /// <param name="input">Instance of CaPackageCodeVmTypeEntrySubstate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaPackageCodeVmTypeEntrySubstate input)
        {
            if (input == null)
            {
                return false;
