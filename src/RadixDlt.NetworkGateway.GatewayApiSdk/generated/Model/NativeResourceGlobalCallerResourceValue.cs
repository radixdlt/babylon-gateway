...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NativeResourceGlobalCallerResourceValue")]
    ...
    public partial class NativeResourceGlobalCallerResourceValue : NativeResourceDetails, IEquatable<NativeResourceGlobalCallerResourceValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceGlobalCallerResourceValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NativeResourceGlobalCallerResourceValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeResourceGlobalCallerResourceValue" /> class.
        /// </summary>
        /// <param name="kind">kind (required) (default to NativeResourceKind.GlobalCallerResource).</param>
        public NativeResourceGlobalCallerResourceValue(NativeResourceKind kind = NativeResourceKind.GlobalCallerResource) : base(kind)
        {
        }
        ...
        {
            return this.Equals(input as NativeResourceGlobalCallerResourceValue);
        }

        /// <summary>
        /// Returns true if NativeResourceGlobalCallerResourceValue instances are equal
        /// </summary>
        /// <param name="input">Instance of NativeResourceGlobalCallerResourceValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NativeResourceGlobalCallerResourceValue input)
        {
            if (input == null)
            {
                return false;
