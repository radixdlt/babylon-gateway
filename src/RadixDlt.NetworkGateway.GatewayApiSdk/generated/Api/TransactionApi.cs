...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Api
{
    ...
    public interface ITransactionApiSync : IApiAccessor
    {
        ...
        /// </summary>
        /// <remarks>
        /// Returns the status and contents of the transaction for a given transaction identifier. Transaction identifiers which aren&#39;t recognised as either belonging to a committed transaction or a transaction submitted through this Network Gateway may return a &#x60;TransactionNotFoundError&#x60;. Transaction identifiers relating to failed transactions will, after a delay, also be reported as a &#x60;TransactionNotFoundError&#x60;. 
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Returns all the information needed to construct new transaction. 
        /// </remarks>
        /// <exception cref="RadixDlt.NetworkGateway.GatewayApiSdk.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    public partial class TransactionApi : IDisposable, ITransactionApi
    {
        ...
        /// <summary>
        /// Construction Returns all the information needed to construct new transaction. 
        /// </summary>
        /// <exception cref="RadixDlt.NetworkGateway.GatewayApiSdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>TransactionConstructionResponse</returns>
        ...
        /// <summary>
        /// Transaction Status Returns overall transaction status and all of its known payloads based on supplied intent hash. 
        /// </summary>
        /// <exception cref="RadixDlt.NetworkGateway.GatewayApiSdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="transactionStatusRequest"></param>
        /// <returns>TransactionStatusResponse</returns>
