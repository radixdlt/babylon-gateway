...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Api
{
    ...
    public interface IStreamApiSync : IApiAccessor
    {
        ...
        /// </summary>
        /// <remarks>
        /// Returns user-initiated transactions which have been committed to the ledger. Returned response is in a paginated format, ordered by most recent. 
        /// </remarks>
    ...
    public partial class StreamApi : IDisposable, IStreamApi
    {
        ...
        /// <summary>
        /// Recent Transactions Returns user-initiated transactions which have been committed to the ledger. Returned response is in a paginated format, ordered by most recent. 
        /// </summary>
        /// <exception cref="RadixDlt.NetworkGateway.GatewayApiSdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="transactionRecentRequest"></param>
        /// <returns>TransactionRecentResponse</returns>
