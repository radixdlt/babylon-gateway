...
namespace RadixDlt.CoreApiSdk.GenericHost.Model
{
    ...
    public static class ResourceTypeValueConverter
    {
        ...
        {
            if (value.Equals("Fungible"))
                return ResourceType.Fungible;

            if (value.Equals("NonFungible"))
                return ResourceType.NonFungible;
        ...
        {
            if (value == ResourceType.Fungible)
                return "Fungible";

            if (value == ResourceType.NonFungible)
                return "NonFungible";
    ...
    public class ResourceTypeNullableJsonConverter : JsonConverter<ResourceType?>
    {
        ...
        public override void Write(Utf8JsonWriter writer, ResourceType? resourceType, JsonSerializerOptions options)
        {
            writer.WriteStringValue(resourceType?.ToString() ?? "null");
        }
    }
}
