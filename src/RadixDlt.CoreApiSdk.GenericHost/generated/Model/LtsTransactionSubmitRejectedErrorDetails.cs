...
namespace RadixDlt.CoreApiSdk.GenericHost.Model
{
    ...
    // moje start
    // moje end
public partial class LtsTransactionSubmitRejectedErrorDetails : LtsTransactionSubmitErrorDetails
{
    /// <summary>
...
return sb.ToString();
    ...
    /// <summary>
    /// A Json converter for type <see cref="LtsTransactionSubmitRejectedErrorDetails" />
    /// </summary>
    public class LtsTransactionSubmitRejectedErrorDetailsJsonConverter : JsonConverter<LtsTransactionSubmitRejectedErrorDetails>
    {
        /// <summary>
        /// Deserializes json to <see cref="LtsTransactionSubmitRejectedErrorDetails" />
        /// </summary>
        ...
        public override LtsTransactionSubmitRejectedErrorDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<LtsTransactionSubmitErrorDetailsType?> type = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<LtsTransactionSubmitErrorDetailsType?>(LtsTransactionSubmitErrorDetailsTypeValueConverter.FromStringOrDefault(typeRawValue));
                            break;
            ...
            if (!errorMessage.IsSet)
                throw new ArgumentException("Property is required for class LtsTransactionSubmitRejectedErrorDetails.", nameof(errorMessage));

            if (!isFresh.IsSet)
                throw new ArgumentException("Property is required for class LtsTransactionSubmitRejectedErrorDetails.", nameof(isFresh));

            if (!isIntentRejectionPermanent.IsSet)
                throw new ArgumentException("Property is required for class LtsTransactionSubmitRejectedErrorDetails.", nameof(isIntentRejectionPermanent));

            if (!isPayloadRejectionPermanent.IsSet)
                throw new ArgumentException("Property is required for class LtsTransactionSubmitRejectedErrorDetails.", nameof(isPayloadRejectionPermanent));

            if (!type.IsSet)
                throw new ArgumentException("Property is required for class LtsTransactionSubmitRejectedErrorDetails.", nameof(type));

            if (errorMessage.IsSet && errorMessage.Value == null)
                throw new ArgumentNullException(nameof(errorMessage), "Property is not nullable for class LtsTransactionSubmitRejectedErrorDetails.");

            if (isFresh.IsSet && isFresh.Value == null)
                throw new ArgumentNullException(nameof(isFresh), "Property is not nullable for class LtsTransactionSubmitRejectedErrorDetails.");

            if (isIntentRejectionPermanent.IsSet && isIntentRejectionPermanent.Value == null)
                throw new ArgumentNullException(nameof(isIntentRejectionPermanent), "Property is not nullable for class LtsTransactionSubmitRejectedErrorDetails.");

            if (isPayloadRejectionPermanent.IsSet && isPayloadRejectionPermanent.Value == null)
                throw new ArgumentNullException(nameof(isPayloadRejectionPermanent), "Property is not nullable for class LtsTransactionSubmitRejectedErrorDetails.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class LtsTransactionSubmitRejectedErrorDetails.");

            if (invalidFromEpoch.IsSet && invalidFromEpoch.Value == null)
                throw new ArgumentNullException(nameof(invalidFromEpoch), "Property is not nullable for class LtsTransactionSubmitRejectedErrorDetails.");

            if (retryFromEpoch.IsSet && retryFromEpoch.Value == null)
                throw new ArgumentNullException(nameof(retryFromEpoch), "Property is not nullable for class LtsTransactionSubmitRejectedErrorDetails.");

            if (retryFromTimestamp.IsSet && retryFromTimestamp.Value == null)
                throw new ArgumentNullException(nameof(retryFromTimestamp), "Property is not nullable for class LtsTransactionSubmitRejectedErrorDetails.");

            return new LtsTransactionSubmitRejectedErrorDetails(errorMessage.Value!, isFresh.Value!.Value!, isIntentRejectionPermanent.Value!.Value!, isPayloadRejectionPermanent.Value!.Value!, type.Value!.Value!, invalidFromEpoch, retryFromEpoch, retryFromTimestamp);
        }

        /// <summary>
        /// Serializes a <see cref="LtsTransactionSubmitRejectedErrorDetails" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="ltsTransactionSubmitRejectedErrorDetails"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, LtsTransactionSubmitRejectedErrorDetails ltsTransactionSubmitRejectedErrorDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(ref writer, ltsTransactionSubmitRejectedErrorDetails, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="LtsTransactionSubmitRejectedErrorDetails" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="ltsTransactionSubmitRejectedErrorDetails"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, LtsTransactionSubmitRejectedErrorDetails ltsTransactionSubmitRejectedErrorDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            if (ltsTransactionSubmitRejectedErrorDetails.ErrorMessage == null)
                throw new ArgumentNullException(nameof(ltsTransactionSubmitRejectedErrorDetails.ErrorMessage), "Property is required for class LtsTransactionSubmitRejectedErrorDetails.");

            if (ltsTransactionSubmitRejectedErrorDetails.RetryFromTimestampOption.IsSet && ltsTransactionSubmitRejectedErrorDetails.RetryFromTimestamp == null)
                throw new ArgumentNullException(nameof(ltsTransactionSubmitRejectedErrorDetails.RetryFromTimestamp), "Property is required for class LtsTransactionSubmitRejectedErrorDetails.");

            writer.WriteString("error_message", ltsTransactionSubmitRejectedErrorDetails.ErrorMessage);

            writer.WriteBoolean("is_fresh", ltsTransactionSubmitRejectedErrorDetails.IsFresh);

            writer.WriteBoolean("is_intent_rejection_permanent", ltsTransactionSubmitRejectedErrorDetails.IsIntentRejectionPermanent);

            writer.WriteBoolean("is_payload_rejection_permanent", ltsTransactionSubmitRejectedErrorDetails.IsPayloadRejectionPermanent);

            var typeRawValue = LtsTransactionSubmitErrorDetailsTypeValueConverter.ToJsonValue(ltsTransactionSubmitRejectedErrorDetails.Type);
            writer.WriteString("type", typeRawValue);

            if (ltsTransactionSubmitRejectedErrorDetails.InvalidFromEpochOption.IsSet)
                writer.WriteNumber("invalid_from_epoch", ltsTransactionSubmitRejectedErrorDetails.InvalidFromEpochOption.Value!.Value);

            if (ltsTransactionSubmitRejectedErrorDetails.RetryFromEpochOption.IsSet)
                writer.WriteNumber("retry_from_epoch", ltsTransactionSubmitRejectedErrorDetails.RetryFromEpochOption.Value!.Value);

            if (ltsTransactionSubmitRejectedErrorDetails.RetryFromTimestampOption.IsSet)
            {
                writer.WritePropertyName("retry_from_timestamp");
                JsonSerializer.Serialize(writer, ltsTransactionSubmitRejectedErrorDetails.RetryFromTimestamp, jsonSerializerOptions);
            }
        }
    }
}
