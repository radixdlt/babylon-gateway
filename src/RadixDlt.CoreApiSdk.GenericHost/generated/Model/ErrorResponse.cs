...
public partial class ErrorResponse
{
    /// <summary>
        ...
        [JsonConstructor]
    public ErrorResponse(int code, ErrorResponseType errorType, string message, Option<string?> traceId = default)
    {
            Code = code;
            ErrorType = errorType;
            Message = message;
...
return sb.ToString();
    ...
    public class ErrorResponseJsonConverter : JsonConverter<ErrorResponse>
    {
        ...
        public override ErrorResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new ErrorResponse(code.Value!.Value!, errorType.Value!.Value!, message.Value!, traceId);
        }
        ...
        public void WriteProperties(ref Utf8JsonWriter writer, ErrorResponse errorResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var errorTypeRawValue = ErrorResponseTypeValueConverter.ToJsonValue(errorResponse.ErrorType);
