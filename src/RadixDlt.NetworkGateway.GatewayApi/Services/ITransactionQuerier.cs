...
public interface ITransactionQuerier
{
    ...
    Task<DetailsLookupResult?> LookupCommittedTransaction(byte[] intentHash, List<GatewayModel.TransactionCommittedDetailsRequest.OptInPropertiesEnum>? optInProperties,  GatewayModel.LedgerState ledgerState, bool withDetails, CancellationToken token = default);
