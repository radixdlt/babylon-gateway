...
public static class ServiceCollectionExtensions
{
    ...
    public static GatewayApiBuilder AddNetworkGatewayApiCore(this IServiceCollection services)
    {
        ...
        services
            ...
            .AddValidatableOptionsAtSection<SlowRequestLoggingOptions, SlowRequestLoggingOptionsValidator>("GatewayApi:SlowRequestLogging")
    ...
    private static void AddRequestServices(IServiceCollection services)
    {
        ...
        services.TryAddScoped<IExtensionsHandler, DefaultExtensionsHandler>();
