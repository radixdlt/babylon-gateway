...
internal class DefaultSborHandler : ISborHandler
{
    private readonly INetworkConfigurationProvider _networkConfigurationProvider;

    public DefaultSborHandler(INetworkConfigurationProvider networkConfigurationProvider)
    {
    ...
    public Task<GatewayModel.SborScryptoEncodeResponse> Encode(GatewayModel.SborScryptoEncodeRequest request, CancellationToken token = default)
    {
        ...
        var result = RadixEngineToolkit.RadixEngineToolkit.ScryptoSborEncode(value);
    ...
    public Task<GatewayModel.SborScryptoDecodeResponse> Decode(GatewayModel.SborScryptoDecodeRequest request, CancellationToken token = default)
    {
        ...
        var result = RadixEngineToolkit.RadixEngineToolkit.ScryptoSborEncodeJson(scryptoSbor.Value);

        return Task.FromResult(new GatewayModel.SborScryptoDecodeResponse(new JRaw(result)));
    }
}
