...
namespace DataAggregator.Migrations
{
    ...
    [Migration("20211210045818_UpdatesToMempoolTransactionsTable")]
    partial class UpdatesToMempoolTransactionsTable
    {
            ...
            modelBuilder.Entity("Common.Database.Models.Mempool.MempoolTransaction", b =>
                {
                    ...
                    b.Property<string>("SubmissionFailureReason")
                        .HasColumnType("text")
                        .HasColumnName("submission_failure_reason");

                    b.Property<bool>("SubmittedByThisGateway")
                        .HasColumnType("boolean")
                        .HasColumnName("submitted_by_this_gateway");

                    b.Property<GatewayTransactionContents>("TransactionsContents")
                        .IsRequired()
                        .HasColumnType("jsonb")
