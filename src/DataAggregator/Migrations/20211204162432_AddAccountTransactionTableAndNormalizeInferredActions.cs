...
{
    public partial class AddAccountTransactionTableAndNormalizeInferredActions : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropColumn(
                name: "inferred_action_from",
                table: "operation_groups");

            migrationBuilder.DropColumn(
                name: "inferred_action_rri",
                table: "operation_groups");

            migrationBuilder.DropColumn(
                name: "inferred_action_to",
                table: "operation_groups");

            migrationBuilder.AddColumn<long>(
                name: "inferred_action_from_account_id",
                table: "operation_groups",
                type: "bigint",
                nullable: true);

            migrationBuilder.AddColumn<long>(
                name: "inferred_action_resource_id",
                table: "operation_groups",
                type: "bigint",
                nullable: true);

            migrationBuilder.AddColumn<long>(
                name: "inferred_action_to_account_id",
                table: "operation_groups",
                type: "bigint",
                nullable: true);

            migrationBuilder.AddColumn<long>(
                name: "inferred_action_validator_id",
                table: "operation_groups",
                type: "bigint",
                nullable: true);
