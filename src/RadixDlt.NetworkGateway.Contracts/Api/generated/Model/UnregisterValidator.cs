...
namespace RadixDlt.NetworkGateway.Contracts.Api.Model
{
    ...
    /// UnregisterValidator
    /// </summary>
    [DataContract(Name = "UnregisterValidator")]
    ...
    public partial class UnregisterValidator : Action, IEquatable<UnregisterValidator>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnregisterValidator" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UnregisterValidator() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UnregisterValidator" /> class.
        /// </summary>
        /// <param name="validator">validator (required).</param>
        /// <param name="type">type (required) (default to &quot;UnregisterValidator&quot;).</param>
        public UnregisterValidator(ValidatorIdentifier validator = default(ValidatorIdentifier), string type = "UnregisterValidator") : base(type)
        {
            // to ensure "validator" is required (not null)
            if (validator == null)
            {
                throw new ArgumentNullException("validator is a required property for UnregisterValidator and cannot be null");
            }
        ...
        {
            return this.Equals(input as UnregisterValidator);
        }

        /// <summary>
        /// Returns true if UnregisterValidator instances are equal
        /// </summary>
        /// <param name="input">Instance of UnregisterValidator to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnregisterValidator input)
        {
            if (input == null)
            {
                return false;
