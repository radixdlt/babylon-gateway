...
namespace RadixDlt.NetworkGateway.Contracts.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NotEnoughTokensForStakeError")]
    ...
    public partial class NotEnoughTokensForStakeError : GatewayError, IEquatable<NotEnoughTokensForStakeError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotEnoughTokensForStakeError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NotEnoughTokensForStakeError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NotEnoughTokensForStakeError" /> class.
        /// </summary>
        /// <param name="requestedAmount">requestedAmount (required).</param>
        /// <param name="availableAmount">availableAmount (required).</param>
        /// <param name="type">The type of error. Each subtype may have its own additional structured fields. (required) (default to &quot;NotEnoughTokensForStakeError&quot;).</param>
        public NotEnoughTokensForStakeError(TokenAmount requestedAmount = default(TokenAmount), TokenAmount availableAmount = default(TokenAmount), string type = "NotEnoughTokensForStakeError") : base(type)
        {
            // to ensure "requestedAmount" is required (not null)
            if (requestedAmount == null)
            {
                throw new ArgumentNullException("requestedAmount is a required property for NotEnoughTokensForStakeError and cannot be null");
            }
            this.RequestedAmount = requestedAmount;
            // to ensure "availableAmount" is required (not null)
            if (availableAmount == null)
            {
                throw new ArgumentNullException("availableAmount is a required property for NotEnoughTokensForStakeError and cannot be null");
            }
        ...
        {
            return this.Equals(input as NotEnoughTokensForStakeError);
        }

        /// <summary>
        /// Returns true if NotEnoughTokensForStakeError instances are equal
        /// </summary>
        /// <param name="input">Instance of NotEnoughTokensForStakeError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotEnoughTokensForStakeError input)
        {
            if (input == null)
            {
                return false;
