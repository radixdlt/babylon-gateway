...
public static class Program
{
    ...
    public static async Task Main(string[] args)
    {
        ...
        al.ApplicationStarted.Register(() => logger.LogError("DEVOPS_TRACKER: GW_API STARTED"));
        al.ApplicationStopping.Register(() => logger.LogError("DEVOPS_TRACKER: GW_API STOPPING"));
        al.ApplicationStopped.Register(() => logger.LogError("DEVOPS_TRACKER: GW_API STOPPED"));
