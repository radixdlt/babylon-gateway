...
dotnet ef migrations add "$MigrationName" --project src/RadixDlt.NetworkGateway.PostgresIntegration --startup-project apps/DatabaseMigrations --context MigrationsDbContext
